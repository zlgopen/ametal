...
/**
 * \addtogroup am_if_src_hwconf_hc32f19x_wdt
 * \copydoc am_hwconf_hc32f19x_wdt.c
 * @{
 */

/** \brief WDT 平台初始化 */
static void __hc32f19x_wdt_plfm_init (void)
{
    am_clk_enable(CLK_WDT);
}

/** \brief 解除WDT 平台初始化 */
static void __hc32f19x_wdt_plfm_deinit (void)
{
...
static const am_hc32_wdt_devinfo_t  __g_wdt_devinfo = {
    ...
    CLK_WDT,                  /**< \brief 时钟ID */
    __hc32f19x_wdt_plfm_init,   /**< \brief WDT 平台初始化 */
    __hc32f19x_wdt_plfm_deinit, /**< \brief 解除WDT 平台初始化 */
};
