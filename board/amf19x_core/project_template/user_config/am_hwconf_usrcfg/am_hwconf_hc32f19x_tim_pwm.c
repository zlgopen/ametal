 ...
 * \sa am_hwconf_hc32f19x_tim_pwm.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_hc32f19x_tim_pwm
 * \copydoc am_hwconf_hc32f19x_tim_pwm.c
 * @{
 */
/*******************************************************************************
  TIM0 配置
...
void __hc32f19x_plfm_tim0_pwm_init (void)
{
    am_clk_enable(CLK_TIM012);
}

/** \brief 解除TIM0平台初始化 */
void __hc32f19x_plfm_tim0_pwm_deinit (void)
{
...
const am_hc32_tim_pwm_devinfo_t  __g_tim0_pwm_devinfo = {
    ...
    __hc32f19x_plfm_tim0_pwm_init,                /**< \brief 平台初始化函数 */
    __hc32f19x_plfm_tim0_pwm_deinit               /**< \brief 平台解初始化函数 */
};
...
void __hc32f19x_plfm_tim1_pwm_init (void)
{
    am_clk_enable(CLK_TIM012);
}

/** \brief 解除TIM1平台初始化 */
void __hc32f19x_plfm_tim1_pwm_deinit (void)
{
    am_clk_disable(CLK_TIM012);
}
...
const am_hc32_tim_pwm_devinfo_t  __g_tim1_pwm_devinfo = {
    ...
    __hc32f19x_plfm_tim1_pwm_init,                /**< \brief 平台初始化函数 */
    __hc32f19x_plfm_tim1_pwm_deinit               /**< \brief 平台解初始化函数 */
};
...
void __hc32f19x_plfm_tim2_pwm_init (void)
{
    am_clk_enable(CLK_TIM012);
}

/** \brief 解除TIM2平台初始化 */
void __hc32f19x_plfm_tim2_pwm_deinit (void)
{
    am_clk_disable(CLK_TIM012);
}
...
const am_hc32_tim_pwm_devinfo_t  __g_tim2_pwm_devinfo = {
    ...
    __hc32f19x_plfm_tim2_pwm_init,                /**< \brief 平台初始化函数 */
    __hc32f19x_plfm_tim2_pwm_deinit               /**< \brief 平台解初始化函数 */
};
...
void __hc32f19x_plfm_tim3_pwm_init (void)
{
    am_clk_enable(CLK_TIM3);
}

/** \brief 解除TIM3平台初始化 */
void __hc32f19x_plfm_tim3_pwm_deinit (void)
{
...
const am_hc32_tim_pwm_devinfo_t  __g_tim3_pwm_devinfo = {
    ...
    __hc32f19x_plfm_tim3_pwm_init,                /**< \brief 平台初始化函数 */
    __hc32f19x_plfm_tim3_pwm_deinit               /**< \brief 平台解初始化函数 */
};
...
void __hc32f19x_plfm_adtim4_pwm_init (void)
{
    am_clk_enable(CLK_TIM456);
}

/** \brief 解除ADTIM4平台初始化 */
void __hc32f19x_plfm_adtim4_pwm_deinit (void)
{
...
const am_hc32_adtim_pwm_devinfo_t  __g_adtim4_pwm_devinfo = {
    ...
    __hc32f19x_plfm_adtim4_pwm_init,              /**< \brief 平台初始化函数 */
    __hc32f19x_plfm_adtim4_pwm_deinit             /**< \brief 平台解初始化函数 */
};
...
void __hc32f19x_plfm_adtim5_pwm_init (void)
{
    am_clk_enable(CLK_TIM456);
}

/** \brief 解除ADTIM5平台初始化 */
void __hc32f19x_plfm_adtim5_pwm_deinit (void)
{
    am_clk_disable(CLK_TIM456);
}
...
const am_hc32_adtim_pwm_devinfo_t  __g_adtim5_pwm_devinfo = {
    ...
    __hc32f19x_plfm_adtim5_pwm_init,              /**< \brief 平台初始化函数 */
    __hc32f19x_plfm_adtim5_pwm_deinit             /**< \brief 平台解初始化函数 */
};
...
void __hc32f19x_plfm_adtim6_pwm_init (void)
{
    am_clk_enable(CLK_TIM456);
}

/** \brief 解除ADTIM6平台初始化 */
void __hc32f19x_plfm_adtim6_pwm_deinit (void)
{
    am_clk_disable(CLK_TIM456);
}
...
const am_hc32_adtim_pwm_devinfo_t  __g_adtim6_pwm_devinfo = {
    ...
    __hc32f19x_plfm_adtim6_pwm_init,              /**< \brief 平台初始化函数 */
    __hc32f19x_plfm_adtim6_pwm_deinit             /**< \brief 平台解初始化函数 */
};
