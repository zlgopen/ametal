...
#ifndef __AM_HK32F103RBT6_INST_INIT_H
#define __AM_HK32F103RBT6_INST_INIT_H
...
/**
 * \addtogroup am_if_hk32f103rbt6_inst_init
 * \copydoc am_hk32f103rbt6_inst_init.h
 * @{
 */
 ...
 */
int am_hk32f103rbt6_nvic_inst_init (void);
 ...
 * \return 无
 */
void am_hk32f103rbt6_nvic_inst_deinit (void);
 ...
 */
am_ili9341_handle_t am_hk32f103rbt6_ili9341_inst_init (void);

/**
 * \brief ILI9341 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_ili9341_inst_init() 函数获得的 ILI9341
 *                   标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_ili9341_inst_deinit (am_ili9341_handle_t handle);
 ...
 * \brief ADC1 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_adc1_inst_init() 函数获得的 ADC 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief ADC2 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_adc2_inst_init() 函数获得的 ADC 标准服务句柄
 *
 * \return 无
 */
 ...
 */
am_crc_handle_t am_hk32f103rbt6_crc_inst_init (void);

/**
 * \brief CRC 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_crc_inst_init() 函数获得的 CRC 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_crc_inst_deinit (am_crc_handle_t handle);
 ...
 */
am_dac_handle_t am_hk32f103rbt6_dac1_inst_init (void);

/**
 * \brief DAC1 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_dac1_inst_init() 函数获得的 DAC 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_dac1_inst_deinit (am_dac_handle_t handle);
 ...
 * \return DAC 标准服务句柄，若为 NULL，表明初始化失败
 */
am_dac_handle_t am_hk32f103rbt6_dac2_inst_init (void);

/**
 * \brief DAC2 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_dac2_inst_init() 函数获得的 DAC 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_dac2_inst_deinit (am_dac_handle_t handle);
 ...
 * \brief I2C1 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_i2c1_inst_init() 函数获得的 I2C 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief I2C2 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_i2c2_inst_init() 函数获得的 I2C 标准服务句柄
 *
 * \return 无
 */
 ...
 */
am_i2c_slv_handle_t am_hk32f103rbt6_i2c1_slv_inst_init (void);

/**
 * \brief I2C1 从机实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_i2c1_slv_inst_init() 函数
 *                   获得的 I2C 从机标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_i2c1_slv_inst_deinit (am_i2c_slv_handle_t handle);
 ...
 * \return I2C 从机标准服务句柄，若为 NULL，表明初始化失败
 */
am_i2c_slv_handle_t am_hk32f103rbt6_i2c2_slv_inst_init (void);

/**
 * \brief I2C2 从机实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_i2c2_slv_inst_init() 函数
 *                   获得的 I2C 从机标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_i2c2_slv_inst_deinit (am_i2c_slv_handle_t handle);
 ...
 * \brief IWDG 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_iwdg_inst_init() 函数获得的 WDT 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief RTC 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_rtc_inst_init() 函数获得的 RTC 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_hk32f103rbt6_spi1_poll_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_hk32f103rbt6_spi2_poll_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_hk32f103rbt6_spi1_dma_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_hk32f103rbt6_spi2_dma_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
 ...
 * \return SPI 标准服务句柄，若为 NULL，表明初始化失败
 */
am_spi_handle_t am_hk32f103rbt6_spi1_int_inst_init (void);

/**
 * \brief SPI1 INT 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_spi1_int_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_spi1_int_inst_deinit (am_spi_handle_t handle);
 ...
 * \return SPI 标准服务句柄，若为 NULL，表明初始化失败
 */
am_spi_handle_t am_hk32f103rbt6_spi2_int_inst_init (void);

/**
 * \brief SPI2 INT 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_spi2_int_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_spi2_int_inst_deinit (am_spi_handle_t handle);
 ...
 *
 * \param[in] handle 通过 am_hk32f103rbt6_spi1_slv_dma_inst_init() 函数
 *                   获得的 SPI SLV标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_hk32f103rbt6_spi2_slv_dma_inst_init() 函数
 *                   获得的 SPI SLV标准服务句柄
 *
 * \return 无
 */
 ...
 */
am_timer_handle_t am_hk32f103rbt6_systick_inst_init (void);

/**
 * \brief SYSTICK 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_systick_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_systick_inst_deinit (am_timer_handle_t handle);
 ...
 */
am_cap_handle_t am_hk32f103rbt6_tim1_cap_inst_init (void);

/**
 * \brief TIM1 CAP 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_tim1_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_tim1_cap_inst_deinit (am_cap_handle_t handle);
 ...
 * \return CAP 标准服务句柄，若为 NULL，表明初始化失败
 */
am_cap_handle_t am_hk32f103rbt6_tim2_cap_inst_init (void);

/**
 * \brief TIM2 CAP 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_tim2_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_tim2_cap_inst_deinit (am_cap_handle_t handle);
 ...
 * \return CAP 标准服务句柄，若为 NULL，表明初始化失败
 */
am_cap_handle_t am_hk32f103rbt6_tim3_cap_inst_init (void);

/**
 * \brief TIM3 CAP 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_tim3_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_tim3_cap_inst_deinit (am_cap_handle_t handle);
 ...
 * \return CAP 标准服务句柄，若为 NULL，表明初始化失败
 */
am_cap_handle_t am_hk32f103rbt6_tim4_cap_inst_init (void);

/**
 * \brief TIM4 CAP 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_tim4_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_tim4_cap_inst_deinit (am_cap_handle_t handle);
 ...
 *
 * \param[in] handle 通过 am_hk32f103rbt6_tim1_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_hk32f103rbt6_tim2_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_hk32f103rbt6_tim3_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_hk32f103rbt6_tim4_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
 ...
 * \return PWM 标准服务句柄，若为 NULL，表明初始化失败
 */
am_timer_handle_t am_hk32f103rbt6_tim1_timing_inst_init (void);

/**
 * \brief TIM1 TIMING 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_tim1_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_tim1_timing_inst_deinit (am_timer_handle_t handle);
 ...
 * \return PWM 标准服务句柄，若为 NULL，表明初始化失败
 */
am_timer_handle_t am_hk32f103rbt6_tim2_timing_inst_init (void);

/**
 * \brief TIM2 TIMING 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_tim2_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_tim2_timing_inst_deinit (am_timer_handle_t handle);
 ...
 * \return PWM 标准服务句柄，若为 NULL，表明初始化失败
 */
am_timer_handle_t am_hk32f103rbt6_tim3_timing_inst_init (void);

/**
 * \brief TIM3 TIMING 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_tim3_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_tim3_timing_inst_deinit (am_timer_handle_t handle);
 ...
 * \return PWM 标准服务句柄，若为 NULL，表明初始化失败
 */
am_timer_handle_t am_hk32f103rbt6_tim4_timing_inst_init (void);

/**
 * \brief TIM4 TIMING 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_tim4_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_tim4_timing_inst_deinit (am_timer_handle_t handle);
 ...
 */
am_uart_handle_t am_hk32f103rbt6_usart1_inst_init (void);

/**
 * \brief UART1 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_uart1_inst_init() 函数获得的 UART 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_usart1_inst_deinit (am_uart_handle_t handle);
 ...
 * \return UART 标准服务句柄，若为 NULL，表明初始化失败
 */
am_uart_handle_t am_hk32f103rbt6_usart2_inst_init (void);

/**
 * \brief UART2 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_uart2_inst_init() 函数获得的 UART 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_usart2_inst_deinit (am_uart_handle_t handle);
 ...
 * \return UART 标准服务句柄，若为 NULL，表明初始化失败
 */
am_uart_handle_t am_hk32f103rbt6_usart3_inst_init (void);

/**
 * \brief UART3 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_uart3_inst_init() 函数获得的 UART 标准服务句柄
 *
 * \return 无
 */
void am_hk32f103rbt6_usart3_inst_deinit (am_uart_handle_t handle);
 ...
 * \brief WWDG 实例解初始化
 *
 * \param[in] handle 通过 am_hk32f103rbt6_wwdg_inst_init() 函数获得的 WDT 标准服务句柄
 *
 * \return 无
 */
...
am_can_handle_t am_hk32f103rbt6_can_inst_init (void);

/** \brief CAN实例解初始化 */
void am_hk32f103rbt6_can_inst_deinit (am_can_handle_t handle);
...
#endif  /* __AM_HK32F103RBT6_INST_INIT_H */
