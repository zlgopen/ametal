...
static const am_hk32f103rbt6_usart_devinfo_t __g_microport_rs485_devinfo = {
...
am_local am_hk32f103rbt6_usart_dev_t __g_microport_rs485_dev;

/** \brief MicroPort RS485 实例初始化，获得 UART 标准服务句柄 */
am_uart_handle_t am_microport_rs485_inst_init (void)
{
    am_uart_handle_t handle;
    handle = am_hk32f103rbt6_usart_init(&__g_microport_rs485_dev,
