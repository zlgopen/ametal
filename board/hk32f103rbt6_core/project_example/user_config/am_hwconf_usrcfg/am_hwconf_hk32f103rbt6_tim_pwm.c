...
const am_hk32f103rbt6_tim_pwm_devinfo_t  __g_tim1_pwm_devinfo = {
    ...
    AMHW_HK32F103RBT6_TIM_PWM_MODE2,                   /**< \brief PWM输出模式2 */
    0,                                        /**< \brief PWM输出高电平有效 */
    &__g_tim1_pwm_chaninfo_list[0],           /**< \brief 通道配置信息列表        */
    AMHW_HK32F103RBT6_TIM_TYPE0,                       /**< \brief 定时器类型 */
    __hk32f103rbt6_plfm_tim1_pwm_init,              /**< \brief 平台初始化函数 */
    __hk32f103rbt6_plfm_tim1_pwm_deinit             /**< \brief 平台解初始化函数 */
};
...
const am_hk32f103rbt6_tim_pwm_devinfo_t  __g_tim2_pwm_devinfo = {
    ...
    __hk32f103rbt6_plfm_tim2_pwm_init,              /**< \brief 平台初始化函数 */
    __hk32f103rbt6_plfm_tim2_pwm_deinit             /**< \brief 平台解初始化函数 */
};
...
const am_hk32f103rbt6_tim_pwm_devinfo_t  __g_tim3_pwm_devinfo = {
    ...
    AMHW_HK32F103RBT6_TIM_TYPE1,                        /**< \brief 定时器类型 */
    __hk32f103rbt6_plfm_tim3_pwm_init,               /**< \brief 平台初始化函数 */
    __hk32f103rbt6_plfm_tim3_pwm_deinit              /**< \brief 平台解初始化函数 */
};
...
const am_hk32f103rbt6_tim_pwm_devinfo_t  __g_tim4_pwm_devinfo = {
    ...
    AMHW_HK32F103RBT6_TIM_TYPE1,                        /**< \brief 定时器类型 */
    __hk32f103rbt6_plfm_tim4_pwm_init,               /**< \brief 平台初始化函数 */
    __hk32f103rbt6_plfm_tim4_pwm_deinit              /**< \brief 平台解初始化函数 */
};
