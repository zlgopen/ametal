...
/**
 * \file
 * \brief HK32F103RBT6 SYSTICK 用户配置文件
 * \sa am_hwconf_hk32f103rbt6_systick.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_hk32f103rbt6_systick
 * \copydoc am_hwconf_hk32f103rbt6_systick.c
 * @{
 */
...
static const am_arm_systick_devinfo_t __g_systick_devinfo = {
    HK32F103RBT6_SYSTICK,                        /**< \brief 指向 SYSTICK 寄存器块指针 */
