...
/**
 * \file
 * \brief HK32F103RBT6 SPI INT 用户配置文件
...
/**
 * \addtogroup am_if_src_hwconf_hk32f103rbt6_spi_int
 * \copydoc am_hwconf_hk32f103rbt6_spi_int.c
 * @{
 */

/** \brief SPI1 平台初始化 */
static void __hk32f103rbt6_plfm_spi1_int_init (void)
{
...
/** \brief 解除SPI1 平台初始化 */
static void __hk32f103rbt6_plfm_spi1_int_deinit (void)
{
...
/** \brief SPI1 设备信息 */
const  struct am_hk32f103rbt6_spi_int_devinfo  __g_spi1_int_devinfo = {
    ...
    __hk32f103rbt6_plfm_spi1_int_init,             /**< \brief SPI1平台初始化函数 */
    __hk32f103rbt6_plfm_spi1_int_deinit            /**< \brief SPI1平台解初始化函数 */
};

/** \brief SPI1 设备实例 */
static am_hk32f103rbt6_spi_int_dev_t __g_spi1_int_dev;

/** \brief SPI1 实例初始化，获得SPI标准服务句柄 */
am_spi_handle_t am_hk32f103rbt6_spi1_int_inst_init (void)
{
    return am_hk32f103rbt6_spi_int_init(&__g_spi1_int_dev, &__g_spi1_int_devinfo);
}

/** \brief SPI1 实例解初始化 */
void am_hk32f103rbt6_spi1_int_inst_deinit (am_spi_handle_t handle)
{
    am_hk32f103rbt6_spi_int_deinit(handle);
}

/** \brief SPI2 平台初始化 */
static void __hk32f103rbt6_plfm_spi2_int_init (void)
{
...
/** \brief 解除SPI2 平台初始化 */
static void __hk32f103rbt6_plfm_spi2_int_deinit (void)
{
 ...
 * \brief SPI2 设备信息
 */
const  struct am_hk32f103rbt6_spi_int_devinfo  __g_spi2_int_devinfo = {
    ...
    __hk32f103rbt6_plfm_spi2_int_init,           /**< \brief SPI2平台初始化函数 */
    __hk32f103rbt6_plfm_spi2_int_deinit          /**< \brief SPI2平台解初始化函数 */
};

/** \brief SPI2 设备实例 */
static am_hk32f103rbt6_spi_int_dev_t __g_spi2_int_dev;

/** \brief SPI2 实例初始化，获得SPI标准服务句柄 */
am_spi_handle_t am_hk32f103rbt6_spi2_int_inst_init (void)
{
    return am_hk32f103rbt6_spi_int_init(&__g_spi2_int_dev, &__g_spi2_int_devinfo);
}
