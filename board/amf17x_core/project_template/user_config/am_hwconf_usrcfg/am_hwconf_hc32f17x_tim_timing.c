...
/**
  ...
  \sa am_hwconf_hc32f17x_tim_timing.c
 *
 *
  \internal
...
/**
  \addtogroup am_if_src_hwconf_hc32f17x_tim_timing
  \copydoc am_hwconf_hc32f17x_tim_timing.c
  @{
 */
...
/** \brief TIM0 平台初始化 */
void __hc32f17x_plfm_tim0_timing_init (void)
{
//    /* 配置GATE引脚，以实现门控功能 */
...
/** \brief 解除 TIM0 平台初始化 */
void __hc32f17x_plfm_tim0_timing_deinit (void)
{
...
const am_hc32_tim_timing_devinfo_t  __g_tim0_timing_devinfo = {
    ...
    __hc32f17x_plfm_tim0_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f17x_plfm_tim0_timing_deinit   /**< \brief 平台解析初始化函数 */
};
...
/** \brief TIM1 平台初始化 */
void __hc32f17x_plfm_tim1_timing_init (void)
{
//    /* 配置GATE引脚，以实现门控功能 */
...
/** \brief 解除 TIM1 平台初始化 */
void __hc32f17x_plfm_tim1_timing_deinit (void)
{
...
const am_hc32_tim_timing_devinfo_t  __g_tim1_timing_devinfo = {
    ...
    AM_TRUE,                           /**< \brief 门控信号为真（1）有效 */
    AMHW_HC32_TIM_CLK_SRC_TCLK,      /**< \brief 计数时钟选择（默认内部） */
    __hc32f17x_plfm_tim1_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f17x_plfm_tim1_timing_deinit   /**< \brief 平台解析初始化函数 */
};
...
/** \brief TIM2 平台初始化 */
void __hc32f17x_plfm_tim2_timing_init (void)
{
//    /* 配置GATE引脚，以实现门控功能 */
...
/** \brief 解除 TIM2 平台初始化 */
void __hc32f17x_plfm_tim2_timing_deinit (void)
{
...
const am_hc32_tim_timing_devinfo_t  __g_tim2_timing_devinfo = {
    ...
    AM_TRUE,                           /**< \brief 门控信号为真（1）有效 */
    AMHW_HC32_TIM_CLK_SRC_TCLK,      /**< \brief 计数时钟选择（默认内部） */
    __hc32f17x_plfm_tim2_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f17x_plfm_tim2_timing_deinit   /**< \brief 平台解析初始化函数 */
};
...
/** \brief TIM3 平台初始化 */
void __hc32f17x_plfm_tim3_timing_init (void)
{
    /* 配置GATE引脚，以实现门控功能 */
...
/** \brief 解除 TIM3 平台初始化 */
void __hc32f17x_plfm_tim3_timing_deinit (void)
{
...
const am_hc32_tim_timing_devinfo_t  __g_tim3_timing_devinfo = {
    ...
    AM_TRUE,                           /**< \brief 门控信号为真（1）有效 */
    AMHW_HC32_TIM_CLK_SRC_TCLK,      /**< \brief 计数时钟选择（默认内部） */
    __hc32f17x_plfm_tim3_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f17x_plfm_tim3_timing_deinit   /**< \brief 平台解析初始化函数 */
};
...
/** \brief ADTIM4 平台初始化 */
void __hc32f17x_plfm_adtim4_timing_init (void)
{
    am_clk_enable(CLK_TIM456);
}

/** \brief 解除 ADTIM4 平台初始化 */
void __hc32f17x_plfm_adtim4_timing_deinit (void)
{
...
const am_hc32_adtim_timing_devinfo_t  __g_adtim4_timing_devinfo = {
    ...
    __hc32f17x_plfm_adtim4_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f17x_plfm_adtim4_timing_deinit   /**< \brief 平台解析初始化函数 */
};
...
*******************************************************************************/
/** \brief ADTIM5 平台初始化 */
void __hc32f17x_plfm_adtim5_timing_init (void)
{
    am_clk_enable(CLK_TIM456);
}

/** \brief 解除 ADTIM5 平台初始化 */
void __hc32f17x_plfm_adtim5_timing_deinit (void)
{
    am_clk_disable(CLK_TIM456);
}
...
const am_hc32_adtim_timing_devinfo_t  __g_adtim5_timing_devinfo = {
    ...
    __hc32f17x_plfm_adtim5_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f17x_plfm_adtim5_timing_deinit   /**< \brief 平台解析初始化函数 */
};
...
/** \brief ADTIM6 平台初始化 */
void __hc32f17x_plfm_adtim6_timing_init (void)
{
    am_clk_enable(CLK_TIM456);
}

/** \brief 解除 ADTIM6 平台初始化 */
void __hc32f17x_plfm_adtim6_timing_deinit (void)
{
    am_clk_disable(CLK_TIM456);
}
...
const am_hc32_adtim_timing_devinfo_t  __g_adtim6_timing_devinfo = {
    ...
    __hc32f17x_plfm_adtim6_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f17x_plfm_adtim6_timing_deinit   /**< \brief 平台解析初始化函数 */
};
