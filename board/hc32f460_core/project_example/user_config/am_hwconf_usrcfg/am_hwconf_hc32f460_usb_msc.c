...
static void __usb_msc_init (void) {
    ...
    am_gpio_pin_cfg(PIOA_9, GPIO_AFIO(AMHW_HC32F460_AFIO_USBF));//VBUS
    /* 配置PIOA_11 PIOA_12为USB功能   */
    am_gpio_pin_cfg(PIOA_11, GPIO_MODE(AMHW_HC32F460_GPIO_MODE_AIN) | GPIO_AFIO(AMHW_HC32F460_AFIO_USBF));//USBDM;
    am_gpio_pin_cfg(PIOA_12, GPIO_MODE(AMHW_HC32F460_GPIO_MODE_AIN) | GPIO_AFIO(AMHW_HC32F460_AFIO_USBF));//USBDP;
}
...
//    amhw_hc32f460_usbd_connect_set((amhw_hc32f460_usbd_t *)HC32F460_USB_OTG_FS_BASE, HC32F460_USB_DISCONNECT);   /* 断开连接 */
    am_clk_disable(CLK_USBFS);                               /* 禁能USB时钟 */
}
...
static const am_hc32f460_usbd_devinfo_t  __g_hc32f460_usbd_msc_info = {
    HC32F460_USB_OTG_FS_BASE,                  /* 寄存器基地址 */
	INUM_USBFS_GLB,                                  /* 中断号 */
