...
/**
 * \file
 * \brief HC32F460 SYSTICK 用户配置文件
 * \sa am_hwconf_hc32f460_systick.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_hc32f460_systick
 * \copydoc am_hwconf_hc32f460_systick.c
 * @{
 */
...
static const am_arm_systick_devinfo_t __g_systick_devinfo = {
    HC32F460_SYSTICK_BASE,                 /**< \brief 指向 SYSTICK 寄存器块指针 */
    CLK_SYSCLK_DIV1,                       /**< \brief SYSTICK 时钟 ID */
