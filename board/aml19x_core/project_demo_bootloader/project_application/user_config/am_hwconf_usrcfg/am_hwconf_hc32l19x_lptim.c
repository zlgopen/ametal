...
/**
  ...
  \sa am_hwconf_hc32l19x_lptim_timing.c
 *
 *
  \internal
...
/**
  \addtogroup am_if_src_hwconf_hc32l19x_lptim_timing
  \copydoc am_hwconf_hc32l19x_lptim_timing.c
  @{
 */
...
/** \brief LPTIM0 平台初始化 */
void __hc32l19x_plfm_lptim0_timing_init (void)
{
    /* 配置GATE引脚，以实现门控功能 */
...
void __hc32l19x_plfm_lptim0_timing_deinit (void)
{
...
const am_hc32_lptim_timing_devinfo_t  __g_lptim0_timing_devinfo = {
    ...
    __hc32l19x_plfm_lptim0_timing_init,    /**< \brief 平台初始化函数 */
    __hc32l19x_plfm_lptim0_timing_deinit   /**< \brief 平台解析初始化函数 */
};
...
/** \brief LPTIM1 平台初始化 */
void __hc32l19x_plfm_lptim1_timing_init (void)
{
    /* 配置GATE引脚，以实现门控功能 */
...
void __hc32l19x_plfm_lptim1_timing_deinit (void)
{
...
const am_hc32_lptim_timing_devinfo_t  __g_lptim1_timing_devinfo = {
    ...
    __hc32l19x_plfm_lptim1_timing_init,    /**< \brief 平台初始化函数 */
    __hc32l19x_plfm_lptim1_timing_deinit   /**< \brief 平台解析初始化函数 */
};
