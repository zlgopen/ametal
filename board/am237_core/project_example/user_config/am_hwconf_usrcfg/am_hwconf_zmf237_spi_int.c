...
/**
 * \addtogroup am_if_src_hwconf_zmf237_spi_int
 * \copydoc am_hwconf_zmf237_spi_int.c
 * @{
 */
...
am_spi_handle_t am_zmf237_spi1_int_inst_init (void)
{
    return am_zlg_spi_int_init(&__g_spi1_int_dev, &__g_spi1_int_devinfo);
}

/** \brief SPI1 实例解初始化 */
void am_zmf237_spi1_int_inst_deinit (am_spi_handle_t handle)
{
...
am_spi_handle_t am_zmf237_spi2_int_inst_init (void)
{
    return am_zlg_spi_int_init(&__g_spi2_int_dev, &__g_spi2_int_devinfo);
}

/** \brief SPI2 实例解初始化 */
void am_zmf237_spi2_int_inst_deinit (am_spi_handle_t handle)
{
    am_zlg_spi_int_deinit(handle);
}
