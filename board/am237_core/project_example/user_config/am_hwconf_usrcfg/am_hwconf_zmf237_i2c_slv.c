...
/**
 * \addtogroup am_if_src_hwconf_zmf237_i2c_slv
 * \copydoc am_hwconf_zmf237_i2c_slv.c
 * @{
 */
...
static const am_zlg_i2c_slv_devinfo_t __g_i2c1_devinfo = {
    ...
    ZMF237_I2C1_BASE,                 /**< \brief I2C1 寄存器块基址 */
...
am_i2c_slv_handle_t  am_zmf237_i2c1_slv_inst_init (void)
{
    return am_zlg_i2c_slv_init(&__g_i2c1_dev, &__g_i2c1_devinfo);
}

/** \brief I2C1 实例解初始化 */
void am_zmf237_i2c1_slv_inst_deinit (am_i2c_slv_handle_t handle)
{
...
static const am_zlg_i2c_slv_devinfo_t __g_i2c2_devinfo = {
    ...
    ZMF237_I2C2_BASE,                 /**< \brief I2C2寄存器块基址 */
...
am_i2c_slv_handle_t  am_zmf237_i2c2_slv_inst_init (void)
{
    return am_zlg_i2c_slv_init(&__g_i2c2_dev, &__g_i2c2_devinfo);
}

/** \brief I2C2 实例解初始化 */
void am_zmf237_i2c2_slv_inst_deinit (am_i2c_slv_handle_t handle)
{
    am_zlg_i2c_slv_deinit(handle);
}
