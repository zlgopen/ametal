...
/**
 * \file
 * \brief ZMF237 SPI 用户配置文件
 * \sa am_hwconf_zmf237_spi_poll.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_zmf237_spi_poll
 * \copydoc am_hwconf_zmf237_spi_poll.c
 * @{
 */
...
am_spi_handle_t am_zmf237_spi1_poll_inst_init (void)
{
    return am_zlg_spi_poll_init(&__g_spi1_poll_dev, &__g_spi1_poll_devinfo);
}

/** \brief SPI1 实例解初始化 */
void am_zmf237_spi1_poll_inst_deinit (am_spi_handle_t handle)
{
...
am_spi_handle_t am_zmf237_spi2_poll_inst_init (void)
{
    return am_zlg_spi_poll_init(&__g_spi2_poll_dev, &__g_spi2_poll_devinfo);
}

/** \brief SPI2 实例解初始化 */
void am_zmf237_spi2_poll_inst_deinit (am_spi_handle_t handle)
{
    am_zlg_spi_poll_deinit(handle);
}
#endif
