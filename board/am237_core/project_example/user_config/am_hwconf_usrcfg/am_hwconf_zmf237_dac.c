...
/**
 * \addtogroup am_if_src_hwconf_zmf237_dac
 * \copydoc am_hwconf_zmf237_dac.c
 * @{
 */
 ...
 * \brief DAC1 平台初始化
 */
void __zmf237_plfm_dac1_init (void)
{
 ...
 * \brief DAC2 平台去初始化
 */
void __zmf237_plfm_dac1_deinit (void)
{
    /* 关闭DAC时钟 */
...
{
    ZMF237_DAC_BASE,                  /**< \brief 指向DAC寄存器块的指针 */
    12,                               /**< \brief DAC转换精度 */
    3270,                             /**< \brief DAC参考电压，单位：mV */
    __zmf237_plfm_dac1_init,
    __zmf237_plfm_dac1_deinit,
};
...
am_dac_handle_t am_zmf237_dac1_inst_init (void)
{
    return am_zlg_dac_init(&__g_dac1_dev, &__g_dac1_devinfo);
}

/** \brief DAC1 实例解初始化 */
void am_zmf237_dac1_inst_deinit (am_dac_handle_t handle)
{
 ...
 * \brief DAC2 平台初始化
 */
void __zmf237_plfm_dac2_init (void)
{
    /* 配置PIOA_5为DAC2_OUT功能 */
 ...
 * \brief DAC2 平台去初始化
 */
void __zmf237_plfm_dac2_deinit (void)
{
    /* 关闭DAC时钟 */
    am_clk_disable(CLK_DAC);
}
...
static const am_zlg_dac_devinfo_t __g_dac2_devinfo =
{
    ...
    12,                               /**< \brief DAC转换精度 */
    3270,                             /**< \brief DAC参考电压，单位：mV */
    __zmf237_plfm_dac2_init,
    __zmf237_plfm_dac2_deinit,
};
...
am_dac_handle_t am_zmf237_dac2_inst_init (void)
{
    return am_zlg_dac_init(&__g_dac2_dev, &__g_dac2_devinfo);
}

/** \brief DAC2 实例解初始化 */
void am_zmf237_dac2_inst_deinit (am_dac_handle_t handle)
{
    am_zlg_dac_deinit(handle);
}
