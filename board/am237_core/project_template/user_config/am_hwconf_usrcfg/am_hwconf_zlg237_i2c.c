...
/**
 * \file
 * \brief ZMF237 I2C 用户配置文件
 * \sa am_hwconf_zlg237_i2c.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_zlg237_i2c
 * \copydoc am_hwconf_zlg237_i2c.c
 * @{
 */

/** \brief I2C1 总线恢复函数 */
static void __zlg237_i2c1_bus_clean (void)
{
    uint8_t i;
 ...
 * \brief I2C1 设备信息
 */
static const am_zlg237_i2c_devinfo_t __g_i2c1_devinfo = {

    ZLG237_I2C1_BASE,         /**< \brief I2C1寄存器块基址 */
    ...
    __zlg237_i2c1_bus_clean,  /**< \brief 总线恢复函数 */
    __zlg237_i2c1_plfm_init,  /**< \brief 平台初始化 */
    __zlg237_i2c1_plfm_deinit /**< \brief 平台去初始化 */
};

static am_zlg237_i2c_dev_t __g_i2c1_dev; /**< \brief I2C1 设备实例 */

/** \brief I2C1 实例初始化，获得I2C标准服务句柄 */
am_i2c_handle_t am_zlg237_i2c1_inst_init (void)
{
    return am_zlg237_i2c_init(&__g_i2c1_dev, &__g_i2c1_devinfo);
}

/** \brief I2C1 实例解初始化 */
void am_zlg237_i2c1_inst_deinit (am_i2c_handle_t handle)
{
    am_zlg237_i2c_deinit(handle);
}

/** \brief I2C2 总线恢复函数 */
static void __zlg237_i2c2_bus_clean (void)
{
    uint8_t i;
 ...
 * \brief I2C2 设备信息
 */
static const am_zlg237_i2c_devinfo_t __g_i2c2_devinfo = {
    ...
    __zlg237_i2c2_bus_clean,               /**< \brief 总线恢复函数 */
    __zlg237_i2c2_plfm_init,               /**< \brief 平台初始化 */
    __zlg237_i2c2_plfm_deinit              /**< \brief 平台去初始化 */
};

static am_zlg237_i2c_dev_t __g_i2c2_dev; /**< \brief I2C2 设备实例 */

/** \brief I2C2 实例初始化，获得I2C标准服务句柄 */
am_i2c_handle_t am_zlg237_i2c2_inst_init (void)
{
    return am_zlg237_i2c_init(&__g_i2c2_dev, &__g_i2c2_devinfo);
}
