...
static const  struct am_zlg237_spi_dma_devinfo  __g_spi1_dma_devinfo = {
    ...
    DMA_CHAN_SPI1_TX,
    DMA_CHAN_SPI1_RX,
    __zlg237_plfm_spi1_dma_init,             /**< \brief SPI1平台初始化函数 */
    __zlg237_plfm_spi1_dma_deinit            /**< \brief SPI1平台解初始化函数 */
};
/** \brief SPI1 设备实例 */
...
static const struct am_zlg237_spi_dma_devinfo  __g_spi2_dma_devinfo = {
    ...
    DMA_CHAN_SPI2_TX,
    DMA_CHAN_SPI2_RX,
    __zlg237_plfm_spi2_dma_init,            /**< \brief SPI2平台初始化函数 */
    __zlg237_plfm_spi2_dma_deinit           /**< \brief SPI2平台解初始化函数 */
};
