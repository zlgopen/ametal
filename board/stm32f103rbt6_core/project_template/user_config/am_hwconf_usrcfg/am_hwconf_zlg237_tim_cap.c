...
/**
 * \addtogroup am_if_src_hwconf_zlg237_tim_cap
 * \copydoc am_hwconf_zlg237_tim_cap.c
 * @{
 */
...
void __zlg237_plfm_tim1_cap_init (void)
{
...
/** \brief 解除TIM1平台初始化 */
void __zlg237_plfm_tim1_cap_deinit (void)
{
    am_zlg237_clk_reset(CLK_TIM1);
...
const am_zlg_tim_cap_devinfo_t  __g_tim1_cap_devinfo = {
    ...
    __zlg237_plfm_tim1_cap_init,        /**< \brief 平台初始化函数 */
    __zlg237_plfm_tim1_cap_deinit       /**< \brief 平台解初始化函数 */
};
...
void __zlg237_plfm_tim2_cap_init (void)
{
...
/** \brief 解除TIM2平台初始化 */
void __zlg237_plfm_tim2_cap_deinit (void)
{
    am_zlg237_clk_reset(CLK_TIM2);
...
const am_zlg_tim_cap_devinfo_t  __g_tim2_cap_devinfo = {
    ...
    __zlg237_plfm_tim2_cap_init,        /**< \brief 平台初始化函数 */
    __zlg237_plfm_tim2_cap_deinit       /**< \brief 平台解初始化函数 */
...
void __zlg237_plfm_tim3_cap_init (void)
{
...
/** \brief 解除TIM3平台初始化 */
void __zlg237_plfm_tim3_cap_deinit (void)
{
    am_zlg237_clk_reset(CLK_TIM3);
...
const am_zlg_tim_cap_devinfo_t  __g_tim3_cap_devinfo = {
    ...
    AMHW_ZLG_TIM_TYPE1,              /**< \brief 定时器类型 */
    __zlg237_plfm_tim3_cap_init,        /**< \brief 平台初始化函数 */
    __zlg237_plfm_tim3_cap_deinit       /**< \brief 平台解初始化函数 */
...
void __zlg237_plfm_tim4_cap_init (void)
{
...
/** \brief 解除TIM4平台初始化 */
void __zlg237_plfm_tim4_cap_deinit (void)
{
    am_zlg237_clk_reset(CLK_TIM4);
...
const am_zlg_tim_cap_devinfo_t  __g_tim4_cap_devinfo = {
    ...
    AMHW_ZLG_TIM_TYPE1,              /**< \brief 定时器类型 */
    __zlg237_plfm_tim4_cap_init,        /**< \brief 平台初始化函数 */
    __zlg237_plfm_tim4_cap_deinit       /**< \brief 平台解初始化函数 */
