...
static const am_mm32_uart_devinfo_t __g_uart1_devinfo = {
    ...
    __mm32_plfm_uart1_init,          /**< \brief USART1的平台初始化 */
    __mm32_plfm_uart1_deinit,        /**< \brief USART1的平台去初始化 */
};

static am_mm32_uart_dev_t  __g_uart1_dev;   /**< \brief 定义串口1 设备 */
...
static const am_mm32_uart_devinfo_t __g_uart2_devinfo = {
    ...
    __mm32_plfm_uart2_init,            /**< \brief USART2的平台初始化 */
    __mm32_plfm_uart2_deinit,          /**< \brief USART2的平台去初始化 */
};

static am_mm32_uart_dev_t  __g_uart2_dev;   /**< \brief 定义串口2设备 */
