...
const  struct am_mm32l073_spi_slv_dma_devinfo __g_spi1_slv_devinfo = {
    MM32L073_SPI1_BASE,                      /* SPI1 寄存器指针 */
    CLK_SPI1,                              /* 时钟 ID 号 */
    DMA_CHAN_SPI1_TX,
    DMA_CHAN_SPI1_RX,
    PIOA_4,
    __mm32l073_spi1_slv_dma_plfm_init,       /* SPI1 平台初始化函数 */
    __mm32l073_spi1_slv_dma_plfm_deinit      /* SPI1 平台解初始化函数 */
};
...
const  struct am_mm32l073_spi_slv_dma_devinfo  __g_spi2_slv_devinfo = {
    MM32L073_SPI2_BASE,                      /* SPI2 寄存器指针   */
    CLK_SPI2,                              /* 时钟 ID 号   */
    DMA_CHAN_SPI2_TX,
    DMA_CHAN_SPI2_RX,
    PIOB_12,
    __mm32l073_spi2_slv_dma_plfm_init,       /* SPI2 平台初始化函数 */
    __mm32l073_spi2_slv_dma_plfm_deinit      /* SPI2 平台解初始化函数 */
};
