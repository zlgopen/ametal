...
/**
 * \file
 * \brief MM32L073 I2C 用户配置文件
 * \sa am_hwconf_mm32l073_i2c.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_mm32l073_i2c
 * \copydoc am_hwconf_mm32l073_i2c.c
 * @{
 */
...
static void __mm32_i2c1_plfm_init (void)
{
    ...
    am_mm32l073_clk_reset(CLK_I2C1);
}
...
static const am_mm32_i2c_devinfo_t __g_i2c1_devinfo = {
    ...
    MM32L073_I2C1_BASE,                 /**< \brief I2C1寄存器块基址 */
...
am_i2c_handle_t am_mm32l073_i2c1_inst_init (void)
{
    if (NULL == __g_i2c1_handle) {
        __g_i2c1_handle = am_mm32_i2c_init(&__g_i2c1_dev, &__g_i2c1_devinfo);
    }
