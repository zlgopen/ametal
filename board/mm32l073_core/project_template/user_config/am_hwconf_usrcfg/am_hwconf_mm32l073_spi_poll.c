...
/**
 * \addtogroup am_if_src_hwconf_mm32l073_spi_poll
 * \copydoc am_hwconf_mm32l073_spi_poll.c
 * @{
 */
...
const  struct am_mm32_spi_poll_devinfo  __g_spi1_poll_devinfo = {
    ...
    __mm32_plfm_spi1_poll_init,           /**< \brief SPI1平台初始化函数 */
    __mm32_plfm_spi1_poll_deinit          /**< \brief SPI1平台解初始化函数 */
};
...
const  struct am_mm32_spi_poll_devinfo  __g_spi2_poll_devinfo = {
    ...
    __mm32_plfm_spi2_poll_init,              /**< \brief SPI2 平台初始化函数 */
    __mm32_plfm_spi2_poll_deinit             /**< \brief SPI2 平台解初始化函数 */
};
...
am_spi_handle_t am_mm32l073_spi2_poll_inst_init (void)
{
    return am_mm32_spi_poll_init(&__g_spi2_poll_dev, &__g_spi2_poll_devinfo);
}

/** \brief SPI2 实例解初始化 */
void am_mm32l073_spi2_poll_inst_deinit (am_spi_handle_t handle)
{
    am_mm32_spi_poll_deinit(handle);
}
#endif
