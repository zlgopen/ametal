 ...
 *
 * \param[in] handle 通过 am_zsn700_ili9341_inst_init() 函数获得的 ILI9341
 *                   标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief ADC 实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_adc1_inst_init() 函数获得的 ADC 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief CRC 实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_crc_inst_init() 函数获得的 CRC 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief DAC 实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_dac_inst_init() 函数获得的 DAC 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief I2C1 实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_i2c1_inst_init() 函数获得的 I2C 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief I2C2 实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_i2c2_inst_init() 函数获得的 I2C 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief I2C1 从机实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_i2c1_slv_inst_init() 函数
 *                   获得的 I2C 从机标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief I2C2 从机实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_i2c2_slv_inst_init() 函数
 *                   获得的 I2C 从机标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief IWDG 实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_iwdg_inst_init() 函数获得的 WDT 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief RTC 实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_rtc_inst_init() 函数获得的 RTC 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_spi0_dma_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_spi1_dma_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_spi0_int_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_spi1_int_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_spi0_poll_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_spi1_poll_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_systick_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim3_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim1_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim2_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim1_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim2_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim3_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim0_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim1_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim2_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim3_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_lptim0_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_lptim1_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim4_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim5_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim6_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim4_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim5_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim6_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim4_timing_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim5_timing_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_tim6_timing_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief UART0 实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_uart1_inst_init() 函数获得的 UART 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief UART2 实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_uart2_inst_init() 函数获得的 UART 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief UART3 实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_uart3_inst_init() 函数获得的 UART 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_lpuart0_inst_init() 函数获得的 UART 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_zsn700_lpuart1_inst_init() 函数获得的 UART 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief WDT 实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_wdt_inst_init() 函数获得的 WDT 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief PCNT 实例解初始化
 *
 * \param[in] handle 通过 am_zsn700_pcnt1_inst_init() 函数获得的 PCNT 服务句柄
 *
 * \return 无
 */
