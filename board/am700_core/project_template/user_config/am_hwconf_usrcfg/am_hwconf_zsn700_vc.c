...
static const am_zsn700_vc_devinfo_t __g_vc_devinfo =
{
    ...
    /**
     * \brief VC 滤波时间，用户配置值查看枚举amhw_zsn700_vc_deb_time：
     *
     * \note ：滤波时间的配置只有在 FLTEN=1 时才有效,如不需要滤波值为：AMHW_ZSN700_DEB_TIME_NO
     */
     ...
     *
     * \note :不用时输出禁能，不能写为NULL，需写：AMHW_ZSN700_VC_OUT_CFG_DISABLE
     */
