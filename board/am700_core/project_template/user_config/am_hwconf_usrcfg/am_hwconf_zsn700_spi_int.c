 ...
 */
/** \brief SPI0 平台初始化 */
static void __zsn700_plfm_spi0_int_init (void)
{
...
/** \brief 解除SPI0 平台初始化 */
static void __zsn700_plfm_spi0_int_deinit (void)
{
    /* 释放引脚为输入模式 */
...
/** \brief SPI0 设备信息 */
const  struct am_zsn700_spi_int_devinfo  __g_spi0_int_devinfo = {
    ZSN700_SPI0_BASE,                        /**< \brief SPI0寄存器指针 */
    CLK_SPI0,                                /**< \brief 时钟ID号 */
    INUM_SPI0,                               /**< \brief SPI0中断号 */
    PIOA_12_SPI0_MOSI | PIOA_12_OUT_PP,     /**< \brief SPI0配置标识 */
    PIOA_12,                                /**< \brief MOSI引脚号 */
    __zsn700_plfm_spi0_int_init,             /**< \brief SPI0平台初始化函数 */
    __zsn700_plfm_spi0_int_deinit            /**< \brief SPI0平台解初始化函数 */
};

/** \brief SPI0 设备实例 */
static am_zsn700_spi_int_dev_t __g_spi0_int_dev;

/** \brief SPI0 实例初始化，获得SPI标准服务句柄 */
am_spi_handle_t am_zsn700_spi0_int_inst_init (void)
{
    return am_zsn700_spi_int_init(&__g_spi0_int_dev, &__g_spi0_int_devinfo);
}
...
const  struct am_zsn700_spi_int_devinfo  __g_spi1_int_devinfo = {
    ...
    __zsn700_plfm_spi1_int_init,             /**< \brief SPI1平台初始化函数 */
    __zsn700_plfm_spi1_int_deinit            /**< \brief SPI1平台解初始化函数 */
};
