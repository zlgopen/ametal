...
/**
 * \file
 * \brief ZSN700 kboot KinetisFlashTool 用户配置文件
 *
 *
 *
 * \internal
...
/**
 * \addtogroup am_if_src_bootconf_zsn700_kft
 * \copydoc am_bootconf_zsn700_kft.c
 * @{
 */
 ...
 */
static am_boot_flash_handle_t am_zsn700_boot_single_flash_inst_init(void)
{
...
am_boot_firmware_handle_t am_zsn700_boot_single_firmware_flash_inst_init(void)
{
    am_boot_flash_handle_t   flash_handle;
    flash_handle = am_zsn700_boot_single_flash_inst_init();
...
static void __zsn700_boot_single_plfm_deinit()
{
 ...
 */
static am_arm_boot_devinfo_t __g_zsn700_boot_single_devinfo = {
    /**< \brief 应用代码区起始地址*/
    0x00006800,
    /** \brief ram起始地址 */
    0x20000000,
    ...
    NULL,
    /** \brief 平台解初始化函数 */
    __zsn700_boot_single_plfm_deinit,
};

int am_zsn700_boot_single_inst_init()
{
    return am_arm_boot_init(&__g_zsn700_boot_single_devinfo);
}
