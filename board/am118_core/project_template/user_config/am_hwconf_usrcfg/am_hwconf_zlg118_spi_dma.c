...
#include "am_zlg118_spi_dma.h"
/**
 * \addtogroup am_if_src_hwconf_zlg118_spi_dma
 * \copydoc am_hwconf_zlg118_spi_dma.c
 * @{
 */
/** \brief SPI0 平台初始化 */
static void __zlg118_plfm_spi0_dma_init (void)
{
...
/** \brief 解除 SPI0 平台初始化 */
static void __zlg118_plfm_spi0_dma_deinit (void)
{
...
/** \brief SPI0 设备信息 */
static const  struct am_zlg118_spi_dma_devinfo  __g_spi0_dma_devinfo = {
    ZLG118_SPI0_BASE,                        /**< \brief SPI0寄存器指针 */
    CLK_SPI0,                                /**< \brief 时钟ID号 */
    INUM_SPI0,                               /**< \brief SPI0中断号 */
    DMA_CHAN_1,
    DMA_CHAN_2,
    __zlg118_plfm_spi0_dma_init,             /**< \brief SPI0平台初始化函数 */
    __zlg118_plfm_spi0_dma_deinit            /**< \brief SPI0平台解初始化函数 */
};
/** \brief SPI0 设备实例 */
static am_zlg118_spi_dma_dev_t __g_spi0_dma_dev;


/** \brief SPI0 实例初始化，获得SPI标准服务句柄 */
am_spi_handle_t am_zlg118_spi0_dma_inst_init (void)
{
    return am_zlg118_spi_dma_init(&__g_spi0_dma_dev, &__g_spi0_dma_devinfo);
}

/** \brief SPI0 实例解初始化 */
void am_zlg118_spi0_dma_inst_deinit (am_spi_handle_t handle)
{
    am_zlg118_spi_dma_deinit(handle);
}

/** \brief SPI1 平台初始化 */
static void __zlg118_plfm_spi1_dma_init (void)
{
...
/** \brief 解除 SPI1 平台初始化 */
static void __zlg118_plfm_spi1_dma_deinit (void)
{
...
/** \brief SPI1 设备信息 */
static const  struct am_zlg118_spi_dma_devinfo  __g_spi1_dma_devinfo = {
    ZLG118_SPI1_BASE,                        /**< \brief SPI1寄存器指针 */
    CLK_SPI1,                                /**< \brief 时钟ID号 */
    INUM_SPI1,                               /**< \brief SPI1中断号 */
    DMA_CHAN_1,
    DMA_CHAN_2,
    __zlg118_plfm_spi1_dma_init,             /**< \brief SPI1平台初始化函数 */
    __zlg118_plfm_spi1_dma_deinit            /**< \brief SPI1平台解初始化函数 */
};
/** \brief SPI1 设备实例 */
static am_zlg118_spi_dma_dev_t __g_spi1_dma_dev;


/** \brief SPI1 实例初始化，获得SPI标准服务句柄 */
am_spi_handle_t am_zlg118_spi1_dma_inst_init (void)
{
    return am_zlg118_spi_dma_init(&__g_spi1_dma_dev, &__g_spi1_dma_devinfo);
}
