...
/**
  \file
  \brief ZLG118 LPTIM 定时功能用户配置文件
  \sa am_hwconf_zlg118_lptim_timing.c
 *
 *
  \internal
...
/**
  \addtogroup am_if_src_hwconf_zlg118_lptim_timing
  \copydoc am_hwconf_zlg118_lptim_timing.c
  @{
 */
...
/** \brief LPTIM0 平台初始化 */
void __zlg118_plfm_lptim0_timing_init (void)
{
    /* 配置GATE引脚，以实现门控功能 */
...
void __zlg118_plfm_lptim0_timing_deinit (void)
{
...
/** \brief LPTIM0 设备信息 */
const am_zlg118_lptim_timing_devinfo_t  __g_lptim0_timing_devinfo = {
    ZLG118_LPTIM0_BASE,                  /**< \brief LPTIM0寄存器块的基地址 */
    INUM_LPTIM0_1,                       /**< \brief LPTIM0中断编号 */
    AMHW_ZLG118_LPTIM_CLK_SRC_PCLK,      /**< \brief 时钟源选择 */
    AMHW_ZLG118_LPTIM_FUNCTION_TIMER,    /**< \brief 定时器/计数器功能选择
                                          *
                                          *（计数器功能需要初始化相关ETR引脚）
                                          *
                                          */
    AMHW_ZLG118_LPTIM_MODE_RELOAD,       /**< \brief 自动重载模式 */
    ...
    __zlg118_plfm_lptim0_timing_init,    /**< \brief 平台初始化函数 */
    __zlg118_plfm_lptim0_timing_deinit   /**< \brief 平台解析初始化函数 */
};

/** \brief LPTIM0 设备定义 */
am_zlg118_lptim_timing_dev_t __g_lptim0_timing_dev;

/** \brief 定时器LPTIM0 Timing实例初始化，获得Timer标准服务句柄 */
am_timer_handle_t am_zlg118_lptim0_timing_inst_init (void)
{
    return am_zlg118_lptim_timing_init(&__g_lptim0_timing_dev,
...
{
    am_zlg118_lptim_timing_deinit(handle);
}
...
/** \brief LPTIM1 平台初始化 */
void __zlg118_plfm_lptim1_timing_init (void)
{
    /* 配置GATE引脚，以实现门控功能 */
...
void __zlg118_plfm_lptim1_timing_deinit (void)
{
...
/** \brief LPTIM1 设备信息 */
const am_zlg118_lptim_timing_devinfo_t  __g_lptim1_timing_devinfo = {
    ZLG118_LPTIM1_BASE,                  /**< \brief LPTIM1寄存器块的基地址 */
    INUM_LPTIM0_1,                       /**< \brief LPTIM1中断编号 */
    AMHW_ZLG118_LPTIM_CLK_SRC_PCLK,      /**< \brief 时钟源选择 */
    AMHW_ZLG118_LPTIM_FUNCTION_COUNTER,  /**< \brief 定时器/计数器功能选择
                                          *
                                          *（计数器功能需要初始化相关ETR引脚）
                                          *
                                          */
    ...
    __zlg118_plfm_lptim1_timing_init,    /**< \brief 平台初始化函数 */
    __zlg118_plfm_lptim1_timing_deinit   /**< \brief 平台解析初始化函数 */
};

/** \brief LPTIM1 设备定义 */
am_zlg118_lptim_timing_dev_t __g_lptim1_timing_dev;

/** \brief 定时器LPTIM1 Timing实例初始化，获得Timer标准服务句柄 */
am_timer_handle_t am_zlg118_lptim1_timing_inst_init (void)
{
    return am_zlg118_lptim_timing_init(&__g_lptim1_timing_dev,
