...
/**
 * \file
 * \brief ZLG118 UART 用户配置文件
 * \sa am_zlg118l_hwconfig_uart.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_zlg118_uart
 * \copydoc am_hwconf_zlg118_uart.c
 * @{
 */
/** \brief 串口0平台初始化 */
static void __zlg118_plfm_uart0_init (void)
{
...
/** \brief 解除串口0平台初始化 */
static void __zlg118_plfm_uart0_deinit (void)
{
...
/** \brief 串口0设备信息 */
static const am_zlg118_uart_devinfo_t __g_uart0_devinfo = {

    ZLG118_UART0_BASE,            /**< \brief 串口0 */
    INUM_UART0_2,                 /**< \brief 串口0的中断编号 */
    AMHW_ZLG118_UART_WORK_MODE_1, /**< \brief 串口工作模式 */

    AMHW_ZLG118_UART_PARITY_NO |  /**< \brief 无极性  MODE0/1:无需校验  MODE2/3:必须校验*/
    AMHW_ZLG118_UART_STOP_1_0_BIT,/**< \brief 1个停止位 */
    ...
    NULL,                         /**< \brief 使用RS485 */
    __zlg118_plfm_uart0_init,     /**< \brief UART0的平台初始化 */
    __zlg118_plfm_uart0_deinit,   /**< \brief UART0的平台去初始化 */
};

/* 串口中断源复用需要调用设备信息 */
am_zlg118_uart_dev_t  *__gp_uart0;

/**< \brief 定义串口0 设备 */
static am_zlg118_uart_dev_t  __g_uart0_dev;

/** \brief UART0实例初始化，获得uart0标准服务句柄 */
am_uart_handle_t am_zlg118_uart0_inst_init (void)
{
    __gp_uart0 = &__g_uart0_dev;
    return am_zlg118_uart_init(&__g_uart0_dev, &__g_uart0_devinfo);
}

/** \brief UART0实例解初始化 */
void am_zlg118_uart0_inst_deinit (am_uart_handle_t handle)
{
    am_zlg118_uart_deinit((am_zlg118_uart_dev_t *)handle);
}

/** \brief uart1平台初始化 */
static void __zlg118_plfm_uart1_init (void)
{
...
/** \brief 解除串口1平台初始化 */
static void __zlg118_plfm_uart1_deinit (void)
{
...
/** \brief 串口1设备信息 */
static const am_zlg118_uart_devinfo_t __g_uart1_devinfo = {

    ZLG118_UART1_BASE,            /**< \brief 串口1 */
    ...
    NULL,                         /**< \brief 使用RS485 */
    __zlg118_plfm_uart1_init,     /**< \brief UART1的平台初始化 */
    __zlg118_plfm_uart1_deinit,   /**< \brief UART1的平台去初始化 */
};

/* 串口中断源复用需要调用设备信息 */
am_zlg118_uart_dev_t  *__gp_uart1;

/**< \brief 定义串口1 设备 */
static am_zlg118_uart_dev_t  __g_uart1_dev;

/** \brief UART1实例初始化，获得uart1标准服务句柄 */
am_uart_handle_t am_zlg118_uart1_inst_init (void)
{
    __gp_uart1 = &__g_uart1_dev;
    return am_zlg118_uart_init(&__g_uart1_dev, &__g_uart1_devinfo);
}
...
/** \brief 串口2平台初始化 */
static void __zlg118_plfm_uart2_init (void)
{
...
/** \brief 解除串口2平台初始化 */
static void __zlg118_plfm_uart2_deinit (void)
{
...
/** \brief 串口2设备信息 */
static const am_zlg118_uart_devinfo_t __g_uart2_devinfo = {

    ZLG118_UART2_BASE,            /**< \brief 串口2 */
    ...
    NULL,                         /**< \brief 使用RS485 */
    __zlg118_plfm_uart2_init,     /**< \brief UART2的平台初始化 */
    __zlg118_plfm_uart2_deinit,   /**< \brief UART2的平台去初始化 */
};

/* 串口中断源复用需要调用设备信息 */
am_zlg118_uart_dev_t  *__gp_uart2;

/**< \brief 定义串口2 设备 */
static am_zlg118_uart_dev_t  __g_uart2_dev;

/** \brief UART2实例初始化，获得uart2标准服务句柄 */
am_uart_handle_t am_zlg118_uart2_inst_init (void)
{
    __gp_uart2 = &__g_uart2_dev;
    return am_zlg118_uart_init(&__g_uart2_dev, &__g_uart2_devinfo);
}
...
/** \brief 串口3平台初始化 */
static void __zlg118_plfm_uart3_init (void)
{
...
/** \brief 解除串口3平台初始化 */
static void __zlg118_plfm_uart3_deinit (void)
{
...
/** \brief 串口3设备信息 */
static const am_zlg118_uart_devinfo_t __g_uart3_devinfo = {

    ZLG118_UART3_BASE,            /**< \brief 串口3 */
    ...
    NULL,                         /**< \brief 使用RS485 */
    __zlg118_plfm_uart3_init,     /**< \brief UART3的平台初始化 */
    __zlg118_plfm_uart3_deinit,   /**< \brief UART3的平台去初始化 */
};

/* 串口中断源复用需要调用设备信息 */
am_zlg118_uart_dev_t  *__gp_uart3;

/**< \brief 定义串口3 设备 */
static am_zlg118_uart_dev_t  __g_uart3_dev;

/** \brief UART3实例初始化，获得uart3标准服务句柄 */
am_uart_handle_t am_zlg118_uart3_inst_init (void)
{
    __gp_uart3 = &__g_uart3_dev;
    return am_zlg118_uart_init(&__g_uart3_dev, &__g_uart3_devinfo);
}
