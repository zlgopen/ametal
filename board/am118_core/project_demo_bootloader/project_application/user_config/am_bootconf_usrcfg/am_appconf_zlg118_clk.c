...
/**
 * \file
 * \brief zlg118 CLK 用户配置文件
 * \sa am_hwconf_zlg118_clk.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_zlg118_clk
 * \copydoc am_hwconf_zlg118_clk.c
 * @{
 */
/** \brief CLK 平台初始化 */
static void __zlg118_clk_plfm_init (void)
{
}

/** \brief CLK 解平台初始化 */
static void __zlg118_clk_plfm_deinit (void)
{
}
 ...
 */
/** \brief CLK设备信息 */
static const am_zlg118_clk_devinfo_t __g_clk_devinfo =
{
    /**
    ...
    __zlg118_clk_plfm_init,

    /** \brief 平台解初始化函数 */
    __zlg118_clk_plfm_deinit,
};

/** \brief 时钟设备实例 */
static am_zlg118_clk_dev_t __g_clk_dev;
 ...
 */
int am_zlg118_clk_inst_deinit (void)
{
    return am_zlg118_clk_init(&__g_clk_dev, &__g_clk_devinfo);
}
