...
#include <am_bootconf_usrcfg/am_appconf_double_zlg118.h>
 ...
 */
am_boot_flash_handle_t am_zlg118_boot_flash_inst_init(void)
{
...
am_boot_firmware_handle_t am_zlg118_boot_firmware_flash_inst_init()
{
    flash_handle = am_zlg118_boot_flash_inst_init();
 ...
 */
static am_arm_boot_devinfo_t __g_zlg118_boot_devinfo = {
    /**< \brief 应用代码区起始地址*/
    0x00006800,
    /** \brief ram起始地址 */
    0x20000000,
...
int am_zlg118_boot_inst_init()
{
    return am_arm_boot_init(&__g_zlg118_boot_devinfo);
}
