...
{
    ZLG118_DAC_BASE,                      /**< \brief 指向DAC寄存器块的指针 */

    12,                                   /**< \brief DAC转换精度 */

    AMHW_ZLG118_DAC_CHAN_MASK_EXTER_REF,  /**< \brief DAC参考电压源 */

    3300,                                 /**< \brief DAC参考电压,单位：mv*/

    AM_ZLG118_DAC_ALIGN_WAY_12_RIGHT,     /**< \brief DAC数据对齐方式 */

    __zlg118_plfm_dac0_init,              /**< \brief DAC平台初始化函数 */

    __zlg118_plfm_dac0_deinit,            /**< \brief DAC平台解初始化函数  */
};
