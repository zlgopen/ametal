...
/**
 * \addtogroup am_if_src_hwconf_zlg118_tim_cap
 * \copydoc am_hwconf_zlg118_tim_cap.c
 * @{
 */
/*******************************************************************************
  TIM0 配置
...
am_zlg118_tim_cap_ioinfo_t __g_tim0_cap_ioinfo_list[] = {
    /**< \brief 通道0 */
    {
        AM_ZLG118_TIM_CAP_CH0A,
        PIOA_0,
...
const am_zlg118_tim_cap_devinfo_t  __g_tim0_cap_devinfo = {
    ZLG118_TIM0_BASE,                   /**< \brief TIM0寄存器块的基地址 */
    INUM_TIM0,                          /**< \brief TIM0中断编号 */
    AMHW_ZLG118_TIM_CLK_DIV1,           /**< \brief 时钟分频系数 */
    2,                                  /**< \brief 2个捕获通道 */
    AMHW_ZLG118_TIM_TYPE_TIM0,          /**< \brief 定时器选择 */

    &__g_tim0_cap_ioinfo_list[0],
    __zlg118_plfm_tim0_cap_init,        /**< \brief 平台初始化函数 */
    __zlg118_plfm_tim0_cap_deinit       /**< \brief 平台解初始化函数 */
};

/** \brief TIM0用于捕获功能的设备定义 */
am_zlg118_tim_cap_dev_t  __g_tim0_cap_dev;

/** \brief tim0 cap实例初始化，获得cap标准服务句柄 */
am_cap_handle_t am_zlg118_tim0_cap_inst_init (void)
{
    return am_zlg118_tim_cap_init(&__g_tim0_cap_dev,
...
{
    am_zlg118_tim_cap_deinit(handle);
}
...
am_zlg118_tim_cap_ioinfo_t __g_tim1_cap_ioinfo_list[] = {
    /**< \brief 通道0 */
    {
        AM_ZLG118_TIM_CAP_CH0A,
        PIOA_0,
...
const am_zlg118_tim_cap_devinfo_t  __g_tim1_cap_devinfo = {
    ZLG118_TIM1_BASE,                   /**< \brief TIM1寄存器块的基地址 */
    INUM_TIM1,                          /**< \brief TIM1中断编号 */
    AMHW_ZLG118_TIM_CLK_DIV1,           /**< \brief 时钟分频系数 */
    2,                                  /**< \brief 2个捕获通道 */
    AMHW_ZLG118_TIM_TYPE_TIM1,          /**< \brief 定时器选择 */

    &__g_tim1_cap_ioinfo_list[0],
    __zlg118_plfm_tim1_cap_init,        /**< \brief 平台初始化函数 */
    __zlg118_plfm_tim1_cap_deinit       /**< \brief 平台解初始化函数 */
};

/** \brief TIM1用于捕获功能的设备定义 */
am_zlg118_tim_cap_dev_t  __g_tim1_cap_dev;

/** \brief tim1 cap实例初始化，获得cap标准服务句柄 */
am_cap_handle_t am_zlg118_tim1_cap_inst_init (void)
{
    return am_zlg118_tim_cap_init(&__g_tim1_cap_dev,
...
am_zlg118_tim_cap_ioinfo_t __g_tim2_cap_ioinfo_list[] = {
    /**< \brief 通道0 */
    {
        AM_ZLG118_TIM_CAP_CH0A,
        PIOA_2,
...
const am_zlg118_tim_cap_devinfo_t  __g_tim2_cap_devinfo = {
    ZLG118_TIM2_BASE,                   /**< \brief TIM2寄存器块的基地址 */
    INUM_TIM2,                          /**< \brief TIM2中断编号 */
    AMHW_ZLG118_TIM_CLK_DIV1,           /**< \brief 时钟分频系数 */
    2,                                  /**< \brief 2个捕获通道 */
    AMHW_ZLG118_TIM_TYPE_TIM2,          /**< \brief 定时器选择 */

    &__g_tim2_cap_ioinfo_list[0],
    __zlg118_plfm_tim2_cap_init,        /**< \brief 平台初始化函数 */
    __zlg118_plfm_tim2_cap_deinit       /**< \brief 平台解初始化函数 */
};

/** \brief TIM2用于捕获功能的设备定义 */
am_zlg118_tim_cap_dev_t  __g_tim2_cap_dev;

/** \brief tim2 cap实例初始化，获得cap标准服务句柄 */
am_cap_handle_t am_zlg118_tim2_cap_inst_init (void)
{
    return am_zlg118_tim_cap_init(&__g_tim2_cap_dev,
...
am_zlg118_tim_cap_ioinfo_t __g_tim3_cap_ioinfo_list[] = {
...
const am_zlg118_tim_cap_devinfo_t  __g_tim3_cap_devinfo = {
    ZLG118_TIM3_BASE,                   /**< \brief TIM3寄存器块的基地址 */
    INUM_TIM3,                          /**< \brief TIM3中断编号 */
    AMHW_ZLG118_TIM_CLK_DIV1,           /**< \brief 时钟分频系数 */
    6,                                  /**< \brief 6个捕获通道 */
    AMHW_ZLG118_TIM_TYPE_TIM3,          /**< \brief 定时器选择 */

    &__g_tim3_cap_ioinfo_list[0],
    __zlg118_plfm_tim3_cap_init,        /**< \brief 平台初始化函数 */
    __zlg118_plfm_tim3_cap_deinit       /**< \brief 平台解初始化函数 */
};

/** \brief TIM3用于捕获功能的设备定义 */
am_zlg118_tim_cap_dev_t  __g_tim3_cap_dev;

/** \brief tim3 cap实例初始化，获得cap标准服务句柄 */
am_cap_handle_t am_zlg118_tim3_cap_inst_init (void)
{
    return am_zlg118_tim_cap_init(&__g_tim3_cap_dev,
...
am_zlg118_adtim_cap_ioinfo_t __g_adtim4_cap_ioinfo_list[] = {
    {
        AM_ZLG118_ADTIM_CAP_CHA,
        PIOB_2,
...
const am_zlg118_adtim_cap_devinfo_t  __g_adtim4_cap_devinfo = {
    ZLG118_TIM4_BASE,                   /**< \brief ADTIM4寄存器块的基地址 */
    INUM_TIM4,                          /**< \brief ADTIM4中断编号 */
    AMHW_ZLG118_ADTIM_PCLK_DIV16,       /**< \brief 时钟分频系数 */
    2,                                  /**< \brief 2个捕获通道 */

    &__g_adtim4_cap_ioinfo_list[0],     /**< \brief 引脚配置信息列表 */
    __zlg118_plfm_adtim4_cap_init,      /**< \brief 平台初始化函数 */
    __zlg118_plfm_adtim4_cap_deinit     /**< \brief 平台解初始化函数 */
};

/** \brief ADTIM4用于捕获功能的设备定义 */
am_zlg118_adtim_cap_dev_t  __g_adtim4_cap_dev;

/** \brief adtim4 cap实例初始化，获得cap标准服务句柄 */
am_cap_handle_t am_zlg118_tim4_cap_inst_init (void)
{
    return am_zlg118_adtim_cap_init(&__g_adtim4_cap_dev,
...
{
    am_zlg118_adtim_cap_deinit(handle);
}
...
am_zlg118_adtim_cap_ioinfo_t __g_adtim5_cap_ioinfo_list[] = {
    {
        AM_ZLG118_ADTIM_CAP_CHA,
        PIOA_3,
...
const am_zlg118_adtim_cap_devinfo_t  __g_adtim5_cap_devinfo = {
    ...
    __zlg118_plfm_adtim5_cap_init,      /**< \brief 平台初始化函数 */
    __zlg118_plfm_adtim5_cap_deinit     /**< \brief 平台解初始化函数 */
};

/** \brief ADTIM5用于捕获功能的设备定义 */
am_zlg118_adtim_cap_dev_t  __g_adtim5_cap_dev;

/** \brief adtim5 cap实例初始化，获得cap标准服务句柄 */
am_cap_handle_t am_zlg118_tim5_cap_inst_init (void)
{
    return am_zlg118_adtim_cap_init(&__g_adtim5_cap_dev,
...
am_zlg118_adtim_cap_ioinfo_t __g_adtim6_cap_ioinfo_list[] = {
    {
        AM_ZLG118_ADTIM_CAP_CHA,
        PIOB_11,
...
const am_zlg118_adtim_cap_devinfo_t  __g_adtim6_cap_devinfo = {
    ...
    __zlg118_plfm_adtim6_cap_init,      /**< \brief 平台初始化函数 */
    __zlg118_plfm_adtim6_cap_deinit     /**< \brief 平台解初始化函数 */
};

/** \brief ADTIM6用于捕获功能的设备定义 */
am_zlg118_adtim_cap_dev_t  __g_adtim6_cap_dev;

/** \brief adtim6 cap实例初始化，获得cap标准服务句柄 */
am_cap_handle_t am_zlg118_tim6_cap_inst_init (void)
{
    return am_zlg118_adtim_cap_init(&__g_adtim6_cap_dev,
