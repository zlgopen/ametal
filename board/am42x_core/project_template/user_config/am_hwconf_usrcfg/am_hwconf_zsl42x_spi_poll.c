...
/**
 * \file
 * \brief ZSL42x SPI 用户配置文件
 * \sa am_hwconf_zsl42x_spi_poll.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_zsl42x_spi_poll
...
/** \brief 解除SPI1 平台初始化 */
static void __zsl42x_plfm_spi1_poll_deinit (void)
{
 ...
 * \brief SPI1 设备信息
 */
const  struct am_zsl42x_spi_poll_devinfo  __g_spi1_poll_devinfo = {
    ZSL42x_SPI1_BASE,                       /**< \brief SPI1寄存器指针 */
    CLK_SPI1,                               /**< \brief 时钟ID号 */
    __zsl42x_plfm_spi1_poll_init,           /**< \brief SPI1平台初始化函数 */
    __zsl42x_plfm_spi1_poll_deinit          /**< \brief SPI1平台解初始化函数 */
};

/** \brief SPI1 设备实例 */
static am_zsl42x_spi_poll_dev_t __g_spi1_poll_dev;

/** \brief SPI1 实例初始化，获得SPI标准服务句柄 */
am_spi_handle_t am_zsl42x_spi1_poll_inst_init (void)
{
    return am_zsl42x_spi_poll_init(&__g_spi1_poll_dev, &__g_spi1_poll_devinfo);
}
