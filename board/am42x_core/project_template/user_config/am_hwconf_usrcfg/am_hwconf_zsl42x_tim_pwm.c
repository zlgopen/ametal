...
#include "am_zsl42x_adtim_pwm.h"
#include "am_clk.h"
#include "am_zsl42x_clk.h"

/**
 * \addtogroup am_if_src_hwconf_zsl42x_tim_pwm
 * \copydoc am_hwconf_zsl42x_tim_pwm.c
 * @{
 */
/*******************************************************************************
  TIM0 配置
...
void __zsl42x_plfm_tim0_pwm_init (void)
{
    am_clk_enable(CLK_TIM012);
}

/** \brief 解除TIM0平台初始化 */
void __zsl42x_plfm_tim0_pwm_deinit (void)
{
    am_clk_disable(CLK_TIM012);
}

/** \brief TIM0用于PWM功能的引脚配置信息列表 */
am_zsl42x_tim_pwm_chaninfo_t __g_tim0_pwm_chaninfo_list[] = {

    /** \brief 通道0引脚配置 */
    {
        AM_ZSL42x_TIM_PWM_CH0A,
        PIOA_2,
...
/** \brief TIM0用于PWM设备信息 */
const am_zsl42x_tim_pwm_devinfo_t  __g_tim0_pwm_devinfo = {
    ZSL42x_TIM0_BASE,                           /**< \brief TIM0寄存器块的基地址 */
    AM_NELEMENTS(__g_tim0_pwm_chaninfo_list),   /**< \brief 配置输出通道个数 */
    0,                                          /**< \brief 互补PWM选择
                                                 *          1：互补PWM
                                                 *          0：独立PWM
                                                 */
    AM_ZSL42x_TIM_PWM_OCPOLARITY_HIGH,          /**< \brief 脉宽极性 */
    &__g_tim0_pwm_chaninfo_list[0],             /**< \brief 通道配置信息列表        */
    AMHW_ZSL42x_TIM_TYPE_TIM0,                  /**< \brief 定时器类型 */
    __zsl42x_plfm_tim0_pwm_init,                /**< \brief 平台初始化函数 */
    __zsl42x_plfm_tim0_pwm_deinit               /**< \brief 平台解初始化函数 */
};

/** \brief TIM0用于PWM设备定义 */
am_zsl42x_tim_pwm_dev_t __g_tim0_pwm_dev;
...
{
    am_zsl42x_tim_pwm_deinit(handle);
}
...
void __zsl42x_plfm_tim1_pwm_init (void)
{
    am_clk_enable(CLK_TIM012);
}

/** \brief 解除TIM1平台初始化 */
void __zsl42x_plfm_tim1_pwm_deinit (void)
{
    am_clk_disable(CLK_TIM012);
}

/** \brief TIM1用于PWM功能的引脚配置信息列表 */
am_zsl42x_tim_pwm_chaninfo_t __g_tim1_pwm_chaninfo_list[] = {
...
/** \brief TIM1用于PWM设备信息 */
const am_zsl42x_tim_pwm_devinfo_t  __g_tim1_pwm_devinfo = {
    ZSL42x_TIM1_BASE,                           /**< \brief TIM1寄存器块的基地址 */
    ...
    AMHW_ZSL42x_TIM_TYPE_TIM1,                  /**< \brief 定时器类型 */
    __zsl42x_plfm_tim1_pwm_init,                /**< \brief 平台初始化函数 */
    __zsl42x_plfm_tim1_pwm_deinit               /**< \brief 平台解初始化函数 */
};

/** \brief TIM1用于PWM设备定义 */
am_zsl42x_tim_pwm_dev_t __g_tim1_pwm_dev;

/** \brief tim1 pwm 实例初始化，获得pwm标准服务句柄 */
am_pwm_handle_t am_zsl42x_tim1_pwm_inst_init (void)
{
    return am_zsl42x_tim_pwm_init(&__g_tim1_pwm_dev,
...
void __zsl42x_plfm_tim2_pwm_init (void)
{
    am_clk_enable(CLK_TIM012);
}

/** \brief 解除TIM2平台初始化 */
void __zsl42x_plfm_tim2_pwm_deinit (void)
{
    am_clk_disable(CLK_TIM012);
}

/** \brief TIM2用于PWM功能的引脚配置信息列表 */
am_zsl42x_tim_pwm_chaninfo_t __g_tim2_pwm_chaninfo_list[] = {
...
/** \brief TIM2用于PWM设备信息 */
const am_zsl42x_tim_pwm_devinfo_t  __g_tim2_pwm_devinfo = {
    ZSL42x_TIM2_BASE,                           /**< \brief TIM2寄存器块的基地址 */
    ...
    AMHW_ZSL42x_TIM_TYPE_TIM2,                  /**< \brief 定时器类型 */
    __zsl42x_plfm_tim2_pwm_init,                /**< \brief 平台初始化函数 */
    __zsl42x_plfm_tim2_pwm_deinit               /**< \brief 平台解初始化函数 */
};

/** \brief TIM2用于PWM设备定义 */
am_zsl42x_tim_pwm_dev_t __g_tim2_pwm_dev;

/** \brief tim2 pwm 实例初始化，获得pwm标准服务句柄 */
am_pwm_handle_t am_zsl42x_tim2_pwm_inst_init (void)
{
    return am_zsl42x_tim_pwm_init(&__g_tim2_pwm_dev,
...
void __zsl42x_plfm_tim3_pwm_init (void)
{
    am_clk_enable(CLK_TIM3);
}

/** \brief 解除TIM3平台初始化 */
void __zsl42x_plfm_tim3_pwm_deinit (void)
{
    am_clk_disable(CLK_TIM3);
}

/** \brief TIM3用于PWM功能的引脚配置信息列表 */
am_zsl42x_tim_pwm_chaninfo_t __g_tim3_pwm_chaninfo_list[] = {
    ...
    /** \brief 通道1引脚配置 */
    {
        AM_ZSL42x_TIM_PWM_CH0B,
        PIOB_4,
        PIOB_4_TIM3_CH0B | PIOB_4_OUT_PP,
...
/** \brief TIM3用于PWM设备信息 */
const am_zsl42x_tim_pwm_devinfo_t  __g_tim3_pwm_devinfo = {
    ZSL42x_TIM3_BASE,                           /**< \brief TIM3寄存器块的基地址 */
    ...
    AMHW_ZSL42x_TIM_TYPE_TIM3,                  /**< \brief 定时器类型 */
    __zsl42x_plfm_tim3_pwm_init,                /**< \brief 平台初始化函数 */
    __zsl42x_plfm_tim3_pwm_deinit               /**< \brief 平台解初始化函数 */
};

/** \brief TIM3用于PWM设备定义 */
am_zsl42x_tim_pwm_dev_t __g_tim3_pwm_dev;
...
void __zsl42x_plfm_adtim4_pwm_init (void)
{
    am_clk_enable(CLK_TIM456);
}

/** \brief 解除ADTIM4平台初始化 */
void __zsl42x_plfm_adtim4_pwm_deinit (void)
{
    am_clk_disable(CLK_TIM456);
}

/** \brief ADTIM4用于PWM功能的引脚配置信息列表 */
am_zsl42x_adtim_pwm_chaninfo_t __g_adtim4_pwm_chaninfo_list[] = {
...
const am_zsl42x_adtim_pwm_devinfo_t  __g_adtim4_pwm_devinfo = {
    ZSL42x_TIM4_BASE,                           /**< \brief ADTIM4寄存器块的基地址 */
    AM_NELEMENTS(__g_adtim4_pwm_chaninfo_list), /**< \brief 配置输出通道个数 */
    0,                                          /**< \brief 互补PWM选择
                                                 *          1：互补PWM
                                                 *          0：独立PWM
                                                 */
    AM_ZSL42x_ADTIM_PWM_OCPOLARITY_HIGH,        /**< \brief 脉宽极性 */
    &__g_adtim4_pwm_chaninfo_list[0],           /**< \brief 通道配置信息列表        */
    __zsl42x_plfm_adtim4_pwm_init,              /**< \brief 平台初始化函数 */
    __zsl42x_plfm_adtim4_pwm_deinit             /**< \brief 平台解初始化函数 */
};

/** \brief ADTIM4用于PWM设备定义 */
am_zsl42x_adtim_pwm_dev_t __g_adtim4_pwm_dev;

/** \brief adtim4 pwm 实例初始化，获得pwm标准服务句柄 */
am_pwm_handle_t am_zsl42x_tim4_pwm_inst_init (void)
{
    return am_zsl42x_adtim_pwm_init(&__g_adtim4_pwm_dev,
...
{
    am_zsl42x_adtim_pwm_deinit(handle);
}
...
void __zsl42x_plfm_adtim5_pwm_init (void)
{
    am_clk_enable(CLK_TIM456);
}

/** \brief 解除ADTIM5平台初始化 */
void __zsl42x_plfm_adtim5_pwm_deinit (void)
{
    am_clk_disable(CLK_TIM456);
}

/** \brief ADTIM5用于PWM功能的引脚配置信息列表 */
am_zsl42x_adtim_pwm_chaninfo_t __g_adtim5_pwm_chaninfo_list[] = {
...

    {
        AM_ZSL42x_ADTIM_PWM_CHB,
        PIOB_0,
        PIOB_0_TIM5_CHB | PIOB_0_OUT_PP ,
        PIOB_0_GPIO | PIOB_0_INPUT_PU
    },
};

/** \brief ADTIM5用于PWM设备信息 */
const am_zsl42x_adtim_pwm_devinfo_t  __g_adtim5_pwm_devinfo = {
    ZSL42x_TIM5_BASE,                           /**< \brief ADTIM5寄存器块的基地址 */
    ...
    __zsl42x_plfm_adtim5_pwm_init,              /**< \brief 平台初始化函数 */
    __zsl42x_plfm_adtim5_pwm_deinit             /**< \brief 平台解初始化函数 */
};

/** \brief ADTIM5用于PWM设备定义 */
am_zsl42x_adtim_pwm_dev_t __g_adtim5_pwm_dev;

/** \brief adtim5 pwm 实例初始化，获得pwm标准服务句柄 */
am_pwm_handle_t am_zsl42x_tim5_pwm_inst_init (void)
{
    return am_zsl42x_adtim_pwm_init(&__g_adtim5_pwm_dev,
...
void __zsl42x_plfm_adtim6_pwm_init (void)
{
    am_clk_enable(CLK_TIM456);
}

/** \brief 解除ADTIM6平台初始化 */
void __zsl42x_plfm_adtim6_pwm_deinit (void)
{
    am_clk_disable(CLK_TIM456);
}

/** \brief ADTIM6用于PWM功能的引脚配置信息列表 */
am_zsl42x_adtim_pwm_chaninfo_t __g_adtim6_pwm_chaninfo_list[] = {
...
const am_zsl42x_adtim_pwm_devinfo_t  __g_adtim6_pwm_devinfo = {
    ZSL42x_TIM6_BASE,                           /**< \brief ADTIM6寄存器块的基地址 */
    ...
    __zsl42x_plfm_adtim6_pwm_init,              /**< \brief 平台初始化函数 */
    __zsl42x_plfm_adtim6_pwm_deinit             /**< \brief 平台解初始化函数 */
};

/** \brief ADTIM6用于PWM设备定义 */
am_zsl42x_adtim_pwm_dev_t __g_adtim6_pwm_dev;

/** \brief adtim6 pwm 实例初始化，获得pwm标准服务句柄 */
am_pwm_handle_t am_zsl42x_tim6_pwm_inst_init (void)
{
    return am_zsl42x_adtim_pwm_init(&__g_adtim6_pwm_dev,
