...
/**
 * \file
 * \brief ZSL42x SYSTICK 用户配置文件
 * \sa am_hwconf_zsl42x_systick.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_zsl42x_systick
 * \copydoc am_hwconf_zsl42x_systick.c
 * @{
 */
...
static const am_arm_systick_devinfo_t __g_systick_devinfo = {
    ZSL42x_SYSTICK,                        /**< \brief 指向 SYSTICK 寄存器块指针 */
