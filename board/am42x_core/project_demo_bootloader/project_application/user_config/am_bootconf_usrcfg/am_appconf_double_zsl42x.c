...
#include <am_bootconf_usrcfg/am_appconf_double_zsl42x.h>
#include "am_zsl42x.h"
...
am_boot_firmware_handle_t am_zsl42x_boot_firmware_flash_inst_init()
{
    flash_handle = am_zsl42x_boot_flash_inst_init();
 ...
 */
static am_arm_boot_devinfo_t __g_zsl42x_boot_devinfo = {
    /**< \brief 应用代码区起始地址*/
    0x00006800,
    /** \brief ram起始地址 */
    0x20000000,
...
int am_zsl42x_boot_inst_init()
{
    return am_arm_boot_init(&__g_zsl42x_boot_devinfo);
}
