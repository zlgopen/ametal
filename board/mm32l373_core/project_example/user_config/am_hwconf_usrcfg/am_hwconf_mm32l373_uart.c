...
/**
 * \file
 * \brief MM32L373 UART 用户配置文件
 * \sa am_mm32l373l_hwconfig_uart.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_mm32l373_uart
 * \copydoc am_hwconf_mm32l373_uart.c
 * @{
 */

/** \brief 串口1平台初始化 */
static void __mm32l373_plfm_uart1_init (void)
{
...
/** \brief 解除串口1平台初始化 */
static void __mm32l373_plfm_uart1_deinit (void)
{
...
static const am_mm32_uart_devinfo_t __g_uart1_devinfo = {
    ...
    MM32L373_UART1_BASE,            /**< \brief 串口1 */
    INUM_UART1,                   /**< \brief 串口1的中断编号 */
    CLK_UART1,                    /**< \brief 串口1的时钟 */

    AMHW_MM32_UART_DATA_8BIT |  /**< \brief 8位数据 */
    AMHW_MM32_UART_PARITY_NO |  /**< \brief 无极性 */
    AMHW_MM32_UART_STOP_1BIT,   /**< \brief 1个停止位 */
    ...
    __mm32l373_plfm_uart1_init,     /**< \brief UART1的平台初始化 */
    __mm32l373_plfm_uart1_deinit,   /**< \brief UART1的平台去初始化 */
};

/**< \brief 定义串口1 设备 */
static am_mm32_uart_dev_t  __g_uart1_dev;

/** \brief 串口2平台初始化 */
static void __mm32l373_plfm_uart2_init (void)
{
...
/** \brief 解除串口2 平台初始化 */
static void __mm32l373_plfm_uart2_deinit (void)
{
...
static const am_mm32_uart_devinfo_t __g_uart2_devinfo = {
    ...
    __mm32l373_plfm_uart2_init,       /**< \brief UART2的平台初始化 */
    __mm32l373_plfm_uart2_deinit,     /**< \brief UART2的平台去初始化 */
};

/**< \brief 定义串口2设备 */
static am_mm32_uart_dev_t  __g_uart2_dev;

/** \brief 串口3平台初始化 */
static void __mm32l373_plfm_uart3_init (void)
{
...
/** \brief 解除串口3 平台初始化 */
static void __mm32l373_plfm_uart3_deinit (void)
{
...
/** \brief 串口3 设备信息 */
static const am_mm32_uart_devinfo_t __g_uart3_devinfo = {

    MM32L373_UART3_BASE,              /**< \brief 串口3 */
    ...
    __mm32l373_plfm_uart3_init,       /**< \brief UART3的平台初始化 */
    __mm32l373_plfm_uart3_deinit,     /**< \brief UART3的平台去初始化 */
};

/**< \brief 定义串口2设备 */
static am_mm32_uart_dev_t  __g_uart3_dev;
...
{
    return am_mm32_uart_init(&__g_uart3_dev, &__g_uart3_devinfo);
}
