...
#ifndef __AM_MM32L373_INST_INIT_H
#define __AM_MM32L373_INST_INIT_H
...
#include "am_rngbuf.h"
#include "am_input.h"
#include "am_mm32_tim_cap.h"
#include "amhw_mm32l373_rtc.h"
...
/**
 * \addtogroup am_if_mm32l373_inst_init
 * \copydoc am_mm32l373_inst_init.h
 * @{
 */
 ...
 */
int am_mm32l373_nvic_inst_init (void);
 ...
 * \return 无
 */
void am_mm32l373_nvic_inst_deinit (void);
 ...
 */
am_ili9341_handle_t am_mm32l373_ili9341_inst_init (void);

/**
 * \brief ILI9341 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_ili9341_inst_init() 函数获得的 ILI9341
 *                   标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_ili9341_inst_deinit (am_ili9341_handle_t handle);
 ...
 * \brief ADC1 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_adc1_inst_init() 函数获得的 ADC 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief ADC2 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_adc2_inst_init() 函数获得的 ADC 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief CRC 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_crc_inst_init() 函数获得的 CRC 标准服务句柄
 *
 * \return 无
 */
 ...
 */
am_dac_handle_t am_mm32l373_dac1_inst_init (void);

/**
 * \brief DAC1 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_dac1_inst_init() 函数获得的 DAC 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_dac1_inst_deinit (am_dac_handle_t handle);
 ...
 * \return DAC 标准服务句柄，若为 NULL，表明初始化失败
 */
am_dac_handle_t am_mm32l373_dac2_inst_init (void);

/**
 * \brief DAC2 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_dac2_inst_init() 函数获得的 DAC 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_dac2_inst_deinit (am_dac_handle_t handle);
 ...
 */
am_i2c_handle_t am_mm32l373_i2c1_inst_init (void);

/**
 * \brief I2C1 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_i2c1_inst_init() 函数获得的 I2C 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_i2c1_inst_deinit (am_i2c_handle_t handle);
 ...
 * \return I2C 标准服务句柄，若为 NULL，表明初始化失败
 */
am_i2c_handle_t am_mm32l373_i2c2_inst_init (void);

/**
 * \brief I2C2 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_i2c2_inst_init() 函数获得的 I2C 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_i2c2_inst_deinit (am_i2c_handle_t handle);
 ...
 */
am_i2c_slv_handle_t am_mm32l373_i2c1_slv_inst_init (void);

/**
 * \brief I2C1 从机实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_i2c1_slv_inst_init() 函数
 *                   获得的 I2C 从机标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_i2c1_slv_inst_deinit (am_i2c_slv_handle_t handle);
 ...
 * \return I2C 从机标准服务句柄，若为 NULL，表明初始化失败
 */
am_i2c_slv_handle_t am_mm32l373_i2c2_slv_inst_init (void);

/**
 * \brief I2C2 从机实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_i2c2_slv_inst_init() 函数
 *                   获得的 I2C 从机标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_i2c2_slv_inst_deinit (am_i2c_slv_handle_t handle);
 ...
 * \brief IWDG 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_iwdg_inst_init() 函数获得的 WDT 标准服务句柄
 *
 * \return 无
 */
 ...
 * \brief RTC 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_rtc_inst_init() 函数获得的 RTC 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_mm32l373_spi1_poll_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_mm32l373_spi2_poll_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
 ...
 * \return SPI 标准服务句柄，若为 NULL，表明初始化失败
 */
am_spi_handle_t am_mm32l373_spi1_dma_inst_init (void);

/**
 * \brief SPI1 DMA 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_spi1_dma_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_spi1_dma_inst_deinit (am_spi_handle_t handle);
 ...
 * \return SPI 标准服务句柄，若为 NULL，表明初始化失败
 */
am_spi_handle_t am_mm32l373_spi2_dma_inst_init (void);

/**
 * \brief SPI2 DMA 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_spi2_dma_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_spi2_dma_inst_deinit (am_spi_handle_t handle);
 ...
 * \return SPI 标准服务句柄，若为 NULL，表明初始化失败
 */
am_spi_handle_t am_mm32l373_spi1_int_inst_init (void);

/**
 * \brief SPI1 INT 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_spi1_int_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_spi1_int_inst_deinit (am_spi_handle_t handle);
 ...
 * \return SPI 标准服务句柄，若为 NULL，表明初始化失败
 */
am_spi_handle_t am_mm32l373_spi2_int_inst_init (void);

/**
 * \brief SPI2 INT 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_spi2_int_inst_init() 函数
 *                   获得的 SPI 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_spi2_int_inst_deinit (am_spi_handle_t handle);
 ...
 */
am_timer_handle_t am_mm32l373_systick_inst_init (void);

/**
 * \brief SYSTICK 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_systick_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_systick_inst_deinit (am_timer_handle_t handle);
 ...
 */
am_cap_handle_t am_mm32l373_tim1_cap_inst_init (void);

/**
 * \brief TIM1 CAP 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_tim1_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_tim1_cap_inst_deinit (am_cap_handle_t handle);
 ...
 * \return CAP 标准服务句柄，若为 NULL，表明初始化失败
 */
am_cap_handle_t am_mm32l373_tim2_cap_inst_init (void);

/**
 * \brief TIM2 CAP 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_tim2_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_tim2_cap_inst_deinit (am_cap_handle_t handle);
 ...
 * \return CAP 标准服务句柄，若为 NULL，表明初始化失败
 */
am_cap_handle_t am_mm32l373_tim3_cap_inst_init (void);

/**
 * \brief TIM3 CAP 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_tim3_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_tim3_cap_inst_deinit (am_cap_handle_t handle);
 ...
 * \return CAP 标准服务句柄，若为 NULL，表明初始化失败
 */
am_cap_handle_t am_mm32l373_tim4_cap_inst_init (void);

/**
 * \brief TIM4 CAP 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_tim4_cap_inst_init() 函数
 *                   获得的 CAP 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_tim4_cap_inst_deinit (am_cap_handle_t handle);
 ...
 */
am_pwm_handle_t am_mm32l373_tim1_pwm_inst_init (void);

/**
 * \brief TIM1 PWM 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_tim1_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_tim1_pwm_inst_deinit (am_pwm_handle_t handle);
 ...
 * \return PWM 标准服务句柄，若为 NULL，表明初始化失败
 */
am_pwm_handle_t am_mm32l373_tim2_pwm_inst_init (void);

/**
 * \brief TIM2 PWM 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_tim2_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_tim2_pwm_inst_deinit (am_pwm_handle_t handle);
 ...
 * \return PWM 标准服务句柄，若为 NULL，表明初始化失败
 */
am_pwm_handle_t am_mm32l373_tim3_pwm_inst_init (void);

/**
 * \brief TIM3 PWM 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_tim3_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_tim3_pwm_inst_deinit (am_pwm_handle_t handle);
 ...
 * \return PWM 标准服务句柄，若为 NULL，表明初始化失败
 */
am_pwm_handle_t am_mm32l373_tim4_pwm_inst_init (void);

/**
 * \brief TIM4 PWM 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_tim4_pwm_inst_init() 函数
 *                   获得的 PWM 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_tim4_pwm_inst_deinit (am_pwm_handle_t handle);
 ...
 *
 * \param[in] handle 通过 am_mm32l373_tim1_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_mm32l373_tim2_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_mm32l373_tim3_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
 ...
 *
 * \param[in] handle 通过 am_mm32l373_tim4_timing_inst_init() 函数
 *                   获得的 TIMER 标准服务句柄
 *
 * \return 无
 */
 ...
 */
am_uart_handle_t am_mm32l373_uart1_inst_init (void);

/**
 * \brief UART1 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_uart1_inst_init() 函数获得的 UART 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_uart1_inst_deinit (am_uart_handle_t handle);
 ...
 * \return UART 标准服务句柄，若为 NULL，表明初始化失败
 */
am_uart_handle_t am_mm32l373_uart2_inst_init (void);

/**
 * \brief UART2 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_uart2_inst_init() 函数获得的 UART 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_uart2_inst_deinit (am_uart_handle_t handle);
 ...
 * \return UART 标准服务句柄，若为 NULL，表明初始化失败
 */
am_uart_handle_t am_mm32l373_uart3_inst_init (void);

/**
 * \brief UART3 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_uart3_inst_init() 函数获得的 UART 标准服务句柄
 *
 * \return 无
 */
void am_mm32l373_uart3_inst_deinit (am_uart_handle_t handle);
 ...
 * \brief WWDG 实例解初始化
 *
 * \param[in] handle 通过 am_mm32l373_wwdg_inst_init() 函数获得的 WDT 标准服务句柄
 *
 * \return 无
 */
...
#endif  /* __AM_MM32L373_INST_INIT_H */
