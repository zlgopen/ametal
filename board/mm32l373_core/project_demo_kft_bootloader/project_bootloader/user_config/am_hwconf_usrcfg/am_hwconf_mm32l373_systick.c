...
/**
 * \file
 * \brief MM32L373 SYSTICK 用户配置文件
 * \sa am_hwconf_mm32l373_systick.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_mm32l373_systick
 * \copydoc am_hwconf_mm32l373_systick.c
 * @{
 */
...
static const am_arm_systick_devinfo_t __g_systick_devinfo = {
    MM32L373_SYSTICK,                        /**< \brief 指向 SYSTICK 寄存器块指针 */
