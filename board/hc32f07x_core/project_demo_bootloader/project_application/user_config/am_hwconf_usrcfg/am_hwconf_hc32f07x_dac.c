...
AMHW_HC32F07X_DAC_CHAN_MASK_AVCC_VOLT, /**< \brief DAC参考电压源 */

3300, /**< \brief DAC参考电压,单位：mv*/

AM_HC32_DAC_ALIGN_WAY_8_RIGHT, /**< \brief DAC数据对齐方式 */
 ...
 * \brief DAC1 平台初始化
 */
void __hc32_plfm_dac1_init(void) {
 ...
 * \brief DAC0 平台去初始化
 */
void __hc32_plfm_dac1_deinit(void) {
	/* 关闭DAC时钟 */
	am_clk_disable(CLK_DAC);
}

/** \brief DAC0 设备信息 */
static const am_hc32_dac_devinfo_t __g_dac1_devinfo = {
HC32_DAC_BASE, /**< \brief 指向DAC寄存器块的指针 */

12, /**< \brief DAC转换精度 */

AMHW_HC32F07X_DAC_CHAN_MASK_EXTER_REF, /**< \brief DAC参考电压源 */

3300, /**< \brief DAC参考电压,单位：mv*/

AM_HC32_DAC_ALIGN_WAY_12_RIGHT, /**< \brief DAC数据对齐方式 */

__hc32_plfm_dac1_init, /**< \brief DAC平台初始化函数 */

__hc32_plfm_dac1_deinit, /**< \brief DAC平台解初始化函数  */
};

/** \brief DAC1设备实例 */
static am_hc32_dac_dev_t __g_dac1_dev;

/** \brief DAC0 实例初始化，获得DAC标准服务句柄 */
am_dac_handle_t am_hc32_dac1_inst_init(void) {
	return am_hc32_dac_init(&__g_dac1_dev, &__g_dac1_devinfo);
}
