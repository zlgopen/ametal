 ...
 * \sa am_hwconf_hc32f07x_led_gpio.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_hc32f07x_led_gpio
 * \copydoc am_hwconf_hc32f07x_led_gpio.c
 * @{
 */
...
/** \brief 设备实例 */
static am_led_gpio_dev_t  __g_hc32f07x_led_gpio;

/** \brief 实例初始化函数 */
int am_hc32_led_gpio_inst_init (void)
{
    return am_led_gpio_init(&__g_hc32f07x_led_gpio, &__g_hc32f07x_led_gpio_info);
}
