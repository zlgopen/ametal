...
/**
 * \addtogroup am_if_src_hwconf_hc32f07x_i2c_slv
 * \copydoc am_hwconf_hc32f07x_i2c_slv.c
 * @{
 */

/** \brief I2C0 平台初始化函数 */
static void __hc32f07x_i2c0_plfm_init (void)
{
...
static void __hc32f07x_i2c0_plfm_deinit (void)
{
...
static const am_hc32_i2c_slv_devinfo_t __g_i2c0_devinfo = {
    ...
    __hc32f07x_i2c0_plfm_init,           /**< \brief 平台初始化 */
    __hc32f07x_i2c0_plfm_deinit          /**< \brief 平台去初始化 */
};
...
/** \brief I2C1 平台初始化函数 */
static void __hc32f07x_i2c1_plfm_init (void)
{
    am_gpio_pin_cfg(PIOB_10, PIOB_10_I2C1_SCL | PIOB_10_OUT_OD);
    am_gpio_pin_cfg(PIOB_11, PIOB_11_I2C1_SDA | PIOB_10_OUT_OD);

    am_clk_enable(CLK_I2C1);
}

/** \brief 解除I2C1 平台初始化函数 */
static void __hc32f07x_i2c1_plfm_deinit (void)
{
...
static const am_hc32_i2c_slv_devinfo_t __g_i2c1_devinfo = {
    ...
    __hc32f07x_i2c1_plfm_init,       /**< \brief 平台初始化 */
    __hc32f07x_i2c1_plfm_deinit      /**< \brief 平台去初始化 */
};
