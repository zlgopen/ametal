 ...
 * \sa am_hwconf_hc32f07x_tim_cap.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_hc32f07x_tim_cap
 * \copydoc am_hwconf_hc32f07x_tim_cap.c
 * @{
 */
/*******************************************************************************
  TIM0 配置
...
void __hc32f07x_plfm_tim0_cap_init (void)
{
    am_clk_enable(CLK_TIM012);
}

/** \brief 解除TIM0平台初始化 */
void __hc32f07x_plfm_tim0_cap_deinit (void)
{
...
const am_hc32_tim_cap_devinfo_t  __g_tim0_cap_devinfo = {
    ...
    __hc32f07x_plfm_tim0_cap_init,        /**< \brief 平台初始化函数 */
    __hc32f07x_plfm_tim0_cap_deinit       /**< \brief 平台解初始化函数 */
};
...
void __hc32f07x_plfm_tim1_cap_init (void)
{
    am_clk_enable(CLK_TIM012);
}

/** \brief 解除TIM1平台初始化 */
void __hc32f07x_plfm_tim1_cap_deinit (void)
{
    am_clk_disable(CLK_TIM012);
}
...
const am_hc32_tim_cap_devinfo_t  __g_tim1_cap_devinfo = {
    ...
    __hc32f07x_plfm_tim1_cap_init,        /**< \brief 平台初始化函数 */
    __hc32f07x_plfm_tim1_cap_deinit       /**< \brief 平台解初始化函数 */
};
...
void __hc32f07x_plfm_tim2_cap_init (void)
{
    am_clk_enable(CLK_TIM012);
}

/** \brief 解除TIM2平台初始化 */
void __hc32f07x_plfm_tim2_cap_deinit (void)
{
    am_clk_disable(CLK_TIM012);
}
...
const am_hc32_tim_cap_devinfo_t  __g_tim2_cap_devinfo = {
    ...
    __hc32f07x_plfm_tim2_cap_init,        /**< \brief 平台初始化函数 */
    __hc32f07x_plfm_tim2_cap_deinit       /**< \brief 平台解初始化函数 */
};
...
void __hc32f07x_plfm_tim3_cap_init (void)
{
    am_clk_enable(CLK_TIM3);
}

/** \brief 解除TIM3平台初始化 */
void __hc32f07x_plfm_tim3_cap_deinit (void)
{
...
const am_hc32_tim_cap_devinfo_t  __g_tim3_cap_devinfo = {
    ...
    __hc32f07x_plfm_tim3_cap_init,        /**< \brief 平台初始化函数 */
    __hc32f07x_plfm_tim3_cap_deinit       /**< \brief 平台解初始化函数 */
};
...
void __hc32f07x_plfm_adtim4_cap_init (void)
{
    am_clk_enable(CLK_TIM456);
}

/** \brief 解除ADTIM4平台初始化 */
void __hc32f07x_plfm_adtim4_cap_deinit (void)
{
...
const am_hc32_adtim_cap_devinfo_t  __g_adtim4_cap_devinfo = {
    ...
    __hc32f07x_plfm_adtim4_cap_init,      /**< \brief 平台初始化函数 */
    __hc32f07x_plfm_adtim4_cap_deinit     /**< \brief 平台解初始化函数 */
};
...
void __hc32f07x_plfm_adtim5_cap_init (void)
{
    am_clk_enable(CLK_TIM456);
}

/** \brief 解除ADTIM5平台初始化 */
void __hc32f07x_plfm_adtim5_cap_deinit (void)
{
    am_clk_disable(CLK_TIM456);
}
...
const am_hc32_adtim_cap_devinfo_t  __g_adtim5_cap_devinfo = {
    ...
    __hc32f07x_plfm_adtim5_cap_init,      /**< \brief 平台初始化函数 */
    __hc32f07x_plfm_adtim5_cap_deinit     /**< \brief 平台解初始化函数 */
};
...
void __hc32f07x_plfm_adtim6_cap_init (void)
{
    am_clk_enable(CLK_TIM456);
}

/** \brief 解除ADTIM6平台初始化 */
void __hc32f07x_plfm_adtim6_cap_deinit (void)
{
    am_clk_disable(CLK_TIM456);
}
...
const am_hc32_adtim_cap_devinfo_t  __g_adtim6_cap_devinfo = {
    ...
    __hc32f07x_plfm_adtim6_cap_init,      /**< \brief 平台初始化函数 */
    __hc32f07x_plfm_adtim6_cap_deinit     /**< \brief 平台解初始化函数 */
};
