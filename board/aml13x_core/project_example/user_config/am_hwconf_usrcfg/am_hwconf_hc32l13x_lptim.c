...
/** \brief LPTIM1 平台初始化 */
void __hc32l13x_plfm_lptim1_timing_init (void)
{
    /* 配置GATE引脚，以实现门控功能 */
...
void __hc32l13x_plfm_lptim1_timing_deinit (void)
{
...
const am_hc32_lptim_timing_devinfo_t  __g_lptim1_timing_devinfo = {
    ...
    __hc32l13x_plfm_lptim1_timing_init,    /**< \brief 平台初始化函数 */
    __hc32l13x_plfm_lptim1_timing_deinit   /**< \brief 平台解析初始化函数 */
};
