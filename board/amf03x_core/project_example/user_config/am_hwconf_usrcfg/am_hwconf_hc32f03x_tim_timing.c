...
const am_hc32_tim_timing_devinfo_t  __g_tim0_timing_devinfo = {
    ...
    __hc32f03x_plfm_tim0_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_tim0_timing_deinit   /**< \brief 平台解析初始化函数 */
};
...
const am_hc32_tim_timing_devinfo_t  __g_tim1_timing_devinfo = {
    ...
    AM_TRUE,                           /**< \brief 门控信号为真（1）有效 */
    AMHW_HC32_TIM_CLK_SRC_TCLK,      /**< \brief 计数时钟选择（默认内部） */
    __hc32f03x_plfm_tim1_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_tim1_timing_deinit   /**< \brief 平台解析初始化函数 */
};
...
const am_hc32_tim_timing_devinfo_t  __g_tim2_timing_devinfo = {
    ...
    AM_TRUE,                           /**< \brief 门控信号为真（1）有效 */
    AMHW_HC32_TIM_CLK_SRC_TCLK,      /**< \brief 计数时钟选择（默认内部） */
    __hc32f03x_plfm_tim2_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_tim2_timing_deinit   /**< \brief 平台解析初始化函数 */
};
...
const am_hc32_tim_timing_devinfo_t  __g_tim3_timing_devinfo = {
    ...
    AM_TRUE,                           /**< \brief 门控信号为真（1）有效 */
    AMHW_HC32_TIM_CLK_SRC_TCLK,      /**< \brief 计数时钟选择（默认内部） */
    __hc32f03x_plfm_tim3_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_tim3_timing_deinit   /**< \brief 平台解析初始化函数 */
};
...
const am_hc32_adtim_timing_devinfo_t  __g_adtim4_timing_devinfo = {
    ...
    __hc32f03x_plfm_adtim4_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_adtim4_timing_deinit   /**< \brief 平台解析初始化函数 */
};
...
const am_hc32_adtim_timing_devinfo_t  __g_adtim5_timing_devinfo = {
    ...
    __hc32f03x_plfm_adtim5_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_adtim5_timing_deinit   /**< \brief 平台解析初始化函数 */
};
...
const am_hc32_adtim_timing_devinfo_t  __g_adtim6_timing_devinfo = {
    ...
    __hc32f03x_plfm_adtim6_timing_init,    /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_adtim6_timing_deinit   /**< \brief 平台解析初始化函数 */
};
