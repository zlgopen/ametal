...
const am_hc32_tim_cap_devinfo_t  __g_tim0_cap_devinfo = {
    ...
    __hc32f03x_plfm_tim0_cap_init,        /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_tim0_cap_deinit       /**< \brief 平台解初始化函数 */
};
...
const am_hc32_tim_cap_devinfo_t  __g_tim1_cap_devinfo = {
    ...
    __hc32f03x_plfm_tim1_cap_init,        /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_tim1_cap_deinit       /**< \brief 平台解初始化函数 */
};
...
const am_hc32_tim_cap_devinfo_t  __g_tim2_cap_devinfo = {
    ...
    __hc32f03x_plfm_tim2_cap_init,        /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_tim2_cap_deinit       /**< \brief 平台解初始化函数 */
};
...
const am_hc32_tim_cap_devinfo_t  __g_tim3_cap_devinfo = {
    ...
    __hc32f03x_plfm_tim3_cap_init,        /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_tim3_cap_deinit       /**< \brief 平台解初始化函数 */
};
...
const am_hc32_adtim_cap_devinfo_t  __g_adtim4_cap_devinfo = {
    ...
    __hc32f03x_plfm_adtim4_cap_init,      /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_adtim4_cap_deinit     /**< \brief 平台解初始化函数 */
};
...
const am_hc32_adtim_cap_devinfo_t  __g_adtim5_cap_devinfo = {
    ...
    __hc32f03x_plfm_adtim5_cap_init,      /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_adtim5_cap_deinit     /**< \brief 平台解初始化函数 */
};
...
const am_hc32_adtim_cap_devinfo_t  __g_adtim6_cap_devinfo = {
    ...
    __hc32f03x_plfm_adtim6_cap_init,      /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_adtim6_cap_deinit     /**< \brief 平台解初始化函数 */
};
