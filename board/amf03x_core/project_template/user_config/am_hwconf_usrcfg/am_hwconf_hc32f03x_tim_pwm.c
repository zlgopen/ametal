...
const am_hc32_tim_pwm_devinfo_t  __g_tim0_pwm_devinfo = {
    ...
    __hc32f03x_plfm_tim0_pwm_init,                /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_tim0_pwm_deinit               /**< \brief 平台解初始化函数 */
};
...
const am_hc32_tim_pwm_devinfo_t  __g_tim1_pwm_devinfo = {
    ...
    __hc32f03x_plfm_tim1_pwm_init,                /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_tim1_pwm_deinit               /**< \brief 平台解初始化函数 */
};
...
const am_hc32_tim_pwm_devinfo_t  __g_tim2_pwm_devinfo = {
    ...
    __hc32f03x_plfm_tim2_pwm_init,                /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_tim2_pwm_deinit               /**< \brief 平台解初始化函数 */
};
...
const am_hc32_tim_pwm_devinfo_t  __g_tim3_pwm_devinfo = {
    ...
    __hc32f03x_plfm_tim3_pwm_init,                /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_tim3_pwm_deinit               /**< \brief 平台解初始化函数 */
};
...
const am_hc32_adtim_pwm_devinfo_t  __g_adtim4_pwm_devinfo = {
    ...
    __hc32f03x_plfm_adtim4_pwm_init,              /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_adtim4_pwm_deinit             /**< \brief 平台解初始化函数 */
};
...
const am_hc32_adtim_pwm_devinfo_t  __g_adtim5_pwm_devinfo = {
    ...
    __hc32f03x_plfm_adtim5_pwm_init,              /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_adtim5_pwm_deinit             /**< \brief 平台解初始化函数 */
};
...
const am_hc32_adtim_pwm_devinfo_t  __g_adtim6_pwm_devinfo = {
    ...
    __hc32f03x_plfm_adtim6_pwm_init,              /**< \brief 平台初始化函数 */
    __hc32f03x_plfm_adtim6_pwm_deinit             /**< \brief 平台解初始化函数 */
};
