...
/**
 * \file
 * \brief stm32f103rbt6 I2C从机驱动，服务I2C从机标准接口
 *
 * \internal
...
#ifndef __AM_STM32F103RBT6_I2C_SLV_H
#define __AM_STM32F103RBT6_I2C_SLV_H
...
/**
 * \addtogroup am_stm32f103rbt6_if_i2c_slv
 * \copydoc am_stm32f103rbt6_i2c_slv.h
 * @{
 */
 ...
 * \brief I2C设备信息参数结构体
 */
typedef struct am_stm32f103rbt6_i2c_slv_devinfo {
...
} am_stm32f103rbt6_i2c_slv_devinfo_t;

/**
 * \brief I2C设备结构体
 */
typedef struct am_stm32f103rbt6_i2c_slv_dev {
   ...
   /** \brief 从机设备,只能存一个从机地址,只能生成一个设备 */
    ...
    /** \brief STM32F103RBT6可生成最多的从机个数即可放多少个从机地址,与 p_i2c_slv_dev数组个数保持一致, */
...
} am_stm32f103rbt6_i2c_slv_dev_t;
...
#endif /* __AM_STM32F103RBT6_I2C_SLV_H */
