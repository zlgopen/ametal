 ...
 * \brief GPIO平台辅助工具宏
 *
 * 该文件被包含于 \sa stm32f103rbt6_pin.h. 其定义了GPIO平台引脚的各个功能。
 *
 * \internal
 ...
 * @{
 */
#define AM_STM32F103RBT6_GPIO_OUTRES_RATE                  AM_BIT(13)     /**< \brief 管脚响应速率 */
#define AM_STM32F103RBT6_GPIO_MODE                         AM_BIT(14)     /**< \brief 管脚模式 */
#define AM_STM32F103RBT6_GPIO_REMAP                        AM_BIT(15)     /**< \brief 管脚复用功能使能 */

#define AM_STM32F103RBT6_GPIO_OUTRESRATEBITS_START         18        /**< \brief 输出响应速率码起始位 */
#define AM_STM32F103RBT6_GPIO_OUTRESRATEBITS_LEN           2         /**< \brief 输出响应速率码长度 */
...
#define AM_STM32F103RBT6_GPIO_MODEBITS_START               20        /**< \brief 模式码起始位 */
#define AM_STM32F103RBT6_GPIO_MODEBITS_LEN                 4         /**< \brief 模式码长度 */
...
#define AM_STM32F103RBT6_GPIO_REMAP_PERIPHERAL_START       24  /**< \brief 重映像外设码起始位 */
#define AM_STM32F103RBT6_GPIO_REMAP_PERIPHERAL_LEN         5   /**< \brief 重映像外设码长度 */
...
#define AM_STM32F103RBT6_GPIO_REMAP_MODE_START             29  /**< \brief 重映像模式码起始位 */
#define AM_STM32F103RBT6_GPIO_REMAP_MODE_LEN               2   /**< \brief 重映像模式码长度 */
