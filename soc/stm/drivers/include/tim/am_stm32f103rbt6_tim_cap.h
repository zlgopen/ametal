...
#ifndef __AM_STM32F103RBT6_TIM_CAP_H
#define __AM_STM32F103RBT6_TIM_CAP_H
...
/**
 * \addtogroup am_stm32f103rbt6_if_tim_cap
 * \copydoc am_stm32f103rbt6_tim_cap.h
 * @{
 */
 ...
 */
typedef struct am_stm32f103rbt6_tim_cap_ioinfo {
    uint32_t gpio;           /**< \brief 对应的GPIO管脚 */
    uint32_t func;           /**< \brief 为捕获功能时的GPIO功能设置 */
    uint32_t dfunc;          /**< \brief 禁能管脚捕获功能时的默认GPIO功能设置 */
} am_stm32f103rbt6_tim_cap_ioinfo_t;

/**
 * \brief TIM捕获功能相关的设备信息
 */
typedef struct am_stm32f103rbt6_tim_cap_devinfo {
    ...
    am_stm32f103rbt6_tim_cap_ioinfo_t    *p_ioinfo;      /**< \brief 指向捕获管脚信息结构体 */
...
} am_stm32f103rbt6_tim_cap_devinfo_t;

/**
 * \brief TIM捕获功能设备
 */
typedef struct am_stm32f103rbt6_tim_cap_dev {
...
} am_stm32f103rbt6_tim_cap_dev_t;
 ...
 *
 * \param[in] handle : am_stm32f103rbt6_tim_cap_init() 初始化函数获得的cap服务句柄
 *
 * \return 无
 */
...
#endif /* __AM_STM32F103RBT6_TIM_CAP_H */
