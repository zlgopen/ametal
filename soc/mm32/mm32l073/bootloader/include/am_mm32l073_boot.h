...
#ifndef __AM_MM32L073_BOOT_H
#define __AM_MM32L073_BOOT_H

#include "am_boot.h"
#include "amhw_mm32_flash.h"
#include "am_boot_flash.h"

typedef struct am_mm32l073_boot_devinfo {
...
}am_mm32l073_boot_devinfo_t;

typedef struct am_mm32l073_boot_dev {
    am_mm32l073_boot_devinfo_t *p_devinfo;
    am_boot_flash_handle_t    flash_handle;   /**< \brief flash操作句柄 */

}am_mm32l073_boot_dev_t;
 ...
 */
int am_mm32l073_boot_init(am_mm32l073_boot_dev_t      *p_dev,
                        am_mm32l073_boot_devinfo_t  *p_devinfo,
                        am_boot_flash_handle_t     flash_handle);


#endif /* __AM_MM32L073_BOOT_H */
