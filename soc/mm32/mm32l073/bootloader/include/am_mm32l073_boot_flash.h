...
#ifndef __AM_MM32L073_BOOT_FLASH_H
#define __AM_MM32L073_BOOT_FLASH_H
#include "am_mm32_flash.h"
#include "am_boot.h"
#include "am_boot_flash.h"

typedef struct am_mm32l073_boot_flash_devinfo {
...
} am_mm32l073_boot_flash_devinfo_t;

typedef struct am_mm32l073_boot_flash_dev {
    am_boot_flash_serv_t            flash_serv;     /**< \brief flash标准服务 */
    am_boot_flash_info_t            flash_info;     /**< \brief flash信息结构体 */
    amhw_mm32_flash_t               *amhw_mm32_flash; /**< \brief flash寄存器结构体 */
    am_mm32l073_boot_flash_devinfo_t *p_devinfo;      /**< \brief 设备信息结构体 */
}am_mm32l073_boot_flash_dev_t;
...
#endif /* __AM_MM32L073_BOOT_FLASH_H */
