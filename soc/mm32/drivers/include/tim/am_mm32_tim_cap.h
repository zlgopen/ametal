...
#ifndef __AM_MM32_TIM_CAP_H
#define __AM_MM32_TIM_CAP_H
...
/**
 * \addtogroup am_mm32_if_tim_cap
 * \copydoc am_mm32_tim_cap.h
 * @{
 */
...
typedef struct am_mm32_tim_cap_devinfo {
    ...
    am_mm32_tim_cap_ioinfo_t    *p_ioinfo;      /**< \brief 指向捕获管脚信息结构体 */
...
} am_mm32_tim_cap_devinfo_t;

/**
 * \brief TIM捕获功能设备
 */
typedef struct am_mm32_tim_cap_dev {
 ...
 *
 * \param[in] handle : am_mm32_tim_cap_init() 初始化函数获得的cap服务句柄
 *
 * \return 无
 */
