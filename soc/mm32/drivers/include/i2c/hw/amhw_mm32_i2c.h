...
#ifndef __AMHW_MM32_I2C_H
#define __AMHW_MM32_I2C_H
...
/**
 * \addtogroup amhw_mm32_if_i2c
 * \copydoc amhw_mm32_i2c.h
 * @{
 */
...
/** \brief 主机模式 */
#define AMHW_MM32_I2C_MASTER                  (1ul | (1ul << 6))

/** \brief 从机模式 */
#define AMHW_MM32_I2C_SLAVE                   (0ul | (0ul << 6))

/** \brief 标准模式(0 ~ 100Kbps),主机模式下有效 */
#define AMHW_MM32_I2C_NORMAL_SPEED            (1ul << 1)

/** \brief 快速模式(<=400Kbps),主机模式下有效 */
#define AMHW_MM32_I2C_HIGH_SPEED              (2ul << 1)

/** \brief 7 位的寻址地址,从机模式下有效 */
#define AMHW_MM32_I2C_7BITADDR_SLAVE          (0ul << 3)

/** \brief 10 位的寻址地址,从机模式下有效 */
#define AMHW_MM32_I2C_10BITADDR_SLAVE         (1ul << 3)

/** \brief 7 位的寻址地址,主机模式下有效 */
#define AMHW_MM32_I2C_7BITADDR_MASTER         (0ul << 4)

/** \brief 10 位的寻址地址,主机模式下有效 */
#define AMHW_MM32_I2C_10BITADDR_MASTER        (1ul << 4)

/** \brief 主机模式下使能发送RESTART条件 */
#define AMHW_MM32_I2C_RESTART_ENABLE          (1ul << 5)

/** \brief 从机模式下使能产生STOP_DET中断 */
#define AMHW_MM32_I2C_STOP_DET_IFADDRESSED    (1ul << 7)

/**
 * \brief I2C中断标志
 */
typedef enum {
   AMHW_MM32_INT_FLAG_RX_UNDER = (1ul << 0),      /**< \brief 接收缓冲欠载 */
   AMHW_MM32_INT_FLAG_RX_OVER  = (1ul << 1),      /**< \brief 接受缓冲过载 */
   AMHW_MM32_INT_FLAG_RX_FULL  = (1ul << 2),      /**< \brief 接收缓冲非空 */
   AMHW_MM32_INT_FLAG_TX_OVER  = (1ul << 3),      /**< \brief 发送缓冲过载 */
   AMHW_MM32_INT_FLAG_TX_EMPTY = (1ul << 4),      /**< \brief 发送缓冲空 */
   AMHW_MM32_INT_FLAG_RD_REQ   = (1ul << 5),      /**< \brief 读请求 */
   AMHW_MM32_INT_FLAG_TX_ABRT  = (1ul << 6),      /**< \brief 发送中止 */
   AMHW_MM32_INT_FLAG_RX_DONE  = (1ul << 7),      /**< \brief 从发送结束 */
   AMHW_MM32_INT_FLAG_ACTIVITY = (1ul << 8),      /**< \brief I2C接口激活 */
   AMHW_MM32_INT_FLAG_STOP_DET = (1ul << 9),      /**< \brief 停止条件检测 */
   AMHW_MM32_INT_FLAG_START_DET= (1ul << 10),     /**< \brief 起始条件检测 */
   AMHW_MM32_INT_FLAG_GEN_CALL = (1ul << 11),     /**< \brief 广播呼叫 */
}amhw_mm32_int_flag_t;

/**
 * \brief I2C状态标志
 */
typedef enum {
   AMHW_MM32_STATUS_FLAG_ACTIVITY     = (1ul << 0),   /**< \brief I2C位活动状态 */
   AMHW_MM32_STATUS_FLAG_TFNF         = (1ul << 1),   /**< \brief 发送缓冲未满 */
   AMHW_MM32_STATUS_FLAG_TFE          = (1ul << 2),   /**< \brief 发送缓冲空 */
   AMHW_MM32_STATUS_FLAG_RFNE         = (1ul << 3),   /**< \brief 接收缓冲非空 */
   AMHW_MM32_STATUS_FLAG_RFF          = (1ul << 4),   /**< \brief 接收缓冲满 */
   AMHW_MM32_STATUS_FLAG_MST_ACTIVITY = (1ul << 5),   /**< \brief 主机状态机活动状态位 */
   AMHW_MM32_STATUS_FLAG_SLV_ACTIVITY = (1ul << 6),   /**< \brief 从机状态机活动状态位 */
}amhw_mm32_status_flag_t;
 ...
 */
am_static_inline
void amhw_mm32_i2c_con_set (amhw_mm32_i2c_t    *p_hw_i2c,
                           uint16_t           flag)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_con_clear (amhw_mm32_i2c_t    *p_hw_i2c,
                             uint16_t           flag)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_tar_set (amhw_mm32_i2c_t    *p_hw_i2c,
                           uint16_t           addr)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_slave_addr_set (amhw_mm32_i2c_t    *p_hw_i2c,
                                  uint16_t           addr)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_dat_write (amhw_mm32_i2c_t    *p_hw_i2c,
                             uint16_t           dat)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_dat_read (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_ss_scl_high_set (amhw_mm32_i2c_t    *p_hw_i2c,
                                   uint16_t           val)
{
 ...
 */
am_static_inline
uint16_t amhw_mm32_i2c_ss_scl_high_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_ss_scl_low_set (amhw_mm32_i2c_t    *p_hw_i2c,
                                  uint16_t           val)
{
 ...
 */
am_static_inline
uint16_t amhw_mm32_i2c_ss_scl_low_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_fs_scl_high_set (amhw_mm32_i2c_t    *p_hw_i2c,
                                   uint16_t           val)
{
 ...
 */
am_static_inline
uint16_t amhw_mm32_i2c_fs_scl_high_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_fs_scl_low_set (amhw_mm32_i2c_t    *p_hw_i2c,
                                  uint16_t           val)
{
 ...
 */
am_static_inline
uint16_t amhw_mm32_i2c_fs_scl_low_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
amhw_mm32_int_flag_t amhw_mm32_i2c_intr_stat_get (amhw_mm32_i2c_t *p_hw_i2c)
{
    return (amhw_mm32_int_flag_t)(p_hw_i2c->ic_intr_stat & 0xffff);
}
 ...
 */
am_static_inline
void amhw_mm32_i2c_intr_mask_set (amhw_mm32_i2c_t    *p_hw_i2c,
                                 uint16_t           flag)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_intr_mask_clear (amhw_mm32_i2c_t    *p_hw_i2c,
                                   uint16_t           flag)
{
 ...
 */
am_static_inline
amhw_mm32_int_flag_t amhw_mm32_i2c_intr_mask_get (amhw_mm32_i2c_t *p_hw_i2c)
{
    return (amhw_mm32_int_flag_t)(p_hw_i2c->ic_intr_mask & 0xffff);
}
 ...
 */
am_static_inline
amhw_mm32_int_flag_t amhw_mm32_i2c_raw_intr_stat_get (
                                                    amhw_mm32_i2c_t *p_hw_i2c)
{
    return (amhw_mm32_int_flag_t)(p_hw_i2c->ic_raw_intr_stat & 0xffff);
}
 ...
 */
am_static_inline
void amhw_mm32_i2c_rx_tl_set (amhw_mm32_i2c_t *p_hw_i2c, uint8_t val)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_rx_tl_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_tx_tl_set (amhw_mm32_i2c_t *p_hw_i2c, uint8_t val)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_tx_tl_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_clr_intr_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_clr_rx_under_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_clr_rx_over_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_clr_tx_over_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_clr_rd_req_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_clr_tx_abrt_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_clr_rx_done_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_clr_activity_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_clr_stop_det_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_clr_start_det_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_clr_gen_call_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_enable (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_disable (amhw_mm32_i2c_t *p_hw_i2c)
{
    p_hw_i2c->ic_enable &= ~0x1ul;
}
 ...
 */
am_static_inline
amhw_mm32_status_flag_t amhw_mm32_i2c_status_get (amhw_mm32_i2c_t *p_hw_i2c)
{
    return (amhw_mm32_status_flag_t)(p_hw_i2c->ic_status);
}
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_txflr_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
uint8_t amhw_mm32_i2c_rxflr_get (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_txdma_enable (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_txdma_disable (amhw_mm32_i2c_t *p_hw_i2c)
{
    p_hw_i2c->ic_dma_cr &= ~0x2ul;
}
 ...
 */
am_static_inline
void amhw_mm32_i2c_rxdma_enable (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_rxdma_disable (amhw_mm32_i2c_t *p_hw_i2c)
{
    p_hw_i2c->ic_dma_cr &= ~0x1ul;
}
 ...
 */
am_static_inline
void amhw_mm32_i2c_sda_setup_set (amhw_mm32_i2c_t *p_hw_i2c, uint8_t val)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_gen_call_ack (amhw_mm32_i2c_t *p_hw_i2c)
{
 ...
 */
am_static_inline
void amhw_mm32_i2c_gen_call_nack (amhw_mm32_i2c_t *p_hw_i2c)
{
    p_hw_i2c->ic_ack_general_call &= ~0x1ul;
}
