...
#ifndef __AM_MM32_SPI_SLV_DMA_H
#define __AM_MM32_SPI_SLV_DMA_H
...
/**
 * \addtogroup am_mm32_if_spi_slv_dma
 * \copydoc am_mm32_spi_slv_dma.h
 * @{
 */
 ...
 * \brief SPI 从机设备信息结构体
 */
typedef struct am_mm32l073_spi_slv_dma_devinfo {
...
} am_mm32_spi_slv_dma_devinfo_t;

/**
 * \brief SPI 设备结构体
 */
typedef struct am_mm32l073_spi_slv_dma_dev {
    ...
    /** \brief DMA 通道描述符 */
    amhw_mm32_dma_xfer_desc_t               g_desc[2];
