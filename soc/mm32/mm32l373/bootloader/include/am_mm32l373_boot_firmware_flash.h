...
#ifndef __AM_MM32L373_BOOT_FIRMWARE_H
#define __AM_MM32L373_BOOT_FIRMWARE_H

#include "am_boot_flash.h"
#include "am_boot_firmware.h"
typedef struct am_mm32l373_boot_firmware_flash_devinfo {
...
}am_mm32l373_boot_firmware_flash_devinfo_t;

typedef struct am_mm32l373_boot_firmware_flash_dev {
    /**< \brief 固件存放的标准服务 */
    am_boot_firmware_serv_t           firmware_flash_serv;
    /**< \brief flash的操作句柄*/
    am_boot_flash_handle_t            flash_handle;
    /**< \brief 设备信息 */
    am_mm32l373_boot_firmware_flash_devinfo_t *p_devinfo;
    /**< \brief 数据缓冲区 */
...
}am_mm32l373_boot_firmware_flash_dev_t;
 ...
 */
am_boot_firmware_handle_t am_mm32l373_boot_firmware_flash_init (
    am_mm32l373_boot_firmware_flash_dev_t     *p_dev,
    am_mm32l373_boot_firmware_flash_devinfo_t *p_devinfo,
    am_boot_flash_handle_t                   flash_handle);
 ...
 * \brief 固件flash存储解初始化
 */
void am_mm32l373_boot_firmware_flash_deint(void);

#endif /* __AM_MM32L373_BOOT_FIRMWARE_H */
