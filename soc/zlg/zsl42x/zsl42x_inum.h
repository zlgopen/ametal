...
#ifndef __ZSL42x_INUM_H
#define __ZSL42x_INUM_H
...
/**
 * \addtogroup zsl42x_if_inum
 * \copydoc zsl42x_inum.h
 * @{
 */
 ...
 *  这一现象，可以参考am_zsl42x_lptim_timing.c该解决方法，以解决其他中断号使用时的上述现象。
 *
 */
