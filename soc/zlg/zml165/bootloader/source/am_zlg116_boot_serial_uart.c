...
#include "am_zml165_boot_serial_uart.h"
#include "am_int.h"
#include "amhw_zlg_uart.h"
#include "am_zml165.h"
#include "am_zml165_inst_init.h"
#include "am_bootconf_zml165.h"

#define UART_CH       ZML165_UART1_BASE  /**< \brief UART通道 */
...
{
    am_zml165_boot_serial_uart_dev_t  *p_dev = (am_zml165_boot_serial_uart_dev_t *)p_arg;
...
static void __zml165_uart_int_init()
{
    /* 使能RDRF接收准中断 */
...
static am_zml165_boot_serial_uart_dev_t __g_serial_uart_dev;
...
am_boot_serial_handle_t am_zml165_boot_serial_uart_init(am_boot_autobaud_handle_t autobaud_handle)
{
    ...
    am_zml165_boot_autobaud_inst_deinit (autobaud_handle);

    uart_handle = am_zml165_uart1_inst_init();
