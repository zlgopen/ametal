 ...
 * \brief DAC数据对齐方式
 */
#define AM_ZLG118_DAC_ALIGN_WAY_12_RIGHT 0  /** \brief 12位数据右对齐 */
#define AM_ZLG118_DAC_ALIGN_WAY_12_LEFT  1  /** \brief 12位数据左对齐 */
#define AM_ZLG118_DAC_ALIGN_WAY_8_RIGHT  2  /** \brief 8 位数据右对齐 */
...
#define AM_ZLG118_DAC_CHAN_SOFTWARE_TRG (6U)    /** \brief 软件触发 */
#define AM_ZLG118_DAC_CHAN_EXTER        (7U)    /** \brief 外部事件触发 */
