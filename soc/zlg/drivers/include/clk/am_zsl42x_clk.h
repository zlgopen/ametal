...
#ifndef __AM_ZSL42x_CLK_H
#define __AM_ZSL42x_CLK_H
...
/**
 * \addtogroup am_zsl42x_if_clk
 * \copydoc am_zsl42x_clk.h
 * @{
 */
 ...
 * \brief CLK 设备信息参数结构体
 */
typedef struct am_zsl42x_clk_devinfo {
     ...
     *       设置其他频率，将默认使用38.4k
     */
    amhw_zsl42x_rcl_fre_t rcl_osc;

    /** \brief
     *    PLL 时钟源选择
     *    -# AMHW_ZSL42x_PLL_INPUT_FRE_SRC_XTH_XTAL : XTH晶振生成的时钟
     *    -# AMHW_ZSL42x_PLL_INPUT_FRE_SRC_XTH_PF00 : XTH从管脚PF00输入的时钟
     *    -# AMHW_ZSL42x_PLL_INPUT_FRE_SRC_XTH_RCH  : RCH时钟
     */
    amhw_zsl42x_pll_input_fre_src pllin_src;
     ...
     */
    amhw_zsl42x_sys_clk_src sysclk_src;
...
} am_zsl42x_clk_devinfo_t;

/**
 * \brief CLK 设备结构体
 */
typedef struct am_zsl42x_clk_dev {
    ...
    /** \brief sys类型 */
    amhw_zsl42x_sys_clk_src sys_type;
