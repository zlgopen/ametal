 ...
 */
typedef enum {
    AMHW_ZSL42x_RTC_PERIOD_INT_TYPE_CUSTOM  = 0,    /* 用户自定义时间 */
    AMHW_ZSL42x_RTC_PERIOD_INT_TYPE_SYSTEAM = 1,    /* 外设规定内容选择 */
 ...
 */
typedef enum {
    AMHW_ZSL42x_RTC_PERIOD_INT_TIME_NO      = 0ul,    /* 不产生周期中断 */
    AMHW_ZSL42x_RTC_PERIOD_INT_TIME_0_5_SEC = 1ul,    /* 0.5秒 */
    AMHW_ZSL42x_RTC_PERIOD_INT_TIME_1_SEC   = 2ul,    /* 1秒 */
    AMHW_ZSL42x_RTC_PERIOD_INT_TIME_1_MIN   = 3ul,    /* 1分钟 */
    AMHW_ZSL42x_RTC_PERIOD_INT_TIME_1_HOUR  = 4ul,    /* 1小时 */
    AMHW_ZSL42x_RTC_PERIOD_INT_TIME_1_DAY   = 5ul,    /* 1天 */
    AMHW_ZSL42x_RTC_PERIOD_INT_TIME_1_MON   = 6ul,    /* 1月 */
} amhw_zsl42x_rtc_period_int_time_t;

/**
 * \brief PRDS RTC周期中断选择
 *
 * \param[in] p_hw_rtc 指向 amhw_zsl42x_rtc_t结构的指针
 * \param[in] stata    amhw_zsl42x_rtc_period_int_time_t枚举选择
 *
 ...
 *
 * \param[in] p_hw_rtc 指向 amhw_zsl42x_rtc_t结构的指针
 * \param[in] stata  AM_FALSE ：使用amhw_zsl42x_rtc_period_int_time_sel配置的中断时间
 *                   AM_TRUE  ：使用amhw_zsl42x_rtc_period_int_time_set配置的中断时间
 * \return 无
 */
am_static_inline
 ...
 */
typedef enum {
    AMHW_ZSL42x_RTC_TIME_MODE_12h = 0ul,    /* 12小时制 */
    AMHW_ZSL42x_RTC_TIME_MODE_24H = 1ul,    /* 24小时制 */
 ...
 *
 * \param[in] p_hw_rtc 指向 amhw_zsl42x_rtc_t结构的指针
 * \param[in] stata    amhw_zsl42x_rtc_time_mode_t枚举选择
 *
 * \return 无
 */
am_static_inline
 ...
 * \param[in] p_hw_rtc 指向 amhw_zsl42x_rtc_t结构的指针
 *
 * \return amhw_zsl42x_rtc_time_mode_t枚举
 */
am_static_inline
amhw_zsl42x_rtc_time_mode_t
 ...
 *
 * \param[in] p_hw_rtc 指向 amhw_zsl42x_rtc_t结构的指针
 * \param[in] stata    amhw_zsl42x_rtc_clk_src_t枚举选择
 *
 * \return 无
 */
am_static_inline
 ...
 * \param[in] p_hw_rtc 指向 amhw_zsl42x_rtc_t结构的指针
 *
 * \return amhw_zsl42x_rtc_clk_src_t枚举
 */
am_static_inline
amhw_zsl42x_rtc_clk_src_t
 ...
 */
typedef enum {
    AMHW_ZSL42x_RTC_MODE_COUNTER   = 0ul,    /* 计数值模式 */
    AMHW_ZSL42x_RTC_MODE_WRITEREAD = 1ul,    /* 读写模式 */
 ...
 *
 * \param[in] p_hw_rtc 指向 amhw_zsl42x_rtc_t结构的指针
 * \param[in] stata    amhw_zsl42x_rtc_mode_t枚举选择
 *
