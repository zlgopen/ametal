...
#ifndef __AMHW_ZSN700_CLKTRIM_H
#define __AMHW_ZSN700_CLKTRIM_H
 ...
 */
am_static_inline
void amhw_zsn700_clktrim_calclk_sel (amhw_zsn700_clktrim_t      *p_hw_clktrim,
 ...
 */
am_static_inline
void amhw_zsn700_clktrim_int_enable (amhw_zsn700_clktrim_t *p_hw_clktrim,
                                     uint8_t                enable)
{
 ...
 */
am_static_inline
void amhw_zsn700_clktrim_mon_enable (amhw_zsn700_clktrim_t *p_hw_clktrim,
                                     uint8_t                enable)
{
    if(enable != 0 && enable != 1) {
        return;
 ...
 */
am_static_inline
void amhw_zsn700_clktrim_refclk_sel (amhw_zsn700_clktrim_t      *p_hw_clktrim,
 ...
 */
am_static_inline
void amhw_zsn700_clktrim_trim_start (amhw_zsn700_clktrim_t *p_hw_clktrim,
                                     uint8_t                start)
{
    if(start != 0 && start != 1) {
        return;
 ...
 */
am_static_inline
uint8_t amhw_zsn700_clktrim_ifr_get (amhw_zsn700_clktrim_t *p_hw_clktrim,
 ...
 */
am_static_inline
uint8_t amhw_zsn700_clktrim_ifr_clear (amhw_zsn700_clktrim_t *p_hw_clktrim,
                                       amhw_clktrim_ifr_t     ifr)
{
    if(ifr < 4) {
        return AM_EPERM;
