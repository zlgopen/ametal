...
#ifndef __AMHW_ZSL42x_CLKTRIM_H
#define __AMHW_ZSL42x_CLKTRIM_H
 ...
 */
am_static_inline
void amhw_zsl42x_clktrim_calclk_sel (amhw_zsl42x_clktrim_t      *p_hw_clktrim,
 ...
 */
am_static_inline
void amhw_zsl42x_clktrim_int_enable (amhw_zsl42x_clktrim_t *p_hw_clktrim,
                                     uint8_t                enable)
{
 ...
 */
am_static_inline
void amhw_zsl42x_clktrim_mon_enable (amhw_zsl42x_clktrim_t *p_hw_clktrim,
                                     uint8_t                enable)
{
    if(enable != 0 && enable != 1) {
        return;
 ...
 */
am_static_inline
void amhw_zsl42x_clktrim_refclk_sel (amhw_zsl42x_clktrim_t      *p_hw_clktrim,
 ...
 */
am_static_inline
void amhw_zsl42x_clktrim_trim_start (amhw_zsl42x_clktrim_t *p_hw_clktrim,
                                     uint8_t                start)
{
    if(start != 0 && start != 1) {
        return;
 ...
 */
am_static_inline
void amhw_zsl42x_clktrim_refcon_set (amhw_zsl42x_clktrim_t *p_hw_clktrim,
                                     uint32_t               rcntval)
{
 ...
 */
am_static_inline
uint32_t amhw_zsl42x_clktrim_refcnt_get (amhw_zsl42x_clktrim_t *p_hw_clktrim)
{
 ...
 */
am_static_inline
uint32_t amhw_zsl42x_clktrim_calcnt_get (amhw_zsl42x_clktrim_t *p_hw_clktrim)
{
 ...
 */
am_static_inline
uint8_t amhw_zsl42x_clktrim_ifr_get (amhw_zsl42x_clktrim_t *p_hw_clktrim,
 ...
 */
am_static_inline
uint8_t amhw_zsl42x_clktrim_ifr_clear (amhw_zsl42x_clktrim_t *p_hw_clktrim,
                                       amhw_clktrim_ifr_t     ifr)
{
    if(ifr < 4) {
        return AM_EPERM;
 ...
 */
am_static_inline
void amhw_zsl42x_clktrim_calcon_set (amhw_zsl42x_clktrim_t *p_hw_clktrim,
                                     uint32_t               ccntval)
{
