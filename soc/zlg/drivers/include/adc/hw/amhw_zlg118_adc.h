...
typedef enum {
    AMHW_ZLG118_WORK_MODE_SINGLE = 0,      /**< \brief 单次转换（至多1个通道）*/
    AMHW_ZLG118_WORK_MODE_SQR,             /**< \brief 顺序扫描规则转换（至多16通道） */
    AMHW_ZLG118_WORK_MODE_JQR,             /**< \brief 插入扫描规则转换 （至多4通道）*/
}amhw_zlg118_adc_work_mode_t;

typedef enum {
    AMHW_ZLG118_CHAN_AIN0_PA0 = 0,      /**< \brief 转换通道0 */
    AMHW_ZLG118_CHAN_AIN1_PA1,          /**< \brief 转换通道1 */
    AMHW_ZLG118_CHAN_AIN2_PA2,          /**< \brief 转换通道2 */
    AMHW_ZLG118_CHAN_AIN3_PA3,          /**< \brief 转换通道3 */
    AMHW_ZLG118_CHAN_AIN4_PA4,          /**< \brief 转换通道4 */
    AMHW_ZLG118_CHAN_AIN5_PA5,          /**< \brief 转换通道5 */
    AMHW_ZLG118_CHAN_AIN6_PA6,          /**< \brief 转换通道6 */
    AMHW_ZLG118_CHAN_AIN7_PA7,          /**< \brief 转换通道7 */
    AMHW_ZLG118_CHAN_AIN8_PB0,          /**< \brief 转换通道8 */
    AMHW_ZLG118_CHAN_AIN9_PB1,          /**< \brief 转换通道9 */
    AMHW_ZLG118_CHAN_AIN10_PC0,         /**< \brief 转换通道10 */
    AMHW_ZLG118_CHAN_AIN11_PC1,         /**< \brief 转换通道11 */
    AMHW_ZLG118_CHAN_AIN12_PC2,         /**< \brief 转换通道12 */
    AMHW_ZLG118_CHAN_AIN13_PC3,         /**< \brief 转换通道13 */
    AMHW_ZLG118_CHAN_AIN14_PC4,         /**< \brief 转换通道14 */
    AMHW_ZLG118_CHAN_AIN15_PC5,         /**< \brief 转换通道15 */
    AMHW_ZLG118_CHAN_AIN16_PB2,         /**< \brief 转换通道16 */
    AMHW_ZLG118_CHAN_AIN17_PB10,        /**< \brief 转换通道17 */
    AMHW_ZLG118_CHAN_AIN18_PB11,        /**< \brief 转换通道18 */
    AMHW_ZLG118_CHAN_AIN19_PB12,        /**< \brief 转换通道19 */
    AMHW_ZLG118_CHAN_AIN20_PB13,        /**< \brief 转换通道20 */
    AMHW_ZLG118_CHAN_AIN21_PB14,        /**< \brief 转换通道21 */
    AMHW_ZLG118_CHAN_AIN22_PB15,        /**< \brief 转换通道22 */
    AMHW_ZLG118_CHAN_AIN23_PE15,        /**< \brief 转换通道23 */
    AMHW_ZLG118_CHAN_AIN24_PE14,        /**< \brief 转换通道24 */
    AMHW_ZLG118_CHAN_AIN25_PE13,        /**< \brief 转换通道25 */
    AMHW_ZLG118_CHAN_DAC_OUT,           /**< \brief 与DAC输出连接，ADC_CR0.Buf必须为1 */
    AMHW_ZLG118_CHAN_VCC_DIV3,          /**< \brief 与内部1/3VCC连接，ADC_CR0.Buf必须为1 */
    AMHW_ZLG118_CHAN_INSIDE_TEMP_SENSOR,/**< \brief 与内置温度传感器输出电压连接，ADC_CR0.Buf必须为1 */
    AMHW_ZLG118_CHAN_INSIDE_REFVCC_12,  /**< \brief 与内部基准1.2V输出电压连接，ADC_CR0.Buf必须为1 */
 ...
 */
typedef enum {
    AMHW_ZLG118_ADC_SAMPLE_PERIOD_4 = 0,     /**< \brief 4个转换周期 */
    AMHW_ZLG118_ADC_SAMPLE_PERIOD_6,         /**< \brief 6个转换周期 */
    AMHW_ZLG118_ADC_SAMPLE_PERIOD_8,         /**< \brief 8个转换周期 */
    AMHW_ZLG118_ADC_SAMPLE_PERIOD_12,        /**< \brief 12个转换周期 */
 ...
 *
 * \param[in] p_hw_adc : 指向ADC寄存器的指针
 * \param[in] choice   : amhw_zlg118_adc_sample_period_t枚举量
 *
 * \return none
 */
am_static_inline
 ...
 * \param[in] p_hw_adc : 指向ADC寄存器的指针
 *
 * \return amhw_zlg118_adc_sample_period_t枚举量
 */
am_static_inline
 ...
 *
 * \param[in] p_hw_adc : 指向ADC寄存器的指针
 * \param[in] choice   : amhw_zlg118_adc_refvoltage_choice_t枚举量
 *
 * \return none
 */
am_static_inline
 ...
 *
 * \param[in] p_hw_adc : 指向ADC寄存器的指针
 * \param[in] choice   : amhw_zlg118_adc_chan_sel_t枚举量
 *
 * \return none
 */
am_static_inline
 ...
 *
 * \param[in] p_hw_adc : 指向ADC寄存器的指针
 * \param[in] choice   : amhw_zlg118_adc_pclk_div_t枚举量
 *
 * \return none
 */
am_static_inline
 ...
 * \param[in] p_hw_adc : 指向ADC寄存器的指针
 *
 * \return amhw_zlg118_adc_pclk_div_t枚举量中的一个
 */
am_static_inline
 ...
 *
 * \param[in] p_hw_adc : 指向ADC寄存器的指针
 * \param[in] mode     : amhw_zlg118_adc_mode_t枚举量
 *
 * \return none
 */
am_static_inline
 ...
 *
 * \param[in] p_hw_adc : 指向ADC寄存器的指针
 * \param[in] choice   : amhw_zlg118_adc_data_align_t枚举量
 *
 * \return none
 */
am_static_inline
...
typedef enum {
    ...
    AMHW_ZLG118_ADC_FLAG_CONVERT_JQR = 5,   /* 插队扫描转换状态标志    1：完成    0：未完成*/
    AMHW_ZLG118_ADC_FLAG_CONVERT_SQR = 4,   /* 顺序扫描转换状态标志    1：完成    0：未完成*/
    AMHW_ZLG118_ADC_FLAG_COMPARE_REG = 3,   /* 转换结果是否位于[LT ， HT)区间    1：位于    0：不位于*/
    AMHW_ZLG118_ADC_FLAG_COMPARE_HT = 2,    /* 转换结果是否位于[HT ， 4095)区间    1：位于    0：不位于*/
    AMHW_ZLG118_ADC_FLAG_COMPARE_LT = 1,    /* 转换结果是否位于[0 ， LT)区间    1：位于    0：不位于*/
    AMHW_ZLG118_ADC_FLAG_CONVERT_SINGLE = 0,/* 单次转换状态标志    1：完成    0：未完成*/
 ...
 *
 * \param[in] p_hw_adc : 指向ADC寄存器的指针
 * \param[in] type     : 标志类别（amhw_zlg118_adc_flag_type_t枚举量）
 *
 * \return AM_TRUE  : 1
 *         AM_FALSE : 0
 */
 ...
 *
 * \param[in] p_hw_adc : 指向ADC寄存器的指针
 * \param[in] type     : 标志类别（amhw_zlg118_adc_int_trigger_src_t枚举量）
 *
