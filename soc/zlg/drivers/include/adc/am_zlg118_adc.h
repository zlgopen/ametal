...
#ifndef  __AM_ZLG118_ADC_H
#define  __AM_ZLG118_ADC_H
...
/**
 * \addtogroup am_zlg118_if_adc
 * \copydoc am_zlg118_adc.h
 * @{
 */
/**
 ...
 */
typedef struct {
    amhw_zlg118_adc_chan_sel_t chan_sel;   /**< \brief 对应的ADC通道类别 */
    uint32_t gpio;                         /**< \brief 对应的GPIO管脚号 */
    uint32_t func;                         /**< \brief 对应的GPIO功能设置 */
    uint32_t dfunc;                        /**< \brief 对应的GPIO功能默认设置 */
} am_zlg118_adc_ioinfo_t;

/**
 * \brief ADC设备信息
 */
typedef struct am_zlg118_adc_devinfo {
    ...
    /* 参考电压选择 */
    amhw_zlg118_adc_refvoltage_choice_t vref_choice;
    ...
    /** \brief ADC对应通道的引脚信息  */
    am_zlg118_adc_ioinfo_t *p_ioinfo;
...
} am_zlg118_adc_devinfo_t;

/**
 * \brief ADC设备实例
 */
typedef struct am_zlg118_adc_dev {
    ...
    /** \brief ADC转换工作模式选择  */
    amhw_zlg118_adc_mode_t adc_mode;
 ...
 * 默认去初始化序列A
 *
 * \param[in] handle : am_zlg118_adc_init() 初始化函数获得的ADC服务句柄
 *
 * \return 无
 */
