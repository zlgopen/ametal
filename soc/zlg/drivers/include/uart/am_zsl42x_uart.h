...
#ifndef __AM_ZSL42x_UART_H
#define __AM_ZSL42x_UART_H
...
/**
 * \addtogroup am_zsl42x_if_uart
 * \copydoc am_zsl42x_uart.h
 * @{
 */
 ...
 *        便用户判断具体的中断源，size为1。
 */
#define AM_ZSL42x_UART_ERRCODE_UART_OTHER_INT  3
 ...
 */
typedef struct am_zsl42x_uart_devinfo {
    ...
    /**
     * \brief 指定使能的中断,AMHW_ZSL42x_UART_INT_*宏值或多个AMHW_ZSL42x_UART_INT_*宏
     */
...
} am_zsl42x_uart_devinfo_t;

/**
 * \brief 串口设备结构体定义
 */
typedef struct am_zsl42x_uart_dev {
    ...
    const am_zsl42x_uart_devinfo_t *p_devinfo; /**< \brief 指向设备信息常量的指针 */

} am_zsl42x_uart_dev_t;
