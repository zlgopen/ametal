 ...
 * \endinternal
 */
#ifndef __AM_ZSL42x_trng_H
#define __AM_ZSL42x_trng_H
...
/**
 * \addtogroup am_zsl42x_if_trng
 * \copydoc am_zsl42x_trng.h
 * @{
 */
 ...
 * \brief 随机数生成环境
 */
#define  AM_ZSL42x_TRNG_POWER_ON      0     /**< \brief 第一次上电产生随机数 */
#define  AM_ZSL42x_TRNG_POWER_NON     1     /**< \brief 非第一次上电产生随机数 */

/**
 * \brief TRNG设备信息结构体
 */
typedef struct am_zsl42x_trng_info {
...
}am_zsl42x_trng_devinfo_t;

/**
 * \brief TRNG设备实例
 */
typedef struct am_zsl42x_trng_dev {

    /** \brief 指向trng设备信息的指针 */
    const am_zsl42x_trng_devinfo_t *p_devinfo;

} am_zsl42x_trng_dev_t;

/** \brief TRNG标准服务操作句柄类型定义 */
typedef am_zsl42x_trng_dev_t *am_trng_handle_t;
