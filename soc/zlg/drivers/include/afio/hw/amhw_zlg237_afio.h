...
typedef enum {
    ...
    AMHW_ZLG237_NO_REMAP,               /**< \brief 没有重映像功能 */
 ...
 *
 * \param[in] p_hw_afio 指向 amhw_zlg237_afio_t 结构的指针
 * \param[in] pin
 ...
 *
 * \param[in] p_hw_afio 指向 amhw_zlg237_afio_t 结构的指针
 * \param[in] mode      重映设模式：amhw_zlg237_afio_uart3_remap_mode_t枚举的宏
 *
 * \return 无
 */
am_static_inline
 ...
 *
 * \param[in] p_hw_afio 指向 amhw_zlg237_afio_t 结构的指针
 * \param[in] mode      重映设模式：amhw_zlg237_afio_tim1_remap_mode枚举的宏
 *
 * \return 无
 */
am_static_inline
 ...
 *
 * \param[in] p_hw_afio 指向 amhw_zlg237_afio_t 结构的指针
 * \param[in] mode      重映设模式：amhw_zlg237_afio_tim2_remap_mode枚举的宏
 *
 * \return 无
 */
am_static_inline
 ...
 *
 * \param[in] p_hw_afio 指向 amhw_zlg237_afio_t 结构的指针
 * \param[in] mode      重映设模式：amhw_zlg237_afio_tim3_remap_mode枚举的宏
 *
 * \return 无
 */
am_static_inline
 ...
 *
 * \param[in] p_hw_afio 指向 amhw_zlg237_afio_t 结构的指针
 * \param[in] mode      重映设模式：amhw_zlg237_afio_can_remap_mode枚举的宏
 *
 * \return 无
 */
am_static_inline
 ...
 *
 * \param[in] p_hw_afio 指向 amhw_zlg237_afio_t 结构的指针
 * \param[in] mode      重映设模式：amhw_zlg237_afio_swj_cfg_mode_t枚举的宏
 *
 * \return 无
 */
am_static_inline
