 ...
 * \endinternal
 */
#ifndef __AM_ZMF237_USBD_H
#define __AM_ZMF237_USBD_H
...
}am_zlg227_usbd_devinfo_t;


typedef struct am_zlg227_usbd_dev am_zlg227_usbd_dev_t;

/**
 * \brief zlg USBD device structure
 */
struct am_zlg227_usbd_dev {
