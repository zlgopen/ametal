...
#ifndef __AMHW_ZSN700_PCA_H
#define __AMHW_ZSN700_PCA_H
...
/**
 * \addtogroup amhw_zsn700_if_pca
 * \copydoc amhw_zsn700_pca.h
 * @{
 */
 ...
 * \brief PCA寄存器块结构体
 */
typedef struct amhw_zsn700_pca {
 ...
 */
am_static_inline
void amhw_zsn700_pca_start (amhw_zsn700_pca_t *p_hw_pca)
{
 ...
 */
am_static_inline
void amhw_zsn700_pca_stop (amhw_zsn700_pca_t *p_hw_pca)
{
    p_hw_pca->ccon &= ~(0x1ul << 6);
}
 ...
 */
am_static_inline
void amhw_zsn700_pca_cidl_set (amhw_zsn700_pca_t    *p_hw_pca,
                               uint8_t               cidl)
{
    if(cidl > 1) {
        cidl = 1;
 ...
 */
am_static_inline
void amhw_zsn700_pca_wdte_set (amhw_zsn700_pca_t    *p_hw_pca,
                               uint8_t               wdte)
{
    if(wdte > 1) {
        wdte = 1;
 ...
 */
am_static_inline
void amhw_zsn700_pca_cps_set (amhw_zsn700_pca_t    *p_hw_pca,
                              uint8_t               cps)
{
    if(cps > 7) {
        cps = 7;
 ...
 */
am_static_inline
void amhw_zsn700_pca_cfie_set (amhw_zsn700_pca_t    *p_hw_pca,
                               uint8_t               cfie)
{
    if(cfie > 1) {
        cfie = 1;
 ...
 */
am_static_inline
void amhw_zsn700_pca_cnt_set (amhw_zsn700_pca_t *p_hw_pca, uint8_t data)
{
    p_hw_pca->cnt = data;
}
 ...
 */
am_static_inline
uint8_t amhw_zsn700_pca_int_get (amhw_zsn700_pca_t   *p_hw_pca,
                                 uint8_t              flag)
{
 ...
 */
am_static_inline
void amhw_zsn700_pca_int_clear (amhw_zsn700_pca_t  *p_hw_pca,
                                uint8_t             flag)
{
    p_hw_pca->iclr &= ~flag;
}
 ...
 */
am_static_inline
void amhw_zsn700_pca_ecom_set (amhw_zsn700_pca_t  *p_hw_pca,
                               uint8_t             num,
                               uint8_t             ecom)
{
    if(ecom > 1) {
 ...
 */
am_static_inline
void amhw_zsn700_pca_capp_set (amhw_zsn700_pca_t  *p_hw_pca,
                               uint8_t             num,
                               uint8_t             capp)
{
    if(capp > 1) {
 ...
 */
am_static_inline
void amhw_zsn700_pca_capn_set (amhw_zsn700_pca_t  *p_hw_pca,
                               uint8_t             num,
                               uint8_t             capn)
{
    if(capn > 1) {
 ...
 */
am_static_inline
void amhw_zsn700_pca_mat_set (amhw_zsn700_pca_t  *p_hw_pca,
                              uint8_t             num,
                              uint8_t             mat)
{
    if(mat > 1) {
 ...
 */
am_static_inline
void amhw_zsn700_pca_tog_set (amhw_zsn700_pca_t  *p_hw_pca,
                              uint8_t             num,
                              uint8_t             tog)
{
    if(tog > 1) {
 ...
 */
am_static_inline
void amhw_zsn700_pca_pwm_set (amhw_zsn700_pca_t  *p_hw_pca,
                              uint8_t             num,
                              uint8_t             pwm)
{
    if(pwm > 1) {
 ...
 */
am_static_inline
void amhw_zsn700_pca_ccie_set (amhw_zsn700_pca_t  *p_hw_pca,
                               uint8_t             num,
                               uint8_t             ccie)
{
    if(ccie > 1) {
 ...
 */
am_static_inline
void amhw_zsn700_pca_ccaph_set (amhw_zsn700_pca_t  *p_hw_pca,
                                uint8_t             num,
                                uint8_t             data)
{
    switch(num) {
 ...
 */
am_static_inline
uint8_t amhw_zsn700_pca_ccaph_get (amhw_zsn700_pca_t  *p_hw_pca,
                                   uint8_t             num)
{
    switch(num) {
    case 0:
 ...
 */
am_static_inline
void amhw_zsn700_pca_ccapl_set (amhw_zsn700_pca_t  *p_hw_pca,
                                uint8_t             num,
                                uint8_t             data)
{
    switch(num) {
 ...
 */
am_static_inline
uint8_t amhw_zsn700_pca_ccapl_get (amhw_zsn700_pca_t  *p_hw_pca,
                                   uint8_t             num)
{
    switch(num) {
    case 0:
 ...
 */
am_static_inline
void amhw_zsn700_pca_ccap_set (amhw_zsn700_pca_t  *p_hw_pca,
                               uint8_t             num,
                               uint16_t            data)
{
    switch(num) {
 ...
 */
am_static_inline
uint16_t amhw_zsn700_pca_ccap_get (amhw_zsn700_pca_t  *p_hw_pca,
                                   uint8_t             num)
{
    switch(num) {
    case 0:
 ...
 */
am_static_inline
void amhw_zsn700_pca_ccapo_enable (amhw_zsn700_pca_t  *p_hw_pca,
                                   uint8_t             num)
{
 ...
 */
am_static_inline
void amhw_zsn700_pca_ccapo_disable (amhw_zsn700_pca_t  *p_hw_pca,
                                    uint8_t             num)
{
    p_hw_pca->ccapo &= ~(1 << num);
}
 ...
 */
am_static_inline
void amhw_zsn700_pca_carr_set (amhw_zsn700_pca_t *p_hw_pca, uint16_t data)
{
    p_hw_pca->carr = data;
}
 ...
 */
am_static_inline
void amhw_zsn700_pca_epwm_enable (amhw_zsn700_pca_t  *p_hw_pca)
{
    p_hw_pca->epwm = 1;
}
 ...
 */
am_static_inline
void amhw_zsn700_pca_epwm_disable (amhw_zsn700_pca_t  *p_hw_pca)
{
    p_hw_pca->epwm = 0;
}
