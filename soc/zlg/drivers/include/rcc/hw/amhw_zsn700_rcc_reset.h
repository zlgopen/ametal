 ...
 */
typedef enum {
    AMHW_ZSN700_RCC_RESET_FLAG_PORT   = 7,  /**< \brief RSTB端口复位标志 */
	AMHW_ZSN700_RCC_RESET_FLAG_SOFT   = 6,  /**< \brief Cotrex-M0+CPU 软件复位标志 */
	AMHW_ZSN700_RCC_RESET_FLAG_LOCKUP = 5,  /**< \brief Cotrex-M0+CPU Lockup复位标志 */
	AMHW_ZSN700_RCC_RESET_FLAG_PCA    = 4,  /**< \brief PCA复位标志 */
	AMHW_ZSN700_RCC_RESET_FLAG_WDT    = 3,  /**< \brief WDT复位标志 */
    AMHW_ZSN700_RCC_RESET_FLAG_LVD    = 2,  /**< \brief LVD复位标志 */
    AMHW_ZSN700_RCC_RESET_FLAG_POR15V = 1,  /**< \brief Vcore域复位标志 */
    AMHW_ZSN700_RCC_RESET_FLAG_POR5V  = 0,  /**< \brief VCC电源域复位标志 */
}amhw_zsn700_rcc_reset_flag_peripheral;

/**
 * \brief 外设复位标志有效性获取
 *
 * \param[in] flag : 复位标志     amhw_zsn700_rcc_reset_flag_peripheral枚举成员
 *
