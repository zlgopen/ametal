...
#define AM_ZLG118_DMA_INT_COMPLETE            0  /** \brief 完成中断标识 */
#define AM_ZLG118_DMA_INT_ERR_ADDR_OVERFLOW   1  /** \brief 地址溢出传输错误 */
#define AM_ZLG118_DMA_INT_ERR_STOPASK         2  /** \brief 传输停止请求引起中止 */
#define AM_ZLG118_DMA_INT_ERR_SRCADDR         3  /** \brief 传输源地址访问错误 */
#define AM_ZLG118_DMA_INT_ERR_DSTADDR         4  /** \brief 传输目的地地址访问错误 */
#define AM_ZLG118_DMA_INT_ERR_STOP            5  /** \brief 传输暂停 */
