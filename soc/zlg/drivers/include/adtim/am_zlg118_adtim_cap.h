...
#define  AM_ZLG118_ADTIM_CAP_CHA  0x00   /**< \brief CAP通道A标识符*/
#define  AM_ZLG118_ADTIM_CAP_CHB  0x01   /**< \brief CAP通道B标识符*/
...
typedef struct am_zlg118_adtim_cap_devinfo {
    ...
    amhw_zlg118_adtim_pclk_div_t  clk_div;       /**< \brief 时钟分频系数 */
    uint8_t                       channels_num;  /**< \brief 使用的通道数，最大为2 */
    am_zlg118_adtim_cap_ioinfo_t *p_ioinfo;      /**< \brief 指向捕获管脚信息结构体 */
 ...
 *
 * \param[in] handle : am_zlg118_adtim_cap_init() 初始化函数获得的cap服务句柄
 *
 * \return 无
 */
