 ...
 * \brief GPIO平台辅助工具宏
 *
 * 该文件被包含于 \sa zml165_pin.h. 其定义了GPIO平台引脚的各个功能。
 *
 * \internal
 ...
 * @{
 */
#define AM_ZML165_GPIO_DIR                   AM_BIT(12) /**< \brief 管脚方向 */
#define AM_ZML165_GPIO_OUTRES_RATE           AM_BIT(13) /**< \brief 管脚响应速率 */
#define AM_ZML165_GPIO_MODE                  AM_BIT(14) /**< \brief 管脚模式 */
#define AM_ZML165_GPIO_FUNEN                 AM_BIT(15) /**< \brief 管脚复用功能使能 */

/** \brief 方向位偏移 */
#define AM_ZML165_GPIO_DIRBIT_START          16         /**< \brief 方向码起始位 */
#define AM_ZML165_GPIO_DIRBIT_LEN            2          /**< \brief 方向码长度 */
...
#define AM_ZML165_GPIO_OUTRESRATEBITS_START  18         /**< \brief 输出响应速率码起始位 */
#define AM_ZML165_GPIO_OUTRESRATEBITS_LEN    2          /**< \brief 输出响应速率码长度 */
...
#define AM_ZML165_GPIO_MODEBITS_START        20         /**< \brief 模式码起始位 */
#define AM_ZML165_GPIO_MODEBITS_LEN          4          /**< \brief 模式码长度 */
...
#define AM_ZML165_GPIO_FUNBITS_START          24        /**< \brief 功能码起始位 */
#define AM_ZML165_GPIO_FUNBITS_LEN            4         /**< \brief 功能码长度 */
