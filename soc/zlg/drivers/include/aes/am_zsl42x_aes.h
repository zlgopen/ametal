 ...
 * \endinternal
 */
#ifndef __AM_ZSL42x_AES_H
#define __AM_ZSL42x_AES_H
 ...
 * \brief AES密钥长度
 */
#define AM_ZSL42x_AES_KEY_LEN_128_BIT    0    /**< \brief 128位密钥长度 */
#define AM_ZSL42x_AES_KEY_LEN_192_BIT    1    /**< \brief 192位密钥长度 */
#define AM_ZSL42x_AES_KEY_LEN_256_BIT    2    /**< \brief 256位密钥长度 */

/**
 * \addtogroup am_zsl42x_if_aes
 * \copydoc am_zsl42x_aes.h
 * @{
 */
/**
 * \brief aes设备信息结构体
 */
typedef struct am_zsl42x_aes_info {
...
}am_zsl42x_aes_devinfo_t;

/**
 * \brief AES设备实例
 */
typedef struct am_zsl42x_aes_dev {
...
typedef am_zsl42x_aes_dev_t *am_aes_handle_t;
