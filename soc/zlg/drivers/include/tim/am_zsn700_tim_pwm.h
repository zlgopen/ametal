 ...
 *                            CH2A、CH2B，（互补3）
 */
#define  AM_ZSN700_TIM_PWM_CH0A        0x00   /**< \brief PWM通道0标识符*/
#define  AM_ZSN700_TIM_PWM_CH0B        0x01   /**< \brief PWM通道1标识符*/
#define  AM_ZSN700_TIM_PWM_CH1A        0x02   /**< \brief PWM通道2标识符*/
#define  AM_ZSN700_TIM_PWM_CH1B        0x03   /**< \brief PWM通道3标识符*/
#define  AM_ZSN700_TIM_PWM_CH2A        0x04   /**< \brief PWM通道4标识符*/
#define  AM_ZSN700_TIM_PWM_CH2B        0x05   /**< \brief PWM通道5标识符*/

/* PWM输出极性 */
#define  AM_ZSN700_TIM_PWM_OCPOLARITY_HIGH 6  /**< \brief 高电平有效 */
#define  AM_ZSN700_TIM_PWM_OCPOLARITY_LOW  7  /**< \brief 低电平有效 */
...
typedef struct am_zsn700_tim_pwm_devinfo {
    ...
    /** \brief PWM输出极性,AM_ZSN700_TIM_PWM_OCPOLARITY_HIGH或AM_ZSN700_TIM_PWM_OCPOLARITY_LOW */
    uint8_t                     ocpolarity;

    am_zsn700_tim_pwm_chaninfo_t  *p_chaninfo;     /**< \brief 指向PWM输出通道信息结构体 */
 ...
 *
 * \param[in] handle : am_zsn700_tim_pwm_init() 初始化函数获得的PWM服务句柄
 *
 * \return 无
 */
