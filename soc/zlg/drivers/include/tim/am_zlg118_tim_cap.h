 ...
 *                              CH2A、CH2B
 */
#define  AM_ZLG118_TIM_CAP_CH0A        0x00   /**< \brief CAP通道0标识符*/
#define  AM_ZLG118_TIM_CAP_CH0B        0x01   /**< \brief CAP通道1标识符*/
#define  AM_ZLG118_TIM_CAP_CH1A        0x02   /**< \brief CAP通道2标识符*/
#define  AM_ZLG118_TIM_CAP_CH1B        0x03   /**< \brief CAP通道3标识符*/
#define  AM_ZLG118_TIM_CAP_CH2A        0x04   /**< \brief CAP通道4标识符*/
#define  AM_ZLG118_TIM_CAP_CH2B        0x05   /**< \brief CAP通道5标识符*/
...
typedef struct am_zlg118_tim_cap_devinfo {
    ...
    amhw_zlg118_tim_clkdiv_t    clk_div;       /**< \brief 时钟分频系数 */
    uint8_t                     channels_num;  /**< \brief 使用的通道数，最大为2 */
    amhw_zlg118_tim_type_t      tim_type;      /**< \brief 定时器类型 */
    am_zlg118_tim_cap_ioinfo_t *p_ioinfo;      /**< \brief 指向捕获管脚信息结构体 */
 ...
 *
 * \param[in] handle : am_zlg118_tim_cap_init() 初始化函数获得的cap服务句柄
 *
 * \return 无
 */
