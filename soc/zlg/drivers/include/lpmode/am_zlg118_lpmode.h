...
typedef enum am_zlg118_lpmode_mode {
    AM_ZLG118_LPMODE_MODE_RUN = 0,      /**< \brief 运行模式 */
    AM_ZLG118_LPMODE_MODE_SLEEP,        /**< \brief 睡眠模式 */
    AM_ZLG118_LPMODE_MODE_DEEPSLEEP,    /**< \brief 深度睡眠模式 */
 ...
 * \brief LPMODE 初始化
 *
 * \return 返回 am_zlg118_lpmode_handle_t 类型的句柄
 */
