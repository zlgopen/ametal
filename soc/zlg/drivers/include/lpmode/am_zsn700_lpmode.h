...
typedef enum am_zsn700_lpmode_mode {
    AM_ZSN700_LPMODE_MODE_RUN = 0,      /**< \brief 运行模式 */
    AM_ZSN700_LPMODE_MODE_SLEEP,        /**< \brief 睡眠模式 */
    AM_ZSN700_LPMODE_MODE_DEEPSLEEP,    /**< \brief 深度睡眠模式 */
 ...
 * \brief LPMODE 初始化
 *
 * \return 返回 am_zsn700_lpmode_handle_t 类型的句柄
 */
 ...
 * \param[in] 无
 *
 * \return am_zsn700_lpmode_mode_t 这一枚举类型的值
 */
