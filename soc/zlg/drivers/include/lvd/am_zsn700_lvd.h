 ...
 * \endinternal
 */
#ifndef __AM_ZSN700_LVD_H
#define __AM_ZSN700_LVD_H
...
/**
 * \addtogroup am_zsn700_if_lvd
 * \copydoc am_zsn700_lvd.h
 * @{
 */
/**
 * \brief LVD设备信息结构体
 */
typedef struct am_zsn700_lvd_info {
...
}am_zsn700_lvd_devinfo_t;

/**
 * \brief LVD设备实例
 */
typedef struct am_zsn700_lvd_dev {
...
typedef am_zsn700_lvd_dev_t *am_lvd_handle_t;
 ...
 * \retval AM_OK    连接成功
 */
int am_zsn700_lvd_tri_set (am_lvd_handle_t handle,
