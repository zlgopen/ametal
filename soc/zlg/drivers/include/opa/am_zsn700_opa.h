 ...
 * \endinternal
 */
#ifndef __AM_ZSN700_OPA_H
#define __AM_ZSN700_OPA_H
 ...
 * \brief OPA工作模式选择
 */
#define AM_ZSN700_OPA_GENERAL  0 /**< \brief 通用模式 */
#define AM_ZSN700_OPA_DAC      1 /**< \brief DAC跟随模式 */

/**
 * \addtogroup am_zsn700_if_opa
 * \copydoc am_zsn700_opa.h
 * @{
 */
/**
 * \brief OPA设备信息结构体
 */
typedef struct am_zsn700_opa_info {
...
}am_zsn700_opa_devinfo_t;

/**
 * \brief LVD设备实例
 */
typedef struct am_zsn700_opa_dev {
...
typedef am_zsn700_opa_dev_t *am_opa_handle_t;
