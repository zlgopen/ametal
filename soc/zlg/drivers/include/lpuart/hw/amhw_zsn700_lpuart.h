...
#define AMHW_ZSN700_LPUART_INT_FRAME_ERR   (1ul << 21)   /* 帧错误中断使能位 */
#define AMHW_ZSN700_LPUART_INT_CTS_TRIGGER (1ul << 20)   /* CTS翻转中断使能位 */
#define AMHW_ZSN700_LPUART_INT_PARITY_ERR  (1ul << 13)   /* 奇偶校验错误中断使能位 */
#define AMHW_ZSN700_LPUART_INT_TX_EMPTY    (1ul << 8)    /* TX空中断使能位  */
#define AMHW_ZSN700_LPUART_INT_TX_COMPLETE (1ul << 1)    /* 发送中断使能位 */
#define AMHW_ZSN700_LPUART_INT_RX_COMPLETE (1ul << 0)    /* 接收中断使能位 */
#define AMHW_ZSN700_LPUART_INT_ALL         0xFF          /* 所有中断标志 */

/**
 * \brief UART 相关中断  禁能
 *
 * \param[in] p_hw_lpuart : 指向UART寄存器结构体的指针
 * \param[in] type        : 中断宏定义  AMHW_ZSN700_LPUART_INT_FRAME_ERR
 *                                 。
 *                                 。
 *                                 。
...
#define AMHW_ZSN700_LPUART_CTS          (1ul << 19)/* 硬件流CTS使能位 */
#define AMHW_ZSN700_LPUART_RTS          (1ul << 18)/* 硬件流RTS使能位 */
#define AMHW_ZSN700_LPUART_DMA_TX       (1ul << 17)/* 发送DMA使能位 */
#define AMHW_ZSN700_LPUART_DMA_RX       (1ul << 16)/* 接收DMA使能位 */
#define AMHW_ZSN700_LPUART_MUT_ADR_AUTO (1ul << 5) /* 多机地址自动识别使能位 */
#define AMHW_ZSN700_LPUART_RX           (1ul << 4) /* 接收使能
                                                    * Mode0:     0：发送; 1：接收
 ...
 *
 * \param[in] p_hw_lpuart : 指向UART寄存器结构体的指针
 * \param[in] type      : 中断宏定义  AMHW_ZSN700_LPUART_CTS
 *                               。
 *                               。
 *                               。
...
#define AMHW_ZSN700_LPUART_STOP_1_0_BIT   (0ul << 14)  /* 1个停止位 */
#define AMHW_ZSN700_LPUART_STOP_1_5_BIT   (1ul << 14)  /* 1.5个停止位 */
#define AMHW_ZSN700_LPUART_STOP_2_0_BIT   (2ul << 14)  /* 2个停止位 */

/**
 * \brief 停止位设置
 *
 * \param[in] p_hw_lpuart : 指向UART寄存器结构体的指针
 * \param[in] stop_bit    : 停止位宏定义   AMHW_ZSN700_LPUART_STOP_1_0_BIT 或
 *                                   AMHW_ZSN700_LPUART_STOP_1_5_BIT 或
 ...
 *
 * \param[in] p_hw_lpuart : 指向UART寄存器结构体的指针
 * \param[in] stop_bit    : 模式宏定义       AMHW_ZSN700_LPUART_MODE_0 或
 *                                   AMHW_ZSN700_LPUART_MODE_1 或
 *                                   AMHW_ZSN700_LPUART_MODE_2 或
 *                                   AMHW_ZSN700_LPUART_MODE_3
 *
 * \return none
 */
am_static_inline
...
#define AMHW_ZSN700_LPUART_SOFT           (0ul << 2)  /* 软件读写SBUF[8] */
#define AMHW_ZSN700_LPUART_HW_PARITY_EVEN (1ul << 2)  /* 硬件偶校验 */
#define AMHW_ZSN700_LPUART_HW_PARITY_ODD  (2ul << 2)  /* 硬件奇校验 */
#define AMHW_ZSN700_LPUART_PARITY_NO      (3ul << 2)  /* 保留 */
/**
 * \brief UART parity bit select
 *
 * \param[in] p_hw_lpuart : 指向UART寄存器结构体的指针
 * \param[in] parity      : 奇偶校验宏定义       AMHW_ZSN700_LPUART_SOFT            或
 *                                      AMHW_ZSN700_LPUART_HW_PARITY_EVEN  或
 *                                      AMHW_ZSN700_LPUART_HW_PARITY_ODD   或
...
typedef enum {
    AMHW_ZSN700_LPUART_SCLK_DIV_MODE0_NO  = 0,    /* 模式0，采样分频无效 */
    AMHW_ZSN700_LPUART_SCLK_DIV_MODE13_16 = 0,    /* 模式1/3，16采样分频 */
    AMHW_ZSN700_LPUART_SCLK_DIV_MODE13_8  = 1,    /* 模式1/3，8采样分频 */
    AMHW_ZSN700_LPUART_SCLK_DIV_MODE13_4  = 2,    /* 模式1/3，4采样分频 */
    AMHW_ZSN700_LPUART_SCLK_DIV_MODE2_32  = 0,    /* 模式2，32采样分频 */
    AMHW_ZSN700_LPUART_SCLK_DIV_MODE2_16  = 1,    /* 模式2，16采样分频 */
    AMHW_ZSN700_LPUART_SCLK_DIV_MODE2_8   = 2,    /* 模式2，8采样分频 */
}amhw_zsn700_lpuart_sclk_div_t;
/**
 * \brief UART 采样分频设置
 *
 * \param[in] p_hw_lpuart : 指向UART寄存器结构体的指针
 * \param[in] parity      : 分频系数amhw_zsn700_lpuart_sclk_div_t枚举量
 *
 * \return none
 */
am_static_inline
 ...
 *         如amhw_zsn700_lpuart_sclk_div_t枚举量）
 */
am_static_inline
...
typedef enum {
    AMHW_ZSN700_LPUART_SCLK_SRC_PCLK = 0,    /* LPUART通信传输时钟为  PCLK */
    AMHW_ZSN700_LPUART_SCLK_SRC_XTL  = 2,    /* LPUART通信传输时钟为  外部低速时钟 */
    AMHW_ZSN700_LPUART_SCLK_SRC_RCL  = 3,    /* LPUART通信传输时钟为  内部低速时钟 */
 ...
 *
 * \param[in] p_hw_lpuart : 指向UART寄存器结构体的指针
 * \param[in] parity      : amhw_zsn700_lpuart_sclk_src_t枚举量
 *
 * \return none
 */
am_static_inline
 ...
 * \param[in] p_hw_lpuart : 指向UART寄存器结构体的指针
 *
 * \return amhw_zsn700_lpuart_sclk_src_t枚举量
 */
am_static_inline
amhw_zsn700_lpuart_sclk_src_t
...
#define AMHW_ZSN700_LPUART_FLAG_CTS          (1ul << 6)   /* CTS高低电平标志位,硬件清零 */
#define AMHW_ZSN700_LPUART_FLAG_CTS_TRIGGER  (1ul << 5)   /* CTS翻转标志位,软件清0 */
#define AMHW_ZSN700_LPUART_FLAG_PARITY_ERR   (1ul << 4)   /* 奇偶校验错误标志位,软件清0 */
#define AMHW_ZSN700_LPUART_FLAG_TX_EMPTY     (1ul << 3)   /* 发送空标志位,硬件清零 */
#define AMHW_ZSN700_LPUART_FLAG_FRAME_ERR    (1ul << 2)   /* 帧错误标志位,软件清0 */
#define AMHW_ZSN700_LPUART_FLAG_TX_COMPLETE  (1ul << 1)   /* 发送完成标志位,软件清0 */
#define AMHW_ZSN700_LPUART_FLAG_RX_COMPLETE  (1ul << 0)   /* 接收完成标志位,软件清0 */

/**
 * \brief UART 标志获取
 *
 * \param[in] p_hw_lpuart : 指向UART寄存器结构体的指针
 * \param[in] flag        : 标志宏定义   AMHW_ZSN700_LPUART_FLAG_CTS          或
 *                                  AMHW_ZSN700_LPUART_FLAG_CTS_TRIGGER  或
 *                                  AMHW_ZSN700_LPUART_FLAG_PARITY_ERR   或
 *                                  AMHW_ZSN700_LPUART_FLAG_TX_EMPTY     或
 *                                  AMHW_ZSN700_LPUART_FLAG_FRAME_ERR    或
 *                                  AMHW_ZSN700_LPUART_FLAG_TX_COMPLETE  或
 *                                  AMHW_ZSN700_LPUART_FLAG_RX_COMPLETE  或
 *
 * \return AM_TRUE  : 标志有效
 *         AM_FALSE : 标志无效
 */
 ...
 *
 * \param[in] p_hw_lpuart : 指向UART寄存器结构体的指针
 * \param[in] flag        : 标志宏定义   AMHW_ZSN700_LPUART_FLAG_CTS_TRIGGER  或
 *                                  AMHW_ZSN700_LPUART_FLAG_PARITY_ERR   或
 *                                  AMHW_ZSN700_LPUART_FLAG_FRAME_ERR    或
 *                                  AMHW_ZSN700_LPUART_FLAG_TX_COMPLETE  或
 *                                  AMHW_ZSN700_LPUART_FLAG_RX_COMPLETE  或
