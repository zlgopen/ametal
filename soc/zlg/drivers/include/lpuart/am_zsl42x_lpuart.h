...
#ifndef __AM_ZSL42x_LPUART_H
#define __AM_ZSL42x_LPUART_H
...
/**
 * \addtogroup am_zsl42x_if_lpuart
 * \copydoc am_zsl42x_lpuart.h
 * @{
 */
 ...
 *        便用户判断具体的中断源，size为1。
 */
#define AM_ZSL42x_LPUART_ERRCODE_LPUART_OTHER_INT  3
 ...
 */
typedef struct am_zsl42x_lpuart_devinfo {

    uint32_t    lpuart_reg_base;    /**< \brief 指向LPUART寄存器块的指针 */

    uint8_t     inum;               /**< \brief 串口中断号 */

    amhw_zsl42x_lpuart_sclk_src_t sclk_src;   /**< \brief 通信传输时钟  */
    ...
    /**
     * \brief 指定使能的中断,AMHW_ZSL42x_LPUART_INT_*宏值或多个AMHW_ZSL42x_LPUART_INT_*宏
     */
...
} am_zsl42x_lpuart_devinfo_t;

/**
 * \brief 串口设备结构体定义
 */
typedef struct am_zsl42x_lpuart_dev {
    ...
    const am_zsl42x_lpuart_devinfo_t *p_devinfo; /**< \brief 指向设备信息常量的指针 */

} am_zsl42x_lpuart_dev_t;
 ...
 */
am_uart_handle_t am_zsl42x_lpuart_init(am_zsl42x_lpuart_dev_t           *p_dev,
