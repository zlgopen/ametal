 ...
 * \brief I2C设备信息参数结构体
 */
typedef struct am_zsl42x_i2c_slv_devinfo {
...
} am_zsl42x_i2c_slv_devinfo_t;

/**
 * \brief I2C设备结构体
 */
typedef struct am_zsl42x_i2c_slv_dev {
   ...
   /** \brief 从机设备,只能存一个从机地址,只能生成一个设备 */
    ...
    /** \brief ZSL42x可生成最多的从机个数即可放多少个从机地址,与 p_i2c_slv_dev数组个数保持一致, */
 ...
 * \return 从I2C标准服务操作句柄
 */
am_i2c_slv_handle_t am_zsl42x_i2c_slv_init (am_zsl42x_i2c_slv_dev_t           *p_dev,
                                         const am_zsl42x_i2c_slv_devinfo_t *p_devinfo);
