...
am_local void __spi_cs_on  (am_zsl42x_spi_poll_dev_t *p_this, am_spi_device_t *p_dev);
am_local void __spi_cs_off (am_zsl42x_spi_poll_dev_t *p_this, am_spi_device_t *p_dev);

am_local void __spi_write_data (am_zsl42x_spi_poll_dev_t *p_dev);
am_local void __spi_read_data (am_zsl42x_spi_poll_dev_t *p_dev);

am_local int  __spi_hard_init (am_zsl42x_spi_poll_dev_t *p_this);
am_local int  __spi_config (am_zsl42x_spi_poll_dev_t *p_this);

am_local uint32_t __spi_speed_cfg (am_zsl42x_spi_poll_dev_t *p_dev,
                                   uint32_t                  target_baud);

am_local int  __spi_mst_sm_event (am_zsl42x_spi_poll_dev_t *p_dev);
/*******************************************************************************
  SPI驱动函数声明
*******************************************************************************/
 ...
 */
am_local
void __spi_cs_on (am_zsl42x_spi_poll_dev_t *p_this, am_spi_device_t *p_dev)
{
 ...
 */
am_local
void __spi_cs_off (am_zsl42x_spi_poll_dev_t *p_this,
                   am_spi_device_t      *p_dev)
{
    amhw_zsl42x_spi_t     *p_hw_spi = (amhw_zsl42x_spi_t *)(p_this->p_devinfo->spi_reg_base);
...
am_local
void __spi_write_data (am_zsl42x_spi_poll_dev_t *p_dev)
{
...
am_local
void __spi_read_data (am_zsl42x_spi_poll_dev_t *p_dev)
{
    amhw_zsl42x_spi_t  *p_hw_spi = (amhw_zsl42x_spi_t *)(p_dev->p_devinfo->spi_reg_base);
...
{
    am_zsl42x_spi_poll_dev_t *p_this = (am_zsl42x_spi_poll_dev_t *)p_arg;
 ...
 */
am_local
int __spi_hard_init (am_zsl42x_spi_poll_dev_t *p_this)
{
    amhw_zsl42x_spi_t *p_hw_spi = (amhw_zsl42x_spi_t *)(p_this->p_devinfo->spi_reg_base);
...
am_local
int __spi_config (am_zsl42x_spi_poll_dev_t *p_this)
{
    const am_zsl42x_spi_poll_devinfo_t *p_devinfo = p_this->p_devinfo;
...
int __spi_msg_start (void              *p_drv,
                     ...
                     am_spi_message_t  *p_msg)
{
    am_zsl42x_spi_poll_dev_t *p_this = (am_zsl42x_spi_poll_dev_t *)p_drv;
 ...
 */
am_local
int __spi_mst_sm_event (am_zsl42x_spi_poll_dev_t *p_dev)
{
 ...
 * \brief SPI初始化
 */
am_spi_handle_t am_zsl42x_spi_poll_init (am_zsl42x_spi_poll_dev_t           *p_dev,
                                         const am_zsl42x_spi_poll_devinfo_t *p_devinfo)
{
 ...
 * \brief SPI 去除初始化
 */
void am_zsl42x_spi_poll_deinit (am_spi_handle_t handle)
{
    am_zsl42x_spi_poll_dev_t *p_dev    = (am_zsl42x_spi_poll_dev_t *)handle;
    amhw_zsl42x_spi_t        *p_hw_spi = (amhw_zsl42x_spi_t *)(p_dev->p_devinfo->spi_reg_base);
 ...
 */
am_local
uint32_t __spi_speed_cfg (am_zsl42x_spi_poll_dev_t *p_dev,
