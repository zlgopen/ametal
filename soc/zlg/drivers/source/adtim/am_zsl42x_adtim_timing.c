...
{
    am_zsl42x_adtim_timing_dev_t *p_dev      = (am_zsl42x_adtim_timing_dev_t *)p_arg;
     ...
     * 判断是否是定时器溢出中断
     */
    if ((amhw_zsl42x_adtim_getirqflag(p_hw_adtim, AMHW_ZSL42x_ADTIM_OVFIrq)) ==
         AM_TRUE) {
...
{
    am_zsl42x_adtim_timing_dev_t *p_dev = (am_zsl42x_adtim_timing_dev_t *)p_drv;
...
static int __adtim_timing_prescale_set (void    *p_drv,
                                        ...
                                        uint32_t prescale)
{
    am_zsl42x_adtim_timing_dev_t   *p_dev = (am_zsl42x_adtim_timing_dev_t *)
                                             p_drv;
...
static int __adtim_timing_prescale_get (void     *p_drv,
                                        ...
                                        uint32_t *p_prescale)
{
    amhw_zsl42x_adtim_pclk_div_t  div   = AMHW_ZSL42x_ADTIM_PCLK_DIV1;
    am_zsl42x_adtim_timing_dev_t *p_dev = (am_zsl42x_adtim_timing_dev_t *)p_drv;
    amhw_zsl42x_adtim_t          *p_hw_adtim;
    ...
    /* 获取分频值 */
    div = amhw_zsl42x_adtim_clkdiv_get(p_hw_adtim);
...
static int __adtim_timing_count_get (void *p_drv, uint8_t chan, void *p_count)
{
    ...
    *(uint32_t *)p_count = amhw_zsl42x_adtim_getcount(p_hw_adtim);
...
static int __adtim_timing_rollover_get (void *p_drv,uint8_t chan,void *p_rollover)
{
    ...
    *(uint32_t *)p_rollover = amhw_zsl42x_adtim_getperiod(p_hw_adtim);
...
static int __adtim_timing_enable (void *p_drv, uint8_t chan, void *p_count)
{
    ...
    /* 设置计数周期 */
    amhw_zsl42x_adtim_setperiod(p_hw_adtim, count);
...
am_timer_handle_t am_zsl42x_adtim_timing_init (
    am_zsl42x_adtim_timing_dev_t             *p_dev,
