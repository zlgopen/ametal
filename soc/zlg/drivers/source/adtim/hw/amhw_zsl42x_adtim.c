...
am_bool_t amhw_zsl42x_adtim_porttrigcfg(
    ...
    switch(trigport) {
    case AMHW_ZSL42x_ADTIM_TRIG_PORT_A:
        ...
        p_hw_adtim4->fconr = (p_hw_adtim4->fconr & (~(3ul << 17))) |
                            (p_cfg->flt_enable << 17);
        break;
    case AMHW_ZSL42x_ADTIM_TRIG_PORT_B:
        ...
        p_hw_adtim4->fconr = (p_hw_adtim4->fconr & (~(3ul << 21))) |
                            (p_cfg->flt_enable << 21);
        break;
    case AMHW_ZSL42x_ADTIM_TRIG_PORT_C:
        ...
        p_hw_adtim4->fconr = (p_hw_adtim4->fconr & (~(3ul << 25))) |
                            (p_cfg->flt_enable << 25);
        break;
    case AMHW_ZSL42x_ADTIM_TRIG_PORT_D:
...
am_bool_t amhw_zsl42x_adtim_disable3cfg(
    ...
    amhw_zsl42x_adtim_clearbrakeport();

    for(i = 0; i <= AMHW_ZSL42x_ADTIM_TRIG_PD5; i++) {

        if(AM_TRUE == p_cfg->stcbrkptcfg[i].portenable) {
            amhw_zsl42x_adtim_enablebrakeport(i, &(p_cfg->stcbrkptcfg[i]));
        }
    }
