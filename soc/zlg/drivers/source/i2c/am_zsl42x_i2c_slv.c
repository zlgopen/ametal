...
/** \brief I2C硬件初始化 */
static int __i2c_slv_hard_init(am_zsl42x_i2c_slv_dev_t *p_dev);
/** \brief I2C中断处理函数 */
...
static int __i2c_slv_setup (void *p_drv, am_i2c_slv_device_t *p_i2c_slv_dev)
{
    ...
    am_zsl42x_i2c_slv_dev_t   *p_dev      = NULL;
    amhw_zsl42x_i2c_t      *p_hw_i2c   = NULL;
    ...
    p_dev    = (am_zsl42x_i2c_slv_dev_t *)p_drv;
    p_hw_i2c = (amhw_zsl42x_i2c_t *)(p_dev->p_devinfo->i2c_regbase);
    ...
    if ( p_i2c_slv_dev->dev_flags & AM_I2C_SLV_GEN_CALL_ACK) {
        amhw_zsl42x_i2c_gen_call_ack(p_hw_i2c);
    } else {
        amhw_zsl42x_i2c_gen_call_nack(p_hw_i2c);
    }
     ...
     */
    amhw_zsl42x_i2c_slave_addr_set (p_hw_i2c, p_i2c_slv_dev->dev_addr);
...
static int __i2c_slv_shutdown (void *p_drv, am_i2c_slv_device_t *p_i2c_slv_dev)
{
    am_zsl42x_i2c_slv_dev_t *p_dev    = (am_zsl42x_i2c_slv_dev_t *)p_drv;
    amhw_zsl42x_i2c_t   *p_hw_i2c_slv = NULL;

    if ( (p_dev              == NULL) ||
         (p_i2c_slv_dev      == NULL)) {
        return -AM_EINVAL;
    }
    p_hw_i2c_slv = (amhw_zsl42x_i2c_t *) p_dev->p_devinfo->i2c_regbase;
    ...
    amhw_zsl42x_i2c_disable (p_hw_i2c_slv);
...
{
    am_zsl42x_i2c_slv_dev_t  *p_dev     = ( am_zsl42x_i2c_slv_dev_t *) p_arg;
    amhw_zsl42x_i2c_t     *p_hw_i2c  = NULL;
    p_hw_i2c  = (amhw_zsl42x_i2c_t *) (p_dev->p_devinfo->i2c_regbase);
    ...
    amhw_zsl42x_i2c_slave_addr_set(p_hw_i2c, p_dev->p_i2c_slv_dev[0]->dev_addr);
...
static void __i2c_slv_irq_handler (void *p_arg)
{
    ...
    uint8_t                  rx_data;
    uint8_t                  tx_data;
    amhw_zsl42x_i2c_t       *p_hw_i2c_slv;
    am_zsl42x_i2c_slv_dev_t    *p_dev          = (am_zsl42x_i2c_slv_dev_t *)p_arg;
 ...
 */
am_i2c_slv_handle_t am_zsl42x_i2c_slv_init (
        am_zsl42x_i2c_slv_dev_t           *p_dev,
        const am_zsl42x_i2c_slv_devinfo_t *p_devinfo)
{
 ...
 * \brief I2C解初始化
 */
void am_zsl42x_i2c_slv_deinit (am_i2c_slv_handle_t handle)
{
    amhw_zsl42x_i2c_t    *p_hw_i2c_slv = NULL;
    am_zsl42x_i2c_slv_dev_t *p_dev        = NULL;
    ...
    p_dev        = (am_zsl42x_i2c_slv_dev_t *)handle;
    p_hw_i2c_slv = (amhw_zsl42x_i2c_t *)p_dev->p_devinfo->i2c_regbase;
