...
#ifndef __ZSN700_INUM_H
#define __ZSN700_INUM_H
...
/**
 * \addtogroup zsn700_if_inum
 * \copydoc zsn700_inum.h
 * @{
 */
 ...
 *  这一现象，可以参考am_zsn700_lptim_timing.c该解决方法，以解决其他中断号使用时的上述现象。
 *
 */
