...
#define CLK_HDIV      ((0x1ul << CLK_PCLK) | 30ul)
...
#define CLK_UART3     ((0x1ul << CLK_PCLK) | 41ul)
#define CLK_UART2     ((0x1ul << CLK_PCLK) | 40ul)
#define CLK_I2S1      ((0x1ul << CLK_PCLK) | 38ul)
#define CLK_I2S0      ((0x1ul << CLK_PCLK) | 37ul)
#define CLK_LPTIM1    ((0x1ul << CLK_PCLK) | 36ul)
#define CLK_DAC       ((0x1ul << CLK_PCLK) | 35ul)
#define CLK_CTS       ((0x1ul << CLK_PCLK) | 34ul)
#define CLK_CAN       ((0x1ul << CLK_PCLK) | 33ul)
#define CLK_USB       ((0x1ul << CLK_PCLK) | 32ul)
