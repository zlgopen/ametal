...
static int __wdt_feed (void *p_drv)
{
    am_hc32_wdt_dev_t *p_dev     = (am_hc32_wdt_dev_t *)p_drv;
    amhw_hc32_wdt_t   *p_hw_wdt =
                           (amhw_hc32_wdt_t *)p_dev->p_devinfo->wdt_regbase;
...
am_wdt_handle_t
am_hc32_wdt_init (am_hc32_wdt_dev_t           *p_dev,
...
{
    am_hc32_wdt_dev_t *p_dev = (am_hc32_wdt_dev_t *)handle;
