...
#define AM_HC32_FLASH_END_ADDR        (0x0003FFFFu)
...
const uint32_t am_hc32_flash_pcgtimer_4mhz[] = {0x20u, 0x17u, 0x1Bu, 0x4650u, 0x222E0u, 0x18u, 0xF0u, 0x3E8u };
 ...
 void am_hc32_flash_lockall(void)
{
    ...
    AM_HC32_FLASH_BYPASS();
    AM_HC32_FLASH->slock2 = AM_HC32_FLASH_LOCK_ALL;
    AM_HC32_FLASH_BYPASS();
    AM_HC32_FLASH->slock3 = AM_HC32_FLASH_LOCK_ALL;
}
 ...
 void am_hc32_flash_unlockall(void)
{
    ...
    AM_HC32_FLASH_BYPASS();
    AM_HC32_FLASH->slock2 = AM_HC32_FLASH_UNLOCK_ALL;
    AM_HC32_FLASH_BYPASS();
    AM_HC32_FLASH->slock3 = AM_HC32_FLASH_UNLOCK_ALL;
}

int32_t am_hc32_flash_sector_erase (amhw_hc32_flash_t *p_hw_flash,
                                    uint32_t           addr)
{
    return am_hc32_flash_sectorerase(addr);
}
                                      ...
                                      uint32_t             size)
{
    ...
    for(i = 0; i < size; i++) {
        am_hc32_flash_writeword(dst_addr + i * 4, p_src[i]);
    }
...
int32_t am_hc32_flash_init(uint8_t freqcfg, am_bool_t able)
{
    ...
    {
        prgtimer[index] = freqcfg * am_hc32_flash_pcgtimer_4mhz[index];
    }
