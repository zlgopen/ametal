...
am_local void __spi_cs_on  (am_hc32f460_spi_poll_dev_t *p_this, am_spi_device_t *p_dev);
am_local void __spi_cs_off (am_hc32f460_spi_poll_dev_t *p_this, am_spi_device_t *p_dev);

am_local void __spi_write_data (am_hc32f460_spi_poll_dev_t *p_dev);
am_local void __spi_read_data (am_hc32f460_spi_poll_dev_t *p_dev);

am_local int  __spi_hard_init (am_hc32f460_spi_poll_dev_t *p_this);
am_local int  __spi_config (am_hc32f460_spi_poll_dev_t *p_this);

am_local uint32_t __spi_speed_cfg (am_hc32f460_spi_poll_dev_t *p_dev,
                                   uint32_t                  target_baud);

am_local int  __spi_mst_sm_event (am_hc32f460_spi_poll_dev_t *p_dev);
/*******************************************************************************
  SPI驱动函数声明
*******************************************************************************/
                   ...
                   am_spi_device_t      *p_dev)
{
    ...
    p_dev->pfunc_cs(p_dev, AM_FALSE);
}

/******************************************************************************/

am_local
void __spi_write_data (am_hc32f460_spi_poll_dev_t *p_dev)
{
    ...
    while (amhw_hc32f460_spi_flag_check (p_hw_spi,
              AMHW_HC32F460_SPI_STATUS_TXBUFFER_EMPTY) == AM_FALSE);
...
am_local
void __spi_read_data (am_hc32f460_spi_poll_dev_t *p_dev)
{
    amhw_hc32f460_spi_t  *p_hw_spi = (amhw_hc32f460_spi_t *)(p_dev->p_devinfo->spi_reg_base);
 ...
 */
am_local
int __spi_hard_init (am_hc32f460_spi_poll_dev_t *p_this)
{
...
am_local
int __spi_config (am_hc32f460_spi_poll_dev_t *p_this)
{
...
int __spi_msg_start (void              *p_drv,
                     ...
                     am_spi_message_t  *p_msg)
{
    am_hc32f460_spi_poll_dev_t *p_this = (am_hc32f460_spi_poll_dev_t *)p_drv;
 ...
 */
am_local
int __spi_mst_sm_event (am_hc32f460_spi_poll_dev_t *p_dev)
{
...
{
    am_hc32f460_spi_poll_dev_t *p_dev    = (am_hc32f460_spi_poll_dev_t *)handle;
    amhw_hc32f460_spi_t        *p_hw_spi = (amhw_hc32f460_spi_t *)(p_dev->p_devinfo->spi_reg_base);
 ...
 */
am_local
uint32_t __spi_speed_cfg (am_hc32f460_spi_poll_dev_t *p_dev,
