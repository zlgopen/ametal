...
am_local void __spi_cs_on  (am_hc32_spi_int_dev_t *p_this, am_spi_device_t *p_dev);
am_local void __spi_cs_off (am_hc32_spi_int_dev_t *p_this, am_spi_device_t *p_dev);

am_local void __spi_write_data (am_hc32_spi_int_dev_t *p_dev);
am_local void __spi_read_data (am_hc32_spi_int_dev_t *p_dev);

am_local void __spi_irq_handler (void *p_arg);
am_local int  __spi_hard_init (am_hc32_spi_int_dev_t *p_this);
am_local int  __spi_config (am_hc32_spi_int_dev_t *p_this);

am_local uint32_t __spi_speed_cfg (am_hc32_spi_int_dev_t *p_dev,
                                   uint32_t                 target_baud);

am_local int  __spi_mst_sm_event (am_hc32_spi_int_dev_t *p_dev, uint32_t event);
/*******************************************************************************
  SPI驱动函数声明
*******************************************************************************/
 ...
 */
am_local
void __spi_cs_on (am_hc32_spi_int_dev_t *p_this, am_spi_device_t *p_dev)
{
 ...
 */
am_local
void __spi_cs_off (am_hc32_spi_int_dev_t *p_this,
                   am_spi_device_t      *p_dev)
{
    amhw_hc32_spi_t     *p_hw_spi = (amhw_hc32_spi_t *)(p_this->p_devinfo->spi_reg_base);
...
am_local
void __spi_write_data (am_hc32_spi_int_dev_t *p_dev)
{
    ...
    while(amhw_hc32_spi_flag_check (
            p_hw_spi, AMHW_HC32_SPI_FLAG_TX_EMPTY) == AM_FALSE);
    /* tx_buf 有效 */
...
am_local
void __spi_read_data (am_hc32_spi_int_dev_t *p_dev)
{
    amhw_hc32_spi_t *p_hw_spi = (amhw_hc32_spi_t *)(p_dev->p_devinfo->spi_reg_base);
 ...
 */
am_static_inline
void __spi_msg_in (am_hc32_spi_int_dev_t *p_dev,
 ...
 */
am_static_inline
struct am_spi_message *__spi_msg_out (am_hc32_spi_int_dev_t *p_dev)
{
...
{
    am_hc32_spi_int_dev_t *p_this = (am_hc32_spi_int_dev_t *)p_arg;
 ...
 */
am_local
int __spi_hard_init (am_hc32_spi_int_dev_t *p_this)
{
    amhw_hc32_spi_t *p_hw_spi = (amhw_hc32_spi_t *)(p_this->p_devinfo->spi_reg_base);
...
{
    am_hc32_spi_int_dev_t  *p_dev    = (am_hc32_spi_int_dev_t *)p_arg;
    amhw_hc32_spi_t        *p_hw_spi = (amhw_hc32_spi_t *)(p_dev->p_devinfo->spi_reg_base);


    /* 发送数据 */
    if(amhw_hc32_spi_flag_check(
            p_hw_spi, AMHW_HC32_SPI_FLAG_TX_EMPTY) == AM_TRUE) {

        amhw_hc32_spi_flag_clr(p_hw_spi);
...
am_local
int __spi_config (am_hc32_spi_int_dev_t *p_this)
{
    const am_hc32_spi_int_devinfo_t *p_devinfo = p_this->p_devinfo;
...
int __spi_msg_start (void              *p_drv,
                     ...
                     am_spi_message_t  *p_msg)
{
    am_hc32_spi_int_dev_t *p_this = (am_hc32_spi_int_dev_t *)p_drv;
 ...
 */
am_local
int __spi_mst_sm_event (am_hc32_spi_int_dev_t *p_dev, uint32_t event)
{
    amhw_hc32_spi_t *p_hw_spi = (amhw_hc32_spi_t *)(p_dev->p_devinfo->spi_reg_base);
    ...
    while (1) {
        ...
        case __SPI_ST_MSG_START:    /* 消息开始 */
        {
            ...
            if (p_cur_msg) {
                ...
                /* 禁能中断 */
                amhw_hc32_spi_int_disable(p_hw_spi);
                p_dev->busy = AM_FALSE;
            }
            am_int_cpu_unlock(key);
        ...
        case __SPI_ST_M_SEND_DATA:    /* 发送数据 */
        {
            ...
            if (p_dev->data_ptr >= p_cur_trans->nbytes) {
                ...
                if (amhw_hc32_spi_flag_check (
                    ...
                    /* 打开接收中断 */
                    amhw_hc32_spi_int_enable(p_hw_spi);
                    amhw_hc32_spi_int_rx_not_empty_enable(p_hw_spi);
                } else {

                    /* 打开中断等待发送就绪 */
                    amhw_hc32_spi_int_enable(p_hw_spi);
                    amhw_hc32_spi_tx_empty_enable(p_hw_spi);
                }
            }
            break;
        }
        ...
        case __SPI_ST_M_RECV_DATA:   /* 接收数据 */
        {
            ...
            if (p_dev->nbytes_to_recv == 0) {
                ...
                /* 禁能发送及接收中断 */
                amhw_hc32_spi_int_disable(p_hw_spi);
                amhw_hc32_spi_tx_empty_disable(p_hw_spi);
                amhw_hc32_spi_int_rx_not_empty_disable(p_hw_spi);
...
{
    am_hc32_spi_int_dev_t *p_dev    = (am_hc32_spi_int_dev_t *)handle;
    amhw_hc32_spi_t       *p_hw_spi = (amhw_hc32_spi_t *)(p_dev->p_devinfo->spi_reg_base);
 ...
 */
am_local
uint32_t __spi_speed_cfg (am_hc32_spi_int_dev_t *p_dev,
