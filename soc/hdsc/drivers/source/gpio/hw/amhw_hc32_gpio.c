                                    ...
                                    int                     pin)
{
    ...
    /* 上拉输入 */
    case AMHW_HC32_GPIO_MODE_IPU:

        /* 数字端口/模拟端口设置*/
        amhw_hc32_gpio_pin_digital_set(p_hw_gpio, pin);
    ...
    /* 模拟输入 */
    case AMHW_HC32_GPIO_MODE_AIN:

        /* 数字端口/模拟端口设置*/
        amhw_hc32_gpio_pin_analog_set(p_hw_gpio, pin);
    ...
    /* 浮空输入 */
    case AMHW_HC32_GPIO_MODE_IN_FLOATING:
    ...
    /* 推挽输出 */
    case AMHW_HC32_GPIO_MODE_OUT_PP:

        /* 数字端口/模拟端口设置*/
        amhw_hc32_gpio_pin_digital_set(p_hw_gpio, pin);

        /* 输入输出方向设置 */
        amhw_hc32_gpio_pin_dir_output(p_hw_gpio, pin);
    ...
    /* 开漏输出 */
    case AMHW_HC32_GPIO_MODE_OUT_OD:
        ...
        /* 开漏输出设置*/
        amhw_hc32_gpio_pin_od_enable(p_hw_gpio, pin);
        break;

    /* 模拟输出 */
    case AMHW_HC32_GPIO_MODE_AOUT:
