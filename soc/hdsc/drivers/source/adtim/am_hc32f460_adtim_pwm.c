                               ...
                               unsigned long  period_ns)
{
    ...
    clkfreq  = am_clk_rate_get(CLK_TIMER6_1);
    ...
    /* 设置计数周期 */
    amhw_hc32f460_adtim_setperiod(p_hw_adtim, ADTIM_PERIODA, period_c);
    ...
    portcfg.portmode  = AMHW_HC32F460_ADTIM_PORT_MODE_CMP_OUTPUT;
    portcfg.outenable = AM_TRUE;
    portcfg.perc      = AMHW_HC32F460_ADTIM_PERIOD_INV;
    portcfg.cmpc      = AMHW_HC32F460_ADTIM_COMPARE_INV;
    ...
    if(p_dev->p_devinfo->comp == 1) {
        ...
        amhw_hc32f460_adtim_setcomparevalue(p_hw_adtim, 
                                          AMHW_HC32F460_ADTIM_COMPARE_A, 
                                          duty_c);
        amhw_hc32f460_adtim_setcomparevalue(p_hw_adtim, 
                                          AMHW_HC32F460_ADTIM_COMPARE_B, 
                                          duty_c);
...
static int __adtim_pwm_disable (void *p_drv, int chan)
{
    ...
    am_hc32f460_adtim_pwm_dev_t      *p_dev    = (am_hc32f460_adtim_pwm_dev_t *)p_drv;
    amhw_hc32f460_adtim_t            *p_hw_adtim = (amhw_hc32f460_adtim_t *)p_dev->p_devinfo->adtim_regbase;
    am_hc32f460_adtim_pwm_chaninfo_t *p_chaninfo = p_dev->p_devinfo->p_chaninfo;
...
void am_hc32f460_adtim_pwm_deinit (am_pwm_handle_t handle)
{
    ...
    am_hc32f460_adtim_pwm_dev_t *p_dev    = (am_hc32f460_adtim_pwm_dev_t *)handle;
    amhw_hc32f460_adtim_t       *p_hw_adtim = NULL;
