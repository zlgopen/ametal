...
typedef struct am_hc32_clk_devinfo {
     ...
     */
    amhw_hc32_pll_input_fre_src pllin_src;
     ...
     */
    amhw_hc32_sys_clk_src sysclk_src;
...
} am_hc32_clk_devinfo_t;

/**
 * \brief CLK 设备结构体
 */
typedef struct am_hc32_clk_dev {
    ...
    /** \brief sys类型 */
    amhw_hc32_sys_clk_src sys_type;
