 ...
 * \brief 随机数生成环境
 */
#define  AM_HC32F460_TRNG_LOAD_NEW_INIT_VALUE      1     /**< \brief 随机数生成前，数据寄存器从随机数发生器装载新的初始值 */
#define  AM_HC32F460_TRNG_NOT_LOAD_NEW_INIT_VALUE  0     /**< \brief 随机数生成前，数据寄存器不从随机数发生器装载新的初始值 */
