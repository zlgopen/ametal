...
#ifndef __AMHW_HC32_LPMODE_H
#define __AMHW_HC32_LPMODE_H
...
/**
 * \addtogroup amhw_hc32_if_lpmode
 * \copydoc amhw_hc32_lpmode.h
 * @{
 */
 ...
 */
typedef struct amhw_hc32_lpmode {
    __IO  uint32_t cr;       /**< \brief 系统控制寄存器  */
} amhw_hc32_lpmode_t;

#define LPMODECTRL ((amhw_hc32_lpmode_t *)0xE000ED10)
 ...
 */
am_static_inline
void amhw_hc32_lpmode_sevonpend (am_bool_t stata)
{
 ...
 */
am_static_inline
void amhw_hc32_lpmode_sleepdeep (am_bool_t stata)
{
 ...
 */
am_static_inline
void amhw_hc32_lpmode_sleeponexit (am_bool_t stata)
{
 ...
 */
am_static_inline
void amhw_hc32_lpmode_wfi (void)
{
#ifdef __CC_ARM
    __ASM("WFI");
#endif
 ...
 */
am_static_inline
void amhw_hc32_lpmode_wfe (void)
{
#ifdef __CC_ARM
    __ASM("WFE");
#endif
