...
typedef enum am_hc32_lpmode_mode {
    AM_HC32_LPMODE_MODE_RUN = 0,      /**< \brief 运行模式 */
    AM_HC32_LPMODE_MODE_SLEEP,        /**< \brief 睡眠模式 */
    AM_HC32_LPMODE_MODE_DEEPSLEEP,    /**< \brief 深度睡眠模式 */
 ...
 * \brief LPMODE 初始化
 *
 * \return 返回 am_hc32_lpmode_handle_t 类型的句柄
 */
