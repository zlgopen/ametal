...
#ifndef __AM_HC32F460_SPI_INT_H
#define __AM_HC32F460_SPI_INT_H
...
/**
 * \addtogroup am_hc32f460_if_spi_int
 * \copydoc am_hc32f460_spi_int.h
 * @{
 */
...
} am_hc32f460_spi_int_devinfo_t;

/**
 * \brief SPI设备
 */
typedef struct am_hc32f460_spi_int_dev {

    am_spi_serv_t                       spi_serve;         /**< \brief SPI标准服务句柄 */
    const am_hc32f460_spi_int_devinfo_t *p_devinfo;        /**< \brief SPI设备信息的指针 */
