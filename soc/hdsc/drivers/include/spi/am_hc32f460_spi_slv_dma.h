...
/**
 * \addtogroup am_hc32f460_if_spi_slv_dma
 * \copydoc am_hc32f460_spi_slv_dma.h
 * @{
 */
...
} am_hc32f460_spi_slv_dma_devinfo_t;

/**
 * \brief SPI 设备结构体
 */
typedef struct am_hc32f460_spi_slv_dma_dev {
    ...
    /** \brief DMA 通道描述符 */
    amhw_hc32f460_dma_xfer_desc_t            g_desc[2];
