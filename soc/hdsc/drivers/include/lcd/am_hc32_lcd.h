 ...
 * \endinternal
 */
#ifndef __AM_HC32_LCD_H
#define __AM_HC32_LCD_H
...
#define AM_HC32_LCD_MODE_0    0  /**< \brief LCD 模式0 */
#define AM_HC32_LCD_MODE_1    1  /**< \brief LCD 模式1 */

/**
 * \addtogroup am_hc32_if_lcd
 * \copydoc am_hc32_lcd.h
 * @{
 */
 ...
 *         （用户在控制端口时1表示打开0表示关闭）
 */
typedef struct am_hc32_lcd_com_seg {
...
}am_hc32_lcd_com_seg_t;

/**
 * \brief LCD设备信息结构体
 */
typedef struct am_hc32_lcd_info {
...
}am_hc32_lcd_devinfo_t;

/**
 * \brief LCD设备实例
 */
typedef struct am_hc32_lcd_dev {
...
typedef am_hc32_lcd_dev_t *am_lcd_handle_t;
