...
typedef struct am_hc32f460_uart_devinfo {
     ...
     *        或AMHW_HC32F460_UART_STOP_*的或值
     *        (如：AMHW_HC32F460_UART_DATA_8BIT|AMHW_HC32F460_UART_PARITY_NO
    ...
    /**
     * \brief 指定使能的其它中断,AMHW_HC32F460_UART_INT_*宏值或多个AMHW_HC32F460_UART_INT_*宏的
     *        或值，除了(# AMHW_HC32F460_UART_INT_TX_EMPTY_ENABLE),
     *               (# AMHW_HC32F460_UART_INT_RX_VAL_ENABLE)，
     *               (# AMHW_HC32F460_UART_INT_TX_COMPLETE_ENABLE)这三个中断（接收错误中断在接收终端你打开后默认开启）。
     */
