...
#define AMHW_HC32F460_UART_STOP_1BIT   (0u << 2)  /** <brief One stop bit */
#define AMHW_HC32F460_UART_STOP_2BIT   (1U << 2)  /** <brief two stop bit */
/** @} */
...
//#define AMHW_HC32F460_UART_TX_EMPTY_FLAG      AM_BIT(3)
#define AMHW_HC32F460_UART_TX_EMPTY_FLAG      AM_BIT(7)

/** \brief Transmit buffer full flag */
//#define AMHW_HC32F460_UART_TX_FULL_FLAG       AM_BIT(2)

/** \brief Receive valid data flag */
//#define AMHW_HC32F460_UART_RX_VAL_FLAG        AM_BIT(1)
#define AMHW_HC32F460_UART_RX_VAL_FLAG        AM_BIT(5)

/** \brief Transmit complete flag */
//#define AMHW_HC32F460_UART_TX_COMPLETE_FALG   AM_BIT(0)
 ...
 */
//am_static_inline
//am_bool_t amhw_hc32f460_uart_int_flag_check (amhw_hc32f460_uart_t    *p_hw_uart,
//                                        uint32_t            flag)
//{
 ...
 */
am_static_inline
void amhw_hc32f460_uart_int_flag_clr (amhw_hc32f460_uart_t    *p_hw_uart,
                                 uint32_t            flag)
{
...
#define AMHW_HC32F460_UART_INT_ALL_ENABLE_MASK    0x7F
/** @} */
 ...
 */
am_static_inline
am_bool_t amhw_hc32f460_uart_uarten_get (amhw_hc32f460_uart_t *p_hw_uart)
{
 ...
 */
am_static_inline
void amhw_hc32f460_uart_send_break (amhw_hc32f460_uart_t *p_hw_uart, am_bool_t flag)
{
