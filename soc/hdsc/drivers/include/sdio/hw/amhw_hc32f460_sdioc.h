...
typedef struct amhw_hc32f460_sdioc_cmd_cfg {
    ...
    amhw_hc32f460_sdioc_cmd_type_t      cmd_type;   /* 命令类型 */

    amhw_hc32f460_sdioc_cmd_res_type_t  rsp_type;   /* 响应类型 */

    am_bool_t                           use_data;   /* 是否使用数据线 */
...
/* 主机状态标志 */
#define  AMHW_HC32F460_SDIOC_PSTAT_CMDL (1 << 24)   /* 命令线状态 */
#define  AMHW_HC32F460_SDIOC_PSTAT_DATL (0xF << 20) /* 数据线状态（D0-D3） */
#define  AMHW_HC32F460_SDIOC_PSTAT_WPL  (1 << 19)   /* 写保护线状态 */
#define  AMHW_HC32F460_SDIOC_PSTAT_CDL  (1 << 18)   /* 卡识别线状态 */
#define  AMHW_HC32F460_SDIOC_PSTAT_CSS  (1 << 17)   /* 设备稳定状态 */
#define  AMHW_HC32F460_SDIOC_PSTAT_CIN  (1 << 16)   /* 设备插入状态 */
#define  AMHW_HC32F460_SDIOC_PSTAT_BRE  (1 << 11)   /* 数据缓冲满 */
#define  AMHW_HC32F460_SDIOC_PSTAT_BWE  (1 << 10)   /* 数据缓冲空 */
#define  AMHW_HC32F460_SDIOC_PSTAT_RTA  (1 << 9)    /* 读操作状态 */
#define  AMHW_HC32F460_SDIOC_PSTAT_WTA  (1 << 8)    /* 写操作状态 */
#define  AMHW_HC32F460_SDIOC_PSTAT_DA   (1 << 2)    /* 数据线传输状态 */
#define  AMHW_HC32F460_SDIOC_PSTAT_CID  (1 << 1)    /* 带数据命令抑制 */
#define  AMHW_HC32F460_SDIOC_PSTAT_CIC  (1 << 0)    /* 命令抑制 */
...
typedef enum{
    AMHW_HC32F460_SDIOC_HOSTCON_CDSS_TRUE = 0, /* 采用真实SDIOx_CD线反映卡识别状态 */
    AMHW_HC32F460_SDIOC_HOSTCON_CDSS_TEST = 1, /* 采用卡识别测试信号反映卡识别状态 */
...
typedef enum {
    AMHW_HC32F460_SDIOC_CK_DIV_1   = 0x00, /* EXCLK的1分频 */
    AMHW_HC32F460_SDIOC_CK_DIV_2   = 0x01, /* EXCLK的2分频 */
    AMHW_HC32F460_SDIOC_CK_DIV_4   = 0x02, /* EXCLK的4分频 */
    AMHW_HC32F460_SDIOC_CK_DIV_8   = 0x04, /* EXCLK的8分频 */
    AMHW_HC32F460_SDIOC_CK_DIV_16  = 0x08, /* EXCLK的16分频 */
    AMHW_HC32F460_SDIOC_CK_DIV_32  = 0x10, /* EXCLK的32分频 */
    AMHW_HC32F460_SDIOC_CK_DIV_64  = 0x20, /* EXCLK的64分频 */
    AMHW_HC32F460_SDIOC_CK_DIV_128 = 0x40, /* EXCLK的128分频 */
    AMHW_HC32F460_SDIOC_CK_DIV_256 = 0x80, /* EXCLK的256分频 */
...
typedef enum {
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_13 = 0,  /* 超时时间为EXCLK × 2^13 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_14 = 1,  /* 超时时间为EXCLK × 2^14 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_15 = 2,  /* 超时时间为EXCLK × 2^15 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_16 = 3,  /* 超时时间为EXCLK × 2^16 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_17 = 4,  /* 超时时间为EXCLK × 2^17 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_18 = 5,  /* 超时时间为EXCLK × 2^18 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_19 = 6,  /* 超时时间为EXCLK × 2^19 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_20 = 7,  /* 超时时间为EXCLK × 2^20 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_21 = 8,  /* 超时时间为EXCLK × 2^21 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_22 = 9,  /* 超时时间为EXCLK × 2^22 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_23 = 10, /* 超时时间为EXCLK × 2^23 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_24 = 11, /* 超时时间为EXCLK × 2^24 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_25 = 12, /* 超时时间为EXCLK × 2^25 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_26 = 13, /* 超时时间为EXCLK × 2^26 */
    AMHW_HC32F460_SDIOC_TIMEOUT_EXCLK_2_27 = 14, /* 超时时间为EXCLK × 2^27 */
...
#define AMHW_HC32F460_SDIOC_NORMAL_INT_EI   (1 << 15) /* 错误中断 */
#define AMHW_HC32F460_SDIOC_NORMAL_INT_CINT (1 << 8)  /* 卡中断 */
#define AMHW_HC32F460_SDIOC_NORMAL_INT_CRM  (1 << 7)  /* 卡移除 */
#define AMHW_HC32F460_SDIOC_NORMAL_INT_CIST (1 << 6)  /* 卡插入 */
#define AMHW_HC32F460_SDIOC_NORMAL_INT_BRR  (1 << 5)  /* 缓冲器可读 */
#define AMHW_HC32F460_SDIOC_NORMAL_INT_BWR  (1 << 4)  /* 缓冲器可写 */
#define AMHW_HC32F460_SDIOC_NORMAL_INT_BGE  (1 << 2)  /* 数据块间隙停止传输 */
#define AMHW_HC32F460_SDIOC_NORMAL_INT_TC   (1 << 1)  /* 传输完成 */
#define AMHW_HC32F460_SDIOC_NORMAL_INT_CC   (1 << 0)  /* 命令完成 */
#define AMHW_HC32F460_SDIOC_NORMAL_INT_ALL  (AMHW_HC32F460_SDIOC_NORMAL_INT_CRM  | \
                                             ...
                                             AMHW_HC32F460_SDIOC_NORMAL_INT_CC)/* 所有普通中断，错误中断和卡中断除外 */
...
#define AMHW_HC32F460_SDIOC_ERR_INT_ACE  (1 << 8) /* 自动发送命令错误 */
#define AMHW_HC32F460_SDIOC_ERR_INT_DEBE (1 << 6) /* 数据停止位错误 */
#define AMHW_HC32F460_SDIOC_ERR_INT_DCE  (1 << 5) /* 数据CRC校验错误 */
#define AMHW_HC32F460_SDIOC_ERR_INT_DTOE (1 << 4) /* 数据超时错误 */
#define AMHW_HC32F460_SDIOC_ERR_INT_CIE  (1 << 3) /* 命令编号错误 */
#define AMHW_HC32F460_SDIOC_ERR_INT_CEBE (1 << 2) /* 命令停止位错误 */
#define AMHW_HC32F460_SDIOC_ERR_INT_CCE  (1 << 1) /* 命令CRC校验错误 */
#define AMHW_HC32F460_SDIOC_ERR_INT_CTOE (1 << 0) /* 命令超时错误 */
...
#define AMHW_HC32F460_SDIOC_AUTOCMD_ERRSTAT_CMDE (1 << 7) /* 未发送错误 */
#define AMHW_HC32F460_SDIOC_AUTOCMD_ERRSTAT_IE   (1 << 4) /* 命令编号错误 */
#define AMHW_HC32F460_SDIOC_AUTOCMD_ERRSTAT_EBE  (1 << 3) /* 停止位错误 */
#define AMHW_HC32F460_SDIOC_AUTOCMD_ERRSTAT_CE   (1 << 2) /* 数据超时错误 */
#define AMHW_HC32F460_SDIOC_AUTOCMD_ERRSTAT_TOE  (1 << 1) /* 命令超时错误 */
#define AMHW_HC32F460_SDIOC_AUTOCMD_ERRSTAT_NE   (1 << 0) /* 未执行错误 */
