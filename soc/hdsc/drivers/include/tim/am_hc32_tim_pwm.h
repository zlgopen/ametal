...
#ifndef __AM_HC32_TIM_PWM_H
#define __AM_HC32_TIM_PWM_H
 ...
 *                            CH2A、CH2B，（互补3）
 */
#define  AM_HC32_TIM_PWM_CH0A        0x00   /**< \brief PWM通道0标识符*/
#define  AM_HC32_TIM_PWM_CH0B        0x01   /**< \brief PWM通道1标识符*/
#define  AM_HC32_TIM_PWM_CH1A        0x02   /**< \brief PWM通道2标识符*/
#define  AM_HC32_TIM_PWM_CH1B        0x03   /**< \brief PWM通道3标识符*/
#define  AM_HC32_TIM_PWM_CH2A        0x04   /**< \brief PWM通道4标识符*/
#define  AM_HC32_TIM_PWM_CH2B        0x05   /**< \brief PWM通道5标识符*/

/* PWM输出极性 */
#define  AM_HC32_TIM_PWM_OCPOLARITY_HIGH 6  /**< \brief 高电平有效 */
#define  AM_HC32_TIM_PWM_OCPOLARITY_LOW  7  /**< \brief 低电平有效 */

/**
 * \brief TIMPWM输出功能相关的GPIO信息
 */
typedef struct am_hc32_tim_pwm_chaninfo {
...
} am_hc32_tim_pwm_chaninfo_t;

/**
 * \brief TIMPWM输出功能相关的设备信息
 */
typedef struct am_hc32_tim_pwm_devinfo {
    ...
    /** \brief PWM输出极性,AM_HC32_TIM_PWM_OCPOLARITY_HIGH或AM_HC32_TIM_PWM_OCPOLARITY_LOW */
    uint8_t                     ocpolarity;

    am_hc32_tim_pwm_chaninfo_t  *p_chaninfo;     /**< \brief 指向PWM输出通道信息结构体 */

    amhw_hc32_tim_type_t         tim_type;       /**< \brief 定时器类型 */
...
} am_hc32_tim_pwm_devinfo_t;

/**
 * \brief TIMPWM输出功能设备结构体
 */
typedef struct am_hc32_tim_pwm_dev {
 ...
 *
 * \param[in] handle : am_hc32_tim_pwm_init() 初始化函数获得的PWM服务句柄
 *
 * \return 无
 */
