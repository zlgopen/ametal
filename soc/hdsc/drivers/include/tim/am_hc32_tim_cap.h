...
#ifndef __AM_HC32_TIM_CAP_H
#define __AM_HC32_TIM_CAP_H
...
/**
 * \addtogroup am_hc32_if_tim_cap
 * \copydoc am_hc32_tim_cap.h
 * @{
 */
 ...
 *                              CH2A、CH2B
 */
#define  AM_HC32_TIM_CAP_CH0A        0x00   /**< \brief CAP通道0标识符*/
#define  AM_HC32_TIM_CAP_CH0B        0x01   /**< \brief CAP通道1标识符*/
#define  AM_HC32_TIM_CAP_CH1A        0x02   /**< \brief CAP通道2标识符*/
#define  AM_HC32_TIM_CAP_CH1B        0x03   /**< \brief CAP通道3标识符*/
#define  AM_HC32_TIM_CAP_CH2A        0x04   /**< \brief CAP通道4标识符*/
#define  AM_HC32_TIM_CAP_CH2B        0x05   /**< \brief CAP通道5标识符*/

/**
 * \brief TIM捕获功能相关的GPIO信息
 */
typedef struct am_hc32_tim_cap_ioinfo {
...
} am_hc32_tim_cap_devinfo_t;

/**
 * \brief TIM捕获功能设备
 */
typedef struct am_hc32_tim_cap_dev {
 ...
 *
 * \param[in] handle : am_hc32_tim_cap_init() 初始化函数获得的cap服务句柄
 *
 * \return 无
 */
