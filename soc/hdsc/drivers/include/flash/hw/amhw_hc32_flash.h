...
/**
 * \addtogroup amhw_hc32_if_flash
 * \copydoc amhw_hc32_flash.h
 * @{
 */
 ...
 */
am_static_inline
void amhw_hc32_flash_deepsleep_lp_disable(amhw_hc32_flash_t *p_hw_flash)
{
 ...
 */
am_static_inline
void amhw_hc32_flash_deepsleep_lp_enable(amhw_hc32_flash_t *p_hw_flash)
{
    p_hw_flash->cr |= (0x1ul << 9) ;
}
 ...
 */
am_static_inline
am_bool_t amhw_hc32_flash_busy_check(amhw_hc32_flash_t *p_hw_flash)
{
 ...
 */
typedef enum {
    AMHW_HC32_FLASH_OPT_READ = 0,       /**< \brief 读 */
    AMHW_HC32_FLASH_OPT_WRITE,          /**< \brief 写 */
    AMHW_HC32_FLASH_OPT_SECTOR_ERASE,   /**< \brief 页擦除  */
    AMHW_HC32_FLASH_OPT_CHIP_ERASE,     /**< \brief 全片擦除  */
}amhw_hc32_flash_opt;
 ...
 */
am_static_inline
void amhw_hc32_flash_opt_set(amhw_hc32_flash_t   *p_hw_flash,
                               amhw_hc32_flash_opt  opt)
{
...
/* 擦写PC值中断 */
#define AMHW_HC32_FLASH_INT_ERASE_PC    (0x1ul << 5)

/* 擦写所有中断 */
#define AMHW_HC32_FLASH_INT_ALL         (0x3ul << 5)
...
/* 擦写保护报警中断标志位 */
#define AMHW_HC32_FLASH_INT_ERASE_P_FLAG     (0x1ul << 1)
