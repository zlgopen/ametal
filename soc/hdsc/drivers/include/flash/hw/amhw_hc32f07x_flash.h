...
#ifndef __AMHW_HC32F07X_FLASH_H
#define __AMHW_HC32F07X_FLASH_H
...
/**
 * \addtogroup amhw_hc32f07x_if_flash
 * \copydoc amhw_hc32f07x_flash.h
 * @{
 */
 ...
 */
typedef struct amhw_hc32f07x_flash {
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_tnvs_set(amhw_hc32f07x_flash_t *p_hw_flash, uint8_t data) {
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_tpgs_set(amhw_hc32f07x_flash_t *p_hw_flash, uint8_t data) {
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_tprog_set(amhw_hc32f07x_flash_t *p_hw_flash, uint8_t data) {
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_tserase_set(amhw_hc32f07x_flash_t *p_hw_flash, uint8_t data) {
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_tmerase_set(amhw_hc32f07x_flash_t *p_hw_flash, uint8_t data) {
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_tprcv_set(amhw_hc32f07x_flash_t *p_hw_flash, uint8_t data) {
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_tsrcv_set(amhw_hc32f07x_flash_t *p_hw_flash, uint8_t data) {
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_tmrcv_set(amhw_hc32f07x_flash_t *p_hw_flash, uint8_t data) {
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_deepsleep_lp_disable(amhw_hc32f07x_flash_t *p_hw_flash) {
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_deepsleep_lp_enable(amhw_hc32f07x_flash_t *p_hw_flash) {
    p_hw_flash->cr |= (0x1ul << 9);
}
 ...
 */
am_static_inline
am_bool_t amhw_hc32f07x_flash_busy_check(amhw_hc32f07x_flash_t *p_hw_flash) {
 ...
 */
typedef enum {
    AMHW_HC32F07X_FLASH_READ_WAITTIME_1 = 0, /**< \brief  0~24MHz: 00/11: 1个周期 */
    AMHW_HC32F07X_FLASH_READ_WAITTIME_2 = 1, /**< \brief 24~48MHz：           01： 2个周期  */
    AMHW_HC32F07X_FLASH_READ_WAITTIME_3 = 2, /**< \brief 48~72MHz：          10: 3个周期  */
} amhw_hc32f07x_flash_read_waittime;
 ...
 * \param[in] p_hw_flash  : 指向FLASH结构体的指针
 * \param[in] data        : 待写入参数
 *                          amhw_hc32_flash_read_waittime枚举类型中的一个
 *
 * return none
 */
am_static_inline
void amhw_hc32f07x_flash_read_waittime_set(amhw_hc32f07x_flash_t *p_hw_flash,
        amhw_hc32f07x_flash_read_waittime waittime) {
 ...
 */
typedef enum {
    AMHW_HC32F07X_FLASH_OPT_READ = 0u, /**< \brief 读 */
    AMHW_HC32F07X_FLASH_OPT_WRITE = 1u, /**< \brief 写 */
    AMHW_HC32F07X_FLASH_OPT_SECTOR_ERASE = 2u, /**< \brief 页擦除  */
    AMHW_HC32F07X_FLASH_OPT_CHIP_ERASE = 3u, /**< \brief 全片擦除  */
} amhw_hc32f07x_flash_opt;
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_opt_set(amhw_hc32f07x_flash_t *p_hw_flash,
                                 amhw_hc32f07x_flash_opt opt)
{
...
/* 擦写被保护地址中断 */
#define AMHW_HC32F07X_FLASH_INT_ERASE_P     (0x1ul << 6)

/* 擦写PC值中断 */
#define AMHW_HC32F07X_FLASH_INT_ERASE_PC    (0x1ul << 5)

/* 擦写所有中断 */
#define AMHW_HC32F07X_FLASH_INT_ALL         (0x3ul << 5)
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_int_disable(amhw_hc32f07x_flash_t *p_hw_flash, uint32_t type) {
    p_hw_flash->cr &= ~type;
}
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_int_enable(amhw_hc32f07x_flash_t *p_hw_flash, uint32_t type) {
    p_hw_flash->cr |= type;
}

/* 擦写保护报警中断标志位 */
#define AMHW_HC32F07X_FLASH_INT_ERASE_P_FLAG     (0x1ul << 1)

/* 擦写PC地址报警中断标志位 */
#define AMHW_HC32F07X_FLASH_INT_ERASE_PC_FLAG    (0x1ul << 0)

/* 所有中断标志位 */
#define AMHW_HC32F07X_FLASH_INT_ALL_FLAG    (0x3ul << 0)
 ...
 */
am_static_inline
am_bool_t amhw_hc32f07x_flash_int_flag_check(amhw_hc32f07x_flash_t *p_hw_flash,
                                             uint32_t               flag)
{
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_int_flag_clr(amhw_hc32f07x_flash_t *p_hw_flash,
                                      uint32_t               flag) {
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_key_set(amhw_hc32f07x_flash_t *p_hw_flash, uint16_t value) {
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_erase_enable(amhw_hc32f07x_flash_t *p_hw_flash,
                                      uint16_t               data)
{
    if (data < 32) {
 ...
 */
am_static_inline
void amhw_hc32f07x_flash_erase_disable(amhw_hc32f07x_flash_t *p_hw_flash,
                                       uint16_t               data)
{
    if (data < 32) {
        p_hw_flash->slock0 &= ~(0x1ul << data);
