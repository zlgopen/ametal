...
#ifndef __AM_HC32_RAM_H
#define __AM_HC32_RAM_H
...
/**
 * \addtogroup am_hc32_if_ram
 * \copydoc am_hc32_ram.h
 * @{
 */
 ...
 * \return 无
 */
void am_hc32_ram_init (amhw_hc32_ram_t *p_hw_ram);
 ...
 */
int32_t am_hc32_ram_erase (amhw_hc32_ram_t *p_hw_ram,
                             uint32_t           start_addr,
                             uint16_t           size);
 ...
 * \retval i 实际成功写入的字数
 */
int32_t am_hc32_ram_write (amhw_hc32_ram_t *p_hw_ram,
                             uint32_t           dst_addr,
                             uint8_t           *p_src,
                             uint16_t           size);
 ...
 * \retval i 实际成功读取的字数
 */
int32_t am_hc32_ram_read (amhw_hc32_ram_t *p_hw_ram,
                            uint32_t           dst_addr,
                            uint8_t           *p_src,
                            uint16_t           size);
