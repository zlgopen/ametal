...
#ifndef __AM_HC32_ADTIM_PWM_H
#define __AM_HC32_ADTIM_PWM_H
...
/**
 * \addtogroup am_hc32_if_adtim_pwm
 * \copydoc am_hc32_adtim_pwm.h
 * @{
 */

/* PWM输出极性 */
#define  AM_HC32_ADTIM_PWM_OCPOLARITY_HIGH 0  /**< \brief 高电平有效 */
#define  AM_HC32_ADTIM_PWM_OCPOLARITY_LOW  1  /**< \brief 低电平有效 */
 ...
 */
#define  AM_HC32_ADTIM_PWM_CHA  0x00   /**< \brief PWM通道A标识符*/
#define  AM_HC32_ADTIM_PWM_CHB  0x01   /**< \brief PWM通道B标识符*/

/**
 * \brief ADTIMPWM输出功能相关的GPIO信息
 */
typedef struct am_hc32_adtim_pwm_chaninfo {
...
} am_hc32_adtim_pwm_chaninfo_t;

/**
 * \brief ADTIMPWM输出功能相关的设备信息
 */
typedef struct am_hc32_adtim_pwm_devinfo {
    ...
    /** \brief PWM输出极性,AM_HC32_LPTIM_PWM_OCPOLARITY_HIGH或AM_HC32_LPTIM_PWM_OCPOLARITY_LOW */
    uint8_t                     ocpolarity;

    am_hc32_adtim_pwm_chaninfo_t  *p_chaninfo;     /**< \brief 指向PWM输出通道信息结构体 */
...
} am_hc32_adtim_pwm_devinfo_t;

/**
 * \brief ADTIMPWM输出功能设备结构体
 */
typedef struct am_hc32_adtim_pwm_dev {
 ...
 */
am_pwm_handle_t am_hc32_adtim_pwm_init(
                    am_hc32_adtim_pwm_dev_t           *p_dev,
                    const am_hc32_adtim_pwm_devinfo_t *p_devinfo);

/**
 * \brief 不使用ADTIMPWM输出功能时，解初始化ADTIMPWM输出功能，释放相关资源
 *
 * \param[in] handle : am_hc32_adtim_pwm_init() 初始化函数获得的PWM服务句柄
 *
 * \return 无
 */
