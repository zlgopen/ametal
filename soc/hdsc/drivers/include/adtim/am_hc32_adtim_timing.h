...
#ifndef __AM_HC32_ADTIM_ADTIMING_H
#define __AM_HC32_ADTIM_ADTIMING_H
...
/**
 * \addtogroup am_hc32_if_adtim_timing
 * \copydoc am_hc32_adtim_timing.h
 * @{
 */
 ...
 */
typedef struct am_hc32_adtim_timing_devinfo {
...
} am_hc32_adtim_timing_devinfo_t;

/**
 * \brief ADTIM定时功能设备
 */
typedef struct am_hc32_adtim_timing_dev {
 ...
 */
am_timer_handle_t
am_hc32_adtim_timing_init (am_hc32_adtim_timing_dev_t           *p_dev,
                             const am_hc32_adtim_timing_devinfo_t *p_devinfo);

/**
 * \brief 不使用ADTIM定时功能时，解初始化ADTIM定时功能，释放相关资源
 *
 * \param[in] handle : am_hc32_adtim_timing_init() 初始化函数获得的Timer服务句柄
 *
 * \return 无
 */
...
#endif /* __AM_HC32_ADTIM_ADTIMING_H */
