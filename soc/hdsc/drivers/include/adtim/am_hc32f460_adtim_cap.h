...
#ifndef __AM_HC32F460_ADTIM_CAP_H
#define __AM_HC32F460_ADTIM_CAP_H
...
/**
 * \addtogroup am_hc32f460_if_adtim_cap
 * \copydoc am_hc32f460_adtim_cap.h
 * @{
 */

#define  AM_HC32F460_ADTIM_CAP_CHA  0x00   /**< \brief CAP通道A标识符*/
#define  AM_HC32F460_ADTIM_CAP_CHB  0x01   /**< \brief CAP通道B标识符*/

/**
 * \brief TIM捕获功能相关的GPIO信息
 */
typedef struct am_hc32f460_adtim_cap_ioinfo {
...
} am_hc32f460_adtim_cap_ioinfo_t;
...
} am_hc32f460_adtim_cap_devinfo_t;

/**
 * \brief TIM捕获功能设备
 */
typedef struct am_hc32f460_adtim_cap_dev {
 ...
 *
 * \param[in] handle : am_hc32f460_adtim_cap_init() 初始化函数获得的cap服务句柄
 *
 * \return 无
 */
...
#endif /* __AM_HC32F460_ADTIM_CAP_H */
