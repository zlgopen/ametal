...
/* 工作时钟 ID */
#define CLK_HCLK         ((1 << (30ul)) | 0ul)
#define CLK_PCLK0        ((1 << (30ul)) | 1ul)
#define CLK_PCLK1        ((1 << (30ul)) | 2ul)
#define CLK_PCLK2        ((1 << (30ul)) | 3ul)
#define CLK_PCLK3        ((1 << (30ul)) | 4ul)
#define CLK_PCLK4        ((1 << (30ul)) | 5ul)
#define CLK_EXCLK        ((1 << (30ul)) | 6ul)
#define CLK_UCLK         ((1 << (30ul)) | 7ul)
#define CLK_CANCLK       ((1 << (30ul)) | 8ul)
#define CLK_STICCLK      ((1 << (30ul)) | 9ul)
#define CLK_SWDTCLK      ((1 << (30ul)) | 10ul)
#define CLK_TCK          ((1 << (30ul)) | 11ul)
#define CLK_TPIUCLK      ((1 << (30ul)) | 12ul)
#define CLK_I2S1CLK      ((1 << (30ul)) | 13ul)
#define CLK_I2S2CLK      ((1 << (30ul)) | 14ul)
#define CLK_I2S3CLK      ((1 << (30ul)) | 15ul)
#define CLK_I2S4CLK      ((1 << (30ul)) | 16ul)

/* 外设时钟时钟源标志 */
#define WORK_CLK_FLAG (1 << 30)
