...
#ifndef __HK32F103RBT6_CLK_H
#define __HK32F103RBT6_CLK_H
...
/**
 * \addtogroup hk32f103rbt6_if_clockid
 * \copydoc hk32f103rbt6_clk.h
 * @{
 */
...
#define CLK_USART2  (0x01ul << 8 | 17ul)  /**< \brief UART2 时钟 */
#define CLK_USART3  (0x01ul << 8 | 18ul)  /**< \brief UART3 时钟 */
...
#define CLK_USART1  (0x02ul << 8 | 14ul) /**< \brief USART1 时钟 */
...
#define CLK_CRC    (0x03ul << 8 | 6ul)   /**< \brief CRC 时钟 */
