...
am_local void __spi_cs_on  (am_hk32f103rbt6_spi_poll_dev_t *p_this,
                            am_spi_device_t          *p_dev);
am_local void __spi_cs_off (am_hk32f103rbt6_spi_poll_dev_t *p_this,
                            am_spi_device_t          *p_dev);

am_local void __spi_write_data (am_hk32f103rbt6_spi_poll_dev_t *p_dev);
am_local void __spi_read_data (am_hk32f103rbt6_spi_poll_dev_t *p_dev);

am_local int  __spi_hard_init (am_hk32f103rbt6_spi_poll_dev_t *p_this);
am_local int  __spi_config (am_hk32f103rbt6_spi_poll_dev_t *p_this);

am_local int  __spi_mst_sm_event (am_hk32f103rbt6_spi_poll_dev_t *p_dev);
/*******************************************************************************
  SPI驱动函数声明
*******************************************************************************/
 ...
 */
am_local
void __spi_cs_on (am_hk32f103rbt6_spi_poll_dev_t *p_this, am_spi_device_t *p_dev)
{
 ...
 */
am_local
void __spi_cs_off (am_hk32f103rbt6_spi_poll_dev_t *p_this,
                   am_spi_device_t      *p_dev)
{
    if (p_this->p_tgl_dev == p_dev) {
        p_this->p_tgl_dev = NULL;
...
am_local
void __spi_write_data (am_hk32f103rbt6_spi_poll_dev_t *p_dev)
{
    ...
    while(amhw_hk32f103rbt6_spi_status_flag_check (
        p_hw_spi, AMHW_HK32F103RBT6_SPI_TX_EMPTY_FLAG) == AM_FALSE);
...
am_local
void __spi_read_data (am_hk32f103rbt6_spi_poll_dev_t *p_dev)
{
    amhw_hk32f103rbt6_spi_t     *p_hw_spi = (amhw_hk32f103rbt6_spi_t *)
                                      (p_dev->p_devinfo->spi_reg_base);
...
{
    am_hk32f103rbt6_spi_poll_dev_t *p_this = (am_hk32f103rbt6_spi_poll_dev_t *)p_arg;
 ...
 */
am_local
int __spi_hard_init (am_hk32f103rbt6_spi_poll_dev_t *p_this)
{
    amhw_hk32f103rbt6_spi_t *p_hw_spi = (amhw_hk32f103rbt6_spi_t *)
...
am_local
int __spi_config (am_hk32f103rbt6_spi_poll_dev_t *p_this)
{
    const am_hk32f103rbt6_spi_poll_devinfo_t *p_devinfo = p_this->p_devinfo;
    amhw_hk32f103rbt6_spi_t                  *p_hw_spi  = (amhw_hk32f103rbt6_spi_t *)
...
int __spi_msg_start (void              *p_drv,
                     ...
                     am_spi_message_t  *p_msg)
{
    am_hk32f103rbt6_spi_poll_dev_t *p_this = (am_hk32f103rbt6_spi_poll_dev_t *)p_drv;
 ...
 */
am_local
int __spi_mst_sm_event (am_hk32f103rbt6_spi_poll_dev_t *p_dev)
{
 ...
 * \brief SPI初始化
 */
am_spi_handle_t am_hk32f103rbt6_spi_poll_init (
    am_hk32f103rbt6_spi_poll_dev_t           *p_dev,
    const am_hk32f103rbt6_spi_poll_devinfo_t *p_devinfo)
{
 ...
 * \brief SPI 去除初始化
 */
void am_hk32f103rbt6_spi_poll_deinit (am_spi_handle_t handle)
{
    am_hk32f103rbt6_spi_poll_dev_t *p_dev    = (am_hk32f103rbt6_spi_poll_dev_t *)handle;
    amhw_hk32f103rbt6_spi_t        *p_hw_spi = (amhw_hk32f103rbt6_spi_t *)
                                         (p_dev->p_devinfo->spi_reg_base);
