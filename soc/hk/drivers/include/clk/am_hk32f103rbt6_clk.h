...
#ifndef __AM_HK32F103RBT6_CLK_H
#define __AM_HK32F103RBT6_CLK_H
...
/**
 * \addtogroup am_hk32f103rbt6_if_clk
 * \copydoc am_hk32f103rbt6_clk.h
 * @{
 */
/**
 * \brief 系统时钟源
 */
typedef enum {
    AM_HK32F103RBT6_SYSCLK_HSI, /**< \brief HSI 作为系统时钟 */
    AM_HK32F103RBT6_SYSCLK_HSE, /**< \brief HSE 作为系统时钟 */
    AM_HK32F103RBT6_SYSCLK_PLL, /**< \brief PLL 输出作为系统时钟 */
    AM_HK32F103RBT6_SYSCLK_LSI, /**< \brief LSI 输出作为系统时钟 */
    AM_HK32F103RBT6_SYSCLK_LSE  /**< \brief LSE 输出作为系统时钟 */
}am_hk32f103rbt6_sys_clk_src;

/**
 * \brief CLK 设备信息参数结构体
 */
typedef struct am_hk32f103rbt6_clk_devinfo {
    /**
     * \brief 系统时钟源选择
     *
     ...
     */
    amhw_hk32f103rbt6_pll_clk_src pllin_src;
     ...
     *  建议配置成48Mhz
     */
    amhw_hk32f103rbt6_pll_usb_clk_div usb_div;
...
} am_hk32f103rbt6_clk_devinfo_t;

/**
 * \brief CLK 设备结构体
 */
typedef struct am_hk32f103rbt6_clk_dev {
