...
#ifndef __AM_HK32F103RBT6_USART_H
#define __AM_HK32F103RBT6_USART_H
...
/**
 * \addtogroup am_hk32f103rbt6_if_usart
 * \copydoc am_hk32f103rbt6_usart.h
 * @{
 */
 ...
 *        便用户判断具体的中断源，size为1。
 */
#define AM_HK32F103RBT6_USART_ERRCODE_USART_OTHER_INT  3

/**
 * \brief 用于软件流控的XON字符定义，默认0x11
 */
#define AM_HK32F103RBT6_USART_XON       0x11

/**
 * \brief 用于软件流控的XOFF字符定义，默认0x13
 */
#define AM_HK32F103RBT6_USART_XOFF      0x13
 ...
 */
typedef struct am_hk32f103rbt6_usart_devinfo {
    ...
    /**
     * \brief 串口配置标志，AMHW_HK32F103RBT6_USART_DATA_*宏或AMHW_HK32F103RBT6_USART_PARITY_*宏
     *        或AMHW_HK32F103RBT6_USART_STOP_*的或值
     *        (如：AMHW_HK32F103RBT6_USART_DATA_8BIT|AMHW_HK32F103RBT6_USART_PARITY_NO
     *                                       |AMHW_HK32F103RBT6_USART_STOP_1BIT)
     */
    uint8_t  cfg_flags;
    ...
    /**
     * \brief 指定使能的其它中断,AMHW_HK32F103RBT6_USART_INT_*宏值或多个AMHW_HK32F103RBT6_USART_INT_*宏的
     *        或值，除了(# AMHW_HK32F103RBT6_USART_INT_TX_EMPTY_ENABLE),
     *                (# AMHW_HK32F103RBT6_USART_INT_RX_VAL_ENABLE)这两个中断。
     */
...
} am_hk32f103rbt6_usart_devinfo_t;

/**
 * \brief 串口设备结构体定义
 */
typedef struct am_hk32f103rbt6_usart_dev {
    ...
    const am_hk32f103rbt6_usart_devinfo_t *p_devinfo; /**< \brief 指向设备信息常量的指针 */

} am_hk32f103rbt6_usart_dev_t;
...
#endif /* __AM_HK32F103RBT6_USART_H */
