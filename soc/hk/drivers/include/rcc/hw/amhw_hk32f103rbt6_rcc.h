 ...
 */
typedef enum {
    AMHW_HK32F103RBT6_SYSCLK_HSI,       /**< \brief HSI 作为系统时钟 */
    AMHW_HK32F103RBT6_SYSCLK_HSE,       /**< \brief HSE 作为系统时钟 */
    AMHW_HK32F103RBT6_SYSCLK_PLL,       /**< \brief PLL 输出作为系统时钟 */
    AMHW_HK32F103RBT6_SYSCLK_LSI_OR_LSE /**< \brief LSI 或  LSE 输出作为系统时钟 */
 ...
 */
typedef enum {
    AMHW_HK32F103RBT6_LCLK_LSI,  /**< \brief 低速内部时钟 */
    AMHW_HK32F103RBT6_LCLK_LSE,  /**< \brief 低速外部时钟 */
 ...
 */
typedef enum {
    AMHW_HK32F103RBT6_RTCCLK_LSE = 1,       /**< \brief PLL 输出作为系统时钟 */
    AMHW_HK32F103RBT6_RTCCLK_LSI = 2,       /**< \brief HSI 振荡器  6 分频作为系统时钟 */
    AMHW_HK32F103RBT6_RTCCLK_HSE_DIV128 =3, /**< \brief HSE 作为系统时钟 */
 ...
 */
typedef enum {
    AMHW_HK32F103RBT6_PLLCLK_HSI = 0,  /**< \brief HSI 作为PLL输入时钟 */
    AMHW_HK32F103RBT6_PLLCLK_HSE = 1,  /**< \brief HSE 作为PLL输入时钟 */
 ...
 */
typedef enum {
    AMHW_HK32F103RBT6_PLL_USB_DIV1P5 = 0, /**< \brief PLL 1.5 分频作为usb输入时钟 */
    AMHW_HK32F103RBT6_PLL_USB_DIV1   = 1, /**< \brief PLL 1 分频作为usb输入时钟 */
 ...
 */
typedef enum {
    AMHW_HK32F103RBT6_CLKINT_INDEX_LSI = 0,  /**< \brief LSI标志 */
    AMHW_HK32F103RBT6_CLKINT_INDEX_LSE = 1,  /**< \brief LSE标志 */
    AMHW_HK32F103RBT6_CLKINT_INDEX_HSI,      /**< \brief HSI标志 */
    AMHW_HK32F103RBT6_CLKINT_INDEX_HSE,      /**< \brief HSE标志 */
    AMHW_HK32F103RBT6_CLKINT_INDEX_PLL,      /**< \brief PLL标志 */
    AMHW_HK32F103RBT6_CLKINT_INDEX_CSSF = 7, /**< \brief CSSF(时钟安全系统中断)标志 */
 ...
 */
typedef enum {
    AMHW_HK32F103RBT6_RCC_APB1_TIM2   = 0,    /**< \brief TIM2定时器 */
    AMHW_HK32F103RBT6_RCC_APB1_TIM3   = 1,    /**< \brief TIM3定时器 */
    AMHW_HK32F103RBT6_RCC_APB1_TIM4   = 2,    /**< \brief TIM4定时器 */
    AMHW_HK32F103RBT6_RCC_APB1_WWDG   = 11,   /**< \brief WWDG窗口看门狗 */
    ...
    AMHW_HK32F103RBT6_RCC_APB1_PWR    = 28,   /**< \brief 电源接口 */
 ...
 */
typedef enum {
    AMHW_HK32F103RBT6_RCC_CSR_PINRSTF   = (1ul << 26),      /**< \brief NRST管脚复位标志 */
    AMHW_HK32F103RBT6_RCC_CSR_PORRSTF   = (1ul << 27),      /**< \brief 上电/掉电复位标志 */
    AMHW_HK32F103RBT6_RCC_CSR_SFTRSTF   = (1ul << 28),      /**< \brief 软件复位标志 */
    AMHW_HK32F103RBT6_RCC_CSR_IWDGRSTF  = (1ul << 29),      /**< \brief 独立看门狗复位标志 */
    AMHW_HK32F103RBT6_RCC_CSR_WWDGRSTF  = (1ul << 30),      /**< \brief 窗口看门狗复位标志 */
    AMHW_HK32F103RBT6_RCC_CSR_LPWRRSTF  = (int)(1ul << 31), /**< \brief 低功耗管理复位标志 */
 ...
 * \param[in]  div ：分频值
 *
 *      - AMHW_HK32F103RBT6_PLL_USB_DIV1P5 ：PLL 时钟1.5分频作为 USB 时钟
 *      - AMHW_HK32F103RBT6_PLL_USB_DIV1   ： PLL 时钟直接作为 USB时钟
 *
 * \return 无
 */
am_static_inline
...
typedef enum amhw_hk32f103rbt6_rcc_hse_iop_set {
    AMHW_HK32F103RBT6_RCC_HSE_IOP_20 = 0,/**< \brief 驱动电流大约为20uA，推荐使用0.5~3MHz晶振 */
    AMHW_HK32F103RBT6_RCC_HSE_IOP_30,    /**< \brief 驱动电流大约为30uA，推荐使用0.5~4MHz晶振 */
    AMHW_HK32F103RBT6_RCC_HSE_IOP_40,    /**< \brief 驱动电流大约为40uA，推荐使用0.5~5MHz晶振 */
    AMHW_HK32F103RBT6_RCC_HSE_IOP_50,    /**< \brief 驱动电流大约为50uA，推荐使用1~6MHz晶振 */
    AMHW_HK32F103RBT6_RCC_HSE_IOP_60,    /**< \brief 驱动电流大约为60uA，推荐使用2~12MHz晶振 */
    AMHW_HK32F103RBT6_RCC_HSE_IOP_80,    /**< \brief 驱动电流大约为80uA，推荐使用2~15MHz晶振 */
    AMHW_HK32F103RBT6_RCC_HSE_IOP_100,   /**< \brief 驱动电流大约为100uA，推荐使用3~20MHz晶振 */
    AMHW_HK32F103RBT6_RCC_HSE_IOP_200,   /**< \brief 驱动电流大约为200uA，推荐使用5~30MHz晶振 */
} amhw_hk32f103rbt6_rcc_hse_iop_set_t;
/**
 * \brief XCH_IOp[2:0]  HSE晶振驱动能力配置
 *
 * \param[in] status_flag：HSE晶振驱动能力配置，
 *                        值为 amhw_hk32f103rbt6_rcc_hse_iop_set_t 这一枚举类型
 *
 */
am_static_inline
 ...
 * \param[in]  index : 低速时钟
 *
 *      - AMHW_HK32F103RBT6_LCLK_LSI  ： 低速内部LSI时钟
 *      - AMHW_HK32F103RBT6_LCLK_LSE  ： 低速外部LSE时钟
 */
am_static_inline
