...
#ifndef __AM_HK32F103RBT6_SPI_SLV_DMA_H
#define __AM_HK32F103RBT6_SPI_SLV_DMA_H
...
/**
 * \addtogroup am_hk32f103rbt6_if_spi_slv_dma
 * \copydoc am_hk32f103rbt6_spi_slv_dma.h
 * @{
 */
 ...
 * \brief SPI 从机设备信息结构体
 */
typedef struct am_hk32f103rbt6_spi_slv_dma_devinfo {
...
} am_hk32f103rbt6_spi_slv_dma_devinfo_t;

/**
 * \brief SPI 设备结构体
 */
typedef struct am_hk32f103rbt6_spi_slv_dma_dev {
    ...
    /** \brief DMA 通道描述符 */
    amhw_hk32f103rbt6_dma_xfer_desc_t               g_desc[2];
...
} am_hk32f103rbt6_spi_slv_dma_dev_t;
...
#endif /* __AM_HK32F103RBT6_SPI_SLV_DMA_H */
