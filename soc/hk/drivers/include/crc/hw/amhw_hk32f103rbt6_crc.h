...
#ifndef __AMHW_HK32F103RBT6_CRC_H
#define __AMHW_HK32F103RBT6_CRC_H
...
/**
 * \addtogroup amhw_hk32f103rbt6_if_crc
 * \copydoc amhw_hk32f103rbt6_crc.h
 * @{
 */
 ...
 */
typedef struct amhw_hk32f103rbt6_crc {
 ...
 */
am_static_inline
void amhw_hk32f103rbt6_crc_32bit_write_data (amhw_hk32f103rbt6_crc_t    *p_hw_crc,
                                    uint32_t           data)
{
    p_hw_crc->crcdr = data;
}
 ...
 */
am_static_inline
uint32_t amhw_hk32f103rbt6_crc_32bit_read_data (amhw_hk32f103rbt6_crc_t *p_hw_crc)
{
 ...
 */
am_static_inline
void amhw_hk32f103rbt6_crc_8bit_write_data (amhw_hk32f103rbt6_crc_t *p_hw_crc, uint8_t data)
{
 ...
 */
am_static_inline
uint8_t amhw_hk32f103rbt6_crc_8bit_read_data (amhw_hk32f103rbt6_crc_t *p_hw_crc)
{
 ...
 */
am_static_inline
void amhw_hk32f103rbt6_crc_reset (amhw_hk32f103rbt6_crc_t *p_hw_crc)
{
    p_hw_crc->crcctl = 1;
}
...
#endif /* __AMHW_HK32F103RBT6_CRC_H */
