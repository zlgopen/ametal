 ...
 *
 * \par 源代码
 * \snippet demo_std_fmse_binary_rw_test.c src_std_fmse_binary_rw_test
 *
 * \internal
...
/**
 * \addtogroup demo_if_std_fmse_binary_rw_test
 * \copydoc demo_std_fmse_binary_rw_test.c
 */
 ...
 * \brief 例程入口
 */
void demo_std_fmse_binary_rw_test_entry (am_fmse_handle_t handle)
{
	uint8_t  i, j;
	uint8_t  bt_rbuf[256];
