 ...
 *
 * \par 源代码
 * \snippet demo_std_fmse_gen_key_pair.c src_std_fmse_gen_key_pair
 *
 * \internal
...
/**
 * \addtogroup demo_if_std_fmse_gen_key_pair
 * \copydoc demo_std_fmse_gen_key_pair.c
 */
 ...
 * \brief 例程入口
 */
void demo_std_fmse_gen_key_pair_entry (am_fmse_handle_t handle, uint8_t mode)
{
	uint8_t i;
	uint8_t rbuf[512];
	uint16_t rlen = 0;
