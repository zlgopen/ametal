 ...
 *
 * \par 源代码
 * \snippet demo_std_fmse_data_encrypt_and_decrypt.c
 *          src_std_fmse_data_encrypt_and_decrypt
 * \internal
...
/**
 * \addtogroup demo_if_std_fmse_data_encrypt_and_decrypt
 * \copydoc demo_std_fmse_data_encrypt_and_decrypt.c
 */
 ...
 * \brief 例程入口
 */
void demo_std_fmse_data_encrypt_and_decrypt_entry (am_fmse_handle_t handle)
{
	uint8_t i;
	uint8_t rbuf[1028];
	uint8_t inbuf[256];
