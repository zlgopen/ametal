 ...
 *
 * \par 源代码
 * \snippet demo_std_fmse_ecc_calc_test.c src_std_fmse_ecc_calc_test
 *
 * \internal
...
/**
 * \addtogroup demo_if_std_fmse_ecc_calc_test
 * \copydoc demo_std_fmse_ecc_calc_test.c
 */
 ...
 * \brief 例程入口
 */
void demo_std_fmse_ecc_calc_test_entry (am_fmse_handle_t handle)
{
	uint8_t i;  
