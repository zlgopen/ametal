 ...
 *
 * \par 源代码
 * \snippet demo_mm32l373_std_wwdg.c src_mm32l373_std_wwdg
 *
 * \internal
...
/**
 * \addtogroup demo_if_mm32l373_std_wwdg
 * \copydoc demo_mm32l373_std_wwdg.c
 */

/** [src_mm32l373_std_wwdg] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo mm32l373_core std wwdg!\r\n");

    demo_std_wdt_entry(am_mm32l373_wwdg_inst_init(),
                       __WWDG_TIMEOUT_MS,
                       __WWDG_FEED_TIME_MS);
}
/** [src_mm32l373_std_wwdg] */
