 ...
 *
 * \par 源代码
 * \snippet demo_mm32l373_std_tim4_cap.c src_mm32l373_std_tim4_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_mm32l373_std_tim4_cap
 * \copydoc demo_mm32l373_std_tim4_cap.c
 */

/** [src_mm32l373_std_tim4_cap] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    am_pwm_handle_t pwm_handle = am_mm32l373_tim3_pwm_inst_init();

    AM_DBG_INFO("demo mm32l373_core std tim13 cap!\r\n");

    /* TIM2 输出频率为 2KHz 的 PWM */
    am_pwm_config(pwm_handle, 0, 500000 / 2, 500000);
    am_pwm_enable(pwm_handle, 0);

    demo_std_timer_cap_entry(am_mm32l373_tim4_cap_inst_init(), 0);
}
/** [src_mm32l373_std_tim4_cap] */
