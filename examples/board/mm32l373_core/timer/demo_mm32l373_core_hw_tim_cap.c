 ...
 *
 * \par 源代码
 * \snippet demo_mm32l373_hw_tim_cap.c src_mm32l373_hw_tim_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_mm32l373_hw_tim_cap
 * \copydoc demo_mm32l373_hw_tim_cap.c
 */

/** [src_mm32l373_hw_tim_cap] */
#include "ametal.h"
#include "am_gpio.h"
#include "am_vdebug.h"
#include "am_board.h"
...
void demo_mm32l373_core_hw_tim_cap_entry (void)
{
    ...
    AM_DBG_INFO("demo mm32l373_core hw tim cap!\r\n");
    ...
    demo_mm32_hw_tim_cap_entry(MM32L373_TIM3,
                              AMHW_MM32_TIM_TYPE1,
                              0,
