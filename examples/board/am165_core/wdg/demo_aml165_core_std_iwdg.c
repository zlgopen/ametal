 ...
 *
 * \par 源代码
 * \snippet demo_aml165_core_std_iwdg.c src_aml165_core_std_iwdg
 *
 * \internal
...
/**
 * \addtogroup demo_if_aml165_core_std_iwdg
 * \copydoc demo_aml165_core_std_iwdg.c
 */

/** [src_aml165_core_std_iwdg] */
...
{
    AM_DBG_INFO("demo aml165_core std iwdg!\r\n");

    demo_std_wdt_entry(am_zml165_iwdg_inst_init(),
                       __IWDG_TIMEOUT_MS,
                       __IWDG_FEED_TIME_MS);
