...
/******************************************************************************/
void demo_aml165_core_mb_master_demo_entry (void)
{
    ...
    /* 串口设备信息初始化 */
    mb_master_info.serial.uart      = am_zml165_uart1_inst_init();
    ...
    /* 定时器设备信息初始化 */
    mb_master_info.timer.timer      = am_zml165_tim2_timing_inst_init ();
