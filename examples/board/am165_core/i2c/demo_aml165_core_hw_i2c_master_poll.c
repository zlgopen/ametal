 ...
 *
 * \par 源代码
 * \snippet demo_aml165_core_hw_i2c_master_poll.c src_aml165_core_hw_i2c_master_poll
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_if_aml165_core_hw_i2c_master_poll
 * \copydoc demo_aml165_core_hw_i2c_master_poll.c
 */
...
{
    am_kprintf("demo aml165_core hw i2c master poll!\r\n");
