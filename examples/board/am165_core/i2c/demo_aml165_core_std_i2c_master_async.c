 ...
 *
 * \par 源代码
 * \snippet demo_aml165_core_std_i2c_master_async.c src_aml165_core_std_i2c_master_async
 *
 * \internal
...
/**
 * \addtogroup demo_if_aml165_core_std_i2c_master_async
 * \copydoc demo_aml165_core_std_i2c_master_async.c
 */

/** [src_aml165_core_std_i2c_master_async] */
...
{
    AM_DBG_INFO("demo aml165_core std i2c master async!\r\n");

    demo_std_i2c_master_async_entry(am_zml165_i2c1_inst_init(),
                                    EEPROM_ADDR,
                                    TEST_LEN);
}
/** [src_aml165_core_std_i2c_master_async] */
