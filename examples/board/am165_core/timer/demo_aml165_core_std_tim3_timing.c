 ...
 *
 * \par 源代码
 * \snippet demo_aml165_core_std_tim3_timing.c src_aml165_core_std_tim3_timing
 *
 * \internal
...
/**
 * \addtogroup demo_if_aml165_core_std_tim3_timing
 * \copydoc demo_aml165_core_std_tim3_timing.c
 */
