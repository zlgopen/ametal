 ...
 *
 * \par 源代码
 * \snippet demo_hk32f103rbt6_std_tim4_cap.c src_hk32f103rbt6_std_tim4_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_hk32f103rbt6_std_tim4_cap
 * \copydoc demo_hk32f103rbt6_std_tim4_cap.c
 */

/** [src_hk32f103rbt6_std_tim4_cap] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    am_pwm_handle_t pwm_handle = am_hk32f103rbt6_tim3_pwm_inst_init();

    AM_DBG_INFO("demo hk32f103rbt6_core std tim13 cap!\r\n");

    /* TIM2 输出频率为 2KHz 的 PWM */
    am_pwm_config(pwm_handle, 0, 500000 / 2, 500000);
    am_pwm_enable(pwm_handle, 0);

    demo_std_timer_cap_entry(am_hk32f103rbt6_tim4_cap_inst_init(), 0);
}
/** [src_hk32f103rbt6_std_tim4_cap] */
