 ...
 *
 * \par 源代码
 * \snippet demo_hk32f103rbt6_std_wwdg.c src_hk32f103rbt6_std_wwdg
 *
 * \internal
...
/**
 * \addtogroup demo_if_hk32f103rbt6_std_wwdg
 * \copydoc demo_hk32f103rbt6_std_wwdg.c
 */

/** [src_hk32f103rbt6_std_wwdg] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo hk32f103rbt6_core std wwdg!\r\n");

    demo_std_wdt_entry(am_hk32f103rbt6_wwdg_inst_init(),
                       __WWDG_TIMEOUT_MS,
                       __WWDG_FEED_TIME_MS);
}
/** [src_hk32f103rbt6_std_wwdg] */
