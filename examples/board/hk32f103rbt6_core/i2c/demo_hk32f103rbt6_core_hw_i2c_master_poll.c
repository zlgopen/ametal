...
#define I2C_MASTER    ((amhw_hk32f103rbt6_i2c_t *)HK32F103RBT6_I2C1_BASE)   /**< \brief I2C主机控制器通道号定义 */
...
void demo_hk32f103rbt6_core_hw_i2c_master_poll_entry (void)
{
    ...
    am_kprintf("demo hk32f103rbt6_core hw i2c master poll!\r\n");
    ...
    demo_hk32f103rbt6_hw_i2c_master_poll_entry((void *)I2C_MASTER, am_clk_rate_get(CLK_APB1));
