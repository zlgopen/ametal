 ...
 *
 * \par 源代码
 * \snippet demo_hk32f103rbt6_std_i2c_master_sync.c src_hk32f103rbt6_std_i2c_master_sync
 *
 * \internal
...
/**
 * \addtogroup demo_if_hk32f103rbt6_std_i2c_master_sync
 * \copydoc demo_hk32f103rbt6_std_i2c_master_sync.c
 */

/** [src_hk32f103rbt6_std_i2c_master_sync] */
#include "ametal.h"
#include "am_board.h"
#include "am_vdebug.h"
#include "am_i2c.h"
...
{
    AM_DBG_INFO("demo hk32f103rbt6_core std i2c master sync!\r\n");

    demo_std_i2c_master_sync_entry(am_hk32f103rbt6_i2c1_inst_init(),
                                   EEPROM_ADDR,
                                   TEST_LEN);
}
/** [src_hk32f103rbt6_std_i2c_master_sync] */
