 ...
 *
 * \par 源代码
 * \snippet demo_hk32f103rbt6_std_led.c src_std_led
 *
 * \internal
...
/**
 * \addtogroup demo_if_hk32f103rbt6_std_led
 * \copydoc demo_hk32f103rbt6_std_led.c
 */
...
{
    AM_DBG_INFO("demo hk32f103rbt6_core std led!\r\n");
