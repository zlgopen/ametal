...
am_local void __rtc_alarm_set (uint32_t second)
{
    ...
    amhw_hk32f103rbt6_pwr_bkp_access_enable(HK32F103RBT6_PWR, AM_HK32F103RBT6_BKP_ENABLE); /* 取消备份域的写保护 */

    amhw_hk32f103rbt6_rtc_crl_cnf_enter(HK32F103RBT6_RTC); /* 允许配置 */
    amhw_hk32f103rbt6_rtc_alrl_set(HK32F103RBT6_RTC, sec & 0xffff);
    amhw_hk32f103rbt6_rtc_alrh_set(HK32F103RBT6_RTC, sec >> 16);
    amhw_hk32f103rbt6_rtc_crl_cnf_out(HK32F103RBT6_RTC); /* 配置更新 */
...
am_local void __rtc_init (void)
{
    ...
    amhw_hk32f103rbt6_rtc_crl_cnf_enter(HK32F103RBT6_RTC); /* 允许配置 RTC */
