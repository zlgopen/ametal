 ...
 *
 * \par 源代码
 * \snippet demo_hk32f103rbt6_drv_sleepmode_wake_up.c src_hk32f103rbt6_drv_sleepmode_wake_up
 *
 * \internal
...
/**
 * \addtogroup demo_if_hk32f103rbt6_drv_sleepmode_wake_up
 * \copydoc demo_hk32f103rbt6_drv_sleepmode_wake_up.c
 */

/** [src_hk32f103rbt6_drv_sleepmode_wake_up] */
#include "ametal.h"
#include "am_board.h"
#include "am_led.h"
#include "am_delay.h"
...
void demo_hk32f103rbt6_drv_sleepmode_wake_up_entry (void)
{
    ...
    /* 唤醒配置 */
    am_hk32f103rbt6_wake_up_cfg(AM_HK32F103RBT6_PWR_MODE_SLEEP, gpio_isr, (void *)0);
