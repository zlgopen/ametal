 ...
 *
 * \par 源代码
 * \snippet demo_hk32f103rbt6_hw_adc_dma.c src_hk32f103rbt6_hw_adc_dma
 *
 * \internal
...
/**
 * \addtogroup demo_if_hk32f103rbt6_hw_adc_dma
 * \copydoc demo_hk32f103rbt6_hw_adc_dma.c
 */

/** [src_hk32f103rbt6_hw_adc_dma] */
#include "ametal.h"
#include "am_vdebug.h"
...
void demo_hk32f103rbt6_core_hw_adc_dma_entry (void)
{
    ...
    demo_hk32f103rbt6_hw_adc_dma_entry((void *)HK32F103RBT6_ADC1,
                                 adc_chan,
