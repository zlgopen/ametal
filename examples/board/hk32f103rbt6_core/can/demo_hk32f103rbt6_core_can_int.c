 ...
 *
 * \par 源代码
 * \snippet demo_hk32f103rbt6_can_int.c demo_hk32f103rbt6_can_int
 *
 * \internal
...
/**\brief 滤波表数组，相关设定请参考demo_hk32f103rbt6_core_can.c例程 */
...
void demo_hk32f103rbt6_core_can_int_entry (void)
{
    ...
    demo_hk32f103rbt6_can_int_entry (am_hk32f103rbt6_can_inst_init(),
                               &can_btr_baud,
                               int_type,
                               table,
