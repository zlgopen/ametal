 ...
 *
 * \par 源代码
 * \snippet demo_hc32l17x_std_uart_ringbuf.c src_hc32l17x_std_uart_ringbuf
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l17x_std_uart_ringbuf
 * \copydoc demo_hc32l17x_std_uart_ringbuf.c
 */

/** [src_hc32l17x_std_uart_ringbuf] */
#include "ametal.h"
...
{
    AM_DBG_INFO("demo aml17x_core std lpuart ringbuf!\r\n");
