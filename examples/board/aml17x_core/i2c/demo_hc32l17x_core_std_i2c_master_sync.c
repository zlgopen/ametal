 ...
 *
 * \par 源代码
 * \snippet demo_hc32l17x_std_i2c_master_sync.c src_hc32l17x_std_i2c_master_sync
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l17x_std_i2c_master_sync
 * \copydoc demo_hc32l17x_std_i2c_master_sync.c
 */

/** [src_hc32l17x_std_i2c_master_sync] */
#include "ametal.h"
#include "am_board.h"
#include "am_vdebug.h"
#include "am_i2c.h"
...
{
    AM_DBG_INFO("demo aml17x_core std i2c master sync!\r\n");
