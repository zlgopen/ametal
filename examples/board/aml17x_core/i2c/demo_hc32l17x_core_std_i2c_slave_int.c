 ...
 *
 * \par 源代码
 * \snippet demo_hc32l17x_std_i2c_slave_int.c src_hc32l17x_std_i2c_slave_int
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l17x_std_i2c_slave_int
 * \copydoc demo_hc32l17x_std_i2c_slave_int.c
 */

/** [src_hc32l17x_std_i2c_slave_int] */
#include "ametal.h"
#include "am_vdebug.h"
#include "am_board.h"
#include "am_gpio.h"
...
{
    am_kprintf("demo aml17x_core std i2c slave int!\r\n");
