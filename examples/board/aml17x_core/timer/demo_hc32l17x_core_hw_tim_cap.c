 ...
 *
 * \par 源代码
 * \snippet demo_hc32l17x_hw_tim_cap.c src_hc32l17x_hw_tim_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l17x_hw_tim_cap
 * \copydoc demo_hc32l17x_hw_tim_cap.c
 */
...
void demo_hc32l17x_core_hw_tim_cap_entry (void)
{
    ...
    AM_DBG_INFO("demo aml17x_core hw tim cap!\r\n");
