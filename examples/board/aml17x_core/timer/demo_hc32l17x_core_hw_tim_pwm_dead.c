 ...
 *       要更改demo_hc32l17x_hw_tim_pwm_dead.c中的分频系数，外设时钟两个参数。
 *
 * \par 源代码
 * \snippet demo_hc32l17x_hw_tim_pwm_dead.c src_hc32l17x_hw_tim_pwm_dead
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l17x_hw_tim_pwm_dead
 * \copydoc demo_hc32l17x_hw_tim_pwm_dead.c
 */

/** [src_hc32l17x_hw_tim_pwm_dead] */
#include "ametal.h"
#include "am_gpio.h"
#include "am_vdebug.h"
#include "am_hc32.h"
...
void demo_hc32l17x_core_hw_tim_pwm_dead_entry (void)
{
    ...
    AM_DBG_INFO("demo aml17x_core hw tim PWM dead!\r\n");
