 ...
 * 
 * \par 源代码
 * \snippet demo_mm32l073_core_hw_clk.c src_mm32l073_core_hw_clk
 * 
 * \internal
...
/**
 * \addtogroup demo_if_mm32l073_core_hw_clk
 * \copydoc demo_mm32l073_core_hw_clk.c
 */

/** [src_mm32l073_core_hw_clk] */
#include "ametal.h"
#include "am_vdebug.h"
...
am_local void __uart_init (void)
{
    ...
    handle = am_mm32l073_uart2_inst_init();
...
void demo_mm32l073_core_hw_clk_entry (void)
{
    ...
    AM_DBG_INFO("demo mm32l073_core hw clk!\r\n");

    am_gpio_pin_cfg(PIOA_9, PIOA_9_MCO | PIOA_9_AF_PP | PIOA_9_SPEED_50MHz);

    amhw_mm32l073_rcc_mco_src_set(4);
