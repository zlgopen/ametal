 ...
 *
 * \par 源代码
 * \snippet demo_mm32l073_core_std_tim1_cap.c src_mm32l073_core_std_tim1_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_mm32l073_core_std_tim1_cap
 * \copydoc demo_mm32l073_core_std_tim1_cap.c
 */

/** [src_mm32l073_core_std_tim1_cap] */
#include "ametal.h"
#include "am_pwm.h"
#include "am_vdebug.h"
...
void demo_mm32l073_core_std_tim1_cap_entry (void)
{
    ...
    AM_DBG_INFO("demo mm32l073_core std tim1 cap!\r\n");

    /* TIM2 输出频率为 2KHz 的 PWM */
    am_pwm_config(pwm_handle, 0, 500000 / 2, 500000);
    am_pwm_enable(pwm_handle, 0);

    demo_std_timer_cap_entry(am_mm32l073_tim1_cap_inst_init(), 3);
}
/** [src_mm32l073_core_std_tim1_cap] */
