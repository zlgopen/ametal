 ...
 */
void demo_mm32l073_core_hw_clk_entry (void);

/**
 * \brief DMA 内存到内存例程，通过驱动层接口实现
 */
void demo_mm32l073_core_drv_dma_m2m_entry (void);

/**
 * \brief FLASH 例程，通过驱动层接口实现
 */
void demo_mm32l073_core_drv_flash_entry (void);
 ...
 */
void demo_mm32l073_core_std_gpio_entry (void);
 ...
 */
void demo_mm32l073_core_hw_i2c_master_poll_entry (void);

/**
 * \brief I2C 从机例程(此例程可以用来模拟 EEPROM)，通过 HW 层接口实现
 */
void demo_mm32l073_core_hw_i2c_slave_poll_entry (void);
 ...
 */
void demo_mm32l073_core_std_i2c_master_async_entry (void);
 ...
 */
void demo_mm32l073_core_std_i2c_slave_entry (void);
 ...
 */
void demo_mm32l073_core_std_key_entry (void);
 ...
 */
void demo_mm32l073_core_std_softimer_entry (void);
 ...
 */
void demo_mm32l073_core_std_spi_flash_dma_entry (void);
 ...
 */
void demo_mm32l073_core_std_spi_master_dma_entry (void);
 ...
 */
void demo_mm32l073_core_hw_tim_timing_entry (void);
 ...
 */
void demo_mm32l073_core_std_tim14_timing_entry (void);
 ...
 */
void demo_mm32l073_core_std_tim16_timing_entry (void);

/**
 * \brief TIM17 定时器 CAP 例程，通过标准接口实现
 */
void demo_mm32l073_core_std_tim17_cap_entry (void);
 ...
 */
void demo_mm32l073_core_std_tim17_timing_entry (void);

/**
 * \brief TIM1 定时器 CAP 例程，通过标准接口实现
 */
void demo_mm32l073_core_std_tim1_cap_entry (void);
 ...
 */
void demo_mm32l073_core_std_tim1_timing_entry (void);

/**
 * \brief TIM2 定时器 CAP 例程，通过标准接口实现
 */
void demo_mm32l073_core_std_tim2_cap_entry (void);

/**
 * \brief TIM2 定时器 PWM 例程，通过标准接口实现
 */
void demo_mm32l073_core_std_tim2_pwm_entry (void);
 ...
 */
void demo_mm32l073_core_std_tim3_cap_entry (void);

/**
 * \brief TIM3 定时器 PWM 例程，通过标准接口实现
 */
void demo_mm32l073_core_std_tim3_pwm_entry (void);

/**
 * \brief TIM3 定时器 TIMING 例程，通过标准接口实现
 */
void demo_mm32l073_core_std_tim3_timing_entry (void);
 ...
 */
void demo_mm32l073_core_std_uart_polling_entry (void);

/**
 * \brief UART 环形缓冲区例程，通过标准接口实现
 */
void demo_mm32l073_core_std_uart_ringbuf_entry (void);
 ...
 */
void demo_mm32l073_core_hw_wwdg_entry (void);

/**
 * \brief IWDG 例程，通过标准接口实现
 */
void demo_mm32l073_core_std_iwdg_entry (void);
 ...
 */
void demo_mm32l073_core_microport_ds1302_entry (void);
 ...
 */
void demo_mm32l073_core_microport_flash_entry (void);

/**
 * \brief MicroPort FLASH 例程，通过 FTL 接口实现
 */
void demo_mm32l073_core_microport_flash_ftl_entry (void);

/**
 * \brief MicroPort FLASH 例程，通过 MTD 接口实现
 */
void demo_mm32l073_core_microport_flash_mtd_entry (void);
 ...
 */
void demo_mm32l073_core_miniport_hc595_digitron_entry (void);

/**
 * \brief MiniPort-595 + MiniPort-VIEW + MiniPort-KEY 例程
 */
void demo_mm32l073_core_miniport_hc595_digitron_key_entry (void);
 ...
 */
void demo_mm32l073_core_miniport_hc595_led_entry (void);
 ...
 */
void demo_mm32l073_core_miniport_led_entry (void);

/**
 * \brief MiniPort-ZLG72128 显示例程
 */
void demo_mm32l073_core_miniport_zlg72128_entry (void);
 ...
 * \brief 读CPU卡例程
 */
void demo_mm32l073_core_dr_fm175xx_cpu_card (void);
/**
 * \brief A类卡读卡类型和卡号例程
 */
void demo_mm32l073_core_dr_fm175xx_picca_read_id(void);

/**
 * \brief A类卡读休眠卡例程
 */
void demo_mm32l073_core_dr_fm175xx_picca_halt (void);

/**
 * \brief A类卡读块例程
 */
void demo_mm32l073_core_dr_fm175xx_picca_read_block (void);

/**
 * \brief A类卡值操作例程
 */
void demo_mm32l073_core_dr_fm175xx_picca_val_operate (void);

/**
 * \brief A类卡写块例程
 */
void demo_mm32l073_core_dr_fm175xx_picca_write_block (void);

/**
 * \brief B类卡读卡号例程
 */
void demo_mm32l073_core_dr_fm175xx_piccb_read_id (void);
/**
 * \brief FM175XX LCPD模式 A类卡读卡类型和卡号例程
 */
void demo_mm32l073_core_dr_fm175xx_picca_lpcd_read_id(void);

/**
 * \brief 传感器查询模式例程入口
 */
void demo_mm32l073_core_sensor_hts221_entry (void);

/**
 * \brief 传感器触发模式例程入口
 */
void demo_mm32l073_core_sensor_hts221_int_entry (void);

/**
 * \brief 三轴陀螺仪传感器查询模式例程入口
 */
void demo_mm32l073_core_sensor_bmg160_entry (void);

/**
 * \brief 三轴磁传感器查询模式例程入口
 */
void demo_mm32l073_core_sensor_mmc5883ma_entry (void);
 ...
 * \brief 磁力传感器查询模式例程入口
 */
void demo_mm32l073_core_sensor_mag3110_entry (void);
 ...
 */
void demo_mm32l073_zsn603_led_test_entry(void);

/**
 * \brief ZSN603 A类卡测试程序
 */
void demo_mm32l073_zsn603_picca_test_entry(void);

/**
 * \brief ZSN603 B类卡测试程序
 */
void demo_mm32l073_zsn603_piccb_test_entry(void);

/**
 * \brief ZSN603 自动检测测试程序
 */
void demo_mm32l073_zsn603_auto_detect_test_entry(void);
 ...
 * \brief GS200 例程
 */
void demo_mm32l073_core_gs200_set_baudrate_entry (void);
