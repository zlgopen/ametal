 ...
 *
 * \par 源代码
 * \snippet demo_mm32l073_core_std_iwdg.c src_mm32l073_core_std_iwdg
 *
 * \internal
...
/**
 * \addtogroup demo_if_mm32l073_core_std_iwdg
 * \copydoc demo_mm32l073_core_std_iwdg.c
 */

/** [src_mm32l073_core_std_iwdg] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo mm32l073_core std iwdg!\r\n");

    demo_std_wdt_entry(am_mm32l073_iwdg_inst_init(),
                       __IWDG_TIMEOUT_MS,
                       __IWDG_FEED_TIME_MS);
