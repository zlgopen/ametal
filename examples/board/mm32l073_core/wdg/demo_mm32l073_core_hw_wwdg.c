 ...
 *
 * \par 源代码
 * \snippet demo_mm32l073_core_hw_wwdg.c src_mm32l073_core_hw_wwdg
 *
 * \internal
...
/**
 * \addtogroup demo_if_mm32l073_core_hw_wwdg
 * \copydoc demo_mm32l073_core_hw_wwdg.c
 */
 
/** [src_mm32l073_core_hw_wwdg] */
#include "ametal.h"
#include "am_clk.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo mm32l073_core hw wwdg!\r\n");

    am_clk_enable(CLK_WWDG);
    am_mm32l073_clk_reset(CLK_WWDG);

    demo_mm32_hw_wwdg_entry(MM32L073_WWDG,
