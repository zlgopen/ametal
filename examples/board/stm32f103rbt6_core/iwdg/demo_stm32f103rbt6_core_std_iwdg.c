 ...
 *
 * \par 源代码
 * \snippet demo_stm32f103rbt6_std_iwdg.c src_stm32f103rbt6_std_iwdg
 *
 * \internal
...
/**
 * \addtogroup demo_if_stm32f103rbt6_std_iwdg
 * \copydoc demo_stm32f103rbt6_std_iwdg.c
 */

/** [src_stm32f103rbt6_std_iwdg] */
#include "ametal.h"
#include "am_board.h"
#include "am_vdebug.h"
#include "am_wdt.h"
...
void demo_stm32f103rbt6_core_std_iwdg_entry (void)
{
    ...
    demo_std_wdt_entry(am_stm32f103rbt6_iwdg_inst_init(),
                        __IWDG_TIMEOUT_MS, 
                        __IWDG_FEED_TIME_MS);
}
/** [src_stm32f103rbt6_std_iwdg] */
