...
/**
 * \file
 * \brief STM32F103RBT6 所有例程函数入口声明
 * \sa demo_stm32f103rbt6_all_entries.h
 *
 * \internal
 ...
 */
void demo_stm32f103rbt6_hw_crc_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_hw_dac_entry (void);

/**
 * \brief DAC 例程，通过标准接口实现
 */
void demo_stm32f103rbt6_core_std_dac_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_hw_gpio_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_std_iwdg_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_hw_rtc_sec_int_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_std_spi_master_poll_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_std_systick_timer_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_std_tim2_cap_entry (void);

/**
 * \brief TIM3 定时器 CAP 例程，通过标准接口实现
 */
void demo_stm32f103rbt6_core_std_tim3_cap_entry (void);

/**
 * \brief TIM4 定时器 CAP 例程，通过标准接口实现
 */
void demo_stm32f103rbt6_core_std_tim4_cap_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_std_tim1_timing_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_hw_uid_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_std_usart_ringbuf_entry (void);
 ...
 */
void demo_stm32f103rbt6_drv_stopmode_wake_up_entry (void);

/**
 * \brief WWDG 例程，通过 HW 层接口实现
 */
void demo_stm32f103rbt6_core_hw_wwdg_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_microport_rtc_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_microport_usb_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_miniport_led_entry (void);
 ...
 * \brief 读CPU卡例程
 */
void demo_stm32f103rbt6_core_dr_fm175xx_cpu_card (void);
/**
 * \brief A类卡读卡类型和卡号例程
 */
void demo_stm32f103rbt6_core_dr_fm175xx_picca_read_id(void);

/**
 * \brief A类卡读休眠卡例程
 */
void demo_stm32f103rbt6_core_dr_fm175xx_picca_halt (void);

/**
 * \brief A类卡读块例程
 */
void demo_stm32f103rbt6_core_dr_fm175xx_picca_read_block (void);

/**
 * \brief A类卡值操作例程
 */
void demo_stm32f103rbt6_core_dr_fm175xx_picca_val_operate(void);
 ...
 */
void demo_stm32f103rbt6_core_dr_fm175xx_picca_lpcd_read_id(void);
 ...
 * \brief can 例程入口
 */
void demo_stm32f103rbt6_core_std_can_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_sensor_tmd3702vc_entry (void);

/**
 * \brief 环境光/颜色、接近传感器触发模式例程入口
 */
void demo_stm32f103rbt6_core_sensor_tmd3702vc_int_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_sensor_tcs3430_entry (void);

/**
 * \brief 环境光/颜色传感器触发模式例程入口
 */
void demo_stm32f103rbt6_core_sensor_tcs3430_int_entry (void);
 ...
 * \brief 接近传感器触发模式例程入口
 */
void demo_stm32f103rbt6_core_sensor_tmd2635_int_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_sensor_tmd2750_int_entry (void);
 ...
 * \brief 温度传感器中断模式例程入口
 */
void demo_stm32f103rbt6_core_sensor_as621x_interrupt_mode_entry (void);
 ...
 */
void demo_stm32f103rbt6_core_sensor_tmg49037_int_entry (void);

/**
 * \brief 光谱传感器查询模式例程入口
 */
void demo_stm32f103rbt6_core_sensor_as7341_entry (void);

/**
 * \brief 光谱传感器触发模式例程入口
 */
void demo_stm32f103rbt6_core_sensor_as7341_int_entry (void);
 ...
 * \brief 高光谱传感器查询模式例程入口
 */
void demo_stm32f103rbt6_core_sensor_as7262_uart_entry (void);

/**
 * \brief 角度传感器查询模式例程入口
 */
void demo_stm32f103rbt6_core_sensor_as5600_entry (void);
