 ...
 *
 * \par 源代码
 * \snippet demo_hc32f19x_core_hw_i2c_slave_poll.c
 *          src_hc32f19x_core_hw_i2c_slave_poll
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f19x_core_hw_i2c_slave_poll
 * \copydoc demo_hc32f19x_core_hw_i2c_slave_poll.c
 */
...
{
    am_kprintf("demo hc32f19x_core hw i2c slave poll!\r\n");
