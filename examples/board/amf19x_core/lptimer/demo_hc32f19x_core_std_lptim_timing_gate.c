 ...
 *   2.在am_hwconf_hc32f19x_lptim.c文件中，__g_lptim1_timing_devinfo设备信息结构体选择
 ...
 *
 * \par 源代码
 * \snippet demo_hc32f19x_std_lptim_timing.c src_hc32f19x_std_lptim_timing
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f19x_std_lptim_timing
 * \copydoc demo_hc32f19x_std_lptim_timing.c
 */

/** [src_hc32f19x_std_lptim_timing] */
...
void demo_hc32f19x_core_std_lptim_timing_gate_entry (void)
{
    ...
    AM_DBG_INFO("demo amf19x_core std lptim timing gate!\r\n");
