 ...
 *
 * \par 源代码
 * \snippet demo_hc32f19x_hw_multichan_adc.c src_hc32f19x_hw_multichan_adc
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f19x_hw_multichan_adc
 * \copydoc demo_hc32f19x_hw_multichan_adc.c
 */

/** [src_hc32f19x_hw_multichan_adc] */
#include "ametal.h"
#include "am_vdebug.h"
#include "am_hc32.h"
#include "am_gpio.h"
...
void demo_hc32f19x_core_hw_multichan_adc_entry (void)
{
    ...
    AM_DBG_INFO("demo amf19x_core hw multichan adc int!\r\n");
