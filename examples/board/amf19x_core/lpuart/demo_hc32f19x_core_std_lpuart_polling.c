 ...
 *
 * \par 源代码
 * \snippet demo_hc32f19x_std_uart_polling.c src_hc32f19x_std_uart_polling
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f19x_std_uart_polling
 * \copydoc demo_hc32f19x_std_uart_polling.c
 */

/** [src_hc32f19x_std_uart_polling] */
#include "ametal.h"
#include "am_board.h"
...
{
    AM_DBG_INFO("demo amf19x_core std lpuart polling!\r\n");
