 ...
 *
 * \par 源代码
 * \snippet demo_hc32f19x_drv_lpmode_wake_up.c src_hc32f19x_drv_lpmode_wake_up
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f19x_drv_lpmode_wake_up
 * \copydoc demo_hc32f19x_drv_lpmode_wake_up.c
 */

/** [src_hc32f19x_drv_lpmode_wake_up] */
#include "ametal.h"
#include "am_board.h"
#include "am_led.h"
#include "am_delay.h"
