...
#include "am_appconf_double_hc32f19x.h"
#include "ametal.h"
#include "am_vdebug.h"
#include "am_led.h"
#include "am_delay.h"
...
{
    AM_DBG_INFO("application : amf19x_core double application start up successful!\r\n");
    am_mdelay(1);
    ...
    while(1) {
        ...
        am_led_toggle(0);
        am_mdelay(1000);
        AM_DBG_INFO("application : amf19x_core double application running!\r\n");
    }
}
