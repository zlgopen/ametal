 ...
 *
 * - 操作步骤（本地升级）：
 *   1. eclipse工程打开demo_amf19x_core_bootloader.ld文件，可根据具体的boot程序大小设置参数，如下：
 *          FLASH  (rx) : ORIGIN = 0x00000000, LENGTH = 0X6600  //长度最大为26.5K
 *
 *      keil工程打开demo_amf19x_core_bootloader.sct文件，根据提示修改boot程序大小，如下：
...
#include "am_bootconf_hc32f19x.h"
