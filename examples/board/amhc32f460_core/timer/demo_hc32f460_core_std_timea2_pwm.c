 ...
 *
 * - 实验现象：
 *   1. PIOA_0(TIMERA_CH1)输出 2KHz 的 PWM，占空比为 50%；
 *
 * \par 源代码
...
void demo_hc32f460_core_std_timea2_pwm_entry (void)
{
    ...
    AM_DBG_INFO("demo hc32f460_core std timea2 pwm!\r\n");

    demo_std_timer_pwm_entry(am_hc32f460_timea2_pwm_inst_init(), TIMERA_CH1);
}
/** [src_hc32f460_std_tim3_pwm] */
