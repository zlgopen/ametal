 ...
 *
 * - 实验现象：
 *   1. PIOE_11输出 2KHz 的 PWM，占空比为 50%；
 *   2. PIOE_10输出 2KHz 的 PWM，占空比为 50%；
 * \par 源代码
...
void demo_hc32f460_core_std_adtim62_pwm_entry (void)
{
    ...
    AM_DBG_INFO("demo hc32f460_core std adtim62 pwm!\r\n");

    demo_std_timer_pwm_entry(am_hc32f460_adtim62_pwm_inst_init(), 0);
}
/** [src_hc32f460_std_tim3_pwm] */
