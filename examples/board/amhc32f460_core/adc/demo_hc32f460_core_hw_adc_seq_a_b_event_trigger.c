...
{
    AM_DBG_INFO("demo amhc32f460_core hw adc seq b event trigger!\r\n");

    /* 配置模拟输入引脚 */
    am_gpio_pin_cfg(PIOA_0, GPIO_MODE(AMHW_HC32F460_GPIO_MODE_AIN));
    am_gpio_pin_cfg(PIOA_1, GPIO_MODE(AMHW_HC32F460_GPIO_MODE_AIN));
    ...
    demo_hc32f460_hw_adc_seq_a_b_event_trigger_entry(HC32F460_ADC1,
                                                     INT_VECTOR_16,
                                                     0,
                                                     1,
                                                     3300);
}
/** [src_hc32f460_hw_adc_seqa_b_event_trigger] */
