 ...
 *
 * \par 源代码
 * \snippet demo_hc32f460_std_key_input_event.c src_hc32f460_std_key_input_event
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f460_std_key_input_event
 * \copydoc demo_hc32f460_std_key_input_event.c
 */

/** [src_hc32f460_std_key_input_event] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo hc32f460_core std input event!\r\n");
