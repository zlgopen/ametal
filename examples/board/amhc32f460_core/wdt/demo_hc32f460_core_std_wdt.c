 ...
 *
 * \par 源代码
 * \snippet demo_hc32f460_std_wdt.c src_hc32f460_std_wdt
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f460_std_wdt
 * \copydoc demo_hc32f460_std_wdt.c
 */

/** [src_hc32f460_std_wdt] */
#include "ametal.h"
#include "am_vdebug.h"
 ...
 *        会产生看门狗事件。
 */
#define __WDT_FEED_TIME_MS     2000
...
{
    AM_DBG_INFO("demo hc32f460_core std wdt!\r\n");

    demo_std_wdt_entry(am_hc32f460_wdt_inst_init(),
                       __WDT_TIMEOUT_MS,
                       __WDT_FEED_TIME_MS);
}
/** [src_hc32f460_std_wdt] */
