 ...
 *
 * \par 源代码
 * \snippet demo_zsn700_core_lcd.c src_zsn700_core_lcd
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsn700_core_lcd
 * \copydoc demo_zsn700_core_lcd.c
 */
...
void demo_zsn700_core_hw_lcd_entry (void)
{
    ...
    demo_zsn700_hw_lcd_entry(ZSN700_LCD, lcd_data);
}
