 ...
 *
 * \par 源代码
 * \snippet demo_zsn700_core_aes_ency_decy.c src_zsn700_core_aes_ency_decy
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsn700_core_aes_ency_decy
 * \copydoc demo_zsn700_core_aes_ency_decy.c
 */

/** [src_zsn700_core_aes_ency_decy] */
#include "ametal.h"
#include "am_zsn700.h"
#include "am_gpio.h"
 ...
 * \brief 密钥长度
 */
#define AES_KEY_LEN    AM_ZSN700_AES_KEY_LEN_128_BIT
...
void demo_zsn700_core_hw_aes_ency_decy_entry (void)
{
    ...
    /* 例程入口 */
    demo_zsn700_hw_aes_ency_decy_entry(ZSN700_AES,
                                       AES_KEY_LEN,
                                       aes_data,
                                       aes_key);
}
