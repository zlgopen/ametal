 ...
 *
 * \步骤
 *   1.在am_hwconf_zsn700_lptim.c文件中，__g_lptim0_timing_devinfo设备信息结构体选择
 *             AMHW_ZSN700_LPTIM_FUNCTION_TIMER  ----------- 定时器模式
 *             AMHW_ZSN700_LPTIM_MODE_RELOAD     ----------- 自动重载模式
 *             AM_FALSE                          ----------- 门控关闭
 *             AM_TRUE                           ----------- TOG、TOGN输出使能打开
 *   2.在am_hwconf_zsn700_lptim.c文件中，__g_lptim1_timing_devinfo设备信息结构体选择
 *             AMHW_ZSN700_LPTIM_FUNCTION_COUNTER----------- 计数器模式
 *             AMHW_ZSN700_LPTIM_MODE_RELOAD     ----------- 自动重载模式
 *             AM_FALSE                          ----------- 门控关闭
 *             AM_TRUE                           ----------- TOG、TOGN输出使能打开
 ...
 *
 * \par 源代码
 * \snippet demo_zsn700_std_lptim_timing.c src_zsn700_std_lptim_timing
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsn700_std_lptim_timing
 * \copydoc demo_zsn700_std_lptim_timing.c
 */

/** [src_zsn700_std_lptim_timing] */
