 ...
 *
 * \par 源代码
 * \snippet demo_zsn700_std_tim4_cap.c src_zsn700_std_tim4_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsn700_std_tim4_cap
 * \copydoc demo_zsn700_std_tim4_cap.c
 */

/** [src_zsn700_std_tim4_cap] */
#include "ametal.h"
#include "am_vdebug.h"
...
void demo_zsn700_core_std_tim4_cap_entry (void)
{
    ...
    am_cap_handle_t tim4_cap_handle = am_zsn700_tim4_cap_inst_init();
    
    AM_DBG_INFO("demo am700_core std tim4 cap!\r\n");
