 ...
 *
 * \par 源代码
 * \snippet demo_zsn700_hw_tim_port_brake.c src_zsn700_hw_tim_port_brake
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsn700_hw_tim_port_brake
 * \copydoc demo_zsn700_hw_tim_port_brake.c
 */

/** [src_zsn700_hw_tim_port_brake] */
#include "ametal.h"
#include "am_clk.h"
#include "am_gpio.h"
#include "am_vdebug.h"
...
void demo_zsn700_core_hw_tim_port_brake_entry (void)
{
    ...
    AM_DBG_INFO("demo am700_core hw adtim port brake!\r\n");
    ...
    demo_zsn700_hw_tim_port_brake_entry(ZSN700_TIM1,
                                        AMHW_ZSN700_TIM_TYPE_TIM1,
                                        ZSN700_TIM_CH0A,
                                        INUM_TIM1,
                                        500000 / 4,
                                        500000);
