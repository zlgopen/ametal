 ...
 *     定其他时间值，则需要更改demo_zsn700_hw_adtim_trig_adc_sqr.c中定时器分频系数的设定。
...
{
    /* 16个顺序通道ADC采集 */
    int adc_chan[] = {AMHW_ZSN700_CHAN_AIN0_PA0,
                      ...
                      AMHW_ZSN700_CHAN_AIN11_PC1,
                      AMHW_ZSN700_CHAN_AIN12_PC2,
                      AMHW_ZSN700_CHAN_AIN13_PC3,
                      AMHW_ZSN700_CHAN_AIN14_PC4,
                      AMHW_ZSN700_CHAN_AIN15_PC5};
    
    AM_DBG_INFO("demo am700_core hw adtim trig adc sqr!\r\n");
    ...
    demo_zsn700_hw_adtim_trig_adc_sqr_entry(ZSN700_TIM4,     //高级定时器4
