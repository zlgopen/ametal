 ...
 *
 * \par 源代码
 * \snippet demo_zsn700_std_tim0_cap.c src_zsn700_std_tim0_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsn700_std_tim0_cap
 * \copydoc demo_zsn700_std_tim0_cap.c
 */

/** [src_zsn700_std_tim0_cap] */
#include "ametal.h"
#include "am_vdebug.h"
...
void demo_zsn700_core_std_tim3_cap_entry (void)
{
    ...
    am_pwm_handle_t tim0_pwm_handle = am_zsn700_tim0_pwm_inst_init();
    am_cap_handle_t tim3_cap_handle = am_zsn700_tim3_cap_inst_init();
    
	  AM_DBG_INFO("demo am700_core std tim1 cap!\r\n");
