 ...
 *
 * \par 源代码
 * \snippet demo_zsn700_std_tim6_cap.c src_zsn700_std_tim6_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsn700_std_tim6_cap
 * \copydoc demo_zsn700_std_tim6_cap.c
 */

/** [src_zsn700_std_tim6_cap] */
#include "ametal.h"
#include "am_vdebug.h"
...
void demo_zsn700_core_std_tim6_cap_entry (void)
{
    ...
    am_cap_handle_t tim6_cap_handle = am_zsn700_tim6_cap_inst_init();
    
	  AM_DBG_INFO("demo am700_core std tim6 cap!\r\n");
