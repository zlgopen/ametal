 ...
 *
 * \par 源代码
 * \snippet demo_zsn700_core_opa_dac.c src_zsn700_core_opa_dac
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsn700_core_opa_dac
 * \copydoc demo_zsn700_core_opa_dac.c
 */

/** [src_zsn700_core_opa_dac] */
#include "ametal.h"
#include "am_zsn700.h"
#include "am_gpio.h"
...
#define OPA_MODE    AM_ZSN700_OPA_DAC    /**< \brief OPA DAC电压跟随模式*/
...
void demo_zsn700_core_hw_opa_dac_entry (void)
{
    ...
    demo_zsn700_hw_opa_dac_entry(ZSN700_OPA,
                                 ZSN700_DAC,
                                 OPA_MODE,
                                 vol_val);
}
