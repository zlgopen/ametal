 ...
 *
 * \par 源代码
 * \snippet demo_hc32l13x_hw_tim_timing.c src_hc32l13x_hw_tim_timing
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l13x_hw_tim_timing
 * \copydoc demo_hc32l13x_hw_tim_timing.c
 */

/** [src_hc32l13x_hw_tim_timing] */
#include "ametal.h"
#include "am_vdebug.h"
...
void demo_hc32l13x_core_hw_tim_timing_entry (void)
{
    ...
    demo_hc32l13x_hw_tim_timing_entry(HC32_TIM0,
