 ...
 *
 * \par 源代码
 * \snippet demo_hc32l13x_std_tim6_cap.c src_hc32l13x_std_tim6_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l13x_std_tim6_cap
 * \copydoc demo_hc32l13x_std_tim6_cap.c
 */

/** [src_hc32l13x_std_tim6_cap] */
#include "ametal.h"
#include "am_vdebug.h"
...
void demo_hc32l13x_core_std_tim6_cap_entry (void)
{
    ...
    am_cap_handle_t tim6_cap_handle = am_hc32l13x_tim6_cap_inst_init();
