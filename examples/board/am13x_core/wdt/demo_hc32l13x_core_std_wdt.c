 ...
 *
 * \par 源代码
 * \snippet demo_zlg118_std_wdt.c src_zlg118_std_wdt
 *
 * \internal
...
/**
 * \addtogroup demo_if_zlg118_std_wdt
 * \copydoc demo_zlg118_std_wdt.c
 */
 ...
 * \brief 看门狗超时时间
 */
#define __WDT_TIMEOUT_MS       ZLG118_WDT_51MS     /* 最大52.4s */
...
void demo_zlg118_core_std_wdt_entry (void)
{
    ...
    demo_std_wdt_entry(am_zlg118_wdt_inst_init(),
                       __WDT_TIMEOUT_MS,
                       __WDT_FEED_TIME_MS);
}
/** [src_zlg118_std_wdt] */
