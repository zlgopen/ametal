 ...
 *
 * \par 源代码
 * \snippet demo_hc32l13x_hw_wdt.c src_hc32l13x_hw_wdt
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l13x_hw_wdt
 * \copydoc demo_hc32l13x_hw_wdt.c
 */
...
void demo_hc32l13x_core_hw_wdt_entry (void)
{
    ...
    am_hc32l13x_clk_reset(CLK_WDT);

    demo_hc32l13x_hw_wdt_entry(HC32_WDT,
                             __WDT_TIMEOUT_MS,
                             __WDT_FEED_TIME_MS);
}
/** [src_hc32l13x_hw_wdt] */
