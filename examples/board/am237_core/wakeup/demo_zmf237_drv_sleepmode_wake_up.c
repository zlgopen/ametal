 ...
 *
 * \par 源代码
 * \snippet demo_zmf237_drv_sleepmode_wake_up.c src_zmf237_drv_sleepmode_wake_up
 *
 * \internal
...
/**
 * \addtogroup demo_if_zmf237_drv_sleepmode_wake_up
 * \copydoc demo_zmf237_drv_sleepmode_wake_up.c
 */

/** [src_zmf237_drv_sleepmode_wake_up] */
#include "ametal.h"
#include "am_board.h"
#include "am_led.h"
#include "am_delay.h"
 ...
 * \brief 例程入口
 */
void demo_zmf237_drv_sleepmode_wake_up_entry (void)
{
    uint32_t i = 0;
    ...
    /* 唤醒配置 */
    am_zmf237_wake_up_cfg(AM_ZMF237_PWR_MODE_SLEEP, gpio_isr, (void *)0);
