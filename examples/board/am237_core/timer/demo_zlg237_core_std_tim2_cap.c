 ...
 *
 * \par 源代码
 * \snippet demo_zlg237_std_tim2_cap.c src_zlg237_std_tim2_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_zlg237_std_tim2_cap
 * \copydoc demo_zlg237_std_tim2_cap.c
 */
...
void demo_zlg237_core_std_tim2_cap_entry (void)
{
    ...
    AM_DBG_INFO("demo am237_core std tim2 cap!\r\n");
