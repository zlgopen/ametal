 ...
 *
 * \par 源代码
 * \snippet demo_zlg237_std_crc.c src_zlg237_std_crc
 *
 * \internal
...
/**
 * \addtogroup demo_if_zlg237_std_crc
 * \copydoc demo_zlg237_std_crc.c
 */
...
{
    AM_DBG_INFO("demo am237_core std crc!\r\n");

    am_crc_handle_t crc_handle;

    crc_handle = am_zlg237_crc_inst_init();
