 ...
 *
 * \par 源代码
 * \snippet demo_zmf237_hw_spi_master.c src_zmf237_hw_spi_master
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_if_zmf237_hw_spi_master
 * \copydoc demo_zmf237_hw_spi_master.c
 */

/** [src_zmf237_hw_spi_master] */
#include "ametal.h"
#include "am_zmf237.h"
 ...
 * \brief 例程入口
 */
void demo_zmf237_core_hw_spi_master_entry (void)
{
    ...
    demo_zlg_hw_spi_master_entry(ZMF237_SPI1,
                                 PIOA_4,
