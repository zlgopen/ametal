 ...
 *
 * \par 源代码
 * \snippet demo_zmf237_std_buzzer.c src_std_buzzer
 *
 * \internal
...
/**
 * \addtogroup demo_if_zmf237_std_buzzer
 * \copydoc demo_zmf237_std_buzzer.c
 */
 ...
 * \brief 例程入口
 */
void demo_zmf237_core_std_buzzer_entry (void)
{
