 ...
 *
 * \par 源代码
 * \snippet demo_zmf237_std_i2c_master_sync.c src_zmf237_std_i2c_master_sync
 *
 * \internal
...
/**
 * \addtogroup demo_if_zmf237_std_i2c_master_sync
 * \copydoc demo_zmf237_std_i2c_master_sync.c
 */

/** [src_zmf237_std_i2c_master_sync] */
#include "ametal.h"
#include "am_board.h"
#include "am_vdebug.h"
#include "am_i2c.h"
 ...
 * \brief 例程入口
 */
void demo_zmf237_core_std_i2c_master_sync_entry (void)
{
    AM_DBG_INFO("demo am237_core std i2c master sync!\r\n");

    demo_std_i2c_master_sync_entry(am_zmf237_i2c1_inst_init(),
                                   EEPROM_ADDR,
                                   TEST_LEN);
}
/** [src_zmf237_std_i2c_master_sync] */
