 ...
 *
 * \par 源代码
 * \snippet demo_zmf237_hw_i2c_slave_poll.c src_zmf237_hw_i2c_slave_poll
 *
 * \internal
...
/**
 * \addtogroup demo_if_zmf237_hw_i2c_slave_poll
 * \copydoc demo_zmf237_hw_i2c_slave_poll.c
 */

/** [src_zmf237_hw_i2c_slave_poll] */
#include "ametal.h"
#include "am_vdebug.h"
#include "am_board.h"
#include "am_gpio.h"
 ...
 * \brief 例程入口
 */
void demo_zmf237_core_hw_i2c_slave_poll_entry (void)
{
    ...
    demo_zlg_hw_i2c_slave_poll_entry(ZMF237_I2C1);
}
/** [src_zmf237_hw_i2c_slave_poll] */
