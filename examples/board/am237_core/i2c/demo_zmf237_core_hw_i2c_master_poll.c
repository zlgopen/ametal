 ...
 *
 * \par 源代码
 * \snippet demo_zmf237_hw_i2c_master_poll.c src_zmf237_hw_i2c_master_poll
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_if_zmf237_hw_i2c_master_poll
 * \copydoc demo_zmf237_hw_i2c_master_poll.c
 */

/** [src_zmf237_hw_i2c_master_poll] */
#include "ametal.h"
#include "am_vdebug.h"
#include "am_gpio.h"
#include "am_clk.h"
...
#define I2C_MASTER    (amhw_zlg_i2c_t *)ZMF237_I2C1_BASE   /**< \brief I2C主机控制器通道号定义 */

/**
 * \brief 例程入口
 */
void demo_zmf237_core_hw_i2c_master_poll_entry (void)
{
