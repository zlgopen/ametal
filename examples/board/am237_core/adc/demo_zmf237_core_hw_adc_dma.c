 ...
 *
 * \par 源代码
 * \snippet demo_zmf237_hw_adc_dma.c src_zmf237_hw_adc_dma
 *
 * \internal
...
/**
 * \addtogroup demo_if_zmf237_hw_adc_dma
 * \copydoc demo_zmf237_hw_adc_dma.c
 */

/** [src_zmf237_hw_adc_dma] */
#include "ametal.h"
#include "am_vdebug.h"
#include "am_zmf237.h"
#include "am_gpio.h"
 ...
 * \brief 例程入口
 */
void demo_zmf237_core_hw_adc_dma_entry (void)
{
    ...
    demo_zlg_hw_adc_dma_entry(ZMF237_ADC1,
                              adc_chan,
