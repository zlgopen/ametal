 ...
 *
 * \par 源代码
 * \snippet demo_zmf237_hw_adc_int.c src_zmf237_hw_adc_int
 *
 * \internal
...
/**
 * \addtogroup demo_if_zmf237_hw_adc_int
 * \copydoc demo_zmf237_hw_adc_int.c
 */

/** [src_zmf237_hw_adc_int] */
#include "ametal.h"
#include "am_vdebug.h"
#include "am_zmf237.h"
#include "am_gpio.h"
 ...
 * \brief 例程入口
 */
void demo_zmf237_core_hw_adc_int_entry (void)
{
    ...
    demo_zlg_hw_adc_int_entry(ZMF237_ADC1,
                              INUM_ADC1_2,
