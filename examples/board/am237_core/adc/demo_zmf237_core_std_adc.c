 ...
 *
 * \par 源代码
 * \snippet demo_zmf237_std_adc.c src_std_adc
 *
 * \internal
...
/**
 * \addtogroup demo_if_zmf237_std_adc
 * \copydoc demo_zmf237_std_adc.c
 */
 ...
 * \brief 例程入口
 */
void demo_zmf237_core_std_adc_entry (void)
{
    AM_DBG_INFO("demo am237_core std adc int!\r\n");

    demo_std_adc_entry(am_zmf237_adc1_inst_init(), 4);
