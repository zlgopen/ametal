 ...
 *      的配置, 屏蔽其他flash配置。
 *
 *      keil工程打开demo_am237_core_bootloader.sct文件，打开双区的配置，屏蔽其他配置
 *
...
void demo_zlg237_core_double_bootloader_uart_entry (void)
{
    ...
    /* bootloader 标准接口初始化  */
    am_zlg237_boot_double_inst_init();

    firmware_handle = am_zlg237_boot_double_firmware_flash_inst_init();
    ...
    demo_std_double_bootloader_entry(
        ...
        am_zlg237_boot_msg_flag_inst_init());
}
