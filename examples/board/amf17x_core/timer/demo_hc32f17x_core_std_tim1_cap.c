 ...
 *
 * \par 源代码
 * \snippet demo_hc32f17x_std_tim1_cap.c src_hc32f17x_std_tim1_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f17x_std_tim1_cap
 * \copydoc demo_hc32f17x_std_tim1_cap.c
 */

/** [src_hc32f17x_std_tim1_cap] */
#include "ametal.h"
#include "am_vdebug.h"
...
void demo_hc32f17x_core_std_tim1_cap_entry (void)
{
    ...
    am_cap_handle_t tim1_cap_handle = am_hc32_tim1_cap_inst_init();
	  ...
	  AM_DBG_INFO("demo amf17x_core std tim1 cap!\r\n");
