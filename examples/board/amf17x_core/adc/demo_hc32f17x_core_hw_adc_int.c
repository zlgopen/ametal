 ...
 *
 * \par 源代码
 * \snippet demo_hc32f17x_hw_adc_int.c src_hc32f17x_hw_adc_int
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f17x_hw_adc_int
 * \copydoc demo_hc32f17x_hw_adc_int.c
 */

/** [src_hc32f17x_hw_adc_int] */
#include "ametal.h"
#include "am_vdebug.h"
#include "am_hc32.h"
#include "am_gpio.h"
...
{
    AM_DBG_INFO("demo amf17x_core hw adc int!\r\n");
