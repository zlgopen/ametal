 ...
 *
 * \par 源代码
 * \snippet demo_hc32f17x_std_i2c_master_async.c src_hc32f17x_std_i2c_master_async
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f17x_std_i2c_master_async
 * \copydoc demo_hc32f17x_std_i2c_master_async.c
 */

/** [src_hc32f17x_std_i2c_master_async] */
#include "ametal.h"
#include "am_board.h"
#include "am_vdebug.h"
#include "am_i2c.h"
...
void demo_hc32f17x_core_std_i2c_master_async_entry (void)
{
    ...
    AM_DBG_INFO("demo amf17x_core std i2c master async!\r\n");
