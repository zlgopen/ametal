 ...
 *
 * \par 源代码
 * \snippet demo_hc32f17x_std_crc.c src_hc32f17x_std_crc
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f17x_std_crc
 * \copydoc demo_hc32f17x_std_crc.c
 */

/** [src_hc32f17x_std_crc] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo amf17x_core std crc!\r\n");
