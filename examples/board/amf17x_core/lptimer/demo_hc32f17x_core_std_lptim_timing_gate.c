 ...
 *
 * \步骤
 *   1.在am_hwconf_hc32f17x_lptim.c文件中，__g_lptim0_timing_devinfo设备信息结构体选择
 *             AMHW_HC32_LPTIM_FUNCTION_TIMER  ----------- 定时器模式
 *             AMHW_HC32_LPTIM_MODE_RELOAD     ----------- 自动重载模式
 *             AM_FALSE                          ----------- 门控关闭
 *             AM_TRUE                           ----------- TOG、TOGN输出使能打开
 *   2.在am_hwconf_hc32f17x_lptim.c文件中，__g_lptim1_timing_devinfo设备信息结构体选择
 ...
 *
 * \par 源代码
 * \snippet demo_hc32f17x_std_lptim_timing.c src_hc32f17x_std_lptim_timing
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f17x_std_lptim_timing
 * \copydoc demo_hc32f17x_std_lptim_timing.c
 */

/** [src_hc32f17x_std_lptim_timing] */
...
void demo_hc32f17x_core_std_lptim_timing_gate_entry (void)
{
    ...
    AM_DBG_INFO("demo amf17x_core std lptim timing gate!\r\n");
