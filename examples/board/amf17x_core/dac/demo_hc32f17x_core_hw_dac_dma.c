 ...
 *
 * \par 源代码
 * \snippet demo_hc32f17x_hw_dac_dma.c src_hc32f17x_hw_dac_dma
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f17x_hw_dac_dma
 * \copydoc demo_hc32f17x_hw_dac_dma.c
 */

/** [src_hc32f17x_hw_dac_dma] */
#include "ametal.h"
#include "am_hc32.h"
 ...
 * \brief 例程入口
 */
void demo_hc32f17x_core_hw_dac_dma_entry (void)
{
    AM_DBG_INFO("demo amf17x_core hw dac dma test!\r\n");
