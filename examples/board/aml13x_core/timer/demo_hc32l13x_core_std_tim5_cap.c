 ...
 *
 * \par 源代码
 * \snippet demo_hc32l13x_std_tim5_cap.c src_hc32l13x_std_tim5_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l13x_std_tim5_cap
 * \copydoc demo_hc32l13x_std_tim5_cap.c
 */

/** [src_hc32l13x_std_tim5_cap] */
#include "ametal.h"
#include "am_vdebug.h"
...
void demo_hc32l13x_core_std_tim5_cap_entry (void)
{
    ...
    am_cap_handle_t tim5_cap_handle = am_hc32_tim5_cap_inst_init();
	  ...
	  AM_DBG_INFO("demo aml13x_core std tim5 cap!\r\n");
