 ...
 *     定其他时间值，则需要更改demo_hc32l13x_hw_adtim_trig_adc_sqr.c中定时器分频系数的设定。
 *   4.不同情况下，ADC的转换速度有限，需要考虑定时器的周期时间是否大于ADC转换时间（多个通道则需要累加转换时间）
 *
 * \par 源代码
 * \snippet demo_hc32l13x_hw_adtim_trig_adc_sqr.c src_hc32l13x_hw_adtim_trig_adc_sqr
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l13x_hw_adtim_trig_adc_sqr
 * \copydoc demo_hc32l13x_hw_adtim_trig_adc_sqr.c
 */

/** [src_hc32l13x_hw_adtim_trig_adc_sqr] */
#include "ametal.h"
#include "am_gpio.h"
#include "am_vdebug.h"
#include "am_hc32.h"
...
void demo_hc32l13x_core_hw_adtim_trig_adc_sqr_entry (void)
{
    ...
    AM_DBG_INFO("demo aml13x_core hw adtim trig adc sqr!\r\n");
