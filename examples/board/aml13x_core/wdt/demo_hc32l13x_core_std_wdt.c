 ...
 *
 * \par 源代码
 * \snippet demo_hc32l13x_std_wdt.c src_hc32l13x_std_wdt
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l13x_std_wdt
 * \copydoc demo_hc32l13x_std_wdt.c
 */
...
{
    AM_DBG_INFO("demo aml13x_core std wdt!\r\n");
