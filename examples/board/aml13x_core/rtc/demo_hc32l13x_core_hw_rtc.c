 ...
 *
 * \par 源代码
 * \snippet demo_hc32l13x_hw_rtc.c src_hc32l13x_hw_rtc
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_if_hc32l13x_hw_rtc
 * \copydoc demo_hc32l13x_hw_rtc.c
 */
 ...
 * \brief 例程入口
 */
void demo_hc32l13x_core_hw_rtc_entry (void)
{
    AM_DBG_INFO("demo aml13x_core hw rtc!\r\n");
