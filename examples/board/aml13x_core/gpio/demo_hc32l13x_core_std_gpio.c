 ...
 *
 * \par 源代码
 * \snippet demo_hc32l13x_std_gpio.c src_hc32l13x_std_gpio
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l13x_std_gpio
 * \copydoc demo_hc32l13x_std_gpio.c
 */
...
{
    AM_DBG_INFO("demo aml13x_core std gpio!\r\n");
