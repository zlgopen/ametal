 ...
 *
 *      除上面工程链接文件之外，需要更改/user_config/../am_appconf_double_hc32l19x.c文件内的信息结构体设置
 *
 *      默认flash分配情况如下：
 *      区域划分:    |------------|-------|-----------------|-------------------|
...
#include "am_appconf_double_hc32l19x.h"
#include "ametal.h"
#include "am_vdebug.h"
#include "am_led.h"
#include "am_delay.h"
...
{
    AM_DBG_INFO("application : aml19x_core double application start up successful!\r\n");
    am_mdelay(1);
    ...
    while(1) {
        ...
        am_led_toggle(0);
        am_mdelay(1000);
        AM_DBG_INFO("application : aml19x_core double application running!\r\n");
    }
}
