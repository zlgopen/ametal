 ...
 *
 * \par 源代码
 * \snippet demo_hc32l19x_hw_uart_int.c src_hc32l19x_hw_uart_int
 *
 * \internal
 ...
 */
 ...
 /**
 * \addtogroup demo_if_hc32l19x_hw_uart_int
 * \copydoc demo_hc32l19x_hw_uart_int.c
 */

/** [src_hc32l19x_hw_uart_int] */
#include "ametal.h"
#include "am_hc32.h"
#include "am_board.h"
#include "am_gpio.h"
...
static void __hc32l19x_uart_pins_intit (void)
{
    /* 初始化引脚 */
...
{
    AM_DBG_INFO("demo aml19x_core hw uart int!\r\n");
