 ...
 *
 * \par 源代码
 * \snippet demo_hc32l19x_std_buzzer.c src_std_buzzer
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l19x_std_buzzer
 * \copydoc demo_hc32l19x_std_buzzer.c
 */
...
{
    AM_DBG_INFO("demo aml19x_core std buzzer!\r\n");
