 ...
 *
 * \par 源代码
 * \snippet demo_hc32l19x_hw_adtim_port_sw_brake.c src_hc32l19x_hw_adtim_port_sw_brake
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l19x_hw_adtim_port_sw_brake
 * \copydoc demo_hc32l19x_hw_adtim_port_sw_brake.c
 */

/** [src_hc32l19x_hw_adtim_port_sw_brake] */
#include "ametal.h"
#include "am_gpio.h"
#include "am_vdebug.h"
#include "am_hc32.h"
...
void demo_hc32l19x_core_hw_adtim_port_sw_brake_entry (void)
{
    ...
    AM_DBG_INFO("demo aml19x_core hw adtim port_sw_brake!\r\n");
