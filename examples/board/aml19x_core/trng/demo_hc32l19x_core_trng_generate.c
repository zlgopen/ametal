 ...
 *
 * \par 源代码
 * \snippet demo_hc32l19x_core_trng_dac.c src_hc32l19x_core_trng_generate
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l19x_core_trng_generate
 * \copydoc demo_hc32l19x_core_trng_generate.c
 */

/** [src_hc32l19x_core_trng_generate] */
#include "ametal.h"
#include "am_hc32.h"
#include "am_gpio.h"
#include "hc32_pin.h"
...
void demo_hc32l19x_core_hw_trng_generate_entry (void)
{
    ...
    AM_DBG_INFO("demo aml19x_core hw trng generate test!\r\n");
