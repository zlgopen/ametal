 ...
 *
 * \par 源代码
 * \snippet demo_hc32l19x_core_lvd_int.c src_hc32l19x_core_lvd_int
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l19x_core_lvd_int
 * \copydoc demo_hc32l19x_core_lvd_int.c
 */

/** [src_hc32l19x_hw_lvd_int] */
#include "ametal.h"
#include "am_hc32.h"
#include "am_gpio.h"
#include "hc32_pin.h"
 ...
 * \brief 用户回调函数
 */
static void __hc32l19x_lvd_callback (void *data)
{
...
void demo_hc32l19x_core_hw_lvd_int_entry (void)
{
    ...
    demo_hc32_hw_lvd_int_entry((void *)HC32_LVD, __hc32l19x_lvd_callback);
}
