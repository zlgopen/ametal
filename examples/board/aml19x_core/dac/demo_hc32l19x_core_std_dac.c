 ...
 *
 * \par 源代码
 * \snippet demo_hc32l19x_std_dac.c src_hc32l19x_std_dac
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l19x_std_dac
 * \copydoc demo_hc32l19x_std_dac.c
 */
...
void demo_hc32l19x_core_std_dac_entry (void)
{
    ...
    AM_DBG_INFO("demo aml19x_core std dac convert test!\r\n");
