 ...
 *
 * \par 源代码
 * \snippet demo_hc32l19x_std_gpio_trigger.c src_hc32l19x_std_gpio_trigger
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l19x_std_gpio_trigger
 * \copydoc demo_hc32l19x_std_gpio_trigger.c
 */

/** [src_hc32l19x_std_gpio_trigger] */
#include "ametal.h"
#include "am_board.h"
#include "am_vdebug.h"
#include "am_delay.h"
...
{
    AM_DBG_INFO("demo aml19x_core std gpio trigger!\r\n");
