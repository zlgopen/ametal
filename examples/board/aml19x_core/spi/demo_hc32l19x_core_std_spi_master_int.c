 ...
 *
 * \par 源代码
 * \snippet demo_hc32l19x_std_spi_master_int.c src_hc32l19x_std_spi_master_int
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_if_hc32l19x_std_spi_master_int
 * \copydoc demo_hc32l19x_std_spi_master_int.c
 */

/** [src_hc32l19x_std_spi_master_int] */
#include "ametal.h"
#include "hc32_pin.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo aml19x_core std spi master int!\r\n");
