 ...
 *
 * \par 源代码
 * \snippet demo_hc32l19x_core_opa_one.c src_hc32l19x_core_opa_one
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l19x_core_opa_one
 * \copydoc demo_hc32l19x_core_opa_one.c
 */

/** [src_hc32l19x_core_opa_one] */
#include "ametal.h"
#include "am_hc32.h"
#include "am_gpio.h"
#include "hc32_pin.h"
...
void demo_hc32l19x_core_hw_opa_one_entry (void)
{
    ...
    AM_DBG_INFO("demo aml19x_core hw opa one test!\r\n");
