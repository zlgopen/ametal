 ...
 *
 * \par 源代码
 * \snippet demo_hc32l19x_hw_lpuart_int.c src_hc32l19x_hw_lpuart_int
 *
 * \internal
 ...
 */
 ...
 /**
 * \addtogroup demo_if_hc32l19x_hw_lpuart_int
 * \copydoc demo_hc32l19x_hw_lpuart_int.c
 */
...
static void __hc32l19x_lpuart_pins_intit (void)
{
    /* 初始化引脚 */
...
{
    AM_DBG_INFO("demo aml19x_core hw lpuart int!\r\n");
