 ...
 *
 * \par 源代码
 * \snippet demo_hc32l19x_std_uart_ringbuf.c src_hc32l19x_std_uart_ringbuf
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32l19x_std_uart_ringbuf
 * \copydoc demo_hc32l19x_std_uart_ringbuf.c
 */
...
{
    AM_DBG_INFO("demo aml19x_core std lpuart ringbuf!\r\n");
