 ...
 *
 * - 操作步骤（本地升级）：
 *   1. eclipse工程打开demo_am116_core_bootloader.ld文件，可根据具体的boot程序大小设置参数，如下：
...
void demo_am116_core_single_bootloader_uart_entry (void)
{
    ...
    /* bootloader 标准接口初始化  */
    am_zlg116_boot_single_inst_init();

    firmware_handle = am_zlg116_boot_single_firmware_flash_inst_init();
