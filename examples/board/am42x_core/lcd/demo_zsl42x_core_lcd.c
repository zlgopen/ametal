 ...
 *
 * \par 源代码
 * \snippet demo_zsl42x_core_lcd.c src_zsl42x_core_lcd
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsl42x_core_lcd
 * \copydoc demo_zsl42x_core_lcd.c
 */
...
void demo_zsl42x_core_hw_lcd_entry (void)
{
    ...
    demo_zsl42x_hw_lcd_entry(ZSL42x_LCD, lcd_data);
}
