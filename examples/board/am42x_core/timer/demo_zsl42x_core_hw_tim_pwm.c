 ...
 *
 * \par 源代码
 * \snippet demo_zsl42x_hw_tim_pwm.c src_zsl42x_hw_tim_pwm
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsl42x_hw_tim_pwm
 * \copydoc demo_zsl42x_hw_tim_pwm.c
 */

/** [src_zsl42x_hw_tim_pwm] */
#include "ametal.h"
#include "am_vdebug.h"
#include "am_zsl42x.h"
...
void demo_zsl42x_core_hw_tim_pwm_entry (void)
{
    ...
    demo_zsl42x_hw_tim_pwm_entry((void *)ZSL42x_TIM0,
