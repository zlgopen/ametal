 ...
 *
 * \par 源代码
 * \snippet demo_zsl42x_hw_tim_port_brake.c src_zsl42x_hw_tim_port_brake
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsl42x_hw_tim_port_brake
 * \copydoc demo_zsl42x_hw_tim_port_brake.c
 */

/** [src_zsl42x_hw_tim_port_brake] */
#include "ametal.h"
#include "am_clk.h"
#include "am_gpio.h"
#include "am_vdebug.h"
...
void demo_zsl42x_core_hw_tim_port_brake_entry (void)
{
    ...
    AM_DBG_INFO("demo am42x_core hw adtim port brake!\r\n");
    ...
    demo_zsl42x_hw_tim_port_brake_entry(ZSL42x_TIM1,
                                        AMHW_ZSL42x_TIM_TYPE_TIM1,
                                        ZSL42x_TIM_CH0A,
                                        INUM_TIM1,
                                        500000 / 4,
                                        500000);
