 ...
 *     定其他时间值，则需要更改demo_zsl42x_hw_adtim_trig_adc_sqr.c中定时器分频系数的设定。
...
{
    /* 13个顺序通道ADC采集 */
    int adc_chan[] = {AMHW_ZSL42x_CHAN_AIN0_PA0,
    ...
    AM_DBG_INFO("demo am42x_core hw adtim trig adc sqr!\r\n");
    ...
    demo_zsl42x_hw_adtim_trig_adc_sqr_entry(ZSL42x_TIM4,     //高级定时器4
