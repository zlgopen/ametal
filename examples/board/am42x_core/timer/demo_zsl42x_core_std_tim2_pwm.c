 ...
 *
 * \par 源代码
 * \snippet demo_zsl42x_std_tim2_pwm.c src_zsl42x_std_tim2_pwm
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsl42x_std_tim2_pwm
 * \copydoc demo_zsl42x_std_tim2_pwm.c
 */

/** [src_zsl42x_std_tim2_pwm] */
...
void demo_zsl42x_core_std_tim2_pwm_entry (void)
{
    ...
    AM_DBG_INFO("demo am42x_core std tim2 pwm!\r\n");

    demo_std_timer_pwm_entry(am_zsl42x_tim2_pwm_inst_init(), AM_ZSL42x_TIM_PWM_CH0A);
}
/** [src_zsl42x_std_tim2_pwm] */
