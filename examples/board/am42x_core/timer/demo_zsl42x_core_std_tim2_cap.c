 ...
 *   2. TIM2 捕获输入通道 1 使用 PIOA_3 引脚捕获；
 ...
 *
 * \par 源代码
 * \snippet demo_zsl42x_std_tim0_cap.c src_zsl42x_std_tim0_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsl42x_std_tim0_cap
 * \copydoc demo_zsl42x_std_tim0_cap.c
 */

/** [src_zsl42x_std_tim0_cap] */
#include "ametal.h"
#include "am_vdebug.h"
...
void demo_zsl42x_core_std_tim2_cap_entry (void)
{
    ...
    am_cap_handle_t tim2_cap_handle = am_zsl42x_tim2_cap_inst_init();
