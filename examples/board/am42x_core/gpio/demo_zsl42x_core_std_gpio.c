 ...
 *
 * \par 源代码
 * \snippet demo_zsl42x_std_gpio.c src_zsl42x_std_gpio
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsl42x_std_gpio
 * \copydoc demo_zsl42x_std_gpio.c
 */
...
{
    AM_DBG_INFO("demo am42x_core std gpio!\r\n");
