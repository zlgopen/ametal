 ...
 *
 * \par 源代码
 * \snippet demo_zsl42x_std_crc.c src_zsl42x_std_crc
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsl42x_std_crc
 * \copydoc demo_zsl42x_std_crc.c
 */
...
{
    AM_DBG_INFO("demo am42x_core std crc!\r\n");

    am_crc_handle_t crc_handle;

    crc_handle = am_zsl42x_crc_inst_init();
