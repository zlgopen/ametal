 ...
 *
 * \par 源代码
 * \snippet demo_zsl42x_core_opa_dac.c src_zsl42x_core_opa_dac
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsl42x_core_opa_dac
 * \copydoc demo_zsl42x_core_opa_dac.c
 */

/** [src_zsl42x_core_opa_dac] */
#include "ametal.h"
#include "am_zsl42x.h"
#include "am_gpio.h"
...
#define OPA_MODE    AM_ZSL42x_OPA_DAC    /**< \brief OPA DAC电压跟随模式*/
...
void demo_zsl42x_core_hw_opa_dac_entry (void)
{
    ...
    AM_DBG_INFO("demo am42x_core hw opa dac test!\r\n");
    ...
    demo_zsl42x_hw_opa_dac_entry(ZSL42x_OPA,
                                 ZSL42x_DAC,
                                 OPA_MODE,
                                 vol_val,
                                 128);
