 ...
 *
 * \par 源代码
 * \snippet demo_zsl42x_core_aes_ency_decy.c src_zsl42x_core_aes_ency_decy
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsl42x_core_aes_ency_decy
 * \copydoc demo_zsl42x_core_aes_ency_decy.c
 */

/** [src_zsl42x_core_aes_ency_decy] */
#include "ametal.h"
#include "am_zsl42x.h"
#include "am_gpio.h"
 ...
 * \brief 密钥长度
 */
#define AES_KEY_LEN    AM_ZSL42x_AES_KEY_LEN_128_BIT
...
void demo_zsl42x_core_hw_aes_ency_decy_entry (void)
{
    ...
    /* 例程入口 */
    demo_zsl42x_hw_aes_ency_decy_entry(ZSL42x_AES,
                                       AES_KEY_LEN,
                                       aes_data,
                                       aes_key);
}
