 ...
 *
 * \par 源代码
 * \snippet demo_hc32f07x_core_opa_dac.c src_hc32f07x_core_opa_dac
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f07x_core_opa_dac
 * \copydoc demo_hc32f07x_core_opa_dac.c
 */

/** [src_hc32f07x_core_opa_dac] */
#include "ametal.h"
#include "am_hc32.h"
#include "am_gpio.h"
#include "hc32_pin.h"
...
#define OPA_MODE    AM_HC32F07X_OPA3_4_DAC    /**< \brief OPA DAC电压跟随模式*/
...
void demo_hc32f07x_core_hw_opa_dac_entry (void)
{
    ...
    AM_DBG_INFO("demo amf07x_core hw opa dac test!\r\n");
    ...
    demo_hc32f07x_hw_opa_dac_entry(HC32_OPA,
                                 HC32_DAC,
                                 OPA_MODE,
                                 vol_val,
                                 128);
