 ...
 *
 * \par 源代码
 * \snippet demo_hc32f07x_std_uart_ringbuf.c src_hc32f07x_std_uart_ringbuf
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f07x_std_uart_ringbuf
 * \copydoc demo_hc32f07x_std_uart_ringbuf.c
 */

/** [src_hc32f07x_std_uart_ringbuf] */
#include "ametal.h"
...
{
    AM_DBG_INFO("demo amf07x_core std lpuart ringbuf!\r\n");
