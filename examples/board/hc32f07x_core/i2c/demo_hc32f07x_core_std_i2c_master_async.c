 ...
 *
 * \par 源代码
 * \snippet demo_hc32f07x_std_i2c_master_async.c src_hc32f07x_std_i2c_master_async
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f07x_std_i2c_master_async
 * \copydoc demo_hc32f07x_std_i2c_master_async.c
 */

/** [src_hc32f07x_std_i2c_master_async] */
#include "ametal.h"
#include "am_board.h"
#include "am_vdebug.h"
#include "am_i2c.h"
...
void demo_hc32f07x_core_std_i2c_master_async_entry (void)
{
    ...
    AM_DBG_INFO("demo hc32f07x_core std i2c master async!\r\n");

    demo_std_i2c_master_async_entry(am_hc32_i2c0_inst_init(),
                                    EEPROM_ADDR,
                                    TEST_LEN);
}
/** [src_hc32f07x_std_i2c_master_async] */
