 ...
 *
 * \par 源代码
 * \snippet demo_hc32f07x_hw_tim_timing.c src_hc32f07x_hw_tim_timing
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f07x_hw_tim_timing
 * \copydoc demo_hc32f07x_hw_tim_timing.c
 */

/** [src_hc32f07x_hw_tim_timing] */
#include "ametal.h"
#include "am_vdebug.h"
#include "am_hc32.h"
...
{
    AM_DBG_INFO("demo amf07x_core hw tim timing!\r\n");
