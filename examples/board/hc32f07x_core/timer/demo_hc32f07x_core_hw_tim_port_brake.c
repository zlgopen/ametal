 ...
 *
 * \par 源代码
 * \snippet demo_hc32f07x_hw_tim_port_brake.c src_hc32f07x_hw_tim_port_brake
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f07x_hw_tim_port_brake
 * \copydoc demo_hc32f07x_hw_tim_port_brake.c
 */

/** [src_hc32f07x_hw_tim_port_brake] */
#include "ametal.h"
#include "am_clk.h"
#include "am_gpio.h"
#include "am_vdebug.h"
...
void demo_hc32f07x_core_hw_tim_port_brake_entry (void)
{
    ...
    AM_DBG_INFO("demo amf07x_core hw adtim port brake!\r\n");
