 ...
 *
 * \par 源代码
 * \snippet demo_hc32f07x_std_tim2_timing.c src_hc32f07x_std_tim2_timing
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f07x_std_tim2_timing
 * \copydoc demo_hc32f07x_std_tim2_timing.c
 */

/** [src_hc32f07x_std_tim2_timing] */
...
{
    AM_DBG_INFO("demo amf07x_core std tim2 timing!\r\n");
