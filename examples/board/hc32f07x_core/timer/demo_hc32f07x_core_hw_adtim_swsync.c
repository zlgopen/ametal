 ...
 *
 * \par 源代码
 * \snippet demo_hc32f07x_hw_adtim_swsync.c src_hc32f07x_hw_adtim_swsync
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f07x_hw_adtim_swsync
 * \copydoc demo_hc32f07x_hw_adtim_swsync.c
 */

/** [src_hc32f07x_hw_adtim_swsync] */
#include "ametal.h"
#include "am_gpio.h"
#include "am_vdebug.h"
...
void demo_hc32f07x_core_hw_adtim_swsync_entry (void)
{
    ...
    AM_DBG_INFO("demo amf07x_core hw adtim swsync!\r\n");
