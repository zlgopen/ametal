 ...
 *
 * - 实验现象：
 *   1. PCA通道0，PB4引脚输出1KHz PWM，占空比为60%。
 *
 * \note
 ...
 *
 * \par 源代码
 * \snippet demo_hc32f07x_drv_pca_16bit_pwm.c src_hc32f07x_drv_pca_16bit_pwm
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f07x_drv_pca_16bit_pwm
 * \copydoc demo_hc32f07x_drv_pca_16bit_pwm.c
 */

/** [src_hc32f07x_drv_pca_16bit_pwm] */
...
void demo_hc32f07x_core_drv_pca_16bit_pwm_entry (void)
{
    ...
    AM_DBG_INFO("demo amf07x_core pca 16bit pwm entry!\r\n");

    handle = am_hc32_pca_inst_init();

    am_hc32_pca_pwm_set(handle, 0, 0, HC32_PCA_PWM_16, 1500, 1400);
