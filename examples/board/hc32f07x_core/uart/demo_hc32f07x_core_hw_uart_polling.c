 ...
 *
 * \par 源代码
 * \snippet demo_hc32f07x_hw_uart_polling.c src_hc32f07x_hw_uart_polling
 *
 * \internal
 ...
 */
 ...
 /**
 * \addtogroup demo_if_hc32f07x_hw_uart_polling
 * \copydoc demo_hc32f07x_hw_uart_polling.c
 */

/** [src_hc32f07x_hw_uart_polling] */
#include "ametal.h"
#include "am_board.h"
#include "am_hc32.h"
#include "am_gpio.h"
...
{
    AM_DBG_INFO("demo amf07x_core hw uart polling!\r\n");
