 ...
 *
 * \par 源代码
 * \snippet demo_hc32f07x_hw_gpio_trigger.c src_hc32f07x_hw_gpio_trigger
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f07x_hw_gpio_trigger
 * \copydoc demo_hc32f07x_hw_gpio_trigger.c
 */
