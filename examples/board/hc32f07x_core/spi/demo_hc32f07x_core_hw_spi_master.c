 ...
 *
 * \par 源代码
 * \snippet demo_hc32f07x_hw_spi_master.c src_hc32f07x_hw_spi_master
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_if_hc32f07x_hw_spi_master
 * \copydoc demo_hc32f07x_hw_spi_master.c
 */

/** [src_hc32f07x_hw_spi_master] */
#include "ametal.h"
#include "am_hc32.h"
...
{
    am_kprintf("demo amf07x_core hw spi master!\r\n");
