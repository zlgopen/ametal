 ...
 *          #define     ALL_SIZE     0X0000CC00    //根据实际情况设置
 *
 *      默认flash分配情况如下：
 *      区域划分:    |----------|-------------------|
...
{
    AM_DBG_INFO("application : amf07x_core single application start up successful!\r\n");

    while(1) {
        AM_DBG_INFO("application : amf07x_core single application running\r\n");
        am_led_toggle(0);
        am_mdelay(1000);
    }
}
