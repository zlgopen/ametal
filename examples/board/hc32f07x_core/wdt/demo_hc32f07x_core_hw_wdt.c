 ...
 *
 * \par 源代码
 * \snippet demo_hc32f07x_hw_wdt.c src_hc32f07x_hw_wdt
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f07x_hw_wdt
 * \copydoc demo_hc32f07x_hw_wdt.c
 */
...
{
    AM_DBG_INFO("demo hc32f07x_core hw wdt!\r\n");
