 ...
 *
 * \par 源代码
 * \snippet demo_hc32f19x_std_wdt.c src_hc32f19x_std_wdt
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f19x_std_wdt
 * \copydoc demo_hc32f19x_std_wdt.c
 */

/** [src_hc32f19x_std_wdt] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo hc32f07x_core std wdt!\r\n");
