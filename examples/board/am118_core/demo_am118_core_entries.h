 ...
 */
void demo_zlg118_core_std_multichan_adc_entry (void);
 ...
 */
void demo_zlg118_hw_crc_entry (void);
 ...
 */
void demo_zlg118_core_hw_dac_entry (void);
...
/**
 * \brief I2C 主机机例程(此例程可以用来模拟 EEPROM)，通过 HW 层接口实现
 */
 ...
 */
void demo_zlg118_core_std_i2c_lm75_entry (void);
 ...
 */
void demo_zlg118_core_hw_rtc_sec_int_entry (void);
 ...
 */
void demo_zlg118_core_std_systick_timer_entry (void);
 ...
 */
void demo_zlg118_core_hw_adtim_vc_brake_entry (void);

/**
 * \brief 定时器 CAP 捕获例程，通过 HW 层接口实现
 */
void demo_zlg118_core_hw_tim_cap_entry (void);

/**
 * \brief TIM0 定时器 CAP 例程，通过标准接口实现
 */
void demo_zlg118_core_std_tim0_cap_entry (void);

/**
 * \brief TIM1 定时器 CAP 例程，通过标准接口实现
 */
void demo_zlg118_core_std_tim1_cap_entry (void);
 ...
 */
void demo_zlg118_core_std_tim4_cap_entry(void);
 ...
 */
void demo_zlg118_core_std_tim6_cap_entry(void);
 ...
 */
void demo_zlg118_core_std_tim0_pwm_entry (void);

/**
 * \brief TIM1 定时器 PWM 例程，通过标准接口实现
 */
void demo_zlg118_core_std_tim1_pwm_entry (void);

/**
 * \brief TIM2 定时器 PWM 例程，通过标准接口实现
 */
void demo_zlg118_core_std_tim2_pwm_entry (void);
 ...
 */
void demo_zlg118_core_std_tim4_pwm_entry (void);
 ...
 */
void demo_zlg118_core_hw_tim_trig_adc_sqr_entry (void);

/**
 * \brief TIM0 定时器 TIMING 例程，通过标准接口实现
 */
void demo_zlg118_core_std_tim0_timing_entry (void);

/**
 * \brief TIM1 定时器 TIMING 例程，通过标准接口实现
 */
void demo_zlg118_core_std_tim1_timing_entry (void);
 ...
 */
void demo_zlg118_core_std_tim5_timing_entry (void);

/**
 * \brief ADTIM6定时器timing例程，通过标准接口实现
 */
void demo_zlg118_core_std_tim6_timing_entry (void);
 ...
 */
void demo_zlg118_core_hw_uid_entry (void);
 ...
 */
void demo_zlg118_core_hw_uart_tx_dma_entry (void);

/**
 * \brief UART 轮询方式例程，通过标准接口实现
 */
void demo_zlg118_core_std_uart_polling_entry (void);
 ...
 */
void demo_zlg118_core_hw_lpuart_rx_dma_entry (void);
 ...
 */
void demo_zlg118_core_std_lpuart_ringbuf_entry (void);
 ...
 */
void demo_zlg118_core_std_wdt_entry (void);
 ...
 */
void demo_zlg118_core_microport_eeprom_entry (void);

/**
 * \brief MicroPort EEPROM 例程，通过 NVRAM 接口实现
 */
void demo_zlg118_core_microport_eeprom_nvram_entry (void);

/**
 * \brief MicroPort FLASH 例程，通过标准接口实现
 */
void demo_zlg118_core_microport_flash_entry (void);

/**
 * \brief MicroPort FLASH 例程，通过 MTD 接口实现
 */
void demo_zlg118_core_microport_flash_mtd_entry (void);

/**
 * \brief MicroPort FLASH 例程，通过 FTL 接口实现
 */
void demo_zlg118_core_microport_flash_ftl_entry (void);

/**
 * \brief MicroPort RS485 例程，通过标准接口实现
 */
void demo_zlg118_core_microport_rs485_entry (void);

/**
 * \brief MicroPort RTC 例程，通过标准接口实现
 */
void demo_zlg118_core_microport_rtc_entry (void);
 ...
 */
void demo_zlg118_core_microport_usb_entry (void);

/**
 * \brief MiniPort-VIEW 例程
 */
void demo_zlg118_core_miniport_digitron_entry (void);
 ...
 */
void demo_zlg118_core_miniport_hc595_digitron_key_entry (void);

/**
 * \brief MiniPort-595 + MiniPort-VIEW + LM75 例程
 */
void demo_zlg118_core_miniport_hc595_digitron_temp_entry (void);
 ...
 */
void demo_zlg118_core_miniport_key_digitron_entry (void);

/**
 * \brief MiniPort-LED 例程
 */
void demo_zlg118_core_miniport_led_entry (void);
 ...
 * \brief 读CPU卡例程
 */
void demo_zlg118_core_dr_fm175xx_cpu_card (void);
/**
 * \brief A类卡读卡类型和卡号例程
 */
void demo_zlg118_core_dr_fm175xx_picca_read_id(void);

/**
 * \brief A类卡读休眠卡例程
 */
void demo_zlg118_core_dr_fm175xx_picca_halt (void);

/**
 * \brief A类卡读块例程
 */
void demo_zlg118_core_dr_fm175xx_picca_read_block (void);

/**
 * \brief A类卡值操作例程
 */
void demo_zlg118_core_dr_fm175xx_picca_val_operate(void);

/**
 * \brief A类卡写块例程
 */
void demo_zlg118_core_dr_fm175xx_picca_write_block(void);

/**
 * \brief B类卡读卡号例程
 */
void demo_zlg118_core_dr_fm175xx_piccb_read_id(void);
/**
 * \brief FM175XX LCPD模式 A类卡读卡类型和卡号例程
 */
void demo_zlg118_core_dr_fm175xx_picca_lpcd_read_id(void);

/**
 * \brief 基于KinetisFlashTool上位机的bootloader 例程
 */
void demo_zlg118_core_kft_bootloader_entry (void);

/**
 * \brief 基于KinetisFlashTool上位机的bootloader的测试应用例程
 */
void demo_zlg118_core_kft_application_entry (void);
...
void demo_zlg118_core_single_application_entry (void);

/**
 * \brief 基于串口助手的单区bootloader例程
 */
void demo_zlg118_core_single_bootloader_uart_entry (void);

/**
 * \brief 基于串口助手的双区bootloader例程
 */
void demo_zlg118_core_double_bootloader_uart_entry(void);
 ...
 */
void demo_zlg118_core_hw_lvd_int_entry (void);
