 ...
 *
 * \par 源代码
 * \snippet demo_zlg118_core_lvd_int.c src_zlg118_core_lvd_int
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_zlg118_core_lvd_int
 * \copydoc demo_zlg118_core_lvd_int.c
 */
 ...
 * \brief 用户回调函数
 */
static void __zlg118_lvd_callback (void *data)
{
...
void demo_zlg118_core_hw_lvd_int_entry (void)
{
    ...
    demo_zlg118_hw_lvd_int_entry((void *)ZLG118_LVD, __zlg118_lvd_callback);
}
