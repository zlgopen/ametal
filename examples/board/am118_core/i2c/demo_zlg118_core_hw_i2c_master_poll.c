 ...
 *
 * \par 源代码
 * \snippet demo_zlg118_core_hw_i2c_master_poll.c src_zlg118_core_hw_i2c_master_poll
 *
 * \internal
 * \par History
...
void demo_zlg118_core_hw_i2c_master_poll_entry (void)
{
    ...
    demo_zlg118_hw_i2c_master_poll_entry(ZLG118_I2C1, am_clk_rate_get (CLK_PCLK));
}
/** [src_zlg118_core_hw_i2c_master_poll] */
