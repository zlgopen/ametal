 ...
 *
 * \par 源代码
 * \snippet demo_hc32f03x_core_opa_dac.c src_hc32f03x_core_opa_dac
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f03x_core_opa_dac
 * \copydoc demo_hc32f03x_core_opa_dac.c
 */

/** [src_hc32f03x_core_opa_dac] */
#include "ametal.h"
#include "am_hc32.h"
#include "am_gpio.h"
...
void demo_hc32f03x_core_hw_opa_dac_entry (void)
{
    ...
    AM_DBG_INFO("demo amf03x_core hw opa dac test!\r\n");
