 ...
 *
 * \par 源代码
 * \snippet demo_hc32f03x_std_wdt.c src_hc32f03x_std_wdt
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f03x_std_wdt
 * \copydoc demo_hc32f03x_std_wdt.c
 */

/** [src_hc32f03x_std_wdt] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo amf03x_core std wdt!\r\n");
