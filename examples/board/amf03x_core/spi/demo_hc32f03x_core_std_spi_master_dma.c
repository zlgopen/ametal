 ...
 *
 * \par 源代码
 * \snippet demo_hc32f03x_std_spi_master_dma.c src_hc32f03x_std_spi_master_dma
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_if_hc32f03x_std_spi_master_dma
 * \copydoc demo_hc32f03x_std_spi_master_dma.c
 */
...
void demo_hc32f03x_core_std_spi_master_dma_entry (void)
{
    ...
    AM_DBG_INFO("demo amf03x_core std spi master dma!\r\n");
