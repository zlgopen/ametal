 ...
 *
 * \par 源代码
 * \snippet demo_hc32f03x_hw_adtim_vc_brake.c src_hc32f03x_hw_adtim_vc_brake
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f03x_hw_adtim_vc_brake
 * \copydoc demo_hc32f03x_hw_adtim_vc_brake.c
 */

/** [src_hc32f03x_hw_adtim_vc_brake] */
#include "ametal.h"
#include "am_gpio.h"
#include "am_vdebug.h"
#include "am_hc32.h"
...
void demo_hc32f03x_core_hw_adtim_vc_brake_entry (void)
{
    ...
    AM_DBG_INFO("demo amf03x_core hw adtim vc_brake!\r\n");
