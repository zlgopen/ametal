 ...
 *
 * \par 源代码
 * \snippet demo_hc32f03x_std_tim4_cap.c src_hc32f03x_std_tim4_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f03x_std_tim4_cap
 * \copydoc demo_hc32f03x_std_tim4_cap.c
 */

/** [src_hc32f03x_std_tim4_cap] */
#include "ametal.h"
#include "am_vdebug.h"
...
void demo_hc32f03x_core_std_tim4_cap_entry (void)
{
    ...
    AM_DBG_INFO("demo amf03x_core std tim4 cap!\r\n");
