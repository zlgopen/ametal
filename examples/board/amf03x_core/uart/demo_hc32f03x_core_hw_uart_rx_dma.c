 ...
 *
 * \par 源代码
 * \snippet demo_hc32f03x_hw_uart_rx_dma.c src_hc32f03x_hw_uart_rx_dma
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f03x_hw_uart_rx_dma
 * \copydoc demo_hc32f03x_hw_uart_rx_dma.c
 */

/** [src_hc32f03x_hw_uart_rx_dma] */
#include "ametal.h"
#include "am_hc32.h"
...
{
    AM_DBG_INFO("demo amf03x_core hw uart rx dma!\r\n");
