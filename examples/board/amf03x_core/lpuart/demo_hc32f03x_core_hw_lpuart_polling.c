 ...
 *
 * \par 源代码
 * \snippet demo_hc32f03x_hw_lpuart_polling.c src_hc32f03x_hw_lpuart_polling
 *
 * \internal
 ...
 */
 ...
 /**
 * \addtogroup demo_if_hc32f03x_hw_lpuart_polling
 * \copydoc demo_hc32f03x_hw_lpuart_polling.c
 */
...
{
    AM_DBG_INFO("demo amf03x_core hw lpuart polling!\r\n");
