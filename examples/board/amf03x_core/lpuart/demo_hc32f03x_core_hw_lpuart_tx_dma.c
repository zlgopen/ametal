 ...
 *
 * \par 源代码
 * \snippet demo_hc32f03x_hw_lpuart_tx_dma.c src_hc32f03x_hw_lpuart_tx_dma
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f03x_hw_lpuart_tx_dma
 * \copydoc demo_hc32f03x_hw_lpuart_tx_dma.c
 */
...
{
    AM_DBG_INFO("demo amf03x_core hw lpuart tx dma!\r\n");
