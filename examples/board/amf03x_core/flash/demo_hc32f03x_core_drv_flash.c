 ...
 *
 * \par 源代码
 * \snippet demo_hc32f03x_drv_flash.c src_hc32f03x_drv_flash
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f03x_drv_flash
 * \copydoc demo_hc32f03x_drv_flash.c
 */

/** [src_hc32f03x_drv_flash] */
#include "ametal.h"
#include "am_board.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo amf03x_core drv flash!\r\n");
