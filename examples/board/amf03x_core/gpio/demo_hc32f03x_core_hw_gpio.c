 ...
 *
 * \par 源代码
 * \snippet demo_hc32f03x_hw_gpio.c src_hc32f03x_hw_gpio
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32f03x_hw_gpio
 * \copydoc demo_hc32f03x_hw_gpio.c
 */

/** [src_hc32f03x_hw_gpio] */
#include "ametal.h"
#include "am_gpio.h"
#include "am_hc32.h"
#include "am_vdebug.h"
...
void demo_hc32f03x_core_hw_gpio_entry (void)
{
    ...
    AM_DBG_INFO("demo amf03x_core hw gpio!\r\n");
