 ...
 *
 * \par 源代码
 * \snippet demo_hk32f103rbt6_adc_dma.c src_hk32f103rbt6_adc_dma
 *
 * \internal
...
/**
 * \addtogroup demo_if_hk32f103rbt6_adc_dma
 * \copydoc demo_hk32f103rbt6_adc_dma.c
 */

/** [src_hk32f103rbt6_adc_dma] */
...
static amhw_hk32f103rbt6_dma_xfer_desc_t g_desc;  /**< \brief DMA描述符 */
...
static void __hk32f103rbt6_adc_init (amhw_hk32f103rbt6_adc_t *p_hw_adc,
                            int               *p_adc_chan,
                            int                adc_chan_num)
{
    int i;
    ...
    for(i=0;i<adc_chan_num;i++) {
        ...
        amhw_hk32f103rbt6_adc_regular_channel_order_set(
            p_hw_adc,
           (amhw_hk32f103rbt6_adc_regular_channel_order_t)(AMHW_HK32F103RBT6_ADC_REGULAR_CHAN_ORDER_1st + i),
    ...
    /* 连续转换 */
    amhw_hk32f103rbt6_adc_cont_set(p_hw_adc, AMHW_HK32F103RBT6_ADC_CONVERSION_CONTINUOUS);
                                   ...
                                   uint8_t            dma_chan)
{
    ...
    /* adc相关初始化配置 */
    __hk32f103rbt6_adc_init(p_hw_adc, p_adc_chan, adc_chan_num);
    ...
    /* 连接 DMA 中断服务函数 */
    am_hk32f103rbt6_dma_isr_connect(dma_chan, dma_isr, (void *)p_hw_adc);
    ...
    /* DMA寄存器配置 */
    am_hk32f103rbt6_dma_xfer_desc_chan_cfg(&g_desc,
