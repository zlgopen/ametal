 ...
 *
 */
static int __hk32f103rbt6_wwdg_enable (amhw_hk32f103rbt6_wwdg_t *p_hw_wwdg,
                              uint32_t         timeout_ms,
                              uint32_t         clk_rate)
{
    ...
    amhw_hk32f103rbt6_wwdg_counter_set (p_hw_wwdg, __g_count);
 ...
 *
 */
static void __hk32f103rbt6_sdt_feed (amhw_hk32f103rbt6_wwdg_t *p_hw_wwdg)
{
    amhw_hk32f103rbt6_wwdg_counter_set(p_hw_wwdg, __g_count);
}
...
{
    __hk32f103rbt6_wwdg_enable(p_hw_wwdg, time_out_ms, clk_rate);

    while (1) {

        /* 喂狗操作 */
        __hk32f103rbt6_sdt_feed(p_hw_wwdg);
