 ...
 *
 * \par 源代码
 * \snippet demo_hk32f103rbt6_hw_i2c_master_poll.c src_hk32f103rbt6_hw_i2c_master_poll
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_if_hk32f103rbt6_hw_i2c_master_poll
 * \copydoc demo_hk32f103rbt6_hw_i2c_master_poll.c
 */

/** [src_hk32f103rbt6_hw_i2c_master_poll] */
#include "ametal.h"
#include "am_delay.h"
#include "am_vdebug.h"
 ...
 * \retval AM_OK 发送完成
 */
static int __i2c_mst_send (amhw_hk32f103rbt6_i2c_t *p_hw_i2c,
...

{
    ...
    if (stop ) {
        ...
        while (!amhw_hk32f103rbt6_i2c_checkflagstaus(p_hw_i2c,
            AMHW_HK32F103RBT6_I2C_FLAG_BTF));
 ...
 * \retval AM_OK 接收完成
 */
static int __i2c_mst_recv (amhw_hk32f103rbt6_i2c_t *p_hw_i2c,
                           i2c_transfer_t    *p_trans,
                           am_bool_t          stop)
{
    uint8_t i;
    ...
    for (i = 0; i < p_trans->length; i++) {
        ...
        /* 接收数据 */
        ((uint8_t *)(p_trans->p_buf))[i] = amhw_hk32f103rbt6_i2c_recv_data(p_hw_i2c);
 ...
 */
static int __i2c_mst_init (amhw_hk32f103rbt6_i2c_t *p_hw_i2c,
                           uint32_t           speed,
                           uint32_t           clk_rate)
{
 ...
 * \return 无
 */
static void __i2c_mst_start (amhw_hk32f103rbt6_i2c_t *p_hw_i2c,
                             i2c_transfer_t    *p_trans,
                             uint32_t           clk_rate)
{
