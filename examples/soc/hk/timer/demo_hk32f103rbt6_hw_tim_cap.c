 ...
 *
 * \par 源代码
 * \snippet demo_hk32f103rbt6_hw_tim_cap.c src_hk32f103rbt6_hw_tim_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_hk32f103rbt6_hw_tim_cap
 * \copydoc demo_hk32f103rbt6_hw_tim_cap.c
 */

/** [src_hk32f103rbt6_hw_tim_cap] */
#include "ametal.h"
#include "am_cap.h"
#include "am_int.h"
#include "am_delay.h"
...
static void __hk32f103rbt6_tim_hw_cap_irq_handler (void *p_arg)
{
 ...
 * \brief 配置定时器为输入捕获
 */
static void tim_cap_chan_config (amhw_hk32f103rbt6_tim_t     *p_hw_tim,
...
static void tim_cap_enable (amhw_hk32f103rbt6_tim_t *p_hw_tim,
                            uint32_t        chan,
                            uint8_t         int_num)
{

    /* 中断连接并使能 */
    am_int_connect(int_num, __hk32f103rbt6_tim_hw_cap_irq_handler, (void *)p_hw_tim);
 ...
 * \brief 定时器输入捕获初始化函数
 */
static void tim_cap_init (amhw_hk32f103rbt6_tim_t *p_hw_tim, amhw_hk32f103rbt6_tim_type_t type)
{
