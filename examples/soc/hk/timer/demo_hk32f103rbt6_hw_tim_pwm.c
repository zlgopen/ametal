...
/**
  * \brief PWM 中断服务函数
  */
static void __hk32f103rbt6_tim_hw_pwm_irq_handler (void *p_arg)
{
 ...
 */
void tim_pwm_chan_config (amhw_hk32f103rbt6_tim_t *p_hw_tim,
                          uint32_t        chan,
                          uint32_t        duty_ns,
                          uint32_t        period_ns,
                          uint32_t        clk_rate)
...
void tim_pwm_enable (amhw_hk32f103rbt6_tim_t      *p_hw_tim,
                     ...
                     int32_t              int_num)
{
    ...
    /* 连接中断回调函数 */
    am_int_connect(int_num, __hk32f103rbt6_tim_hw_pwm_irq_handler, (void *)p_hw_tim);
 ...
 * \return 无
 */
void tim_pwm_init (amhw_hk32f103rbt6_tim_t     *p_hw_tim, amhw_hk32f103rbt6_tim_type_t type)
{
