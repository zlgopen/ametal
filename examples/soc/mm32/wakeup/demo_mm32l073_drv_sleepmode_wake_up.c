 ...
 *
 * \par 源代码
 * \snippet demo_mm32l073_drv_sleepmode_wake_up.c src_mm32l073_drv_sleepmode_wake_up
 *
 * \internal
...
/**
 * \addtogroup demo_if_mm32l073_drv_sleepmode_wake_up
 * \copydoc demo_mm32l073_drv_sleepmode_wake_up.c
 */

/** [src_mm32l073_drv_sleepmode_wake_up] */
#include "ametal.h"
#include "am_vdebug.h"
...
void demo_mm32l073_drv_sleepmode_wake_up_entry (void)
{
    ...
    /* 唤醒配置 */
    am_mm32l073_wake_up_cfg(AM_MM32L073_PWR_MODE_SLEEP, gpio_isr, (void *)0);
