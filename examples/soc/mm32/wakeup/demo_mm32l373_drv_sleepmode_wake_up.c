 ...
 *
 * \par 源代码
 * \snippet demo_mm32l373_drv_sleepmode_wake_up.c src_mm32l373_drv_sleepmode_wake_up
 *
 * \internal
...
/**
 * \addtogroup demo_if_mm32l373_drv_sleepmode_wake_up
 * \copydoc demo_mm32l373_drv_sleepmode_wake_up.c
 */

/** [src_mm32l373_drv_sleepmode_wake_up] */
#include "ametal.h"
#include "am_board.h"
#include "am_led.h"
#include "am_delay.h"
...
void demo_mm32l373_drv_sleepmode_wake_up_entry (void)
{
    ...
    /* 唤醒配置 */
    am_mm32l373_wake_up_cfg(AM_MM32L373_PWR_MODE_SLEEP, gpio_isr, (void *)0);
