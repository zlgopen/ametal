 ...
 *
 * \par 源代码
 * \snippet demo_zsl42x_hw_lpuart_tx_dma.c src_zsl42x_hw_lpuart_tx_dma
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsl42x_hw_lpuart_tx_dma
 * \copydoc demo_zsl42x_hw_lpuart_tx_dma.c
 */

/** [src_zsl42x_hw_lpuart_tx_dma] */
#include "ametal.h"
#include "am_int.h"
...
static void lpuart_dma_isr (void *p_arg , uint32_t flag)
{
    ...
    if (flag == AM_ZSL42x_DMA_INT_COMPLETE) {
        if (flag_chan == g_dma_chan) {
            ...
            /* 禁能LPUART发送时使用DMA传输 */
            amhw_zsl42x_lpuart_disable(gp_hw_lpuart, AMHW_ZSL42x_LPUART_DMA_TX);
 ...
 * \brief DMA传输配置。
 */
static int lpuart_tx_dma_tran_cfg (amhw_zsl42x_lpuart_t *p_hw_lpuart,
                                   int32_t             dma_chan,
...
{
    /* 串口发送DMA传输使能 */
    amhw_zsl42x_lpuart_enable(p_hw_lpuart, AMHW_ZSL42x_LPUART_DMA_TX);
...
/** [src_zsl42x116_hw_lpuart_tx_dma] */
