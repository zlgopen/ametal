...
/*******************************************************************************
  宏定义
*******************************************************************************/
#define LCD_CLK_SRC   AMHW_ZSN700_LCD_CLK_SRC_RCL   /**< \brief 时钟源 */
#define LCD_BIAS_SRC  AMHW_ZSN700_LCD_BIAS_CAP_DIV  /**< \brief 偏置电压源 */
#define LCD_DUTY      AMHW_ZSN700_DUTY_1_4          /**< \brief 占空比 */
#define LCD_BIAS      AMHW_ZSN700_BIAS_1_3          /**< \brief 偏置电压 */
#define LCD_CPCLK     AMHW_ZSN700_CPCLK_2K_HZ       /**< \brief 电压泵频率 */
#define LCD_SCAN_CLK  AMHW_ZSN700_LCDCLK_128_HZ     /**< \brief 扫描频率 */

/*******************************************************************************
  全局变量
*******************************************************************************/
static amhw_zsn700_lcd_t       *gp_hw_lcd   = NULL;  /**< \brief lcd 外设 */
