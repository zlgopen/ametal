 ...
 *
 * \par 源代码
 * \snippet demo_zsl42x_hw_i2c_master_poll.c src_zsl42x_hw_i2c_master_poll
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_if_zsl42x_hw_i2c_master_poll
 * \copydoc demo_zsl42x_hw_i2c_master_poll.c
 */

/** [src_zsl42x_hw_i2c_master_poll] */
#include "ametal.h"
#include "am_delay.h"
#include "am_vdebug.h"
#include "am_errno.h"
 ...
 * \return 无
 */
static am_err_t __i2c_msg_start (amhw_zsl42x_i2c_t  *p_hw_i2c,
                                 i2c_message_t    *p_msg)
{
    int     state;
    uint8_t data_ptr = 0;
 ...
 */
static int __i2c_mst_init (amhw_zsl42x_i2c_t *p_hw_i2c,
                           uint32_t         speed,
                           uint32_t         clk_rate)
{
