 ...
 *
 * \par 源代码
 * \snippet demo_zml165_drv_sleepmode_timer_wake_up.c src_zml165_drv_sleepmode_timer_wake_up
 *
 * \internal
...
/**
 * \addtogroup demo_if_zml165_drv_sleepmode_timer_wake_up
 * \copydoc demo_zml165_drv_sleepmode_timer_wake_up.c
 */

/** [src_zml165_drv_sleepmode_timer_wake_up] */
#include "ametal.h"
#include "am_timer.h"
#include "am_delay.h"
#include "am_vdebug.h"
                                                    ...
                                                    uint32_t          timer_clk_rate)
{
    ...
    /* 唤醒配置 */
    am_zml165_wake_up_cfg(AM_ZML165_PWR_MODE_SLEEP, NULL, NULL);
    ...
    while (1) {
        ...
        /* 等待串口发送完成 */
        while((ZML165_UART1->csr & AMHW_ZLG_UART_TX_COMPLETE_FALG) == AM_FALSE);
