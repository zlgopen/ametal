...
static amhw_zlg118_dma_xfer_desc_t g_desc; /**< \brief 描述符 */
...
static int dma_m2m_test (uint8_t dma_chan)
{
    ...
    /* DMA 传输配置 */
    flags = AMHW_ZLG118_DMA_CHAN_TRANSFER_MODE_BURST   |    /* 突发传输模式 */
            AMHW_ZLG118_DMA_CHAN_SIZE_8BIT             |    /* 数据位宽 8bit */
            AMHW_ZLG118_DMA_CHAN_SRC_ADD_INC_ENABLE    |    /* 源地址自增 */
            AMHW_ZLG118_DMA_CHAN_DST_ADD_INC_ENABLE    |    /* 目标地址自增 */
            AMHW_ZLG118_DMA_CHAN_RELOAD_COUNTER_ENABLE |    /* 重载传输数据量 */
            AMHW_ZLG118_DMA_CHAN_RELOAD_SRC_ADD_ENABLE |    /* 重载源地址 */
            AMHW_ZLG118_DMA_CHAN_RELOAD_DST_ADD_ENABLE |    /* 重载目标地址 */
            AMHW_ZLG118_DMA_CHAN_INT_ERR_DISABLE       |    /* 错误中断禁能 */
            AMHW_ZLG118_DMA_CHAN_INT_TX_CMP_ENABLE     |    /* 传输完成中断使能 */
            AMHW_ZLG118_DMA_CHAN_CIRCULAR_MODE_ENABLE ;     /* 循环工作模式 */
    ...
    if (am_zlg118_dma_xfer_desc_chan_cfg(&g_desc,
                                       AMHW_ZLG118_DMA_MER_TO_MER, /* 内存到内存 */
                                       dma_chan) == AM_ERROR) {
        return AM_ERROR;
    } else {
