...
/**
 * \file
 * \brief ZSL42x系列外设驱动的所有例程函数入口声明
 * \sa    demo_zsl42x_entries.h
 *
 * \internal
...
#ifndef __DEMO_ZSL42x_ENTRIES_H
#define __DEMO_ZSL42x_ENTRIES_H
 ...
 * \retval 无
 */
void demo_zsl42x_hw_adc_int_entry (void    *p_hw_adc,
                                 int      int_num,
                                 uint8_t  chan,
                                 uint32_t vref_mv);
 ...
 * \retval 无
 */
void demo_zsl42x_hw_adc_dma_entry (void    *p_hw_adc,
                                 int     *p_adc_chan,
                                 int      chan_num,
                                 uint32_t vref_mv,
                                 int      dma_chan,
 ...
 * \retval 无
 */
void demo_zsl42x_hw_clk_entry (am_clk_id_t *p_clk_id_buf, uint8_t buf_lenth);
 ...
 * \retval 无
 */
void demo_zsl42x_drv_dma_m2m_entry (uint32_t dma_chan);
 ...
 * \retval 无
 */
void demo_zsl42x_hw_gpio_trigger_entry (void *p_hw_gpio, int32_t pin);
 ...
 * \retval 无
 */
void demo_zsl42x_hw_spi_master_entry (void    *p_hw_spi,
                                    int32_t  cs_pin);
 ...
 * \retval 无
 */
void demo_zsl42x_hw_tim_cap_entry (void     *p_hw_tim,
                                 uint32_t  chan,
                                 uint32_t  clk_rate,
                                 int32_t   inum);
 ...
 * \retval 无
 */
void demo_zsl42x_hw_tim_cmp_toggle_entry (void    *p_hw_tim,
                                        uint8_t  type,
                                        uint32_t chan,
                                        uint32_t clk_rate,
                                        uint8_t  clk_div,
 ...
 * \retval 无
 */
void demo_zsl42x_hw_tim_pwm_dead_entry (void    *p_hw_tim,
                                      uint8_t  type,
                                      uint8_t  chan_a,
                                      uint8_t  chan_b,
                                      uint32_t duty_us,
 ...
 *
 * \param[in] p_tim_cfg 指向软件同步配置结构体的指针（amhw_zsl42x_adtim_sw_sync_t）
 *
 * \retval 无
 */
 ...
 * \retval 无
 */
void demo_zsl42x_hw_adtim_port_sw_brake_entry (void          *p_hw_adtim,
                                             uint8_t        chan,
 ...
 * \retval 无
 */
void demo_zsl42x_hw_adtim_trig_adc_sqr_entry (void    *p_hw_adtim,
                                            uint32_t period_us,
                                            void    *p_hw_adc,
                                            int      adc_int_num,
                                            int     *p_adc_chan,
 ...
 * \retval 无
 */
void demo_zsl42x_hw_tim_pwm_entry (void    *p_hw_tim,
                                 uint8_t  type,
                                 uint32_t chan,
                                 uint32_t clk_rate,
                                 uint8_t  clk_div,
 ...
 * \retval 无
 */
void demo_zsl42x_hw_tim_timing_entry (void    *p_hw_tim,
                                    uint8_t  type,
                                    uint32_t clk_rate,
                                    int32_t  int_num);
 ...
 * \retval 无
 */
void demo_zsl42x_hw_uart_int_entry (void             *p_hw_uart,
                                  void            (*pfn_init) (void),
                                  uint32_t          clk_rate,
 ...
 * \retval 无
 */
void demo_zsl42x_hw_uart_polling_entry (void     *p_hw_uart,
                                      uint32_t  clk_rate);
 ...
 * \retval 无
 */
void demo_zsl42x_hw_uart_rx_dma_entry (void    *p_hw_uart,
                                     uint32_t clk_rate,
                                     int32_t  dma_chan,
                                     int32_t  dma_src);
 ...
 * \retval 无
 */
void demo_zsl42x_hw_lpuart_int_entry (void             *p_hw_lpuart,
                                    void            (*pfn_init) (void),
                                    uint8_t           sclk_src,
                                    uint32_t          clk_rate,
                                    uint32_t          baudrate,
 ...
 * \retval 无
 */
void demo_zsl42x_hw_lpuart_polling_entry (void     *p_hw_lpuart,
                                        uint8_t   clk_src,
                                        uint32_t  clk_rate,
                                        uint32_t  baudrate);
 ...
 * \retval 无
 */
void demo_zsl42x_hw_lpuart_rx_dma_entry (void    *p_hw_lpuart,
                                       uint8_t  clk_src,
                                       uint32_t clk_rate,
                                       uint32_t baudrate,
                                       int32_t  dma_chan,
 ...
 * \retval 无
 */
void demo_zsl42x_hw_lpuart_tx_dma_entry (void    *p_hw_lpuart,
                                       uint8_t  clk_src,
                                       uint32_t clk_rate,
                                       uint32_t baudrate,
                                       int32_t  dma_chan,
...
/**
 * \brief ZSL42x I2C 主机例程，通过 HW 层接口实现
 *
 ...
 * \return 无
 */
void demo_zsl42x_hw_i2c_master_poll_entry (void      *p_hw_i2c,
                                         uint32_t   clk_rate);

/**
 * \brief ZSL42x I2C 从机例程，通过 HW 层接口实现
 *
 * \param[in] p_hw_i2c     指向 I2C 外设寄存器块的指针
 ...
 * \retval 无
 */
void demo_zsl42x_hw_dac_dma_entry(void     *p_hw_dac,
                                int32_t   dma_src,
                                int32_t   dma_chan,
                                uint16_t *p_vol_val);
 ...
 * \param[in] lvd_vids : LVD 阈值电压，amhw_zsl42x_lvd_vids_t
 * \param[in] lvd_src  : LVD 监测来源选择，宏定义 AMHW_ZSL42x_LVD_SRC_
 *
 * \retval 无
 */
 ...
 * \retval 无
 */
void demo_zsl42x_hw_opa_dac_entry (void      *p_hw_opa,
                                 void      *p_hw_dac,
                                 uint8_t    mode,
                                 uint16_t  *p_vol_val,
                                 uint32_t   number);
 ...
 * \retval 无
 */
void demo_zsl42x_hw_aes_ency_decy_entry (void     *p_hw_aes,
                                       uint8_t   key_len,
                                       uint32_t *p_aes_data,
                                       uint32_t *p_key_data);
...
/**
 * \brief zsl42xx3x OPA例程，通过异步标准接口实现
 *
 ...
 * \return 无
 */
void demo_zsl42xx3x_drv_opa_entry (void *p_handle, uint8_t ch);

/**
 * \brief zsl42xx3x OPA 电压跟随例程，通过 HW 层接口实现
 *
 * \param[in] p_hw_opa :指向OPA寄存器指针
 * \param[in] mode     :OPA工作模式
 * \param[in] ch       :OPA通道
 ...
 * \retval :无
 */
void demo_zsl42xx3x_hw_opa_entry (void *p_hw_opa, uint8_t mode, uint8_t ch);
