...
static void __adc_isr (void *p_arg)
{
    ...
    __g_adc_dat[i] = amhw_zsl42x_adc_data_get (p_hw_adc) & 0x0fff;
                                 ...
                                 uint32_t vref_mv)
{
    ...
    uint32_t                   sum      = 0;
    amhw_zsl42x_adc_chan_sel_t chan_sel = (amhw_zsl42x_adc_chan_sel_t)chan;
    ...
    /* 设置参考电压源 */
    amhw_zsl42x_adc_refvol_sel(p_adc, AMHW_ZSL42x_ADC_REFVOL_AVCC);
    ...
    /* 使能单次转换模式 */
    amhw_zsl42x_adc_mode_sel(p_adc, AMHW_ZSL42x_ADC_MODE_SINGLE);
    ...
    /* 链接ADC采样通道和引脚 */
    amhw_zsl42x_adc_sgl_chan_sel(p_adc, chan_sel);

    /* 对齐方式设置 */
    amhw_zsl42x_adc_align_way_sel(p_adc,
    ...
    while(1) {
        ...
        /* 单次转换启动 */
        amhw_zsl42x_adc_single_convert_start(p_adc);
