 ...
 *
 * \par 源代码
 * \snippet demo_zlg118116_hw_tim_port_brake.c src_zlg118116_hw_tim_port_brake
 *
 * \internal
...
/**
 * \addtogroup demo_if_zlg118116_hw_tim_port_brake
 * \copydoc demo_zlg118116_hw_tim_port_brake.c
 */

/** [src_zlg118116_hw_tim_port_brake] */
#include "ametal.h"
#include "am_clk.h"
#include "am_clk.h"
#include "am_int.h"
...
static void __irq_handler (void *p_arg)
{
    ...
    if(amhw_zlg118_tim_mode23_int_flag_check(
           p_hw_tim,
           AMHW_ZLG118_TIM_INT_FLAG_BRAKE) ==
           AM_TRUE) {
                                       ...
                                       uint32_t           period_ns)
{
    ...
    /* 刹车使能 */
    amhw_zlg118_tim_mode23_dtr_enable(p_hw_tim, AMHW_ZLG118_TIM_DTR_BKE);

    /* 刹车中断使能 */
    amhw_zlg118_tim_mode23_int_enable(p_hw_tim, AMHW_ZLG118_TIM_INT_BIE);
                                          ...
                                          uint32_t period_ns)
{
    ...
    /* 定时器配置 */
    if((__zlg118_hw_tim_init(p_tim, type, chan, duty_ns , period_ns)) ==
       AM_FALSE) {
        return;
    }
