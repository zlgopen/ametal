 ...
 *
 * \par 源代码
 * \snippet demo_zsl42x116_hw_tim_pwm.c src_zsl42x116_hw_tim_pwm
 *
 * \internal
...
/**
 * \addtogroup demo_if_zsl42x116_hw_tim_pwm
 * \copydoc demo_zsl42x116_hw_tim_pwm.c
 */

/** [src_zsl42x116_hw_tim_pwm] */
#include "ametal.h"
#include "am_clk.h"
#include "am_int.h"
#include "am_gpio.h"
...
/**
  * \brief PWM 中断服务函数
  */
static void __zsl42x_tim_hw_pwm_irq_handler (void *p_arg)
{
 ...
 */
void tim_pwm_chan_config (amhw_zsl42x_tim_t *p_hw_tim,
                          uint32_t           chan,
                          uint32_t           duty_ns,
                          uint32_t           period_ns,
                          uint32_t           clk_rate,
                          uint8_t            clk_div)
{
    ...
    /* 分频系数设置 */
    amhw_zsl42x_tim_mode_clkdiv_set(p_hw_tim, (amhw_zsl42x_tim_clkdiv_t)clk_div);
...
void tim_pwm_enable (amhw_zsl42x_tim_t      *p_hw_tim,
                     amhw_zsl42x_tim_type_t  type,
                     uint32_t                chan,
                     int32_t                 int_num)
{
    /* 连接中断回调函数 */
    am_int_connect(int_num, __zsl42x_tim_hw_pwm_irq_handler, (void *)p_hw_tim);
 ...
 * \return 无
 */
void tim_pwm_init (amhw_zsl42x_tim_t *p_hw_tim, uint8_t type, uint8_t chan)
{
                                 ...
                                 int32_t  inum)
{
    ...
    tim_pwm_enable(p_tim, (amhw_zsl42x_tim_type_t)type, chan, inum);
