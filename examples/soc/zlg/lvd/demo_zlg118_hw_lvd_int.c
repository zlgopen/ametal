...
/*******************************************************************************
  宏定义
*******************************************************************************/
#define LVD_TRI_TYPE AMHW_ZLG118_LVD_RTEN                /**< \brief LVD触发条件 */
...
#define LVD_TRI_ACT  ANHW_ZLG118_LVD_TRI_ACT_NVIC_INT    /**< \brief LVD触发动作*/
...
{
    if (amhw_zlg118_int_status_check (gp_hw_lvd)){

        /* 清除中断标志 */
        amhw_zlg118_int_falg_clr (gp_hw_lvd);
...
static void lvd_int_init (void (*p_lvd_cb) (void *))
{
        ...
        /* 使能中断 */
        amhw_zlg118_lvd_int_enable (gp_hw_lvd);
