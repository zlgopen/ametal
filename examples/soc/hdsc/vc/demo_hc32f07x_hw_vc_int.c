...
/*******************************************************************************
  宏定义
*******************************************************************************/
#define VC_INUM      INUM_VC0_VC1_VC2_LVD                           /**< \brief VC中断编号 */
...
#define VC_BIAS      AMHW_HC32_VC0_BIAS_1_2_UA        /**< \brief 功耗*/
#define VC_DEB_TIME  AMHW_HC32_DEB_TIME_28_US         /**< \brief 滤波时间*/
#define VC_P_IN      AMHW_HC32_VC0_P_INPUT_PC0        /**< \brief P端输入*/
#define VC_N_IN      AMHW_HC32_VC0_N_INPUT_PA7        /**< \brief N端输入*/
#define VC_OUT_CFG   AMHW_HC32_VC_OUT_CFG_DISABLE     /**< \brief 输出配置 */
#define VC_INT_TYPE  AMHW_HC32_VC_OUT_TRI_INT_RISING  /**< \brief 中断触发类型 */
                                  ...
                                  uint16_t mv_val)
{
    ...
    amhw_hc32f07x_dac_chan0_12bit_right_aligned_data(gp_hw_dac, vol_val);
