 ...
 */
 ...
 /**
 * \addtogroup demo_if_hc32_hw_uart_polling
 * \copydoc demo_hc32_hw_uart_polling.c
 */

/** [src_hc32_hw_uart_polling] */
#include "ametal.h"
 ...
 */
static void uart_polling_init (amhw_hc32_uart_t *p_hw_uart, uint32_t clk_rate)
{
    /* 工作模式设置  */
                                      ...
                                      uint32_t  clk_rate)
{
    ...
    amhw_hc32_uart_poll_send(p_uart, uart_hw_str, sizeof(uart_hw_str));

    while (1) {

        /* 接收字符 */
        amhw_hc32_uart_poll_receive(p_uart, buf_src, 1);

        /* 发送刚刚接收的字符 */
        amhw_hc32_uart_poll_send(p_uart, buf_src, 1);
    }
}
/** [src_hc32116_hw_uart_polling] */
