...
/*******************************************************************************
  宏定义
*******************************************************************************/
#define LVD_TRI_TYPE AMHW_HC32_LVD_RTEN                /**< \brief LVD触发条件 */
...
#define LVD_TRI_ACT  ANHW_HC32_LVD_TRI_ACT_NVIC_INT    /**< \brief LVD触发动作*/
...
{
    if (amhw_hc32_int_status_check (gp_hw_lvd)){

        /* 清除中断标志 */
        amhw_hc32_int_falg_clr (gp_hw_lvd);
...
static void lvd_int_init (void (*p_lvd_cb) (void *))
{
        ...
        /* 使能中断 */
        amhw_hc32_lvd_int_enable (gp_hw_lvd);
