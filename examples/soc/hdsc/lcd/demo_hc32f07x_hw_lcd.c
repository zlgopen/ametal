...
/*******************************************************************************
  宏定义
*******************************************************************************/
#define LCD_CLK_SRC   AMHW_HC32_LCD_CLK_SRC_RCL   /**< \brief 时钟源 */
#define LCD_BIAS_SRC  AMHW_HC32_LCD_BIAS_CAP_DIV  /**< \brief 偏置电压源 */
#define LCD_DUTY      AMHW_HC32_DUTY_1_4          /**< \brief 占空比 */
#define LCD_BIAS      AMHW_HC32_BIAS_1_3          /**< \brief 偏置电压 */
#define LCD_CPCLK     AMHW_HC32_CPCLK_2K_HZ       /**< \brief 电压泵频率 */
#define LCD_SCAN_CLK  AMHW_HC32_LCDCLK_128_HZ     /**< \brief 扫描频率 */

/*******************************************************************************
  全局变量
*******************************************************************************/
static amhw_hc32_lcd_t       *gp_hw_lcd   = NULL;  /**< \brief lcd 外设 */
...
static void lcd_init ()
{
    ...
    amhw_hc32f07x_rcc_rcl_trim_set(*((uint16_t*)0x00100C22));
