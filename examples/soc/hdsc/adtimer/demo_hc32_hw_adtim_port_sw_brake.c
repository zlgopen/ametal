 ...
 *
 * \par 源代码
 * \snippet demo_hc32_hw_adtim_port_sw_brake.c src_hc32_hw_adtim_port_sw_brake
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32_hw_adtim_port_sw_brake
 * \copydoc demo_hc32_hw_adtim_port_sw_brake.c
 */

/** [src_hc32_hw_adtim_port_sw_brake] */
#include "ametal.h"
#include "am_delay.h"
#include "am_vdebug.h"
#include "am_clk.h"
...
static am_bool_t __hc32_hw_adtim_init(void          *p_hw_adtim,
    ...
    portcfg.dissel    = AMHW_HC32_ADTIM_DISSEL3;       // 选择强制输出无效条件3
                                             ...
                                             uint8_t        src)
{
    char                              i;
    uint8_t                           t;
    amhw_hc32_adtim_disable_3_cfg_t disable_cfg;
    amhw_hc32_adtim_t              *p_adtim = (amhw_hc32_adtim_t *)
                                                p_hw_adtim;
    ...
    src = (amhw_hc32_adtim_trigsel_t)src;

    disable_cfg.stcbrkptcfg[src].portenable  = AM_TRUE;
    disable_cfg.stcbrkptcfg[src].polaritysel = AMHW_HC32_ADTIM_PtBrkHigh;
    disable_cfg.fltenable = AM_TRUE;
    disable_cfg.fltclk    = AMHW_HC32_ADTIM_FLTCLK_PCLK_DIV1;

    /* 无效条件3配置(端口刹车) */
    amhw_hc32_adtim_disable3cfg(&disable_cfg);
    ...
    amhw_hc32_adtim_clearportbrakeflag();
    ...
    /* 软件刹车开启 */
    amhw_hc32_adtim_swbrake(AM_TRUE);
    ...
    /* 软件刹车关闭 */
    amhw_hc32_adtim_swbrake(AM_FALSE);
