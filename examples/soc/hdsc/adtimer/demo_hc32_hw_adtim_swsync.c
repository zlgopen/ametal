 ...
 *
 * \par 源代码
 * \snippet demo_hc32_hw_adtim_swsync.c src_hc32_hw_adtim_swsync
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32_hw_adtim_swsync
 * \copydoc demo_hc32_hw_adtim_swsync.c
 */

/** [src_hc32_hw_adtim_swsync] */
#include "ametal.h"
#include "am_delay.h"
#include "am_vdebug.h"
#include "am_clk.h"
...
void demo_hc32_hw_adtim_swsync_entry (void *p_tim_cfg)
{
    ...
    amhw_hc32_adtim_sw_sync_t    *p_cfg = (amhw_hc32_adtim_sw_sync_t *)
                                            p_tim_cfg;

    amhw_hc32_adtim_t *p_hw_adtim4 = (amhw_hc32_adtim_t *)HC32_TIM4_BASE;
    amhw_hc32_adtim_t *p_hw_adtim5 = (amhw_hc32_adtim_t *)HC32_TIM5_BASE;
    amhw_hc32_adtim_t *p_hw_adtim6 = (amhw_hc32_adtim_t *)HC32_TIM6_BASE;
    ...
    if(p_cfg->adtim4 == AM_TRUE) {
        amhw_hc32_adtim_init(p_hw_adtim4, &basecnt);
    }

    if(p_cfg->adtim5 == AM_TRUE) {
        amhw_hc32_adtim_init(p_hw_adtim5, &basecnt);
    }

    if(p_cfg->adtim6 == AM_TRUE) {
        amhw_hc32_adtim_init(p_hw_adtim6, &basecnt);
    }
    ...
    while (1) {
        ...
        /* 软件同步启动 */
        amhw_hc32_adtim_swsyncstart(p_cfg);

        /* 分别获取定时器的计数值  */
        tim4_data = amhw_hc32_adtim_getcount(p_hw_adtim4);
        tim5_data = amhw_hc32_adtim_getcount(p_hw_adtim5);
        tim6_data = amhw_hc32_adtim_getcount(p_hw_adtim6);
        ...
        /* 软件同步停止 */
        amhw_hc32_adtim_swsyncstop(p_cfg);
        ...
        /* 软件同步清零 */
        amhw_hc32_adtim_swsyncclear(p_cfg);
