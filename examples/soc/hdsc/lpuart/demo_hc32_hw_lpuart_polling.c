 ...
 *
 * \par 源代码
 * \snippet demo_hc32_hw_lpuart_polling.c src_hc32_hw_lpuart_polling
 *
 * \internal
 ...
 */
 ...
 /**
 * \addtogroup demo_if_hc32_hw_lpuart_polling
 * \copydoc demo_hc32_hw_lpuart_polling.c
 */

/** [src_hc32_hw_lpuart_polling] */
#include "ametal.h"
 ...
 */
static void lpuart_polling_init (amhw_hc32_lpuart_t *p_hw_lpuart,
                                 uint8_t               clk_src,
                                 uint32_t              clk_rate)
{
    /* 工作模式设置  */
                                        ...
                                        uint32_t  baudrate)
{
    ...
    amhw_hc32_lpuart_poll_send(p_lpuart,
                                 lpuart_hw_str,
    ...
    while (1) {
        ...
        /* 接收字符 */
        amhw_hc32_lpuart_poll_receive(p_lpuart, buf_src, 1);

        /* 发送刚刚接收的字符 */
        amhw_hc32_lpuart_poll_send(p_lpuart, buf_src, 1);
    }
}
/** [src_hc32116_hw_lpuart_polling] */
