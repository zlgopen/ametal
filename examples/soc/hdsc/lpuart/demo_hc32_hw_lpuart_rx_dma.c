 ...
 *
 * \par 源代码
 * \snippet demo_hc32_hw_lpuart_rx_dma.c src_hc32_hw_lpuart_rx_dma
 *
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32_hw_lpuart_rx_dma
 * \copydoc demo_hc32_hw_lpuart_rx_dma.c
 */

/** [src_hc32_hw_lpuart_rx_dma] */
#include "ametal.h"
#include "am_int.h"
...
static void lpuart_dma_isr (void *p_arg , uint32_t flag)
{
    ...
    if (flag == AM_HC32_DMA_INT_COMPLETE) {
        if (flag_chan == g_dma_chan) {
            ...
            /* 禁能LPUART发送时使用DMA传输 */
            amhw_hc32_lpuart_disable(gp_hw_lpuart, AMHW_HC32_LPUART_DMA_RX);
 ...
 */
static int lpuart_rx_dma_tran_cfg (amhw_hc32_lpuart_t *p_hw_lpuart,
                                 int32_t          dma_chan,
...
{
    /* 串口发送DMA传输使能 */
    amhw_hc32_lpuart_enable(p_hw_lpuart, AMHW_HC32_LPUART_DMA_RX);
                                       ...
                                       int32_t  dma_src)
{
    ...
    amhw_hc32_lpuart_poll_send(gp_hw_lpuart,
    ...
    amhw_hc32_lpuart_poll_send(gp_hw_lpuart, g_buf_dst, sizeof(g_buf_dst));
    amhw_hc32_lpuart_poll_send(gp_hw_lpuart,
                                 (uint8_t *)"\r\nDMA transfer done!\r\n",
                                  sizeof("\r\nDMA transfer done!\r\n") - 1);
