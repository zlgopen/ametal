 ...
 *
 * \par 源代码
 * \snippet demo_hc32116_hw_tim_port_brake.c src_hc32116_hw_tim_port_brake
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32116_hw_tim_port_brake
 * \copydoc demo_hc32116_hw_tim_port_brake.c
 */

/** [src_hc32116_hw_tim_port_brake] */
#include "ametal.h"
#include "am_clk.h"
#include "am_clk.h"
#include "am_int.h"
                                       ...
                                       uint32_t           period_ns)
{
    ...
    /* 刹车使能 */
    amhw_hc32_tim_mode23_dtr_enable(p_hw_tim, AMHW_HC32_TIM_DTR_BKE);

    /* 刹车中断使能 */
    amhw_hc32_tim_mode23_int_enable(p_hw_tim, AMHW_HC32_TIM_INT_BIE);
                                        ...
                                        uint32_t period_ns)
{
    ...
    /* 定时器配置 */
    if((__hc32_hw_tim_init(p_tim, type, chan, duty_ns , period_ns)) ==
       AM_FALSE) {
        return;
    }
