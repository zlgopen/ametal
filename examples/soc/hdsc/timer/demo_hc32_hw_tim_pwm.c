 ...
 *
 * \par 源代码
 * \snippet demo_hc32116_hw_tim_pwm.c src_hc32116_hw_tim_pwm
 *
 * \internal
...
/**
 * \addtogroup demo_if_hc32116_hw_tim_pwm
 * \copydoc demo_hc32116_hw_tim_pwm.c
 */

/** [src_hc32116_hw_tim_pwm] */
#include "ametal.h"
#include "am_clk.h"
#include "am_int.h"
#include "am_gpio.h"
...
/**
  * \brief PWM 中断服务函数
  */
static void __hc32_tim_hw_pwm_irq_handler (void *p_arg)
{
 ...
 */
void tim_pwm_chan_config (amhw_hc32_tim_t *p_hw_tim,
                          uint32_t           chan,
                          uint32_t           duty_ns,
                          uint32_t           period_ns,
                          uint32_t           clk_rate,
                          uint8_t            clk_div)
{
    ...
    /* 分频系数设置 */
    amhw_hc32_tim_mode_clkdiv_set(p_hw_tim, (amhw_hc32_tim_clkdiv_t)clk_div);
...
void tim_pwm_enable (amhw_hc32_tim_t      *p_hw_tim,
                     amhw_hc32_tim_type_t  type,
                     uint32_t                chan,
                     int32_t                 int_num)
{
    /* 连接中断回调函数 */
    am_int_connect(int_num, __hc32_tim_hw_pwm_irq_handler, (void *)p_hw_tim);
 ...
 * \return 无
 */
void tim_pwm_init (amhw_hc32_tim_t *p_hw_tim, uint8_t type, uint8_t chan)
{
                                 ...
                                 int32_t  inum)
{
    ...
    tim_pwm_enable(p_tim, (amhw_hc32_tim_type_t)type, chan, inum);
