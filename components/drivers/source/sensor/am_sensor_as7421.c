...
//////struct as7421_debug_info {
//////    const char  **reg_name_str;
//////    uint8_t     *reg;
//////};

//////const char *__as7421_reg_name_string[] = {
//////"ASTATUS     ",
//////"CH0_DATA_L  ",
//////"CH0_DATA_H  ",
//////"ITIME_L     ",
...
//////static uint8_t __as7421_reg_name[] = {
//////0x60,
//////0x61,
//////0x62,
//////__AS7421_REG_ITIME_L,
//////__AS7421_REG_ITIME_M,
//////__AS7421_REG_ITIME_H,
//////0x66,
//////0x67,
//////0x68,
//////0x69,
...
//////__AS7421_REG_ATIME,
//////__AS7421_REG_WTIME,
//////__AS7421_REG_SP_TH_L_LSB,
//////__AS7421_REG_SP_TH_L_MSB,
//////__AS7421_REG_SP_TH_H_LSB,
//////__AS7421_REG_SP_TH_H_MSB,
//////__AS7421_REG_AUXID,
//////__AS7421_REG_REVID,
//////__AS7421_REG_ID,
//////__AS7421_REG_STATUS,
//////__AS7421_REG_ASTATUS,
//////__AS7421_REG_CH0_DATA_L,
//////__AS7421_REG_CH0_DATA_H,
//////__AS7421_REG_CH1_DATA_L,
//////__AS7421_REG_CH1_DATA_H,
//////__AS7421_REG_CH2_DATA_L,
//////__AS7421_REG_CH2_DATA_H,
//////__AS7421_REG_CH3_DATA_L,
//////__AS7421_REG_CH3_DATA_H,
//////__AS7421_REG_CH4_DATA_L,
//////__AS7421_REG_CH4_DATA_H,
//////__AS7421_REG_CH5_DATA_L,
//////__AS7421_REG_CH5_DATA_H,
//////__AS7421_REG_STATUS2,
//////__AS7421_REG_STATUS3,
//////__AS7421_REG_STATUS5,
//////__AS7421_REG_STATUS6,
//////__AS7421_REG_CFG0,
//////__AS7421_REG_CFG1,
//////__AS7421_REG_CFG3,
//////__AS7421_REG_CFG6,
...
//////__AS7421_REG_ASTEPL,
//////__AS7421_REG_ASTEPH,
//////__AS7421_REG_AGC_GAIN_MAX,
//////__AS7421_REG_AZ_CONFIG,
//////__AS7421_REG_FD_TIME1,
//////__AS7421_REG_FD_TIME2,
//////__AS7421_REG_FIFO_CFG0,
//////__AS7421_REG_FD_STATUS,
//////__AS7421_REG_INTENAB,
//////__AS7421_REG_CONTROL,
//////__AS7421_REG_FIFO_MAP,
//////__AS7421_REG_FIFO_LVL,
//////__AS7421_REG_FDATAL,
//////__AS7421_REG_FDATAH,

//////};

//////struct as7421_debug_info __g_as7421_debug_info = {
//////    __as7421_reg_name_string,
//////    __as7421_reg_name,
//////};

///////** \brief AS7421 调试输出所有寄存器值 */
//////am_local void __as7421_regval_check(am_sensor_as7421_dev_t *p_this)
//////{
//////    uint8_t reg_buf[0xFF - 0x60 + 1]    = {0};         /* 缓存寄存器值 */
//////    uint8_t counter = 0;
//////    uint8_t reg_num = 0;

//////    __as7421_read(p_this, 0x60, reg_buf, (0xFF - 0x60 + 1));

//////    reg_num = AM_NELEMENTS(__as7421_reg_name);

//////    for (counter = 0; counter < reg_num; counter++) {
//////        am_kprintf("%s : 0x%02x \r\n",
//////                    __g_as7421_debug_info.reg_name_str[counter], 
//////                    reg_buf[__g_as7421_debug_info.reg[counter] - 0x60]);
//////    }
//////}
//////#endif
