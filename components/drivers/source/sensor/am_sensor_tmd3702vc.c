...
/**< 调试信息输出 */
#define __TMD3702VC_DEBUG           (1)

/*********************************************************************************************
 * 宏定义
 ********************************************************************************************/
#define __TMD3702VC_REG_ENABLE      (0x80)  /**< \brief 使能状态                            */
#define __TMD3702VC_REG_ATIME       (0x81)  /**< \brief 控制ALS ADC的积分时间               */
#define __TMD3702VC_REG_PRATE       (0x82)  /**< \brief Prox采样持续时间:(PRATE + 1) * 88us */
#define __TMD3702VC_REG_WTIME       (0x83)  /**< \brief ALS与Prox之间的等待时间             */
#define __TMD3702VC_REG_AILTL       (0x84)  /**< \brief ALS中断低阈值低字节 (Clear)         */
#define __TMD3702VC_REG_AILTH       (0x85)  /**< \brief ALS中断低阈值高字节 (Clear)         */
#define __TMD3702VC_REG_AIHTL       (0x86)  /**< \brief ALS中断高阈值低字节 (Clear)         */
#define __TMD3702VC_REG_AIHTH       (0x87)  /**< \brief ALS中断高阈值高字节 (Clear)         */
#define __TMD3702VC_REG_PILTL       (0x88)  /**< \brief Prox中断低阈值低字节                */
#define __TMD3702VC_REG_PILTH       (0x89)  /**< \brief Prox中断低阈值高字节                */
#define __TMD3702VC_REG_PIHTL       (0x8A)  /**< \brief Prox中断高阈值低字节                */
#define __TMD3702VC_REG_PIHTH       (0x8B)  /**< \brief Prox中断高阈值高字节                */
#define __TMD3702VC_REG_PERS        (0x8C)  /**< \brief ALS and prox中断过滤器              */
#define __TMD3702VC_REG_CFG0        (0x8D)  /**< \brief 配置寄存器0                         */
#define __TMD3702VC_REG_PCFG0       (0x8E)  /**< \brief Prox配置寄存器0                     */
#define __TMD3702VC_REG_PCFG1       (0x8F)  /**< \brief Prox配置寄存器1                     */
#define __TMD3702VC_REG_CFG1        (0x90)  /**< \brief 配置寄存器1                         */
#define __TMD3702VC_REG_REVID       (0x91)  /**< \brief 修订ID                              */
#define __TMD3702VC_REG_ID          (0x92)  /**< \brief 设备ID                              */
#define __TMD3702VC_REG_STATUS      (0x93)  /**< \brief 设备状态                            */
#define __TMD3702VC_REG_CDATAL      (0x94)  /**< \brief Clear 通道ADC数据低字节             */
#define __TMD3702VC_REG_CDATAH      (0x95)  /**< \brief Clear 通道ADC数据高字节             */
#define __TMD3702VC_REG_RDATAL      (0x96)  /**< \brief Red 通道ADC数据低字节               */
#define __TMD3702VC_REG_RDATAH      (0x97)  /**< \brief Red 通道ADC数据高字节               */
#define __TMD3702VC_REG_GDATAL      (0x98)  /**< \brief Green/IR 通道ADC数据低字节          */
#define __TMD3702VC_REG_GDATAH      (0x99)  /**< \brief Green/IR 通道ADC数据高字节          */
#define __TMD3702VC_REG_BDATAL      (0x9A)  /**< \brief Blue 通道ADC数据低字节              */
#define __TMD3702VC_REG_BDATAH      (0x9B)  /**< \brief Blue 通道ADC数据高字节              */
#define __TMD3702VC_REG_PDATAL      (0x9C)  /**< \brief Prox ADC数据低字节                  */
#define __TMD3702VC_REG_PDATAH      (0x9D)  /**< \brief Prox ADC数据高字节                  */
#define __TMD3702VC_REG_REVID2      (0x9E)  /**< \brief 修订ID 2                            */
#define __TMD3702VC_REG_CFG2        (0x9F)  /**< \brief 配置寄存器2                         */
#define __TMD3702VC_REG_SOFTRST     (0xA0)  /**< \brief 软复位                              */
#define __TMD3702VC_REG_CFG3        (0xAB)  /**< \brief 配置寄存器3                         */
#define __TMD3702VC_REG_CFG4        (0xAC)  /**< \brief 配置寄存器4 (must be set to 0x3D)   */
#define __TMD3702VC_REG_CFG6        (0xAE)  /**< \brief 配置寄存器6                         */
#define __TMD3702VC_REG_POFFSETL    (0xC0)  /**< \brief Prox偏移低字节数据                  */
#define __TMD3702VC_REG_POFFSETH    (0xC1)  /**< \brief Prox偏移高字节数据                  */
#define __TMD3702VC_REG_CALIB       (0xD7)  /**< \brief Prox偏移校准                        */
#define __TMD3702VC_REG_CALIBCFG    (0xD9)  /**< \brief Prox偏移校准控制                    */
#define __TMD3702VC_REG_CALIBSTAT   (0xDC)  /**< \brief Prox偏移校准状态                    */
#define __TMD3702VC_REG_INTENAB     (0xDD)  /**< \brief 中断使能                            */
#define __TMD3702VC_REG_FAC_L       (0xE6)  /**< \brief 出厂设置低数据 (lot code data)      */
#define __TMD3702VC_REG_FAC_H       (0xE7)  /**< \brief 出厂设置高数据 (lot code data)      */
#define __TMD3702VC_REG_TEST3       (0xF2)  /**< \brief 测试3 (must be set to 0xC4)         */
...
am_local am_err_t __tmd3702vc_param_init(am_sensor_tmd3702vc_dev_t *p_this)
{
    ...
    /* CFG3 寄存器配置 */
    __tmd3702vc_status_clr_all(p_this);      /* 清除STATUS寄存器 */
                                         ...
                                         tmd3702vc_result_info_t    *p_result)
{
    ...
    uint8_t result_buf[10]  = {0};         /* 缓存寄存器值 */
...
am_local am_err_t __pfn_trigger_on (void *p_drv, int id)
{
    ...
    __tmd3702vc_ioctl(p_this, AM_SENSOR_TMD3702VC_INT_ENABLE,
                                (void *)(AM_TMD3702VC_PIEN |    /* Prox中断 */
                                         AM_TMD3702VC_AIEN));   /* ALS中断 */
